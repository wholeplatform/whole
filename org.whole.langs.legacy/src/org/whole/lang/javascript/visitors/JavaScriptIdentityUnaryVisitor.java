 ...
 * @generator Whole
 */
public class JavaScriptIdentityUnaryVisitor<V extends IVisitor> extends
		AbstractUnaryVisitor<V> implements IJavaScriptVisitor {
	public JavaScriptIdentityUnaryVisitor() {
		super(null);
	}

	public JavaScriptIdentityUnaryVisitor(IVisitor visitor1) {
		super(visitor1);
	}
