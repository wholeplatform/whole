 ...
 * @generator Whole
 */
public class JavaScriptSequenceVisitor extends
		AbstractBinaryVisitor<IJavaScriptVisitor> implements IJavaScriptVisitor {
	public JavaScriptSequenceVisitor(IVisitor visitor1, IVisitor visitor2) {
