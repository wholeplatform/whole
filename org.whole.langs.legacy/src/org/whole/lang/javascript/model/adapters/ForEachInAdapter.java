 ...
 * @generator Whole
 */
public class ForEachInAdapter extends AbstractEntityAdapter implements
		ForEachIn {
	private static final long serialVersionUID = 1;

	public ForEachInAdapter(IEntity implementor) {
		super(implementor);
	}

	public ForEachInAdapter() {
	}
	...
	public EntityDescriptor<ForEachIn> wGetEntityDescriptor() {
		return JavaScriptEntityDescriptorEnum.ForEachIn;
	}
