...
public class TextEntityDescriptorEnum extends EntityDescriptorEnum {
	...
	public static final int IRow_ord = 6;
	public static final int IText_ord = 7;
	...
	public static final EntityDescriptor<Indent> Indent = (EntityDescriptor<Indent>) instance.valueOf(Indent_ord);
	...
	public static final EntityDescriptor<Row> Row = (EntityDescriptor<Row>) instance.valueOf(Row_ord);
	public static final EntityDescriptor<Text> Text = (EntityDescriptor<Text>) instance.valueOf(Text_ord);
	public static final EntityDescriptor<IRow> IRow = (EntityDescriptor<IRow>) instance.valueOf(IRow_ord);
	...
	protected void initEntityDescriptors() {
		putCompositeEntity(Document_ord, "Document", Document.class, false, IRow_ord, true, false);
		putDataEntity(Indent_ord, "Indent", Indent.class, false, int.class);
		putDataEntity(RowSeparator_ord, "RowSeparator", RowSeparator.class, false, String.class);
		putDataEntity(TextSeparator_ord, "TextSeparator", TextSeparator.class, false, String.class);
		putCompositeEntity(Row_ord, "Row", Row.class, false, IText_ord, true, false);
		putDataEntity(Text_ord, "Text", Text.class, false, String.class);
		putSimpleEntity(IRow_ord, "IRow", IRow.class, true, Indent_ord, TextSeparator_ord, Row_ord, RowSeparator_ord,
				Document_ord);
		putSimpleEntity(IText_ord, "IText", IText.class, true, TextSeparator_ord, Text_ord, Row_ord, Document_ord);
	}
}
