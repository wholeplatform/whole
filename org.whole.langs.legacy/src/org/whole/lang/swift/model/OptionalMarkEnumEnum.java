 ...
 *  @generator Whole
 */
public class OptionalMarkEnumEnum extends EnumType<OptionalMarkEnumEnum.Value> {
    public static final int PostfixQuestionMark_ord = 0;
    public static final int InfixQuestionMark_ord = 1;
    public static final int ExclamationMark_ord = 2;
    public static final OptionalMarkEnumEnum instance = new OptionalMarkEnumEnum();
