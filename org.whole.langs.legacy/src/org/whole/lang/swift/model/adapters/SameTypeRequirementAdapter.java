 ...
 *  @generator Whole
 */
public class SameTypeRequirementAdapter extends AbstractEntityAdapter implements SameTypeRequirement {
    private static final long serialVersionUID = 1;

    public SameTypeRequirementAdapter(IEntity implementor) {
        super(implementor);
    }

    public SameTypeRequirementAdapter() {
    }
    ...
    public Type getLeftTypeIdentifier() {
        return wGet(SwiftFeatureDescriptorEnum.leftTypeIdentifier).wGetAdapter(SwiftEntityDescriptorEnum.Type);
    }
    ...
    public AbstractEqualityToken getEqualityToken() {
        return wGet(SwiftFeatureDescriptorEnum.equalityToken).wGetAdapter(SwiftEntityDescriptorEnum.AbstractEqualityToken);
    }
    ...
    public Type getRightTypeIdentifier() {
        return wGet(SwiftFeatureDescriptorEnum.rightTypeIdentifier).wGetAdapter(SwiftEntityDescriptorEnum.Type);
    }
