 ...
 *  @generator Whole
 */
public class EditorPlaceholderExprAdapter extends AbstractEntityAdapter implements EditorPlaceholderExpr {
    private static final long serialVersionUID = 1;

    public EditorPlaceholderExprAdapter(IEntity implementor) {
        super(implementor);
    }

    public EditorPlaceholderExprAdapter() {
    }
    ...
    public EntityDescriptor<EditorPlaceholderExpr> wGetEntityDescriptor() {
        return SwiftEntityDescriptorEnum.EditorPlaceholderExpr;
    }
