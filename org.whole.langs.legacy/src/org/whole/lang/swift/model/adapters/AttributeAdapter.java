...
public class AttributeAdapter extends AbstractEntityAdapter implements Attribute {
    ...
    public Identifier getAttributeName() {
        return wGet(SwiftFeatureDescriptorEnum.attributeName).wGetAdapter(SwiftEntityDescriptorEnum.Identifier);
    }
    ...
    public AbstractArgument getArgument() {
        return wGet(SwiftFeatureDescriptorEnum.argument).wGetAdapter(SwiftEntityDescriptorEnum.AbstractArgument);
    }
