...
public class PrecedenceGroupAssignmentAdapter extends AbstractEntityAdapter implements PrecedenceGroupAssignment {
    ...
    public Identifier getAssignmentKeyword() {
        return wGet(SwiftFeatureDescriptorEnum.assignmentKeyword).wGetAdapter(SwiftEntityDescriptorEnum.Identifier);
    }
    ...
    public FlagEnum getFlag() {
        return wGet(SwiftFeatureDescriptorEnum.flag).wGetAdapter(SwiftEntityDescriptorEnum.FlagEnum);
    }
