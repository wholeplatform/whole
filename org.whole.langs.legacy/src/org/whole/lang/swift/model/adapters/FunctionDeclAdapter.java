 ...
 *  @generator Whole
 */
public class FunctionDeclAdapter extends AbstractEntityAdapter implements FunctionDecl {
    private static final long serialVersionUID = 1;

    public FunctionDeclAdapter(IEntity implementor) {
        super(implementor);
    }
    ...
    public AbstractFunctionIdentifier getFunctionIdentifier() {
        return wGet(SwiftFeatureDescriptorEnum.functionIdentifier).wGetAdapter(SwiftEntityDescriptorEnum.AbstractFunctionIdentifier);
    }
    ...
    public FunctionSignature getSignature() {
        return wGet(SwiftFeatureDescriptorEnum.signature).wGetAdapter(SwiftEntityDescriptorEnum.FunctionSignature);
    }
