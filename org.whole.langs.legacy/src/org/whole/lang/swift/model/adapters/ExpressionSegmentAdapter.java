...
public class ExpressionSegmentAdapter extends AbstractEntityAdapter implements ExpressionSegment {
    ...
    public RawStringDelimiter getDelimiter() {
        return wGet(SwiftFeatureDescriptorEnum.delimiter).wGetAdapter(SwiftEntityDescriptorEnum.RawStringDelimiter);
    }
    ...
    public FunctionCallArgumentList getExpressions() {
        return wGet(SwiftFeatureDescriptorEnum.expressions).wGetAdapter(SwiftEntityDescriptorEnum.FunctionCallArgumentList);
    }
