...
public class PrefixOperatorExprAdapter extends AbstractEntityAdapter implements PrefixOperatorExpr {
    ...
    public PrefixOperator getOperatorToken() {
        return wGet(SwiftFeatureDescriptorEnum.operatorToken).wGetAdapter(SwiftEntityDescriptorEnum.PrefixOperator);
    }
    ...
    public Expr getPostfixExpression() {
        return wGet(SwiftFeatureDescriptorEnum.postfixExpression).wGetAdapter(SwiftEntityDescriptorEnum.Expr);
    }
