 ...
 *  @generator Whole
 */
public class MetatypeTypeAdapter extends AbstractEntityAdapter implements MetatypeType {
    private static final long serialVersionUID = 1;

    public MetatypeTypeAdapter(IEntity implementor) {
        super(implementor);
    }

    public MetatypeTypeAdapter() {
    }
    ...
    public TypeOrProtocolValue getTypeOrProtocol() {
        return wGet(SwiftFeatureDescriptorEnum.typeOrProtocol).wGetAdapter(SwiftEntityDescriptorEnum.TypeOrProtocolValue);
    }
