...
public class PrecedenceGroupRelationAdapter extends AbstractEntityAdapter implements PrecedenceGroupRelation {
    ...
    public HigherThanOrLowerThanValue getHigherThanOrLowerThan() {
        return wGet(SwiftFeatureDescriptorEnum.higherThanOrLowerThan).wGetAdapter(SwiftEntityDescriptorEnum.HigherThanOrLowerThanValue);
    }
    ...
    public PrecedenceGroupNameList getOtherNames() {
        return wGet(SwiftFeatureDescriptorEnum.otherNames).wGetAdapter(SwiftEntityDescriptorEnum.PrecedenceGroupNameList);
    }
