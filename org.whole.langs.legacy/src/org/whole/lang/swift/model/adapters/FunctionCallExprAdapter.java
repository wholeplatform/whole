 ...
 *  @generator Whole
 */
public class FunctionCallExprAdapter extends AbstractEntityAdapter implements FunctionCallExpr {
    private static final long serialVersionUID = 1;

    public FunctionCallExprAdapter(IEntity implementor) {
        super(implementor);
    }

    public FunctionCallExprAdapter() {
    }
    ...
    public EntityDescriptor<FunctionCallExpr> wGetEntityDescriptor() {
        return SwiftEntityDescriptorEnum.FunctionCallExpr;
    }
