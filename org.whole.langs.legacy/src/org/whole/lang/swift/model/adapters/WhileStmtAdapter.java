 ...
 *  @generator Whole
 */
public class WhileStmtAdapter extends AbstractEntityAdapter implements WhileStmt {
    private static final long serialVersionUID = 1;

    public WhileStmtAdapter(IEntity implementor) {
        super(implementor);
    }

    public WhileStmtAdapter() {
    }
    ...
    public EntityDescriptor<WhileStmt> wGetEntityDescriptor() {
        return SwiftEntityDescriptorEnum.WhileStmt;
    }
    ...
    public ConditionElementList getConditions() {
        return wGet(SwiftFeatureDescriptorEnum.conditions).wGetAdapter(SwiftEntityDescriptorEnum.ConditionElementList);
    }
