...
public class FunctionTypeAdapter extends AbstractEntityAdapter implements FunctionType {
    ...
    public TupleTypeElementList getArguments() {
        return wGet(SwiftFeatureDescriptorEnum.arguments).wGetAdapter(SwiftEntityDescriptorEnum.TupleTypeElementList);
    }
    ...
    public Type getReturnType() {
        return wGet(SwiftFeatureDescriptorEnum.returnType).wGetAdapter(SwiftEntityDescriptorEnum.Type);
    }
