 ...
 *  @generator Whole
 */
public class EnumCaseDeclAdapter extends AbstractEntityAdapter implements EnumCaseDecl {
    private static final long serialVersionUID = 1;

    public EnumCaseDeclAdapter(IEntity implementor) {
        super(implementor);
    }

    public EnumCaseDeclAdapter() {
    }
    ...
    public EntityDescriptor<EnumCaseDecl> wGetEntityDescriptor() {
        return SwiftEntityDescriptorEnum.EnumCaseDecl;
    }
    ...
    public EnumCaseElementList getElements() {
        return wGet(SwiftFeatureDescriptorEnum.elements).wGetAdapter(SwiftEntityDescriptorEnum.EnumCaseElementList);
    }
