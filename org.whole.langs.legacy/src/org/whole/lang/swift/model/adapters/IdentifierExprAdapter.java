 ...
 *  @generator Whole
 */
public class IdentifierExprAdapter extends AbstractEntityAdapter implements IdentifierExpr {
    private static final long serialVersionUID = 1;

    public IdentifierExprAdapter(IEntity implementor) {
        super(implementor);
    }

    public IdentifierExprAdapter() {
    }
    ...
    public AbstractIdentifier getIdentifier() {
        return wGet(SwiftFeatureDescriptorEnum.identifier).wGetAdapter(SwiftEntityDescriptorEnum.AbstractIdentifier);
    }
