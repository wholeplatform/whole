...
public class VersionTupleAdapter extends AbstractEntityAdapter implements VersionTuple {
    ...
    public AbstractMajorMinor getMajorMinor() {
        return wGet(SwiftFeatureDescriptorEnum.majorMinor).wGetAdapter(SwiftEntityDescriptorEnum.AbstractMajorMinor);
    }
    ...
    public IntegerLiteral getPatchVersion() {
        return wGet(SwiftFeatureDescriptorEnum.patchVersion).wGetAdapter(SwiftEntityDescriptorEnum.IntegerLiteral);
    }
