...
public class DictionaryElementAdapter extends AbstractEntityAdapter implements DictionaryElement {
    ...
    public Expr getKeyExpression() {
        return wGet(SwiftFeatureDescriptorEnum.keyExpression).wGetAdapter(SwiftEntityDescriptorEnum.Expr);
    }
    ...
    public Expr getValueExpression() {
        return wGet(SwiftFeatureDescriptorEnum.valueExpression).wGetAdapter(SwiftEntityDescriptorEnum.Expr);
    }
