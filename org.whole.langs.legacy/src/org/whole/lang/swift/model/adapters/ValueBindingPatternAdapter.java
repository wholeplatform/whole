 ...
 *  @generator Whole
 */
public class ValueBindingPatternAdapter extends AbstractEntityAdapter implements ValueBindingPattern {
    private static final long serialVersionUID = 1;

    public ValueBindingPatternAdapter(IEntity implementor) {
        super(implementor);
    }

    public ValueBindingPatternAdapter() {
    }
    ...
    public LetOrVarKeywordEnum getLetOrVarKeyword() {
        return wGet(SwiftFeatureDescriptorEnum.letOrVarKeyword).wGetAdapter(SwiftEntityDescriptorEnum.LetOrVarKeywordEnum);
    }
    ...
    public Pattern getValuePattern() {
        return wGet(SwiftFeatureDescriptorEnum.valuePattern).wGetAdapter(SwiftEntityDescriptorEnum.Pattern);
    }
