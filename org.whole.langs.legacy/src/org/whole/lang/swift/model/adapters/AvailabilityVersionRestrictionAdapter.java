...
public class AvailabilityVersionRestrictionAdapter extends AbstractEntityAdapter implements AvailabilityVersionRestriction {
    ...
    public Identifier getPlatform() {
        return wGet(SwiftFeatureDescriptorEnum.platform).wGetAdapter(SwiftEntityDescriptorEnum.Identifier);
    }
    ...
    public VersionTuple getVersion() {
        return wGet(SwiftFeatureDescriptorEnum.version).wGetAdapter(SwiftEntityDescriptorEnum.VersionTuple);
    }
