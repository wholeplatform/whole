 ...
 *  @generator Whole
 */
public class MatchingPatternConditionAdapter extends AbstractEntityAdapter implements MatchingPatternCondition {
    private static final long serialVersionUID = 1;

    public MatchingPatternConditionAdapter(IEntity implementor) {
        super(implementor);
    }

    public MatchingPatternConditionAdapter() {
    }
