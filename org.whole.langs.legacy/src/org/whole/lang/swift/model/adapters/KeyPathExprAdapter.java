 ...
 *  @generator Whole
 */
public class KeyPathExprAdapter extends AbstractEntityAdapter implements KeyPathExpr {
    private static final long serialVersionUID = 1;

    public KeyPathExprAdapter(IEntity implementor) {
        super(implementor);
    }

    public KeyPathExprAdapter() {
    }
    ...
    public AbstractRootExpr getRootExpr() {
        return wGet(SwiftFeatureDescriptorEnum.rootExpr).wGetAdapter(SwiftEntityDescriptorEnum.AbstractRootExpr);
    }
