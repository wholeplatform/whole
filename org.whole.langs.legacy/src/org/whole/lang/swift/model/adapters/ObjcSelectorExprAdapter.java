...
public class ObjcSelectorExprAdapter extends AbstractEntityAdapter implements ObjcSelectorExpr {
    ...
    public KindValue getKind() {
        return wGet(SwiftFeatureDescriptorEnum.kind).wGetAdapter(SwiftEntityDescriptorEnum.KindValue);
    }
    ...
    public Expr getName() {
        return wGet(SwiftFeatureDescriptorEnum.name).wGetAdapter(SwiftEntityDescriptorEnum.Expr);
    }
