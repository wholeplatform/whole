...
import org.whole.lang.swift.model.NameValueEnum.Value;

/**
 *  @generator Whole
 */
public class NameValueAdapter extends AbstractEntityAdapter implements NameValue {
    private static final long serialVersionUID = 1;

    public NameValueAdapter(IEntity implementor) {
        super(implementor);
    }
