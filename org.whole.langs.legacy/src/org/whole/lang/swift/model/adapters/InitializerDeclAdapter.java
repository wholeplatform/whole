...
public class InitializerDeclAdapter extends AbstractEntityAdapter implements InitializerDecl {
    ...
    public OptionalMarkEnum getOptionalMark() {
        return wGet(SwiftFeatureDescriptorEnum.optionalMark).wGetAdapter(SwiftEntityDescriptorEnum.OptionalMarkEnum);
    }
    ...
    public FunctionParameterList getParameters() {
        return wGet(SwiftFeatureDescriptorEnum.parameters).wGetAdapter(SwiftEntityDescriptorEnum.FunctionParameterList);
    }
