 ...
 *  @generator Whole
 */
public class LabeledSpecializeEntryImpl extends AbstractSimpleEntity implements LabeledSpecializeEntry {
    private static final long serialVersionUID = 1;

    public EntityDescriptor<LabeledSpecializeEntry> wGetEntityDescriptor() {
        return SwiftEntityDescriptorEnum.LabeledSpecializeEntry;
    }

    public int wGetEntityOrd() {
        return SwiftEntityDescriptorEnum.LabeledSpecializeEntry_ord;
    }
