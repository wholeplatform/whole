...
import org.whole.lang.swift.model.AbstractOperatorToken;
...
public class BinaryOperatorExprImpl extends AbstractSimpleEntity implements BinaryOperatorExpr {
    ...
    public int wGetEntityOrd() {
        return SwiftEntityDescriptorEnum.BinaryOperatorExpr_ord;
    }
    ...
    private AbstractOperatorToken operatorToken;
    ...
    public void wSet(int index, IEntity value) {
        switch (index) {
            case 0 :
            setOperatorToken(value.wGetAdapter(SwiftEntityDescriptorEnum.AbstractOperatorToken));
            break;
            default :
            throw new IllegalArgumentException();
        }
