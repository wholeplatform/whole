...
import org.whole.lang.swift.model.EnumCaseDecl;
...
import org.whole.lang.swift.model.EnumCaseElementList;
...
public class EnumCaseDeclImpl extends AbstractSimpleEntity implements EnumCaseDecl {
    ...
    public int wGetEntityOrd() {
        return SwiftEntityDescriptorEnum.EnumCaseDecl_ord;
    }
    ...
    public void wSet(int index, IEntity value) {
        switch (index) {
            ...
            break;
            case 2 :
            setElements(value.wGetAdapter(SwiftEntityDescriptorEnum.EnumCaseElementList));
            break;
            default :
            throw new IllegalArgumentException();
        }
