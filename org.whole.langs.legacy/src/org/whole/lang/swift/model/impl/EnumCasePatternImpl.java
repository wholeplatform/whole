...
import org.whole.lang.swift.model.EnumCasePattern;
...
import org.whole.lang.swift.model.TuplePatternElementList;
...
public class EnumCasePatternImpl extends AbstractSimpleEntity implements EnumCasePattern {
    ...
    public int wGetEntityOrd() {
        return SwiftEntityDescriptorEnum.EnumCasePattern_ord;
    }
    ...
    private Identifier caseName;

    public Identifier getCaseName() {
        return notifyRequested(SwiftFeatureDescriptorEnum.caseName, caseName);
    }

    public void setCaseName(Identifier caseName) {
        notifyChanged(SwiftFeatureDescriptorEnum.caseName, this.caseName, this.caseName = caseName);
    }
    private TuplePatternElementList associatedTuple;

    public TuplePatternElementList getAssociatedTuple() {
        return notifyRequested(SwiftFeatureDescriptorEnum.associatedTuple, associatedTuple);
    }

    public void setAssociatedTuple(TuplePatternElementList associatedTuple) {
        notifyChanged(SwiftFeatureDescriptorEnum.associatedTuple, this.associatedTuple, this.associatedTuple = associatedTuple);
    }
    ...
    public void wSet(int index, IEntity value) {
        switch (index) {
            ...
            break;
            case 1 :
            setCaseName(value.wGetAdapter(SwiftEntityDescriptorEnum.Identifier));
            break;
            case 2 :
            setAssociatedTuple(value.wGetAdapter(SwiftEntityDescriptorEnum.TuplePatternElementList));
            break;
            default :
            throw new IllegalArgumentException();
        }
