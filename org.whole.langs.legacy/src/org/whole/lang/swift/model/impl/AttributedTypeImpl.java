...
public class AttributedTypeImpl extends AbstractSimpleEntity implements AttributedType {
    ...
    public int wGetEntityOrd() {
        return SwiftEntityDescriptorEnum.AttributedType_ord;
    }
    ...
    private SpecifierValue specifier;
    ...
    public void wSet(int index, IEntity value) {
        switch (index) {
            case 0 :
            setSpecifier(value.wGetAdapter(SwiftEntityDescriptorEnum.SpecifierValue));
            break;
            case 1 :
