 ...
 *  @generator Whole
 */
public class OpenQuoteEnumEnum extends EnumType<OpenQuoteEnumEnum.Value> {
    public static final int StringQuote_ord = 0;
    public static final int MultilineStringQuote_ord = 1;
    public static final OpenQuoteEnumEnum instance = new OpenQuoteEnumEnum();
