 ...
 *  @generator Whole
 */
public class PeriodEnumEnum extends EnumType<PeriodEnumEnum.Value> {
    public static final int Period_ord = 0;
    public static final int PrefixPeriod_ord = 1;
    public static final PeriodEnumEnum instance = new PeriodEnumEnum();
