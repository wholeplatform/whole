 ...
 *  @generator Whole
 */
public class SwiftSequenceVisitor extends AbstractBinaryVisitor<ISwiftVisitor> implements ISwiftVisitor {

    public SwiftSequenceVisitor(IVisitor visitor1, IVisitor visitor2) {
