 ...
 *  @generator Whole
 */
public class SwiftIdentityUnaryVisitor<V extends IVisitor>  extends AbstractUnaryVisitor<V> implements ISwiftVisitor {

    public SwiftIdentityUnaryVisitor() {
        super(null);
    }

    public SwiftIdentityUnaryVisitor(IVisitor visitor1) {
        super(visitor1);
    }
