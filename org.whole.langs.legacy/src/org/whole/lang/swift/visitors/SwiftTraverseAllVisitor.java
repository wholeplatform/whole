 ...
 *  @generator Whole
 */
public class SwiftTraverseAllVisitor extends SwiftIdentityUnaryVisitor<ISwiftVisitor> {

    public SwiftTraverseAllVisitor() {
        wSetVisitor1(this);
    }

    public SwiftTraverseAllVisitor(IVisitor visitor1) {
        super(visitor1);
    }
