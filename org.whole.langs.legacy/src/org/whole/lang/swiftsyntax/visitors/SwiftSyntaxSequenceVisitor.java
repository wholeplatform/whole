 ...
 *  @generator Whole
 */
public class SwiftSyntaxSequenceVisitor extends AbstractBinaryVisitor<ISwiftSyntaxVisitor> implements ISwiftSyntaxVisitor {

    public SwiftSyntaxSequenceVisitor(IVisitor visitor1, IVisitor visitor2) {
