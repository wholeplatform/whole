 ...
 *  @generator Whole
 */
public class SwiftSyntaxTraverseAllVisitor extends SwiftSyntaxIdentityUnaryVisitor<ISwiftSyntaxVisitor> {

    public SwiftSyntaxTraverseAllVisitor() {
        wSetVisitor1(this);
    }

    public SwiftSyntaxTraverseAllVisitor(IVisitor visitor1) {
        super(visitor1);
    }
