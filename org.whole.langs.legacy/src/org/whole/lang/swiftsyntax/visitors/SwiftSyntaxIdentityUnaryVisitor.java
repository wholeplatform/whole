 ...
 *  @generator Whole
 */
public class SwiftSyntaxIdentityUnaryVisitor<V extends IVisitor>  extends AbstractUnaryVisitor<V> implements ISwiftSyntaxVisitor {

    public SwiftSyntaxIdentityUnaryVisitor() {
        super(null);
    }

    public SwiftSyntaxIdentityUnaryVisitor(IVisitor visitor1) {
        super(visitor1);
    }
