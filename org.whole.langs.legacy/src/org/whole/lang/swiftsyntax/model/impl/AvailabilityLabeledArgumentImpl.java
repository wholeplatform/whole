...
import org.whole.lang.swiftsyntax.model.AvailabilityLabeledArgument;
...
public class AvailabilityLabeledArgumentImpl extends AbstractSimpleEntity implements AvailabilityLabeledArgument {
    ...
    public EntityDescriptor<AvailabilityLabeledArgument> wGetEntityDescriptor() {
        return SwiftSyntaxEntityDescriptorEnum.AvailabilityLabeledArgument;
    }

    public int wGetEntityOrd() {
        return SwiftSyntaxEntityDescriptorEnum.AvailabilityLabeledArgument_ord;
    }
    ...
    public void setValue(Syntax value) {
    ...
    public void wSet(int index, IEntity value) {
        switch (index) {
            ...
            break;
            case 2 :
            setValue(value.wGetAdapter(SwiftSyntaxEntityDescriptorEnum.Syntax));
            break;
            default :
            throw new IllegalArgumentException();
        }
