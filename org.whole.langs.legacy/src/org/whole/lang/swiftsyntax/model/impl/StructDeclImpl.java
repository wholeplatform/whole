...
import org.whole.lang.swiftsyntax.model.StructDecl;
 ...
 *  @generator Whole
 */
public class StructDeclImpl extends AbstractSimpleEntity implements StructDecl {
    ...
    public int wGetEntityOrd() {
        return SwiftSyntaxEntityDescriptorEnum.StructDecl_ord;
    }
    ...
    private Token structKeyword;

    public Token getStructKeyword() {
        return notifyRequested(SwiftSyntaxFeatureDescriptorEnum.structKeyword, structKeyword);
    }

    public void setStructKeyword(Token structKeyword) {
        notifyChanged(SwiftSyntaxFeatureDescriptorEnum.structKeyword, this.structKeyword, this.structKeyword = structKeyword);
    }
    ...
    public IEntity wGet(int index) {
        switch (index) {
            ...
            case 2 :
            return getStructKeyword().wGetAdaptee(false);
            case 3 :
    ...
    public void wSet(int index, IEntity value) {
        switch (index) {
            ...
            break;
            case 2 :
            setStructKeyword(value.wGetAdapter(SwiftSyntaxEntityDescriptorEnum.Token));
            break;
            case 3 :
