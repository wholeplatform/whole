...
import org.whole.lang.swiftsyntax.model.PoundSourceLocation;
...
public class PoundSourceLocationImpl extends AbstractSimpleEntity implements PoundSourceLocation {
    ...
    public int wGetEntityOrd() {
        return SwiftSyntaxEntityDescriptorEnum.PoundSourceLocation_ord;
    }
    ...
    private Token poundSourceLocation;

    public Token getPoundSourceLocation() {
        return notifyRequested(SwiftSyntaxFeatureDescriptorEnum.poundSourceLocation, poundSourceLocation);
    }

    public void setPoundSourceLocation(Token poundSourceLocation) {
        notifyChanged(SwiftSyntaxFeatureDescriptorEnum.poundSourceLocation, this.poundSourceLocation, this.poundSourceLocation = poundSourceLocation);
    }
    ...
    public PoundSourceLocationArgs getArgs() {
        return notifyRequested(SwiftSyntaxFeatureDescriptorEnum.args, args);
    }

    public void setArgs(PoundSourceLocationArgs args) {
        notifyChanged(SwiftSyntaxFeatureDescriptorEnum.args, this.args, this.args = args);
    }
    ...
    public IEntity wGet(int index) {
        switch (index) {
            case 0 :
            return getPoundSourceLocation().wGetAdaptee(false);
            case 1 :
    ...
    public void wSet(int index, IEntity value) {
        switch (index) {
            case 0 :
            setPoundSourceLocation(value.wGetAdapter(SwiftSyntaxEntityDescriptorEnum.Token));
            break;
            case 1 :
            setLeftParen(value.wGetAdapter(SwiftSyntaxEntityDescriptorEnum.Token));
            break;
            case 2 :
            setArgs(value.wGetAdapter(SwiftSyntaxEntityDescriptorEnum.PoundSourceLocationArgs));
            break;
            case 3 :
