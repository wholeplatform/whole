...
import org.whole.lang.swiftsyntax.model.SourceFile;
...
public class SourceFileImpl extends AbstractSimpleEntity implements SourceFile {
    ...
    public EntityDescriptor<SourceFile> wGetEntityDescriptor() {
        return SwiftSyntaxEntityDescriptorEnum.SourceFile;
    }

    public int wGetEntityOrd() {
        return SwiftSyntaxEntityDescriptorEnum.SourceFile_ord;
    }
    ...
    public Token getEofToken() {
        return notifyRequested(SwiftSyntaxFeatureDescriptorEnum.eofToken, eofToken);
    }

    public void setEofToken(Token eofToken) {
        notifyChanged(SwiftSyntaxFeatureDescriptorEnum.eofToken, this.eofToken, this.eofToken = eofToken);
    }
    ...
    public IEntity wGet(int index) {
        switch (index) {
            ...
            case 1 :
            return getEofToken().wGetAdaptee(false);
            default :
    ...
    public void wSet(int index, IEntity value) {
        switch (index) {
            ...
            break;
            case 1 :
            setEofToken(value.wGetAdapter(SwiftSyntaxEntityDescriptorEnum.Token));
            break;
            default :
            throw new IllegalArgumentException();
        }
