...
import org.whole.lang.swiftsyntax.model.AccessLevelModifier;
...
public class AccessLevelModifierImpl extends AbstractSimpleEntity implements AccessLevelModifier {
    ...
    public int wGetEntityOrd() {
        return SwiftSyntaxEntityDescriptorEnum.AccessLevelModifier_ord;
    }
    ...
    public void wSet(int index, IEntity value) {
        switch (index) {
            ...
            break;
            case 2 :
            setModifier(value.wGetAdapter(SwiftSyntaxEntityDescriptorEnum.Token));
            break;
            case 3 :
