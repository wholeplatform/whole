...
import org.whole.lang.swiftsyntax.model.ConditionElement;
 ...
 *  @generator Whole
 */
public class ConditionElementImpl extends AbstractSimpleEntity implements ConditionElement {
    private static final long serialVersionUID = 1;

    public EntityDescriptor<ConditionElement> wGetEntityDescriptor() {
        return SwiftSyntaxEntityDescriptorEnum.ConditionElement;
    }

    public int wGetEntityOrd() {
        return SwiftSyntaxEntityDescriptorEnum.ConditionElement_ord;
    }
    ...
    public void wSet(int index, IEntity value) {
        switch (index) {
            case 0 :
            setCondition(value.wGetAdapter(SwiftSyntaxEntityDescriptorEnum.Syntax));
            break;
            case 1 :
