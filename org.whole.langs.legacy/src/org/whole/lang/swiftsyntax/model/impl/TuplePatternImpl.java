...
import org.whole.lang.swiftsyntax.model.TuplePatternElementList;

/**
 *  @generator Whole
 */
public class TuplePatternImpl extends AbstractSimpleEntity implements TuplePattern {
    private static final long serialVersionUID = 1;

    public EntityDescriptor<TuplePattern> wGetEntityDescriptor() {
        return SwiftSyntaxEntityDescriptorEnum.TuplePattern;
    }

    public int wGetEntityOrd() {
        return SwiftSyntaxEntityDescriptorEnum.TuplePattern_ord;
    }
    ...
    private TuplePatternElementList elements;

    public TuplePatternElementList getElements() {
        return notifyRequested(SwiftSyntaxFeatureDescriptorEnum.elements, elements);
    }

    public void setElements(TuplePatternElementList elements) {
    ...
    public void wSet(int index, IEntity value) {
        switch (index) {
            ...
            break;
            case 1 :
            setElements(value.wGetAdapter(SwiftSyntaxEntityDescriptorEnum.TuplePatternElementList));
            break;
            case 2 :
