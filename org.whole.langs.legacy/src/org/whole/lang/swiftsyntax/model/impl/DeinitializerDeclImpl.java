...
import org.whole.lang.swiftsyntax.model.DeinitializerDecl;
 ...
 *  @generator Whole
 */
public class DeinitializerDeclImpl extends AbstractSimpleEntity implements DeinitializerDecl {
    private static final long serialVersionUID = 1;

    public EntityDescriptor<DeinitializerDecl> wGetEntityDescriptor() {
        return SwiftSyntaxEntityDescriptorEnum.DeinitializerDecl;
    }

    public int wGetEntityOrd() {
        return SwiftSyntaxEntityDescriptorEnum.DeinitializerDecl_ord;
    }
    ...
    private Token deinitKeyword;

    public Token getDeinitKeyword() {
        return notifyRequested(SwiftSyntaxFeatureDescriptorEnum.deinitKeyword, deinitKeyword);
    }

    public void setDeinitKeyword(Token deinitKeyword) {
        notifyChanged(SwiftSyntaxFeatureDescriptorEnum.deinitKeyword, this.deinitKeyword, this.deinitKeyword = deinitKeyword);
    }
    ...
    public IEntity wGet(int index) {
        switch (index) {
            ...
            case 2 :
            return getDeinitKeyword().wGetAdaptee(false);
            case 3 :
    ...
    public void wSet(int index, IEntity value) {
        switch (index) {
            ...
            break;
            case 2 :
            setDeinitKeyword(value.wGetAdapter(SwiftSyntaxEntityDescriptorEnum.Token));
            break;
            case 3 :
