 ...
 *  @generator Whole
 */
public class CustomAttributeAdapter extends AbstractEntityAdapter implements CustomAttribute {
    private static final long serialVersionUID = 1;

    public CustomAttributeAdapter(IEntity implementor) {
        super(implementor);
    }
    ...
    public Type getAttributeName() {
        return wGet(SwiftSyntaxFeatureDescriptorEnum.attributeName).wGetAdapter(SwiftSyntaxEntityDescriptorEnum.Type);
    }
