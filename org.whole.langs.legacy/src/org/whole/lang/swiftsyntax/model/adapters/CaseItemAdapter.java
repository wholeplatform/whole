 ...
 *  @generator Whole
 */
public class CaseItemAdapter extends AbstractEntityAdapter implements CaseItem {
    private static final long serialVersionUID = 1;

    public CaseItemAdapter(IEntity implementor) {
        super(implementor);
    }
    ...
    public EntityDescriptor<CaseItem> wGetEntityDescriptor() {
        return SwiftSyntaxEntityDescriptorEnum.CaseItem;
    }
