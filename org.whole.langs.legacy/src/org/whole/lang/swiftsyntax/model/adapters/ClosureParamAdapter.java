 ...
 *  @generator Whole
 */
public class ClosureParamAdapter extends AbstractEntityAdapter implements ClosureParam {
    private static final long serialVersionUID = 1;

    public ClosureParamAdapter(IEntity implementor) {
        super(implementor);
    }

    public ClosureParamAdapter() {
    }
