 ...
 *  @generator Whole
 */
public class WhereClauseAdapter extends AbstractEntityAdapter implements WhereClause {
    private static final long serialVersionUID = 1;

    public WhereClauseAdapter(IEntity implementor) {
        super(implementor);
    }

    public WhereClauseAdapter() {
    }
    ...
    public Expr getGuardResult() {
        return wGet(SwiftSyntaxFeatureDescriptorEnum.guardResult).wGetAdapter(SwiftSyntaxEntityDescriptorEnum.Expr);
    }
