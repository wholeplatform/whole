 ...
 *  @generator Whole
 */
public class ObjCSelectorPieceAdapter extends AbstractEntityAdapter implements ObjCSelectorPiece {
    private static final long serialVersionUID = 1;

    public ObjCSelectorPieceAdapter(IEntity implementor) {
        super(implementor);
    }

    public ObjCSelectorPieceAdapter() {
    }
