 ...
 *  @generator Whole
 */
public class TupleExprAdapter extends AbstractEntityAdapter implements TupleExpr {
    private static final long serialVersionUID = 1;

    public TupleExprAdapter(IEntity implementor) {
        super(implementor);
    }

    public TupleExprAdapter() {
    }
    ...
    public TupleElementList getElementList() {
        return wGet(SwiftSyntaxFeatureDescriptorEnum.elementList).wGetAdapter(SwiftSyntaxEntityDescriptorEnum.TupleElementList);
    }
