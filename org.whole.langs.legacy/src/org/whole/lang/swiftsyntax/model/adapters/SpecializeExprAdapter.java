 ...
 *  @generator Whole
 */
public class SpecializeExprAdapter extends AbstractEntityAdapter implements SpecializeExpr {
    private static final long serialVersionUID = 1;

    public SpecializeExprAdapter(IEntity implementor) {
        super(implementor);
    }

    public SpecializeExprAdapter() {
    }
