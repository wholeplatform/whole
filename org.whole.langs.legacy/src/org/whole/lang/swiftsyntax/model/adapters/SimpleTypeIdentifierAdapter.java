 ...
 *  @generator Whole
 */
public class SimpleTypeIdentifierAdapter extends AbstractEntityAdapter implements SimpleTypeIdentifier {
    private static final long serialVersionUID = 1;

    public SimpleTypeIdentifierAdapter(IEntity implementor) {
        super(implementor);
    }

    public SimpleTypeIdentifierAdapter() {
    }
    ...
    public EntityDescriptor<SimpleTypeIdentifier> wGetEntityDescriptor() {
        return SwiftSyntaxEntityDescriptorEnum.SimpleTypeIdentifier;
    }
