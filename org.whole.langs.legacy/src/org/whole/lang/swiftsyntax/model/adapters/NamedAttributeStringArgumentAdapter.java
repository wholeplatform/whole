...
public class NamedAttributeStringArgumentAdapter extends AbstractEntityAdapter implements NamedAttributeStringArgument {
    ...
    public Token getNameTok() {
        return wGet(SwiftSyntaxFeatureDescriptorEnum.nameTok).wGetAdapter(SwiftSyntaxEntityDescriptorEnum.Token);
    }
    ...
    public Syntax getStringOrDeclname() {
        return wGet(SwiftSyntaxFeatureDescriptorEnum.stringOrDeclname).wGetAdapter(SwiftSyntaxEntityDescriptorEnum.Syntax);
    }
