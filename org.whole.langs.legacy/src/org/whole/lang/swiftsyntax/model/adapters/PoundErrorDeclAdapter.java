 ...
 *  @generator Whole
 */
public class PoundErrorDeclAdapter extends AbstractEntityAdapter implements PoundErrorDecl {
    private static final long serialVersionUID = 1;

    public PoundErrorDeclAdapter(IEntity implementor) {
        super(implementor);
    }

    public PoundErrorDeclAdapter() {
    }
    ...
    public Token getPoundError() {
        return wGet(SwiftSyntaxFeatureDescriptorEnum.poundError).wGetAdapter(SwiftSyntaxEntityDescriptorEnum.Token);
    }
    ...
    public StringLiteralExpr getMessage() {
        return wGet(SwiftSyntaxFeatureDescriptorEnum.message).wGetAdapter(SwiftSyntaxEntityDescriptorEnum.StringLiteralExpr);
    }
