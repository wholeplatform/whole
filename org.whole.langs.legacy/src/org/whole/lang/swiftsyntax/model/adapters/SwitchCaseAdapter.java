...
public class SwitchCaseAdapter extends AbstractEntityAdapter implements SwitchCase {
    ...
    public Attribute getUnknownAttr() {
        return wGet(SwiftSyntaxFeatureDescriptorEnum.unknownAttr).wGetAdapter(SwiftSyntaxEntityDescriptorEnum.Attribute);
    }
    ...
    public Syntax getLabel() {
        return wGet(SwiftSyntaxFeatureDescriptorEnum.label).wGetAdapter(SwiftSyntaxEntityDescriptorEnum.Syntax);
    }
