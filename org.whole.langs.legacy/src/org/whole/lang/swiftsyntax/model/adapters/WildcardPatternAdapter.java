 ...
 *  @generator Whole
 */
public class WildcardPatternAdapter extends AbstractEntityAdapter implements WildcardPattern {
    private static final long serialVersionUID = 1;

    public WildcardPatternAdapter(IEntity implementor) {
        super(implementor);
    }

    public WildcardPatternAdapter() {
    }
