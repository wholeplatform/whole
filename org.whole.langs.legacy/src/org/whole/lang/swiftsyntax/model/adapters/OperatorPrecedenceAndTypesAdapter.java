 ...
 *  @generator Whole
 */
public class OperatorPrecedenceAndTypesAdapter extends AbstractEntityAdapter implements OperatorPrecedenceAndTypes {
    private static final long serialVersionUID = 1;

    public OperatorPrecedenceAndTypesAdapter(IEntity implementor) {
        super(implementor);
    }

    public OperatorPrecedenceAndTypesAdapter() {
    }
    ...
    public IdentifierList getPrecedenceGroupAndDesignatedTypes() {
        return wGet(SwiftSyntaxFeatureDescriptorEnum.precedenceGroupAndDesignatedTypes).wGetAdapter(SwiftSyntaxEntityDescriptorEnum.IdentifierList);
    }
