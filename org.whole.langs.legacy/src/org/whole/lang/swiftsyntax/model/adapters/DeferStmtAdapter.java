 ...
 *  @generator Whole
 */
public class DeferStmtAdapter extends AbstractEntityAdapter implements DeferStmt {
    private static final long serialVersionUID = 1;

    public DeferStmtAdapter(IEntity implementor) {
        super(implementor);
    }

    public DeferStmtAdapter() {
    }
    ...
    public Token getDeferKeyword() {
        return wGet(SwiftSyntaxFeatureDescriptorEnum.deferKeyword).wGetAdapter(SwiftSyntaxEntityDescriptorEnum.Token);
    }
