 ...
 *  @generator Whole
 */
public class TuplePatternAdapter extends AbstractEntityAdapter implements TuplePattern {
    private static final long serialVersionUID = 1;

    public TuplePatternAdapter(IEntity implementor) {
        super(implementor);
    }

    public TuplePatternAdapter() {
    }
    ...
    public TuplePatternElementList getElements() {
        return wGet(SwiftSyntaxFeatureDescriptorEnum.elements).wGetAdapter(SwiftSyntaxEntityDescriptorEnum.TuplePatternElementList);
    }
