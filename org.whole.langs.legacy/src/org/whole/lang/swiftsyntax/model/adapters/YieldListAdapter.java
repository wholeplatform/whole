 ...
 *  @generator Whole
 */
public class YieldListAdapter extends AbstractEntityAdapter implements YieldList {
    private static final long serialVersionUID = 1;

    public YieldListAdapter(IEntity implementor) {
        super(implementor);
    }

    public YieldListAdapter() {
    }
    ...
    public ExprList getElementList() {
        return wGet(SwiftSyntaxFeatureDescriptorEnum.elementList).wGetAdapter(SwiftSyntaxEntityDescriptorEnum.ExprList);
    }
