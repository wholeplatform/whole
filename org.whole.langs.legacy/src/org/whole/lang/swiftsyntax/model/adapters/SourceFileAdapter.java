 ...
 *  @generator Whole
 */
public class SourceFileAdapter extends AbstractEntityAdapter implements SourceFile {
    private static final long serialVersionUID = 1;

    public SourceFileAdapter(IEntity implementor) {
        super(implementor);
    }
    ...
    public Token getEofToken() {
        return wGet(SwiftSyntaxFeatureDescriptorEnum.eofToken).wGetAdapter(SwiftSyntaxEntityDescriptorEnum.Token);
    }
