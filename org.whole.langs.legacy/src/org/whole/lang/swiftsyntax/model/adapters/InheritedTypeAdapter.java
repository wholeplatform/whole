 ...
 *  @generator Whole
 */
public class InheritedTypeAdapter extends AbstractEntityAdapter implements InheritedType {
    private static final long serialVersionUID = 1;

    public InheritedTypeAdapter(IEntity implementor) {
        super(implementor);
    }

    public InheritedTypeAdapter() {
    }
