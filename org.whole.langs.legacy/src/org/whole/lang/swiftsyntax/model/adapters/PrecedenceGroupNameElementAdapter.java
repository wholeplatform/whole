 ...
 *  @generator Whole
 */
public class PrecedenceGroupNameElementAdapter extends AbstractEntityAdapter implements PrecedenceGroupNameElement {
    private static final long serialVersionUID = 1;

    public PrecedenceGroupNameElementAdapter(IEntity implementor) {
        super(implementor);
    }

    public PrecedenceGroupNameElementAdapter() {
    }
