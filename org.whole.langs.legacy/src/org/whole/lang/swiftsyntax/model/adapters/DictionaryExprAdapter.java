 ...
 *  @generator Whole
 */
public class DictionaryExprAdapter extends AbstractEntityAdapter implements DictionaryExpr {
    private static final long serialVersionUID = 1;

    public DictionaryExprAdapter(IEntity implementor) {
        super(implementor);
    }

    public DictionaryExprAdapter() {
    }
    ...
    public Syntax getContent() {
        return wGet(SwiftSyntaxFeatureDescriptorEnum.content).wGetAdapter(SwiftSyntaxEntityDescriptorEnum.Syntax);
    }
