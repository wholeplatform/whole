 ...
 *  @generator Whole
 */
public class TypeInitializerClauseAdapter extends AbstractEntityAdapter implements TypeInitializerClause {
    private static final long serialVersionUID = 1;

    public TypeInitializerClauseAdapter(IEntity implementor) {
        super(implementor);
    }

    public TypeInitializerClauseAdapter() {
    }
    ...
    public Type getValue() {
        return wGet(SwiftSyntaxFeatureDescriptorEnum.value).wGetAdapter(SwiftSyntaxEntityDescriptorEnum.Type);
    }
