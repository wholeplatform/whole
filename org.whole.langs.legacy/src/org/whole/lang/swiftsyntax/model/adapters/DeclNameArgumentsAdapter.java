 ...
 *  @generator Whole
 */
public class DeclNameArgumentsAdapter extends AbstractEntityAdapter implements DeclNameArguments {
    private static final long serialVersionUID = 1;

    public DeclNameArgumentsAdapter(IEntity implementor) {
        super(implementor);
    }

    public DeclNameArgumentsAdapter() {
    }
    ...
    public DeclNameArgumentList getArguments() {
        return wGet(SwiftSyntaxFeatureDescriptorEnum.arguments).wGetAdapter(SwiftSyntaxEntityDescriptorEnum.DeclNameArgumentList);
    }
