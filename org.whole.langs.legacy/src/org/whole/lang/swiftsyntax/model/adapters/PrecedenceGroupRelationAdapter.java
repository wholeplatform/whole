 ...
 *  @generator Whole
 */
public class PrecedenceGroupRelationAdapter extends AbstractEntityAdapter implements PrecedenceGroupRelation {
    private static final long serialVersionUID = 1;

    public PrecedenceGroupRelationAdapter(IEntity implementor) {
        super(implementor);
    }

    public PrecedenceGroupRelationAdapter() {
    }
    ...
    public Token getHigherThanOrLowerThan() {
        return wGet(SwiftSyntaxFeatureDescriptorEnum.higherThanOrLowerThan).wGetAdapter(SwiftSyntaxEntityDescriptorEnum.Token);
    }
    ...
    public PrecedenceGroupNameList getOtherNames() {
        return wGet(SwiftSyntaxFeatureDescriptorEnum.otherNames).wGetAdapter(SwiftSyntaxEntityDescriptorEnum.PrecedenceGroupNameList);
    }
