 ...
 *  @generator Whole
 */
public class AccessorBlockAdapter extends AbstractEntityAdapter implements AccessorBlock {
    private static final long serialVersionUID = 1;

    public AccessorBlockAdapter(IEntity implementor) {
        super(implementor);
    }

    public AccessorBlockAdapter() {
    }
    ...
    public AccessorList getAccessors() {
        return wGet(SwiftSyntaxFeatureDescriptorEnum.accessors).wGetAdapter(SwiftSyntaxEntityDescriptorEnum.AccessorList);
    }
