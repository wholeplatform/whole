 ...
 *  @generator Whole
 */
public class DeclNameArgumentAdapter extends AbstractEntityAdapter implements DeclNameArgument {
    private static final long serialVersionUID = 1;

    public DeclNameArgumentAdapter(IEntity implementor) {
        super(implementor);
    }

    public DeclNameArgumentAdapter() {
    }
