 ...
 *  @generator Whole
 */
public class AvailabilityConditionAdapter extends AbstractEntityAdapter implements AvailabilityCondition {
    private static final long serialVersionUID = 1;

    public AvailabilityConditionAdapter(IEntity implementor) {
        super(implementor);
    }

    public AvailabilityConditionAdapter() {
    }
    ...
    public Token getPoundAvailableKeyword() {
        return wGet(SwiftSyntaxFeatureDescriptorEnum.poundAvailableKeyword).wGetAdapter(SwiftSyntaxEntityDescriptorEnum.Token);
    }
    ...
    public AvailabilitySpecList getAvailabilitySpec() {
        return wGet(SwiftSyntaxFeatureDescriptorEnum.availabilitySpec).wGetAdapter(SwiftSyntaxEntityDescriptorEnum.AvailabilitySpecList);
    }
