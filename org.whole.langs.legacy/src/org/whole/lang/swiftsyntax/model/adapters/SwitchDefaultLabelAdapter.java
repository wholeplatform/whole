 ...
 *  @generator Whole
 */
public class SwitchDefaultLabelAdapter extends AbstractEntityAdapter implements SwitchDefaultLabel {
    private static final long serialVersionUID = 1;

    public SwitchDefaultLabelAdapter(IEntity implementor) {
        super(implementor);
    }

    public SwitchDefaultLabelAdapter() {
    }
    ...
    public Token getDefaultKeyword() {
        return wGet(SwiftSyntaxFeatureDescriptorEnum.defaultKeyword).wGetAdapter(SwiftSyntaxEntityDescriptorEnum.Token);
    }
