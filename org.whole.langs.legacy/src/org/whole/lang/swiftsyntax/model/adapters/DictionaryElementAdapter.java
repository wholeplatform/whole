 ...
 *  @generator Whole
 */
public class DictionaryElementAdapter extends AbstractEntityAdapter implements DictionaryElement {
    private static final long serialVersionUID = 1;

    public DictionaryElementAdapter(IEntity implementor) {
        super(implementor);
    }

    public DictionaryElementAdapter() {
    }
    ...
    public Expr getKeyExpression() {
        return wGet(SwiftSyntaxFeatureDescriptorEnum.keyExpression).wGetAdapter(SwiftSyntaxEntityDescriptorEnum.Expr);
    }
    ...
    public Expr getValueExpression() {
        return wGet(SwiftSyntaxFeatureDescriptorEnum.valueExpression).wGetAdapter(SwiftSyntaxEntityDescriptorEnum.Expr);
    }
