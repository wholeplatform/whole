 ...
 *  @generator Whole
 */
public class GenericArgumentAdapter extends AbstractEntityAdapter implements GenericArgument {
    private static final long serialVersionUID = 1;

    public GenericArgumentAdapter(IEntity implementor) {
        super(implementor);
    }

    public GenericArgumentAdapter() {
    }
    ...
    public Type getArgumentType() {
        return wGet(SwiftSyntaxFeatureDescriptorEnum.argumentType).wGetAdapter(SwiftSyntaxEntityDescriptorEnum.Type);
    }
