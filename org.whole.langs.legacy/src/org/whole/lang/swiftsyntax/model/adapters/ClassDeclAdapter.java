 ...
 *  @generator Whole
 */
public class ClassDeclAdapter extends AbstractEntityAdapter implements ClassDecl {
    private static final long serialVersionUID = 1;

    public ClassDeclAdapter(IEntity implementor) {
        super(implementor);
    }

    public ClassDeclAdapter() {
    }
    ...
    public EntityDescriptor<ClassDecl> wGetEntityDescriptor() {
        return SwiftSyntaxEntityDescriptorEnum.ClassDecl;
    }
    ...
    public Token getClassKeyword() {
        return wGet(SwiftSyntaxFeatureDescriptorEnum.classKeyword).wGetAdapter(SwiftSyntaxEntityDescriptorEnum.Token);
    }
