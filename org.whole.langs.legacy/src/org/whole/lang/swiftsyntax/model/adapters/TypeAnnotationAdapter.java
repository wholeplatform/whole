 ...
 *  @generator Whole
 */
public class TypeAnnotationAdapter extends AbstractEntityAdapter implements TypeAnnotation {
    private static final long serialVersionUID = 1;

    public TypeAnnotationAdapter(IEntity implementor) {
        super(implementor);
    }

    public TypeAnnotationAdapter() {
    }
    ...
    public EntityDescriptor<TypeAnnotation> wGetEntityDescriptor() {
        return SwiftSyntaxEntityDescriptorEnum.TypeAnnotation;
    }
