 ...
 *  @generator Whole
 */
public class GenericParameterClauseAdapter extends AbstractEntityAdapter implements GenericParameterClause {
    private static final long serialVersionUID = 1;

    public GenericParameterClauseAdapter(IEntity implementor) {
        super(implementor);
    }

    public GenericParameterClauseAdapter() {
    }
    ...
    public GenericParameterList getGenericParameterList() {
        return wGet(SwiftSyntaxFeatureDescriptorEnum.genericParameterList).wGetAdapter(SwiftSyntaxEntityDescriptorEnum.GenericParameterList);
    }
