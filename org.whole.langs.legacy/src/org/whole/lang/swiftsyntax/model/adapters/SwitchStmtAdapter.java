...
public class SwitchStmtAdapter extends AbstractEntityAdapter implements SwitchStmt {
    ...
    public Token getSwitchKeyword() {
        return wGet(SwiftSyntaxFeatureDescriptorEnum.switchKeyword).wGetAdapter(SwiftSyntaxEntityDescriptorEnum.Token);
    }
    ...
    public SwitchCaseList getCases() {
        return wGet(SwiftSyntaxFeatureDescriptorEnum.cases).wGetAdapter(SwiftSyntaxEntityDescriptorEnum.SwitchCaseList);
    }
