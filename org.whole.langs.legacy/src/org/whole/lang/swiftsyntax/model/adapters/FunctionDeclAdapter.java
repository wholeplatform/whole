...
public class FunctionDeclAdapter extends AbstractEntityAdapter implements FunctionDecl {
    ...
    public Token getFuncKeyword() {
        return wGet(SwiftSyntaxFeatureDescriptorEnum.funcKeyword).wGetAdapter(SwiftSyntaxEntityDescriptorEnum.Token);
    }
    ...
    public FunctionSignature getSignature() {
        return wGet(SwiftSyntaxFeatureDescriptorEnum.signature).wGetAdapter(SwiftSyntaxEntityDescriptorEnum.FunctionSignature);
    }
