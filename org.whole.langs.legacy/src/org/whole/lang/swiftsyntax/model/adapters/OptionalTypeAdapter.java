 ...
 *  @generator Whole
 */
public class OptionalTypeAdapter extends AbstractEntityAdapter implements OptionalType {
    private static final long serialVersionUID = 1;

    public OptionalTypeAdapter(IEntity implementor) {
        super(implementor);
    }
    ...
    public Type getWrappedType() {
        return wGet(SwiftSyntaxFeatureDescriptorEnum.wrappedType).wGetAdapter(SwiftSyntaxEntityDescriptorEnum.Type);
    }
