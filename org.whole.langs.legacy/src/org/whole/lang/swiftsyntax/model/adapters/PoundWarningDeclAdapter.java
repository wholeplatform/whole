 ...
 *  @generator Whole
 */
public class PoundWarningDeclAdapter extends AbstractEntityAdapter implements PoundWarningDecl {
    private static final long serialVersionUID = 1;

    public PoundWarningDeclAdapter(IEntity implementor) {
        super(implementor);
    }

    public PoundWarningDeclAdapter() {
    }
    ...
    public Token getPoundWarning() {
        return wGet(SwiftSyntaxFeatureDescriptorEnum.poundWarning).wGetAdapter(SwiftSyntaxEntityDescriptorEnum.Token);
    }
