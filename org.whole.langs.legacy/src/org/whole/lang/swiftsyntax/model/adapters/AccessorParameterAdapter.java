 ...
 *  @generator Whole
 */
public class AccessorParameterAdapter extends AbstractEntityAdapter implements AccessorParameter {
    private static final long serialVersionUID = 1;

    public AccessorParameterAdapter(IEntity implementor) {
        super(implementor);
    }

    public AccessorParameterAdapter() {
    }
    ...
    public EntityDescriptor<AccessorParameter> wGetEntityDescriptor() {
        return SwiftSyntaxEntityDescriptorEnum.AccessorParameter;
    }
