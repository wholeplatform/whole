 ...
 *  @generator Whole
 */
public class TupleElementAdapter extends AbstractEntityAdapter implements TupleElement {
    private static final long serialVersionUID = 1;

    public TupleElementAdapter(IEntity implementor) {
        super(implementor);
    }
    ...
    public EntityDescriptor<TupleElement> wGetEntityDescriptor() {
        return SwiftSyntaxEntityDescriptorEnum.TupleElement;
    }
