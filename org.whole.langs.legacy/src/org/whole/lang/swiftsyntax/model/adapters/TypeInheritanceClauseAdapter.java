 ...
 *  @generator Whole
 */
public class TypeInheritanceClauseAdapter extends AbstractEntityAdapter implements TypeInheritanceClause {
    private static final long serialVersionUID = 1;

    public TypeInheritanceClauseAdapter(IEntity implementor) {
        super(implementor);
    }

    public TypeInheritanceClauseAdapter() {
    }
    ...
    public InheritedTypeList getInheritedTypeCollection() {
        return wGet(SwiftSyntaxFeatureDescriptorEnum.inheritedTypeCollection).wGetAdapter(SwiftSyntaxEntityDescriptorEnum.InheritedTypeList);
    }
