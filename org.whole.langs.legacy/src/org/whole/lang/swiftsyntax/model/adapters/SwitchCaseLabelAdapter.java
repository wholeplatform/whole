 ...
 *  @generator Whole
 */
public class SwitchCaseLabelAdapter extends AbstractEntityAdapter implements SwitchCaseLabel {
    private static final long serialVersionUID = 1;

    public SwitchCaseLabelAdapter(IEntity implementor) {
        super(implementor);
    }

    public SwitchCaseLabelAdapter() {
    }
    ...
    public CaseItemList getCaseItems() {
        return wGet(SwiftSyntaxFeatureDescriptorEnum.caseItems).wGetAdapter(SwiftSyntaxEntityDescriptorEnum.CaseItemList);
    }
