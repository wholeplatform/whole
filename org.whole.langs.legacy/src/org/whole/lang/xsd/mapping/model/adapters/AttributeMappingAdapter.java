 ...
 * @generator Whole
 */
public class AttributeMappingAdapter extends AbstractEntityAdapter implements
		AttributeMapping {
	private static final long serialVersionUID = 1;

	public AttributeMappingAdapter(IEntity implementor) {
		super(implementor);
	}

	public AttributeMappingAdapter() {
	}
	...
	public EntityDescriptor<AttributeMapping> wGetEntityDescriptor() {
		return MappingEntityDescriptorEnum.AttributeMapping;
	}
