 ...
 * @generator Whole
 */
public class AnyStructuralMappingAdapter extends AbstractEntityAdapter
		implements AnyStructuralMapping {
	private static final long serialVersionUID = 1;

	public AnyStructuralMappingAdapter(IEntity implementor) {
		super(implementor);
	}

	public AnyStructuralMappingAdapter() {
	}
