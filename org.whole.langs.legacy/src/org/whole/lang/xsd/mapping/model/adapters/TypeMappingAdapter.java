 ...
 * @generator Whole
 */
public class TypeMappingAdapter extends AbstractEntityAdapter implements
		TypeMapping {
	private static final long serialVersionUID = 1;

	public TypeMappingAdapter(IEntity implementor) {
		super(implementor);
	}
	...
	public EntityDescriptor<TypeMapping> wGetEntityDescriptor() {
		return MappingEntityDescriptorEnum.TypeMapping;
	}
