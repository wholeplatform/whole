 ...
 * @generator Whole
 */
public class MixedStructuralMappingImpl extends AbstractSimpleEntity implements
		MixedStructuralMapping {
	...
	public int wGetEntityOrd() {
		return MappingEntityDescriptorEnum.MixedStructuralMapping_ord;
	}
