 ...
 * @generator Whole
 */
public class ContentMappingAdapter extends AbstractEntityAdapter implements
		ContentMapping {
	private static final long serialVersionUID = 1;

	public ContentMappingAdapter(IEntity implementor) {
		super(implementor);
	}

	public ContentMappingAdapter() {
	}
	...
	public EntityDescriptor<ContentMapping> wGetEntityDescriptor() {
		return MappingEntityDescriptorEnum.ContentMapping;
	}
