 ...
 * @generator Whole
 */
public class AnnotationImpl extends AbstractSimpleEntity implements Annotation {
	...
	public int wGetEntityOrd() {
		return XsdEntityDescriptorEnum.Annotation_ord;
	}
	...
	public AnnotationList getList() {
		return notifyRequested(XsdFeatureDescriptorEnum.list, list);
	}

	public void setList(AnnotationList list) {
		notifyChanged(XsdFeatureDescriptorEnum.list, this.list,
				this.list = list);
	}
	...
	public IEntity wGet(int index) {
		...
		case 3:
			return getList().wGetAdaptee(false);
		default:
