 ...
 * @generator Whole
 */
public class MaxExclusiveImpl extends AbstractSimpleEntity implements
		MaxExclusive {
	private static final long serialVersionUID = 1;

	public EntityDescriptor<MaxExclusive> wGetEntityDescriptor() {
		return XsdEntityDescriptorEnum.MaxExclusive;
	}

	public int wGetEntityOrd() {
		return XsdEntityDescriptorEnum.MaxExclusive_ord;
	}
