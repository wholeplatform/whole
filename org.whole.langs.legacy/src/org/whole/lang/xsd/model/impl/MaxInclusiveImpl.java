 ...
 * @generator Whole
 */
public class MaxInclusiveImpl extends AbstractSimpleEntity implements
		MaxInclusive {
	private static final long serialVersionUID = 1;

	public EntityDescriptor<MaxInclusive> wGetEntityDescriptor() {
		return XsdEntityDescriptorEnum.MaxInclusive;
	}

	public int wGetEntityOrd() {
		return XsdEntityDescriptorEnum.MaxInclusive_ord;
	}
