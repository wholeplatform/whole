 ...
 * @generator Whole
 */
public class LengthImpl extends AbstractSimpleEntity implements Length {
	private static final long serialVersionUID = 1;

	public EntityDescriptor<Length> wGetEntityDescriptor() {
		return XsdEntityDescriptorEnum.Length;
	}

	public int wGetEntityOrd() {
		return XsdEntityDescriptorEnum.Length_ord;
	}
