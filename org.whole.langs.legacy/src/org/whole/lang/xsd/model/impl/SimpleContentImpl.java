 ...
 * @generator Whole
 */
public class SimpleContentImpl extends AbstractSimpleEntity implements
		SimpleContent {
	...
	public int wGetEntityOrd() {
		return XsdEntityDescriptorEnum.SimpleContent_ord;
	}
	...
	private SimpleDerivation derivation;
	...
	public void wSet(int index, IEntity value) {
		...
		case 4:
			setDerivation(value
					.wGetAdapter(XsdEntityDescriptorEnum.SimpleDerivation));
			break;
		default:
			throw new IllegalArgumentException();
		}
