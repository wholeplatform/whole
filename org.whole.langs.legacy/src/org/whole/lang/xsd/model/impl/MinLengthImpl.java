 ...
 * @generator Whole
 */
public class MinLengthImpl extends AbstractSimpleEntity implements MinLength {
	private static final long serialVersionUID = 1;

	public EntityDescriptor<MinLength> wGetEntityDescriptor() {
		return XsdEntityDescriptorEnum.MinLength;
	}

	public int wGetEntityOrd() {
		return XsdEntityDescriptorEnum.MinLength_ord;
	}
