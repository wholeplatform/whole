 ...
 * @generator Whole
 */
public class FieldImpl extends AbstractSimpleEntity implements Field {
	private static final long serialVersionUID = 1;

	public EntityDescriptor<Field> wGetEntityDescriptor() {
		return XsdEntityDescriptorEnum.Field;
	}

	public int wGetEntityOrd() {
		return XsdEntityDescriptorEnum.Field_ord;
	}
	...
	public XPath getXpath() {
		return notifyRequested(XsdFeatureDescriptorEnum.xpath, xpath);
	}

	public void setXpath(XPath xpath) {
		notifyChanged(XsdFeatureDescriptorEnum.xpath, this.xpath,
				this.xpath = xpath);
	}
	...
	public IEntity wGet(int index) {
		...
		case 3:
			return getXpath().wGetAdaptee(false);
		case 4:
	...
	public void wSet(int index, IEntity value) {
		...
		case 2:
			...
			break;
		case 3:
			setXpath(value.wGetAdapter(XsdEntityDescriptorEnum.XPath));
			break;
		case 4:
