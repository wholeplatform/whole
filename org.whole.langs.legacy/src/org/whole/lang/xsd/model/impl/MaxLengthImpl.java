 ...
 * @generator Whole
 */
public class MaxLengthImpl extends AbstractSimpleEntity implements MaxLength {
	private static final long serialVersionUID = 1;

	public EntityDescriptor<MaxLength> wGetEntityDescriptor() {
		return XsdEntityDescriptorEnum.MaxLength;
	}

	public int wGetEntityOrd() {
		return XsdEntityDescriptorEnum.MaxLength_ord;
	}
	...
	public void wSet(int index, IEntity value) {
		...
		case 3:
			...
			break;
		case 4:
			setValue(value.wGetAdapter(XsdEntityDescriptorEnum.IntegerData));
			break;
		case 5:
