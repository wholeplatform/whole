 ...
 * @generator Whole
 */
public class SimpleDerivationAdapter extends AbstractEntityAdapter implements
		SimpleDerivation {
	private static final long serialVersionUID = 1;

	public SimpleDerivationAdapter(IEntity implementor) {
		super(implementor);
	}

	public SimpleDerivationAdapter() {
	}
	...
	public EntityDescriptor<SimpleDerivation> wGetEntityDescriptor() {
		return XsdEntityDescriptorEnum.SimpleDerivation;
	}
