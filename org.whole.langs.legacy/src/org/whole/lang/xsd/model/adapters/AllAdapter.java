 ...
 * @generator Whole
 */
public class AllAdapter extends AbstractEntityAdapter implements All {
	private static final long serialVersionUID = 1;

	public AllAdapter(IEntity implementor) {
		super(implementor);
	}
	...
	public EntityDescriptor<All> wGetEntityDescriptor() {
		return XsdEntityDescriptorEnum.All;
	}
