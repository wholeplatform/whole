 ...
 * @generator Whole
 */
public class MinInclusiveAdapter extends AbstractEntityAdapter implements
		MinInclusive {
	private static final long serialVersionUID = 1;

	public MinInclusiveAdapter(IEntity implementor) {
		super(implementor);
	}

	public MinInclusiveAdapter() {
	}
	...
	public EntityDescriptor<MinInclusive> wGetEntityDescriptor() {
		return XsdEntityDescriptorEnum.MinInclusive;
	}
