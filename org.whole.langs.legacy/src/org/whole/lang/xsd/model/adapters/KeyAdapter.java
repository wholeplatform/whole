 ...
 * @generator Whole
 */
public class KeyAdapter extends AbstractEntityAdapter implements Key {
	private static final long serialVersionUID = 1;

	public KeyAdapter(IEntity implementor) {
		super(implementor);
	}
	...
	public EntityDescriptor<Key> wGetEntityDescriptor() {
		return XsdEntityDescriptorEnum.Key;
	}
