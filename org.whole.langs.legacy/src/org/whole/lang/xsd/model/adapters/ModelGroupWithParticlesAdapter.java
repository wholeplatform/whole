 ...
 * @generator Whole
 */
public class ModelGroupWithParticlesAdapter extends AbstractEntityAdapter
		implements ModelGroupWithParticles {
	private static final long serialVersionUID = 1;

	public ModelGroupWithParticlesAdapter(IEntity implementor) {
		super(implementor);
	}

	public ModelGroupWithParticlesAdapter() {
	}
	...
	public EntityDescriptor<ModelGroupWithParticles> wGetEntityDescriptor() {
		return XsdEntityDescriptorEnum.ModelGroupWithParticles;
	}
