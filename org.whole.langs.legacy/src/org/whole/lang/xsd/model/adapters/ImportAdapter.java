 ...
 * @generator Whole
 */
public class ImportAdapter extends AbstractEntityAdapter implements Import {
	private static final long serialVersionUID = 1;

	public ImportAdapter(IEntity implementor) {
		super(implementor);
	}
	...
	public AnyURI getNamespace() {
		return wGet(XsdFeatureDescriptorEnum.namespace).wGetAdapter(
