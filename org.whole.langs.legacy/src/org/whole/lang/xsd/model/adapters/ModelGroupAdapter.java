 ...
 * @generator Whole
 */
public class ModelGroupAdapter extends AbstractEntityAdapter implements
		ModelGroup {
	private static final long serialVersionUID = 1;

	public ModelGroupAdapter(IEntity implementor) {
		super(implementor);
	}

	public ModelGroupAdapter() {
	}
	...
	public EntityDescriptor<ModelGroup> wGetEntityDescriptor() {
		return XsdEntityDescriptorEnum.ModelGroup;
	}
