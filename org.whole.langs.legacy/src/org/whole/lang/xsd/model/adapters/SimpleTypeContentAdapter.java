 ...
 * @generator Whole
 */
public class SimpleTypeContentAdapter extends AbstractEntityAdapter implements
		SimpleTypeContent {
	private static final long serialVersionUID = 1;

	public SimpleTypeContentAdapter(IEntity implementor) {
		super(implementor);
	}

	public SimpleTypeContentAdapter() {
	}
	...
	public EntityDescriptor<SimpleTypeContent> wGetEntityDescriptor() {
		return XsdEntityDescriptorEnum.SimpleTypeContent;
	}
