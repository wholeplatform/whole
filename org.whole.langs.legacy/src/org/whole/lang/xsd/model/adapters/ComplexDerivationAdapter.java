 ...
 * @generator Whole
 */
public class ComplexDerivationAdapter extends AbstractEntityAdapter implements
		ComplexDerivation {
	private static final long serialVersionUID = 1;

	public ComplexDerivationAdapter(IEntity implementor) {
		super(implementor);
	}

	public ComplexDerivationAdapter() {
	}
	...
	public EntityDescriptor<ComplexDerivation> wGetEntityDescriptor() {
		return XsdEntityDescriptorEnum.ComplexDerivation;
	}
