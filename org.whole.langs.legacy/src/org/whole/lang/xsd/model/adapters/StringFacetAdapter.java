 ...
 * @generator Whole
 */
public class StringFacetAdapter extends AbstractEntityAdapter implements
		StringFacet {
	private static final long serialVersionUID = 1;

	public StringFacetAdapter(IEntity implementor) {
		super(implementor);
	}

	public StringFacetAdapter() {
	}
	...
	public EntityDescriptor<StringFacet> wGetEntityDescriptor() {
		return XsdEntityDescriptorEnum.StringFacet;
	}
