 ...
 * @generator Whole
 */
public class IntegerFacetAdapter extends AbstractEntityAdapter implements
		IntegerFacet {
	private static final long serialVersionUID = 1;

	public IntegerFacetAdapter(IEntity implementor) {
		super(implementor);
	}

	public IntegerFacetAdapter() {
	}
	...
	public EntityDescriptor<IntegerFacet> wGetEntityDescriptor() {
		return XsdEntityDescriptorEnum.IntegerFacet;
	}
