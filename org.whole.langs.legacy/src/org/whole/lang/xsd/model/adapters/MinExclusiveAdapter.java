 ...
 * @generator Whole
 */
public class MinExclusiveAdapter extends AbstractEntityAdapter implements
		MinExclusive {
	private static final long serialVersionUID = 1;

	public MinExclusiveAdapter(IEntity implementor) {
		super(implementor);
	}

	public MinExclusiveAdapter() {
	}
	...
	public EntityDescriptor<MinExclusive> wGetEntityDescriptor() {
		return XsdEntityDescriptorEnum.MinExclusive;
	}
