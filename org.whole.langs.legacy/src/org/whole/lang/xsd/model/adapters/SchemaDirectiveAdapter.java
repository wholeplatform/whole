 ...
 * @generator Whole
 */
public class SchemaDirectiveAdapter extends AbstractEntityAdapter implements
		SchemaDirective {
	private static final long serialVersionUID = 1;

	public SchemaDirectiveAdapter(IEntity implementor) {
		super(implementor);
	}

	public SchemaDirectiveAdapter() {
	}
	...
	public EntityDescriptor<SchemaDirective> wGetEntityDescriptor() {
		return XsdEntityDescriptorEnum.SchemaDirective;
	}
