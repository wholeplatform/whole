 ...
 * @generator Whole
 */
public class NamedComponentAdapter extends AbstractEntityAdapter implements
		NamedComponent {
	private static final long serialVersionUID = 1;

	public NamedComponentAdapter(IEntity implementor) {
		super(implementor);
	}

	public NamedComponentAdapter() {
	}
	...
	public EntityDescriptor<NamedComponent> wGetEntityDescriptor() {
		return XsdEntityDescriptorEnum.NamedComponent;
	}
