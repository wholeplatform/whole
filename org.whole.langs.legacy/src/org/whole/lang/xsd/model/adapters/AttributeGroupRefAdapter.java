 ...
 * @generator Whole
 */
public class AttributeGroupRefAdapter extends AbstractEntityAdapter implements
		AttributeGroupRef {
	private static final long serialVersionUID = 1;

	public AttributeGroupRefAdapter(IEntity implementor) {
		super(implementor);
	}

	public AttributeGroupRefAdapter() {
	}
