 ...
 * @generator Whole
 */
public class RedefineAdapter extends AbstractEntityAdapter implements Redefine {
	private static final long serialVersionUID = 1;

	public RedefineAdapter(IEntity implementor) {
		super(implementor);
	}

	public RedefineAdapter() {
	}
	...
	public RedefineComponents getDefinitions() {
		return wGet(XsdFeatureDescriptorEnum.definitions).wGetAdapter(
				XsdEntityDescriptorEnum.RedefineComponents);
	}
