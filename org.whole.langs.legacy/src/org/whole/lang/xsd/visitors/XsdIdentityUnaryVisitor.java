 ...
 * @generator Whole
 */
public class XsdIdentityUnaryVisitor<V extends IVisitor> extends
		AbstractUnaryVisitor<V> implements IXsdVisitor {
	public XsdIdentityUnaryVisitor() {
		super(null);
	}

	public XsdIdentityUnaryVisitor(IVisitor visitor1) {
		super(visitor1);
	}
