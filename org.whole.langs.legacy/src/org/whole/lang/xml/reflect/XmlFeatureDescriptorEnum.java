...
public class XmlFeatureDescriptorEnum extends FeatureDescriptorEnum {
	...
	public static final FeatureDescriptor element = instance
			.valueOf(element_ord);
	public static final FeatureDescriptor xmlDecl = instance
			.valueOf(xmlDecl_ord);
	public static final FeatureDescriptor docTypeDecl = instance
	...
	public static final FeatureDescriptor version = instance
			.valueOf(version_ord);
	public static final FeatureDescriptor encoding = instance
			.valueOf(encoding_ord);
	public static final FeatureDescriptor standalone = instance
			.valueOf(standalone_ord);
	public static final FeatureDescriptor name = instance.valueOf(name_ord);
	public static final FeatureDescriptor externalId = instance
			.valueOf(externalId_ord);
	public static final FeatureDescriptor systemLiteral = instance
			.valueOf(systemLiteral_ord);
	public static final FeatureDescriptor pubidLiteral = instance
			.valueOf(pubidLiteral_ord);
	public static final FeatureDescriptor instruction = instance
