...
public class XmlEntityFactory extends GenericEntityFactory {
	...
	public Prolog createProlog(XMLDecl xmlDecl, DocTypeDecl docTypeDecl,
			Misc misc) {
		return create(XmlEntityDescriptorEnum.Prolog, xmlDecl, docTypeDecl,
				misc);
	}
	...
	public XMLDecl createXMLDecl(Version version, Encoding encoding,
			Standalone standalone) {
		return create(XmlEntityDescriptorEnum.XMLDecl, version, encoding,
				standalone);
	}

	public IEntityBuilder<XMLDecl> buildXMLDecl() {
		return new EntityBuilder<XMLDecl>(
				create(XmlEntityDescriptorEnum.XMLDecl));
	}
	...
	public IEntityBuilder<DocTypeDecl> buildDocTypeDecl() {
		return new EntityBuilder<DocTypeDecl>(
				create(XmlEntityDescriptorEnum.DocTypeDecl));
	}
	...
	public PublicId createPublicId(PubidLiteral pubidLiteral,
			SystemLiteral systemLiteral) {
		return create(XmlEntityDescriptorEnum.PublicId, pubidLiteral,
				systemLiteral);
	}

	public IEntityBuilder<PublicId> buildPublicId() {
		return new EntityBuilder<PublicId>(
				create(XmlEntityDescriptorEnum.PublicId));
	}
	...
	public Element createElement(IName tag, Attributes attributes,
			IContent content) {
		return create(XmlEntityDescriptorEnum.Element, tag, attributes, content);
	}

	public IEntityBuilder<Element> buildElement() {
		return new EntityBuilder<Element>(
				create(XmlEntityDescriptorEnum.Element));
	}
	...
	public IEntityBuilder<Attribute> buildAttribute() {
		return new EntityBuilder<Attribute>(
				create(XmlEntityDescriptorEnum.Attribute));
	}
	...
	public IEntityBuilder<QualifiedName> buildQualifiedName() {
		return new EntityBuilder<QualifiedName>(
				create(XmlEntityDescriptorEnum.QualifiedName));
	}
