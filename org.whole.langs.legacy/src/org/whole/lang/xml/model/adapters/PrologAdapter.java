...
public class PrologAdapter extends AbstractEntityAdapter implements Prolog {
    ...
    public XMLDecl getXmlDecl() {
        return wGet(XmlFeatureDescriptorEnum.xmlDecl).wGetAdapter(XmlEntityDescriptorEnum.XMLDecl);
    }
    ...
    public DocTypeDecl getDocTypeDecl() {
        return wGet(XmlFeatureDescriptorEnum.docTypeDecl).wGetAdapter(XmlEntityDescriptorEnum.DocTypeDecl);
    }
    ...
    public Misc getMisc() {
        return wGet(XmlFeatureDescriptorEnum.misc).wGetAdapter(XmlEntityDescriptorEnum.Misc);
    }
