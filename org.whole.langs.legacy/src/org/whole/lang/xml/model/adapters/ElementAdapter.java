...
public class ElementAdapter extends AbstractEntityAdapter implements Element {
    ...
    public IName getTag() {
        return wGet(XmlFeatureDescriptorEnum.tag).wGetAdapter(XmlEntityDescriptorEnum.IName);
    }
    ...
    public Attributes getAttributes() {
        return wGet(XmlFeatureDescriptorEnum.attributes).wGetAdapter(XmlEntityDescriptorEnum.Attributes);
    }
    ...
    public IContent getContent() {
        return wGet(XmlFeatureDescriptorEnum.content).wGetAdapter(XmlEntityDescriptorEnum.IContent);
    }
