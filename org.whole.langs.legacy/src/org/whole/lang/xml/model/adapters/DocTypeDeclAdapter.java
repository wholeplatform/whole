 ...
 *  @generator Whole
 */
public class DocTypeDeclAdapter extends AbstractEntityAdapter implements DocTypeDecl {
    ...
    public IExternalId getExternalId() {
        return wGet(XmlFeatureDescriptorEnum.externalId).wGetAdapter(XmlEntityDescriptorEnum.IExternalId);
    }
