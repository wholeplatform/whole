 ...
 *  @generator Whole
 */
public class XmlTraverseAllChildrenVisitor extends XmlIdentityUnaryVisitor<IXmlVisitor> {

    public XmlTraverseAllChildrenVisitor() {
        wSetVisitor1(this);
    }

    public XmlTraverseAllChildrenVisitor(IVisitor visitor1) {
        super(visitor1);
    }
