...
public class JavaSourcePersistenceKit extends AbstractSpecificPersistenceKit {
	private static class SingletonHolder {
		private static final JavaSourcePersistenceKit instance = new JavaSourcePersistenceKit();
	}
	public static JavaSourcePersistenceKit instance() {
		return SingletonHolder.instance;
	}
	protected JavaSourcePersistenceKit() {
		super("Java", "java", JavaLanguageKit.URI);
	}
