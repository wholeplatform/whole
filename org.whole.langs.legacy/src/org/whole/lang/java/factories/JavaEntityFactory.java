...
public class JavaEntityFactory extends GenericEntityFactory {
	...
	public CompilationUnit createCompilationUnit(PackageDeclaration _package,
			ImportDeclarations imports, TypeDeclarations types) {
		return create(JavaEntityDescriptorEnum.CompilationUnit, _package,
				imports, types);
	}

	public IEntityBuilder<CompilationUnit> buildCompilationUnit() {
		return new EntityBuilder<CompilationUnit>(
				create(JavaEntityDescriptorEnum.CompilationUnit));
	}
	...
	public PackageDeclaration createPackageDeclaration(Javadoc javadoc,
			Annotations annotations, Name name) {
		return create(JavaEntityDescriptorEnum.PackageDeclaration, javadoc,
				annotations, name);
	}

	public IEntityBuilder<PackageDeclaration> buildPackageDeclaration() {
		return new EntityBuilder<PackageDeclaration>(
				create(JavaEntityDescriptorEnum.PackageDeclaration));
	}
	...
	public MethodRef createMethodRef(Name qualifier, SimpleName name,
			MethodRefParameters parameters) {
		return create(JavaEntityDescriptorEnum.MethodRef, qualifier, name,
				parameters);
	}

	public IEntityBuilder<MethodRef> buildMethodRef() {
		return new EntityBuilder<MethodRef>(
				create(JavaEntityDescriptorEnum.MethodRef));
	}
	...
	public MethodRefParameter createMethodRefParameter(Type type,
			Varargs varargs, SimpleName name) {
		return create(JavaEntityDescriptorEnum.MethodRefParameter, type,
				varargs, name);
	}

	public IEntityBuilder<MethodRefParameter> buildMethodRefParameter() {
		return new EntityBuilder<MethodRefParameter>(
				create(JavaEntityDescriptorEnum.MethodRefParameter));
	}
	...
	public IEntityBuilder<MemberRef> buildMemberRef() {
		return new EntityBuilder<MemberRef>(
				create(JavaEntityDescriptorEnum.MemberRef));
	}
	...
	public IEntityBuilder<TagElement> buildTagElement() {
		return new EntityBuilder<TagElement>(
				create(JavaEntityDescriptorEnum.TagElement));
	}
	...
	public SingleMemberAnnotation createSingleMemberAnnotation(Name typeName,
			Expression value) {
		return create(JavaEntityDescriptorEnum.SingleMemberAnnotation,
				typeName, value);
	}
	...
	public IEntityBuilder<SingleMemberAnnotation> buildSingleMemberAnnotation() {
		return new EntityBuilder<SingleMemberAnnotation>(
				create(JavaEntityDescriptorEnum.SingleMemberAnnotation));
	}
	...
	public NormalAnnotation createNormalAnnotation(Name typeName,
			MemberValuePairs values) {
		return create(JavaEntityDescriptorEnum.NormalAnnotation, typeName,
				values);
	}

	public IEntityBuilder<NormalAnnotation> buildNormalAnnotation() {
		return new EntityBuilder<NormalAnnotation>(
				create(JavaEntityDescriptorEnum.NormalAnnotation));
	}
	...
	public MemberValuePair createMemberValuePair(SimpleName name,
			Expression value) {
	...
	public IEntityBuilder<MemberValuePair> buildMemberValuePair() {
		return new EntityBuilder<MemberValuePair>(
				create(JavaEntityDescriptorEnum.MemberValuePair));
	}
	...
	public ImportDeclaration createImportDeclaration(Name name,
			ImportModifier onDemand, ImportModifier _static) {
		return create(JavaEntityDescriptorEnum.ImportDeclaration, name,
				onDemand, _static);
	}

	public IEntityBuilder<ImportDeclaration> buildImportDeclaration() {
		return new EntityBuilder<ImportDeclaration>(
				create(JavaEntityDescriptorEnum.ImportDeclaration));
	}
	...
	public EnumDeclaration createEnumDeclaration(Javadoc javadoc,
			ExtendedModifiers modifiers, SimpleName name,
			Types superInterfaceTypes, EnumConstants enumConstants,
			BodyDeclarations bodyDeclarations) {
		return create(JavaEntityDescriptorEnum.EnumDeclaration, javadoc,
				modifiers, name, superInterfaceTypes, enumConstants,
				bodyDeclarations);
	}

	public IEntityBuilder<EnumDeclaration> buildEnumDeclaration() {
		return new EntityBuilder<EnumDeclaration>(
				create(JavaEntityDescriptorEnum.EnumDeclaration));
	}
	...
	public EnumConstants createEnumConstants(
			EnumConstantDeclaration... entities) {
		return create(JavaEntityDescriptorEnum.EnumConstants,
				(IEntity[]) entities);
	}
	...
	public EnumConstantDeclaration createEnumConstantDeclaration(
			Javadoc javadoc, ExtendedModifiers modifiers, SimpleName name,
			Arguments arguments,
			AnonymousClassDeclaration anonymousClassDeclaration) {
		return create(JavaEntityDescriptorEnum.EnumConstantDeclaration,
				javadoc, modifiers, name, arguments, anonymousClassDeclaration);
	}

	public IEntityBuilder<EnumConstantDeclaration> buildEnumConstantDeclaration() {
		return new EntityBuilder<EnumConstantDeclaration>(
				create(JavaEntityDescriptorEnum.EnumConstantDeclaration));
	}
	...
	public AnonymousClassDeclaration createAnonymousClassDeclaration(
			int initialSize) {
		return clone(JavaEntityDescriptorEnum.AnonymousClassDeclaration,
				initialSize);
	}
	...
	public AnnotationTypeDeclaration createAnnotationTypeDeclaration(
			...
			BodyDeclarations bodyDeclarations) {
		return create(JavaEntityDescriptorEnum.AnnotationTypeDeclaration,
				javadoc, modifiers, name, bodyDeclarations);
	}

	public IEntityBuilder<AnnotationTypeDeclaration> buildAnnotationTypeDeclaration() {
		return new EntityBuilder<AnnotationTypeDeclaration>(
				create(JavaEntityDescriptorEnum.AnnotationTypeDeclaration));
	}
	...
	public ClassDeclaration createClassDeclaration(Javadoc javadoc,
			ExtendedModifiers modifiers, SimpleName name,
			TypeParameters typeParameters, Type superclassType,
			Types superInterfaceTypes, BodyDeclarations bodyDeclarations) {
		return create(JavaEntityDescriptorEnum.ClassDeclaration, javadoc,
				modifiers, name, typeParameters, superclassType,
				superInterfaceTypes, bodyDeclarations);
	}

	public IEntityBuilder<ClassDeclaration> buildClassDeclaration() {
		return new EntityBuilder<ClassDeclaration>(
				create(JavaEntityDescriptorEnum.ClassDeclaration));
	}
	...
	public InterfaceDeclaration createInterfaceDeclaration(Javadoc javadoc,
			ExtendedModifiers modifiers, SimpleName name,
			TypeParameters typeParameters, Types superInterfaceTypes,
			BodyDeclarations bodyDeclarations) {
		return create(JavaEntityDescriptorEnum.InterfaceDeclaration, javadoc,
				modifiers, name, typeParameters, superInterfaceTypes,
				bodyDeclarations);
	}

	public IEntityBuilder<InterfaceDeclaration> buildInterfaceDeclaration() {
		return new EntityBuilder<InterfaceDeclaration>(
				create(JavaEntityDescriptorEnum.InterfaceDeclaration));
	}
	...
	public IEntityBuilder<TypeParameter> buildTypeParameter() {
		return new EntityBuilder<TypeParameter>(
				create(JavaEntityDescriptorEnum.TypeParameter));
	}
	...
	public AnnotationTypeMemberDeclaration createAnnotationTypeMemberDeclaration(
			Javadoc javadoc, ExtendedModifiers modifiers, SimpleName name,
			Type type, Expression _default) {
		return create(JavaEntityDescriptorEnum.AnnotationTypeMemberDeclaration,
				javadoc, modifiers, name, type, _default);
	}

	public IEntityBuilder<AnnotationTypeMemberDeclaration> buildAnnotationTypeMemberDeclaration() {
		return new EntityBuilder<AnnotationTypeMemberDeclaration>(
	...
	public Initializer createInitializer(Javadoc javadoc,
			ExtendedModifiers modifiers, Block body) {
		return create(JavaEntityDescriptorEnum.Initializer, javadoc, modifiers,
				body);
	}

	public IEntityBuilder<Initializer> buildInitializer() {
		return new EntityBuilder<Initializer>(
				create(JavaEntityDescriptorEnum.Initializer));
	}
	...
	public FieldDeclaration createFieldDeclaration(Javadoc javadoc,
			ExtendedModifiers modifiers, Type type,
			VariableDeclarationFragments fragments) {
		return create(JavaEntityDescriptorEnum.FieldDeclaration, javadoc,
				modifiers, type, fragments);
	}

	public IEntityBuilder<FieldDeclaration> buildFieldDeclaration() {
		return new EntityBuilder<FieldDeclaration>(
				create(JavaEntityDescriptorEnum.FieldDeclaration));
	}
	...
	public MethodDeclaration createMethodDeclaration(Javadoc javadoc,
			ExtendedModifiers modifiers, TypeParameters typeParameters,
			Type returnType, SimpleName name, Parameters parameters,
			ExtraDimensions extraDimensions, Names thrownExceptions, Block body) {
		return create(JavaEntityDescriptorEnum.MethodDeclaration, javadoc,
				modifiers, typeParameters, returnType, name, parameters,
				extraDimensions, thrownExceptions, body);
	}

	public IEntityBuilder<MethodDeclaration> buildMethodDeclaration() {
		return new EntityBuilder<MethodDeclaration>(
				create(JavaEntityDescriptorEnum.MethodDeclaration));
	}
	...
	public ConstructorDeclaration createConstructorDeclaration(Javadoc javadoc,
			ExtendedModifiers modifiers, TypeParameters typeParameters,
			SimpleName name, Parameters parameters,
			ExtraDimensions extraDimensions, Names thrownExceptions, Block body) {
		return create(JavaEntityDescriptorEnum.ConstructorDeclaration, javadoc,
				modifiers, typeParameters, name, parameters, extraDimensions,
				thrownExceptions, body);
	}

	public IEntityBuilder<ConstructorDeclaration> buildConstructorDeclaration() {
		return new EntityBuilder<ConstructorDeclaration>(
				create(JavaEntityDescriptorEnum.ConstructorDeclaration));
	}
	...
	public IEntityBuilder<SingleVariableDeclaration> buildSingleVariableDeclaration() {
		return new EntityBuilder<SingleVariableDeclaration>(
				create(JavaEntityDescriptorEnum.SingleVariableDeclaration));
	}
	...
	public ParameterizedType createParameterizedType(Type type,
			Types typeArguments) {
		return create(JavaEntityDescriptorEnum.ParameterizedType, type,
				typeArguments);
	}

	public IEntityBuilder<ParameterizedType> buildParameterizedType() {
		return new EntityBuilder<ParameterizedType>(
				create(JavaEntityDescriptorEnum.ParameterizedType));
	}
	...
	public AssertStatement createAssertStatement(Expression expression,
			Expression message) {
		return create(JavaEntityDescriptorEnum.AssertStatement, expression,
				message);
	}

	public IEntityBuilder<AssertStatement> buildAssertStatement() {
		return new EntityBuilder<AssertStatement>(
				create(JavaEntityDescriptorEnum.AssertStatement));
	}
	...
	public IEntityBuilder<ConstructorInvocation> buildConstructorInvocation() {
		return new EntityBuilder<ConstructorInvocation>(
				create(JavaEntityDescriptorEnum.ConstructorInvocation));
	}
	...
	public IEntityBuilder<DoStatement> buildDoStatement() {
		return new EntityBuilder<DoStatement>(
				create(JavaEntityDescriptorEnum.DoStatement));
	}
	...
	public EnhancedForStatement createEnhancedForStatement(
			...
			Statement body) {
		return create(JavaEntityDescriptorEnum.EnhancedForStatement, parameter,
				expression, body);
	}

	public IEntityBuilder<EnhancedForStatement> buildEnhancedForStatement() {
		return new EntityBuilder<EnhancedForStatement>(
	...
	public ForStatement createForStatement(Expressions initializers,
			Expression expression, Expressions updaters, Statement body) {
		return create(JavaEntityDescriptorEnum.ForStatement, initializers,
				expression, updaters, body);
	}

	public IEntityBuilder<ForStatement> buildForStatement() {
		return new EntityBuilder<ForStatement>(
				create(JavaEntityDescriptorEnum.ForStatement));
	}
	...
	public IfStatement createIfStatement(Expression expression,
			Statement thenStatement, Statement elseStatement) {
		return create(JavaEntityDescriptorEnum.IfStatement, expression,
				thenStatement, elseStatement);
	}

	public IEntityBuilder<IfStatement> buildIfStatement() {
		return new EntityBuilder<IfStatement>(
				create(JavaEntityDescriptorEnum.IfStatement));
	}
	...
	public LabeledStatement createLabeledStatement(SimpleName label,
			Statement body) {
	...
	public IEntityBuilder<LabeledStatement> buildLabeledStatement() {
		return new EntityBuilder<LabeledStatement>(
				create(JavaEntityDescriptorEnum.LabeledStatement));
	}
	...
	public SwitchStatement createSwitchStatement(Expression expression,
		...
		return create(JavaEntityDescriptorEnum.SwitchStatement, expression,
				statements);
	}

	public IEntityBuilder<SwitchStatement> buildSwitchStatement() {
		return new EntityBuilder<SwitchStatement>(
				create(JavaEntityDescriptorEnum.SwitchStatement));
	}
	...
	public IEntityBuilder<SynchronizedStatement> buildSynchronizedStatement() {
		return new EntityBuilder<SynchronizedStatement>(
	...
	public TryStatement createTryStatement(Block body,
			CatchClauses catchClauses, Block _finally) {
		return create(JavaEntityDescriptorEnum.TryStatement, body,
				catchClauses, _finally);
	}

	public IEntityBuilder<TryStatement> buildTryStatement() {
		return new EntityBuilder<TryStatement>(
				create(JavaEntityDescriptorEnum.TryStatement));
	}
	...
	public CatchClause createCatchClause(SingleVariableDeclaration exception,
			Block body) {
	...
	public IEntityBuilder<CatchClause> buildCatchClause() {
		return new EntityBuilder<CatchClause>(
				create(JavaEntityDescriptorEnum.CatchClause));
	}
	...
	public IEntityBuilder<VariableDeclarationStatement> buildVariableDeclarationStatement() {
		return new EntityBuilder<VariableDeclarationStatement>(
	...
	public WhileStatement createWhileStatement(Expression expression,
			Statement body) {
	...
	public IEntityBuilder<WhileStatement> buildWhileStatement() {
		return new EntityBuilder<WhileStatement>(
				create(JavaEntityDescriptorEnum.WhileStatement));
	}
	...
	public IEntityBuilder<ArrayAccess> buildArrayAccess() {
		return new EntityBuilder<ArrayAccess>(
				create(JavaEntityDescriptorEnum.ArrayAccess));
	}
	...
	public ArrayCreation createArrayCreation(ArrayType type,
			Expressions dimensions, ArrayInitializer initializer) {
		return create(JavaEntityDescriptorEnum.ArrayCreation, type, dimensions,
				initializer);
	}

	public IEntityBuilder<ArrayCreation> buildArrayCreation() {
		return new EntityBuilder<ArrayCreation>(
				create(JavaEntityDescriptorEnum.ArrayCreation));
	}
	...
	public Assignment createAssignment(Expression leftHandSide,
			AssignmentOperator operator, Expression rightHandSide) {
		return create(JavaEntityDescriptorEnum.Assignment, leftHandSide,
				operator, rightHandSide);
	}

	public IEntityBuilder<Assignment> buildAssignment() {
		return new EntityBuilder<Assignment>(
				create(JavaEntityDescriptorEnum.Assignment));
	}
	...
	public IEntityBuilder<CastExpression> buildCastExpression() {
		return new EntityBuilder<CastExpression>(
				create(JavaEntityDescriptorEnum.CastExpression));
	}
	...
	public ClassInstanceCreation createClassInstanceCreation(
			Expression expression, Types typeArguments, Type type,
			Arguments arguments,
			AnonymousClassDeclaration anonymousClassDeclaration) {
		return create(JavaEntityDescriptorEnum.ClassInstanceCreation,
				expression, typeArguments, type, arguments,
				anonymousClassDeclaration);
	}

	public IEntityBuilder<ClassInstanceCreation> buildClassInstanceCreation() {
		return new EntityBuilder<ClassInstanceCreation>(
	...
	public IEntityBuilder<ConditionalExpression> buildConditionalExpression() {
		return new EntityBuilder<ConditionalExpression>(
				create(JavaEntityDescriptorEnum.ConditionalExpression));
	}
	...
	public IEntityBuilder<FieldAccess> buildFieldAccess() {
		return new EntityBuilder<FieldAccess>(
				create(JavaEntityDescriptorEnum.FieldAccess));
	}
	...
	public InfixExpression createInfixExpression(Expression leftOperand,
			InfixOperator operator, Expression rightOperand,
			Expressions extendedOperands) {
		return create(JavaEntityDescriptorEnum.InfixExpression, leftOperand,
				operator, rightOperand, extendedOperands);
	}

	public IEntityBuilder<InfixExpression> buildInfixExpression() {
		return new EntityBuilder<InfixExpression>(
				create(JavaEntityDescriptorEnum.InfixExpression));
	}
	...
	public InstanceofExpression createInstanceofExpression(
			Expression leftOperand, Type rightOperand) {
		return create(JavaEntityDescriptorEnum.InstanceofExpression,
				leftOperand, rightOperand);
	}

	public IEntityBuilder<InstanceofExpression> buildInstanceofExpression() {
		return new EntityBuilder<InstanceofExpression>(
	...
	public MethodInvocation createMethodInvocation(Expression expression,
			Types typeArguments, SimpleName name, Arguments arguments) {
		return create(JavaEntityDescriptorEnum.MethodInvocation, expression,
				typeArguments, name, arguments);
	}

	public IEntityBuilder<MethodInvocation> buildMethodInvocation() {
		return new EntityBuilder<MethodInvocation>(
				create(JavaEntityDescriptorEnum.MethodInvocation));
	}
	...
	public PostfixExpression createPostfixExpression(Expression operand,
		...
		return create(JavaEntityDescriptorEnum.PostfixExpression, operand,
				operator);
	}

	public IEntityBuilder<PostfixExpression> buildPostfixExpression() {
		return new EntityBuilder<PostfixExpression>(
				create(JavaEntityDescriptorEnum.PostfixExpression));
	}
	...
	public PrefixExpression createPrefixExpression(PrefixOperator operator,
			Expression operand) {
		return create(JavaEntityDescriptorEnum.PrefixExpression, operator,
				operand);
	}

	public IEntityBuilder<PrefixExpression> buildPrefixExpression() {
		return new EntityBuilder<PrefixExpression>(
				create(JavaEntityDescriptorEnum.PrefixExpression));
	}
	...
	public SuperFieldAccess createSuperFieldAccess(Name qualifier,
			SimpleName name) {
		return create(JavaEntityDescriptorEnum.SuperFieldAccess, qualifier,
				name);
	}

	public IEntityBuilder<SuperFieldAccess> buildSuperFieldAccess() {
		return new EntityBuilder<SuperFieldAccess>(
				create(JavaEntityDescriptorEnum.SuperFieldAccess));
	}
	...
	public SuperMethodInvocation createSuperMethodInvocation(Name qualifier,
			Types typeArguments, SimpleName name, Arguments arguments) {
		return create(JavaEntityDescriptorEnum.SuperMethodInvocation,
				qualifier, typeArguments, name, arguments);
	}

	public IEntityBuilder<SuperMethodInvocation> buildSuperMethodInvocation() {
		return new EntityBuilder<SuperMethodInvocation>(
	...
	public IEntityBuilder<VariableDeclarationExpression> buildVariableDeclarationExpression() {
		return new EntityBuilder<VariableDeclarationExpression>(
	...
	public VariableDeclarationFragments createVariableDeclarationFragments(
			VariableDeclarationFragment... entities) {
		return create(JavaEntityDescriptorEnum.VariableDeclarationFragments,
				(IEntity[]) entities);
	}
	...
	public VariableDeclarationFragments createVariableDeclarationFragments(
			int initialSize) {
		return clone(JavaEntityDescriptorEnum.VariableDeclarationFragments,
				initialSize);
	}
	...
	public VariableDeclarationFragment createVariableDeclarationFragment(
			...
			Expression initializer) {
		return create(JavaEntityDescriptorEnum.VariableDeclarationFragment,
				name, extraDimensions, initializer);
	}

	public IEntityBuilder<VariableDeclarationFragment> buildVariableDeclarationFragment() {
		return new EntityBuilder<VariableDeclarationFragment>(
				create(JavaEntityDescriptorEnum.VariableDeclarationFragment));
	}
