 ...
 *  @generator Whole
 */
public class JavaIdentityUnaryVisitor<V extends IVisitor>  extends AbstractUnaryVisitor<V> implements IJavaVisitor {

    public JavaIdentityUnaryVisitor() {
        super(null);
    }

    public JavaIdentityUnaryVisitor(IVisitor visitor1) {
        super(visitor1);
    }
