 ...
 *  @generator Whole
 */
public class JavaTraverseAllVisitor extends JavaIdentityUnaryVisitor<IJavaVisitor> {

    public JavaTraverseAllVisitor() {
        wSetVisitor1(this);
    }

    public JavaTraverseAllVisitor(IVisitor visitor1) {
        super(visitor1);
    }
