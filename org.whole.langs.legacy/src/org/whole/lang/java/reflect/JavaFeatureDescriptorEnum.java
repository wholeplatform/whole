...
public class JavaFeatureDescriptorEnum extends FeatureDescriptorEnum {
	...
	public static final FeatureDescriptor javadoc = instance
			.valueOf(javadoc_ord);
	public static final FeatureDescriptor annotations = instance
			.valueOf(annotations_ord);
	public static final FeatureDescriptor name = instance.valueOf(name_ord);
	public static final FeatureDescriptor docElements = instance
	...
	public static final FeatureDescriptor varargs = instance
			.valueOf(varargs_ord);
	public static final FeatureDescriptor tagName = instance
			.valueOf(tagName_ord);
	public static final FeatureDescriptor fragments = instance
			.valueOf(fragments_ord);
	public static final FeatureDescriptor typeName = instance
			.valueOf(typeName_ord);
	...
	public static final FeatureDescriptor onDemand = instance
			.valueOf(onDemand_ord);
	public static final FeatureDescriptor _static = instance
			.valueOf(_static_ord);
	public static final FeatureDescriptor modifiers = instance
			.valueOf(modifiers_ord);
	public static final FeatureDescriptor bodyDeclarations = instance
			.valueOf(bodyDeclarations_ord);
	public static final FeatureDescriptor superInterfaceTypes = instance
			.valueOf(superInterfaceTypes_ord);
	public static final FeatureDescriptor enumConstants = instance
			.valueOf(enumConstants_ord);
	public static final FeatureDescriptor arguments = instance
			.valueOf(arguments_ord);
	public static final FeatureDescriptor anonymousClassDeclaration = instance
			.valueOf(anonymousClassDeclaration_ord);
	public static final FeatureDescriptor typeParameters = instance
			.valueOf(typeParameters_ord);
	public static final FeatureDescriptor superclassType = instance
			.valueOf(superclassType_ord);
	public static final FeatureDescriptor typeBounds = instance
			.valueOf(typeBounds_ord);
	public static final FeatureDescriptor _default = instance
			.valueOf(_default_ord);
	public static final FeatureDescriptor body = instance.valueOf(body_ord);
	public static final FeatureDescriptor returnType = instance
			.valueOf(returnType_ord);
	public static final FeatureDescriptor extraDimensions = instance
			.valueOf(extraDimensions_ord);
	public static final FeatureDescriptor thrownExceptions = instance
	...
	public static final FeatureDescriptor message = instance
			.valueOf(message_ord);
	public static final FeatureDescriptor label = instance.valueOf(label_ord);
	public static final FeatureDescriptor parameter = instance
			.valueOf(parameter_ord);
	public static final FeatureDescriptor initializers = instance
			.valueOf(initializers_ord);
	public static final FeatureDescriptor updaters = instance
			.valueOf(updaters_ord);
	public static final FeatureDescriptor thenStatement = instance
			.valueOf(thenStatement_ord);
	public static final FeatureDescriptor elseStatement = instance
			.valueOf(elseStatement_ord);
	public static final FeatureDescriptor statements = instance
			.valueOf(statements_ord);
	public static final FeatureDescriptor catchClauses = instance
			.valueOf(catchClauses_ord);
	public static final FeatureDescriptor _finally = instance
			.valueOf(_finally_ord);
	public static final FeatureDescriptor exception = instance
			.valueOf(exception_ord);
	public static final FeatureDescriptor typeDeclaration = instance
	...
	public static final FeatureDescriptor dimensions = instance
			.valueOf(dimensions_ord);
	public static final FeatureDescriptor leftHandSide = instance
			.valueOf(leftHandSide_ord);
	public static final FeatureDescriptor operator = instance
			.valueOf(operator_ord);
	public static final FeatureDescriptor rightHandSide = instance
			.valueOf(rightHandSide_ord);
	public static final FeatureDescriptor thenExpression = instance
			.valueOf(thenExpression_ord);
	public static final FeatureDescriptor elseExpression = instance
			.valueOf(elseExpression_ord);
	public static final FeatureDescriptor leftOperand = instance
			.valueOf(leftOperand_ord);
	public static final FeatureDescriptor rightOperand = instance
			.valueOf(rightOperand_ord);
	public static final FeatureDescriptor extendedOperands = instance
			.valueOf(extendedOperands_ord);
	public static final FeatureDescriptor operand = instance
			.valueOf(operand_ord);
	...
	private JavaFeatureDescriptorEnum() {
		...
		putFeatureDescriptor(anonymousClassDeclaration_ord,
