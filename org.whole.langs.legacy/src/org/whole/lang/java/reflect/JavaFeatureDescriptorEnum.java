...
public class JavaFeatureDescriptorEnum extends FeatureDescriptorEnum {
    public static final int imports_ord = 0;
    public static final int _package_ord = 1;
    public static final int types_ord = 2;
    public static final int module_ord = 3;
    public static final int javadoc_ord = 4;
    public static final int annotations_ord = 5;
    public static final int name_ord = 6;
    public static final int docElements_ord = 7;
    public static final int text_ord = 8;
    public static final int tags_ord = 9;
    public static final int qualifier_ord = 10;
    public static final int parameters_ord = 11;
    public static final int type_ord = 12;
    public static final int varargs_ord = 13;
    public static final int tagName_ord = 14;
    public static final int fragments_ord = 15;
    public static final int typeName_ord = 16;
    public static final int value_ord = 17;
    public static final int values_ord = 18;
    public static final int onDemand_ord = 19;
    public static final int _static_ord = 20;
    public static final int modifiers_ord = 21;
    public static final int bodyDeclarations_ord = 22;
    public static final int superInterfaceTypes_ord = 23;
    public static final int enumConstants_ord = 24;
    public static final int arguments_ord = 25;
    public static final int anonymousClassDeclaration_ord = 26;
    public static final int typeParameters_ord = 27;
    public static final int superclassType_ord = 28;
    public static final int open_ord = 29;
    public static final int moduleDirectives_ord = 30;
    public static final int modules_ord = 31;
    public static final int implementations_ord = 32;
    public static final int typeBounds_ord = 33;
    public static final int _default_ord = 34;
    public static final int body_ord = 35;
    public static final int returnType_ord = 36;
    public static final int extraDimensions_ord = 37;
    public static final int thrownExceptions_ord = 38;
    public static final int initializer_ord = 39;
    public static final int varargsAnnotations_ord = 40;
    public static final int componentType_ord = 41;
    public static final int typeArguments_ord = 42;
    public static final int bound_ord = 43;
    public static final int upperBound_ord = 44;
    public static final int expression_ord = 45;
    public static final int message_ord = 46;
    public static final int label_ord = 47;
    public static final int parameter_ord = 48;
    public static final int initializers_ord = 49;
    public static final int updaters_ord = 50;
    public static final int thenStatement_ord = 51;
    public static final int elseStatement_ord = 52;
    public static final int statements_ord = 53;
    public static final int catchClauses_ord = 54;
    public static final int _finally_ord = 55;
    public static final int exception_ord = 56;
    public static final int typeDeclaration_ord = 57;
    public static final int array_ord = 58;
    public static final int index_ord = 59;
    public static final int dimensions_ord = 60;
    public static final int leftHandSide_ord = 61;
    public static final int operator_ord = 62;
    public static final int rightHandSide_ord = 63;
    public static final int thenExpression_ord = 64;
    public static final int elseExpression_ord = 65;
    public static final int leftOperand_ord = 66;
    public static final int rightOperand_ord = 67;
    public static final int extendedOperands_ord = 68;
    public static final int operand_ord = 69;
    ...
    public static final FeatureDescriptor module = instance.valueOf(module_ord);
    ...
    public static final FeatureDescriptor open = instance.valueOf(open_ord);
    public static final FeatureDescriptor moduleDirectives = instance.valueOf(moduleDirectives_ord);
    public static final FeatureDescriptor modules = instance.valueOf(modules_ord);
    public static final FeatureDescriptor implementations = instance.valueOf(implementations_ord);
    ...
    private JavaFeatureDescriptorEnum() {
        ...
        putFeatureDescriptor(module_ord, "module");
        ...
        putFeatureDescriptor(open_ord, "open");
        putFeatureDescriptor(moduleDirectives_ord, "moduleDirectives");
        putFeatureDescriptor(modules_ord, "modules");
        putFeatureDescriptor(implementations_ord, "implementations");
