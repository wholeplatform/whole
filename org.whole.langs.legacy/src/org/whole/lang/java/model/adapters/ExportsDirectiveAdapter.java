 ...
 *  @generator Whole
 */
public class ExportsDirectiveAdapter extends AbstractEntityAdapter implements ExportsDirective {
    private static final long serialVersionUID = 1;

    public ExportsDirectiveAdapter(IEntity implementor) {
        super(implementor);
    }

    public ExportsDirectiveAdapter() {
    }
