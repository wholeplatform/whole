 ...
 *  @generator Whole
 */
public class WildcardTypeAdapter extends AbstractEntityAdapter implements WildcardType {
    ...
    public Type getBound() {
        return wGet(JavaFeatureDescriptorEnum.bound).wGetAdapter(JavaEntityDescriptorEnum.Type);
    }
    ...
    public UpperBound getUpperBound() {
        return wGet(JavaFeatureDescriptorEnum.upperBound).wGetAdapter(JavaEntityDescriptorEnum.UpperBound);
    }
