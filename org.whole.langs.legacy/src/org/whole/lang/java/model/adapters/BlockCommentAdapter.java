 ...
 *  @generator Whole
 */
public class BlockCommentAdapter extends AbstractEntityAdapter implements BlockComment {
    ...
    public DocElements getDocElements() {
        return wGet(JavaFeatureDescriptorEnum.docElements).wGetAdapter(JavaEntityDescriptorEnum.DocElements);
    }
