 ...
 *  @generator Whole
 */
public class TagElementAdapter extends AbstractEntityAdapter implements TagElement {
    ...
    public TagName getTagName() {
        return wGet(JavaFeatureDescriptorEnum.tagName).wGetAdapter(JavaEntityDescriptorEnum.TagName);
    }
    ...
    public DocElements getFragments() {
        return wGet(JavaFeatureDescriptorEnum.fragments).wGetAdapter(JavaEntityDescriptorEnum.DocElements);
    }
