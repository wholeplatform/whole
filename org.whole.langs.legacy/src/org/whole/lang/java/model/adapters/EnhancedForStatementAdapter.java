 ...
 *  @generator Whole
 */
public class EnhancedForStatementAdapter extends AbstractEntityAdapter implements EnhancedForStatement {
    ...
    public SingleVariableDeclaration getParameter() {
        return wGet(JavaFeatureDescriptorEnum.parameter).wGetAdapter(JavaEntityDescriptorEnum.SingleVariableDeclaration);
    }
