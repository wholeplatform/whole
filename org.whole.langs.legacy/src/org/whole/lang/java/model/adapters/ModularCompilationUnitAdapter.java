 ...
 *  @generator Whole
 */
public class ModularCompilationUnitAdapter extends AbstractEntityAdapter implements ModularCompilationUnit {
    private static final long serialVersionUID = 1;

    public ModularCompilationUnitAdapter(IEntity implementor) {
        super(implementor);
    }

    public ModularCompilationUnitAdapter() {
    }
    ...
    public ModuleDeclaration getModule() {
        return wGet(JavaFeatureDescriptorEnum.module).wGetAdapter(JavaEntityDescriptorEnum.ModuleDeclaration);
    }
