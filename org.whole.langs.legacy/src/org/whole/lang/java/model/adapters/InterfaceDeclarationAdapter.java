 ...
 *  @generator Whole
 */
public class InterfaceDeclarationAdapter extends AbstractEntityAdapter implements InterfaceDeclaration {
    private static final long serialVersionUID = 1;

    public InterfaceDeclarationAdapter(IEntity implementor) {
        super(implementor);
    }

    public InterfaceDeclarationAdapter() {
    }
