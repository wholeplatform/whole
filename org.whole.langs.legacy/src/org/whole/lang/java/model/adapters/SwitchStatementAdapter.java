 ...
 *  @generator Whole
 */
public class SwitchStatementAdapter extends AbstractEntityAdapter implements SwitchStatement {
    ...
    public Statements getStatements() {
        return wGet(JavaFeatureDescriptorEnum.statements).wGetAdapter(JavaEntityDescriptorEnum.Statements);
    }
