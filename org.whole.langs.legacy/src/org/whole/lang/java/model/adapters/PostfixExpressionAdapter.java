 ...
 *  @generator Whole
 */
public class PostfixExpressionAdapter extends AbstractEntityAdapter implements PostfixExpression {
    ...
    public Expression getOperand() {
        return wGet(JavaFeatureDescriptorEnum.operand).wGetAdapter(JavaEntityDescriptorEnum.Expression);
    }
    ...
    public PostfixOperator getOperator() {
        return wGet(JavaFeatureDescriptorEnum.operator).wGetAdapter(JavaEntityDescriptorEnum.PostfixOperator);
    }
