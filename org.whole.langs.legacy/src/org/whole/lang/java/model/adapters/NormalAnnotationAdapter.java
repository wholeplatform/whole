 ...
 *  @generator Whole
 */
public class NormalAnnotationAdapter extends AbstractEntityAdapter implements NormalAnnotation {
    ...
    public Name getTypeName() {
        return wGet(JavaFeatureDescriptorEnum.typeName).wGetAdapter(JavaEntityDescriptorEnum.Name);
    }
    ...
    public MemberValuePairs getValues() {
        return wGet(JavaFeatureDescriptorEnum.values).wGetAdapter(JavaEntityDescriptorEnum.MemberValuePairs);
    }
