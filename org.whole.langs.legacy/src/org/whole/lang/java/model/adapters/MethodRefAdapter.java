 ...
 *  @generator Whole
 */
public class MethodRefAdapter extends AbstractEntityAdapter implements MethodRef {
    ...
    public MethodRefParameters getParameters() {
        return wGet(JavaFeatureDescriptorEnum.parameters).wGetAdapter(JavaEntityDescriptorEnum.MethodRefParameters);
    }
