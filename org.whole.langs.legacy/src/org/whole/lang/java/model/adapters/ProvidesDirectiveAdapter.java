 ...
 *  @generator Whole
 */
public class ProvidesDirectiveAdapter extends AbstractEntityAdapter implements ProvidesDirective {
    private static final long serialVersionUID = 1;

    public ProvidesDirectiveAdapter(IEntity implementor) {
        super(implementor);
    }

    public ProvidesDirectiveAdapter() {
    }
    ...
    public Names getImplementations() {
        return wGet(JavaFeatureDescriptorEnum.implementations).wGetAdapter(JavaEntityDescriptorEnum.Names);
    }
