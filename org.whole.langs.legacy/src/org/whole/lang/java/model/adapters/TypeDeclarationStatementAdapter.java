 ...
 *  @generator Whole
 */
public class TypeDeclarationStatementAdapter extends AbstractEntityAdapter implements TypeDeclarationStatement {
    ...
    public TypeDeclaration getTypeDeclaration() {
        return wGet(JavaFeatureDescriptorEnum.typeDeclaration).wGetAdapter(JavaEntityDescriptorEnum.TypeDeclaration);
    }
