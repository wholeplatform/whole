 ...
 *  @generator Whole
 */
public class OrdinaryCompilationUnitAdapter extends AbstractEntityAdapter implements OrdinaryCompilationUnit {
    private static final long serialVersionUID = 1;

    public OrdinaryCompilationUnitAdapter(IEntity implementor) {
        super(implementor);
    }

    public OrdinaryCompilationUnitAdapter() {
    }
    ...
    public EntityDescriptor<OrdinaryCompilationUnit> wGetEntityDescriptor() {
        return JavaEntityDescriptorEnum.OrdinaryCompilationUnit;
    }
