 ...
 *  @generator Whole
 */
public class PrefixExpressionAdapter extends AbstractEntityAdapter implements PrefixExpression {
    ...
    public PrefixOperator getOperator() {
        return wGet(JavaFeatureDescriptorEnum.operator).wGetAdapter(JavaEntityDescriptorEnum.PrefixOperator);
    }
