 ...
 *  @generator Whole
 */
public class FieldDeclarationAdapter extends AbstractEntityAdapter implements FieldDeclaration {
    private static final long serialVersionUID = 1;

    public FieldDeclarationAdapter(IEntity implementor) {
        super(implementor);
    }

    public FieldDeclarationAdapter() {
    }
