 ...
 *  @generator Whole
 */
public class ConstructorInvocationAdapter extends AbstractEntityAdapter implements ConstructorInvocation {
    private static final long serialVersionUID = 1;

    public ConstructorInvocationAdapter(IEntity implementor) {
        super(implementor);
    }

    public ConstructorInvocationAdapter() {
    }
