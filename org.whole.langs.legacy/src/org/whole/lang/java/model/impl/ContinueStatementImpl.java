 ...
 *  @generator Whole
 */
public class ContinueStatementImpl extends AbstractSimpleEntity implements ContinueStatement {
    private static final long serialVersionUID = 1;

    public EntityDescriptor<ContinueStatement> wGetEntityDescriptor() {
        return JavaEntityDescriptorEnum.ContinueStatement;
    }

    public int wGetEntityOrd() {
        return JavaEntityDescriptorEnum.ContinueStatement_ord;
    }
