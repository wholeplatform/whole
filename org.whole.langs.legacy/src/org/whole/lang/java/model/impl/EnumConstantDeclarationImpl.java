...
import org.whole.lang.java.model.AnonymousClassDeclaration;

/**
 *  @generator Whole
 */
public class EnumConstantDeclarationImpl extends AbstractSimpleEntity implements EnumConstantDeclaration {
    ...
    public AnonymousClassDeclaration getAnonymousClassDeclaration() {
        return notifyRequested(JavaFeatureDescriptorEnum.anonymousClassDeclaration, anonymousClassDeclaration);
    }

    public void setAnonymousClassDeclaration(AnonymousClassDeclaration anonymousClassDeclaration) {
        notifyChanged(JavaFeatureDescriptorEnum.anonymousClassDeclaration, this.anonymousClassDeclaration, this.anonymousClassDeclaration = anonymousClassDeclaration);
    }
    ...
    public void wSet(int index, IEntity value) {
        switch (index) {
            ...
            break;
            case 4 :
            setAnonymousClassDeclaration(value.wGetAdapter(JavaEntityDescriptorEnum.AnonymousClassDeclaration));
            break;
            default :
            throw new IllegalArgumentException();
        }
