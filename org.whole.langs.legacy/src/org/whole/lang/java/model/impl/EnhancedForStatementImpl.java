...
import org.whole.lang.java.model.EnhancedForStatement;
 ...
 *  @generator Whole
 */
public class EnhancedForStatementImpl extends AbstractSimpleEntity implements EnhancedForStatement {
    ...
    public void setParameter(SingleVariableDeclaration parameter) {
        notifyChanged(JavaFeatureDescriptorEnum.parameter, this.parameter, this.parameter = parameter);
    }
    ...
    public void wSet(int index, IEntity value) {
        switch (index) {
            case 0 :
            setParameter(value.wGetAdapter(JavaEntityDescriptorEnum.SingleVariableDeclaration));
            break;
            case 1 :
