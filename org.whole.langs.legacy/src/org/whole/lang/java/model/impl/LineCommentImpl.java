...
import org.whole.lang.java.model.TextElement;
 ...
 *  @generator Whole
 */
public class LineCommentImpl extends AbstractSimpleEntity implements LineComment {
    ...
    public void setText(TextElement text) {
        notifyChanged(JavaFeatureDescriptorEnum.text, this.text, this.text = text);
    }
