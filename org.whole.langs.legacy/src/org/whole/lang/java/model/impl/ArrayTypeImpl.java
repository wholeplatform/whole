...
public class ArrayTypeImpl extends AbstractSimpleEntity implements ArrayType {
    ...
    public Type getComponentType() {
        return notifyRequested(JavaFeatureDescriptorEnum.componentType, componentType);
    }

    public void setComponentType(Type componentType) {
        notifyChanged(JavaFeatureDescriptorEnum.componentType, this.componentType, this.componentType = componentType);
    }
