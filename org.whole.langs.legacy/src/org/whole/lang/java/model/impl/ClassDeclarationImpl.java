 ...
 * @generator Whole
 */
public class ClassDeclarationImpl extends AbstractSimpleEntity implements
		ClassDeclaration {
	...
	public Type getSuperclassType() {
		return notifyRequested(JavaFeatureDescriptorEnum.superclassType,
				superclassType);
	}

	public void setSuperclassType(Type superclassType) {
		notifyChanged(JavaFeatureDescriptorEnum.superclassType,
				this.superclassType, this.superclassType = superclassType);
	}
