 ...
 */
public class JSONPersistenceKit extends AbstractSpecificPersistenceKit {
	private static class SingletonHolder {
		private static final JSONPersistenceKit instance = new JSONPersistenceKit();
	}
	public static final JSONPersistenceKit instance() {
		return SingletonHolder.instance;
	}
	private JSONPersistenceKit() {
