 ...
 * @generator Whole
 */
public class LessOrEqualsImpl extends AbstractSimpleEntity implements LessOrEquals {
	private static final long serialVersionUID = 1;

	public EntityDescriptor<LessOrEquals> wGetEntityDescriptor() {
		return ImpEntityDescriptorEnum.LessOrEquals;
	}

	public int wGetEntityOrd() {
		return ImpEntityDescriptorEnum.LessOrEquals_ord;
	}
