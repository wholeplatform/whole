...
import org.whole.examples.lang.imp.ui.figures.VariableDeclarationFigure;
...
public class VariableDeclarationPart extends AbstractContentPanePart {
	...
	protected List<IEntity> getModelSpecificChildren() {
		...
		VariableDeclaration variableDeclaration = getModelEntity();
		children.add(variableDeclaration.getType());
		children.add(variableDeclaration.getName());
		children.add(variableDeclaration.getInitializer());
		return children;
	}
}
