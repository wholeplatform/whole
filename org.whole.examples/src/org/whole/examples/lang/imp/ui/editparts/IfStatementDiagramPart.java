...
import org.whole.lang.ui.notations.flowchart.figures.IfControlFigure;

/**
 * @author Riccardo Solmi
 */
public class IfStatementDiagramPart extends AbstractContentPanePart {
	protected IFigure createFigure() {
		return new IfControlFigure();
	}
