...
public class MotoGP_TeamsActions extends AbstractTemplateFactory<org.whole.lang.actions.model.LanguageActionFactory> {
    ...
    public void apply(IBuilderOperation op) {
        ...
        b1.Resolver();
        b1.Resolver();
        b3.QualifiedType("org.whole.examples.dataintegration.motogp.MotoGP_TeamsCSVGrammar");
        b1.Resolver();
        b1.Resolver();
        ...
        b1.Resolver();
        b1.Resolver();
        b3.QualifiedType("org.whole.examples.dataintegration.motogp.MotoGP_TeamsFLFGrammar");
        b1.Resolver();
        b1.Resolver();
        b3._ClassInstanceCreation();
        b3.Types_(0);
