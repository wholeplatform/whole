 ...
 */
public class SimpleTableRowFigure extends ContentPaneFigure {
	public SimpleTableRowFigure(IEntityStyling entityStyling) {
		...
		initContentPanes(featuresStyling.length);

		for (int i=0; i<featuresStyling.length; i++)
