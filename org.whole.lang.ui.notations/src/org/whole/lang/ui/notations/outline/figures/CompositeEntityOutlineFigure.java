 ...
 */
public class CompositeEntityOutlineFigure extends ContentPaneFigure {
	protected CompositeFigure compositeFigure;

	public CompositeEntityOutlineFigure(EntityDescriptor<?> ed) {
		...
		compositeFigure = new CompositeFigure(
				new ColumnLayout().withMargin(5, 24, 5, 0).withSpacing(5));
