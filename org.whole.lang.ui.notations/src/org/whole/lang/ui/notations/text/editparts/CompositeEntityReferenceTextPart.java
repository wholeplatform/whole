 ...
 */
public class CompositeEntityReferenceTextPart extends AbstractContentPanePart {
	protected EntityDescriptor<?> ed;

	public CompositeEntityReferenceTextPart(EntityDescriptor<?> ed) {
		this.ed = ed;
	}

	protected IFigure createFigure() {
		return new CompositeEntityReferenceTextFigure(ed, new ActionListener() {
	...
	protected List<IEntity> getModelChildren() {
		((CompositeEntityReferenceTextFigure) getFigure()).setAdjacentSize(
