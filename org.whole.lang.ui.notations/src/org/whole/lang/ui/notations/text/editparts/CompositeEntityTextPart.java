...
import org.whole.lang.ui.notations.text.figures.CompositeEntityTextFigure;

/**
 * @author Riccardo Solmi
 */
public class CompositeEntityTextPart extends AbstractCompositePart {
	protected EntityDescriptor<?> ed;

	public CompositeEntityTextPart(EntityDescriptor<?> ed) {
		this.ed = ed;
	}

	protected IFigure createFigure() {
		return new CompositeEntityTextFigure(ed);
	}
