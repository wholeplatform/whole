 ...
 */
public class CompositeEntityReferenceTreeFigure extends CompositeEntityTreeFigure {
	protected ActionListener linkListener;

	public CompositeEntityReferenceTreeFigure(EntityDescriptor<?> ed, boolean isRightToLeft, ActionListener linkListener) {
		super(ed, isRightToLeft);
