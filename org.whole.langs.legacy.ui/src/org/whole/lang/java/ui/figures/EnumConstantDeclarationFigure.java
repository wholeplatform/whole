 ...
 */
public class EnumConstantDeclarationFigure extends ContentPaneFigure {
    private IFigure f1, f2;

    public EnumConstantDeclarationFigure() {
    ...
    public void hideDelimiters(boolean value) {
        f1.setVisible(!value);
        f2.setVisible(!value);
    }
}
