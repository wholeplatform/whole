 ...
 */
public class AnnotationTypeMemberDeclarationFigure extends ContentPaneFigure {

	public AnnotationTypeMemberDeclarationFigure() {
		super(new ColumnLayout());
		initContentPanes(4);
		EntityFigure row;
		add(createContentPane(0));
		add(row = new EntityFigure(new RowLayout().withSpacing(4)));
		row.addContent("AnnotationTypeMemberDeclaration");
