...
import org.whole.lang.java.ui.figures.OrdinaryCompilationUnitFigure;
 ...
 */
public class OrdinaryCompilationUnitPart extends AbstractContentPanePart {
	protected IFigure createFigure() {
		return new OrdinaryCompilationUnitFigure();
	}

	protected List<IEntity> getModelSpecificChildren() {
		OrdinaryCompilationUnit compilationUnit = getModelEntity();
