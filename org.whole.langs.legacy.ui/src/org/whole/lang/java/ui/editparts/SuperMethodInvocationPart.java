...
import org.whole.lang.java.ui.figures.SuperMethodInvocationFigure;
 ...
 */
public class SuperMethodInvocationPart extends AbstractContentPanePart {
	protected IFigure createFigure() {
		return new SuperMethodInvocationFigure();
	}

	protected List<IEntity> getModelSpecificChildren() {
		List<IEntity> list = new ArrayList<IEntity>(4);
		SuperMethodInvocation entity = getModelEntity();
