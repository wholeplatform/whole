 ...
 *  @generator Whole
 */
public class SwitchStatementFigure extends ContentPaneFigure {

    public SwitchStatementFigure() {
        initContentPanes(2);
        setLayoutManager(new ColumnLayout());
        EntityFigure row = new EntityFigure(new RowLayout().withSpacing(4));
        row.addKeyword("switch");
        row.addContentLight("(");
        ...
        EntityFigure row1 = new EntityFigure(new RowLayout());
        row1.addContentLighter("}");
        add(row1);
    }
}
