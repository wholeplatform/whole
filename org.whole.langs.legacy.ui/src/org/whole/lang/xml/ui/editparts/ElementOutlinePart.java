...
import org.whole.lang.xml.ui.figures.ElementOutlineFigure;

/**
 * @generator Riccardo Solmi
 */
public class ElementOutlinePart extends AbstractContentPanePart {
	protected IFigure createFigure() {
		Element entity = getModelEntity();
		IContent content = entity.getContent();
		boolean startOpened = !EntityUtils.isResolver(content)
			&& !(EntityUtils.isComposite(content) && content.wIsEmpty());
