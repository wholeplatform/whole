...
import org.whole.lang.xml.ui.editparts.XmlTextualPartFactoryVisitor;

/**
 * @author Riccardo Solmi
 */
public class XmlTextualEditorKit extends AbstractEditorKit {
	private static final long serialVersionUID = 1L;
	public static final String ID = XmlTextualEditorKit.class.getName();
	...
	public IEditPartFactory getPartFactory() {
		return new XmlTextualPartFactoryVisitor();
	}
	...
	public boolean canApply(ILanguageKit languageKit) {
		return languageKit.getURI().equals(XmlLanguageKit.URI);
	}
}