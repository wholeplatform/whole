 ...
 *  @generator Whole
 */
public class IfStmtFigure extends ContentPaneFigure {
    ...
    public IfStmtFigure() {
        ...
        row.add(createContentPane(2, new CurlyBracketsBorder()));
        add(row);
        EntityFigure row1 = new EntityFigure(new RowLayout().withSpacing(4));
        row1.addKeyword("else");
        row1.add(createContentPane(3));
        add(row1);
    }
}
