...
import org.whole.lang.swift.ui.figures.EnumDeclFigure;

/**
 *  @generator Whole
 */
public class EnumDeclPart extends AbstractContentPanePart {

    protected IFigure createFigure() {
        return new EnumDeclFigure();
    }

    protected List<IEntity> getModelSpecificChildren() {
        EnumDecl entity = getModelEntity();
        ...
        children.add(entity.getGenericParameters());
