...
import org.whole.lang.swift.ui.figures.TupleElementFigure;

/**
 *  @generator Whole
 */
public class TupleElementPart extends AbstractContentPanePart {

    protected IFigure createFigure() {
        return new TupleElementFigure();
    }

    protected List<IEntity> getModelSpecificChildren() {
        TupleElement entity = getModelEntity();
