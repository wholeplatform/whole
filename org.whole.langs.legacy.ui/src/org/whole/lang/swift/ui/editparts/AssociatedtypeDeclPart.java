...
import org.whole.lang.swift.ui.figures.AssociatedtypeDeclFigure;

/**
 *  @generator Whole
 */
public class AssociatedtypeDeclPart extends AbstractContentPanePart {

    protected IFigure createFigure() {
        return new AssociatedtypeDeclFigure();
    }

    protected List<IEntity> getModelSpecificChildren() {
        AssociatedtypeDecl entity = getModelEntity();
