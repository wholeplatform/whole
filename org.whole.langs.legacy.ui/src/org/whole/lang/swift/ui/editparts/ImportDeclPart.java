...
import org.whole.lang.swift.ui.figures.ImportDeclFigure;

/**
 *  @generator Whole
 */
public class ImportDeclPart extends AbstractContentPanePart {

    protected IFigure createFigure() {
        return new ImportDeclFigure();
    }

    protected List<IEntity> getModelSpecificChildren() {
        ImportDecl entity = getModelEntity();
        List<IEntity> children = new ArrayList<IEntity>(4);
        children.add(entity.getAttributes());
        children.add(entity.getModifiers());
        children.add(entity.getImportKind());
