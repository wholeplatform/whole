...
import org.whole.lang.swift.ui.figures.SubscriptDeclFigure;

/**
 *  @generator Whole
 */
public class SubscriptDeclPart extends AbstractContentPanePart {

    protected IFigure createFigure() {
        return new SubscriptDeclFigure();
    }

    protected List<IEntity> getModelSpecificChildren() {
        SubscriptDecl entity = getModelEntity();
        ...
        children.add(entity.getIndices());
