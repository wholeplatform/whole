...
import org.whole.lang.swift.ui.figures.TypealiasDeclFigure;

/**
 *  @generator Whole
 */
public class TypealiasDeclPart extends AbstractContentPanePart {

    protected IFigure createFigure() {
        return new TypealiasDeclFigure();
    }

    protected List<IEntity> getModelSpecificChildren() {
        TypealiasDecl entity = getModelEntity();
