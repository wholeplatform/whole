 ...
 */
public class DownTextualAction extends NavigateTextualAction {
	public static final String ID = DownTextualAction.class.getName();

	public DownTextualAction(IWorkbenchPart part, IEnablerPredicate enablerPredicate, IEntity prototype, String text) {
		super(part, enablerPredicate, prototype, text);
	}
	public DownTextualAction(IWorkbenchPart part, IEnablerPredicate enablerPredicate, EntityDescriptor<?> type, String text) {
	...
	public void runNavigate() {
		...
		Point targetLocation = caretBounds.getBottomLeft().translate(0, caretBounds.height);
		...
		if (targetPart != null)
			...
			if (nextRowIndex >= document.wSize())
				return;
