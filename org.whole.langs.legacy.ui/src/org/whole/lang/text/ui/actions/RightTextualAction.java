 ...
 */
public class RightTextualAction extends NavigateTextualAction {
	public static final String ID = RightTextualAction.class.getName();

	public RightTextualAction(IWorkbenchPart part, IEnablerPredicate enablerPredicate, IEntity prototype, String text) {
		super(part, enablerPredicate, prototype, text);
	}
	public RightTextualAction(IWorkbenchPart part, IEnablerPredicate enablerPredicate, EntityDescriptor<?> type, String text) {
	...
	protected boolean calculateNavigateEnabled(ITextualEntityPart targetPart) {
		return targetPart.getCaretPosition() == targetPart.getCaretPositions() && !targetPart.hasSelectionRange();
	}
	...
	public void runNavigate() {
		...
		MatcherIterator<IEntity> iterator = IteratorFactory.descendantOrSelfMatcherIterator();
