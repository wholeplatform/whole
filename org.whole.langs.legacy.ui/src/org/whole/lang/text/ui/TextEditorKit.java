 ...
 */
package org.whole.lang.text.ui;
 ...
 */
public class TextEditorKit extends AbstractEditorKit {
	...
	public IEditPartFactory getPartFactory() {
		return new TextPartFactoryVisitor();
	}

	public boolean canApply(ILanguageKit languageKit) {
		return languageKit.getURI().equals(TextLanguageKit.URI);
	}
