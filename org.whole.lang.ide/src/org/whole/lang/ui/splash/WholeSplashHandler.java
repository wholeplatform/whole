 ...
 */
package org.whole.lang.ui.splash;
 ...
 */
public class WholeSplashHandler extends BasicSplashHandler {
	...
	public void init(Shell splash) {
		...
		getContent().addPaintListener(new PaintListener() {
			public void paintControl(PaintEvent e) {
				...
				e.gc.drawText(WholeIDEPlugin.getInstance().getBundle().getVersion().toString(), 250, 52, true);
			}
		});
	}
}
