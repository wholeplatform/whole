 ...
 */
public class ContextView extends AbstractDerivedGraphicalView {
	public static String ID = ContextView.class.getName();
	@Override
	...
	protected AbstractDerivedGraphicalViewer createGraphicalViewer(Composite parent, WholeEditDomain editDomain) {
		return new ContextViewer(parent, editDomain, this);
	}
	...
	public IEntity getSelfModel() {
		if (hasContents && !isDisposed()) {
			...
			if (activePage != null)
				return ((ContextViewer) activePage.getViewer()).getSelfModel();
		}
		return null;
	}
