 ...
 */
public class PackageFragmentBrowseChooser extends AbstractBrowseChooser {
	protected IPackageFragment lastSelectedFragment;

	public PackageFragmentBrowseChooser(Composite parent, int style, int buttonWidthHint) {
