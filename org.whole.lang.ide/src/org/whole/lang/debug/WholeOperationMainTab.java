...
public class WholeOperationMainTab extends AbstractLauncherTab implements IPDELauncherConstants {
	private static final ImageDescriptor WHOLE_OPERATION_ICON = WholeIDEPlugin.getImageDescriptor("icons/debug/whole_operation.gif");
	...
	public WholeOperationMainTab() {
		...
		tabImage = WHOLE_OPERATION_ICON.createImage();
	}
