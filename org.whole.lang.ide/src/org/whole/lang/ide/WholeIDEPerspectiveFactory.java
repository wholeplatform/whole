 ...
 */
public class WholeIDEPerspectiveFactory extends WholeUIPerspectiveFactory {
	public static String ID = WholeIDEPerspectiveFactory.class.getName();
	...
	protected void addPerspectiveShortcuts(IPageLayout layout) {
		...
		layout.addPerspectiveShortcut(WholeIDEDebugPerspectiveFactory.ID);
