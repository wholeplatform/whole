 ...
 */
public class WholeIDESamplePerspectiveFactory extends WholeIDEPerspectiveFactory {
	public static String ID = WholeIDESamplePerspectiveFactory.class.getName();
