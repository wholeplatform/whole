 ...
 */
public class ModelDrivenDialogFactory implements ITaskDialogFactory {
	private static class SingletonHolder {
		private static final ModelDrivenDialogFactory instance = new ModelDrivenDialogFactory();
	}
	public static ModelDrivenDialogFactory instance() {
		return SingletonHolder.instance;
	}
	private ModelDrivenDialogFactory() {
	}
	...
	public Dialog createDialog(Shell shell, String title, String message, Assignments assignments, IBindingManager bindings) {
		...
		return ContextInjectionFactory.make(ModelDrivenDialog.class, context, params);
	}
}
