...
public class RationalAdapter extends AbstractEntityAdapter implements Rational {
    ...
    public IntegerNumber getNumerator() {
        return wGet(MathFeatureDescriptorEnum.numerator).wGetAdapter(MathEntityDescriptorEnum.IntegerNumber);
    }
    ...
    public IntegerNumber getDenominator() {
        return wGet(MathFeatureDescriptorEnum.denominator).wGetAdapter(MathEntityDescriptorEnum.IntegerNumber);
    }
