 ...
 *  @generator Whole
 */
public class NotProperSubsetAdapter extends AbstractEntityAdapter implements NotProperSubset {
    private static final long serialVersionUID = 1;

    public NotProperSubsetAdapter(IEntity implementor) {
        super(implementor);
    }

    public NotProperSubsetAdapter() {
    }
    ...
    public EntityDescriptor<NotProperSubset> wGetEntityDescriptor() {
        return MathEntityDescriptorEnum.NotProperSubset;
    }
