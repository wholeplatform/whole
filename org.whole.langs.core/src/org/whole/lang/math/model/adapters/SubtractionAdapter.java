...
public class SubtractionAdapter extends AbstractEntityAdapter implements Subtraction {
    ...
    public Expression getMinuend() {
        return wGet(MathFeatureDescriptorEnum.minuend).wGetAdapter(MathEntityDescriptorEnum.Expression);
    }
    ...
    public Expression getSubtrahend() {
        return wGet(MathFeatureDescriptorEnum.subtrahend).wGetAdapter(MathEntityDescriptorEnum.Expression);
    }
