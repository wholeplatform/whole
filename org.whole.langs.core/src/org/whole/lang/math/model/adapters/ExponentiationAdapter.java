 ...
 *  @generator Whole
 */
public class ExponentiationAdapter extends AbstractEntityAdapter implements Exponentiation {
    ...
    public Expression getBase() {
        return wGet(MathFeatureDescriptorEnum.base).wGetAdapter(MathEntityDescriptorEnum.Expression);
    }
    ...
    public Expression getExponent() {
        return wGet(MathFeatureDescriptorEnum.exponent).wGetAdapter(MathEntityDescriptorEnum.Expression);
    }
