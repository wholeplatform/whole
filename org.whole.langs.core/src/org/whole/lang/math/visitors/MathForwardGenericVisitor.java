 ...
 *  @generator Whole
 */
public class MathForwardGenericVisitor extends AbstractUnaryVisitor<IVisitor> implements IMathVisitor {

    public MathForwardGenericVisitor(IVisitor visitor1) {
        super(visitor1);
    }
