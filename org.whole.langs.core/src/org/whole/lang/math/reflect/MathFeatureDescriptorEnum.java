...
public class MathFeatureDescriptorEnum extends FeatureDescriptorEnum {
	...
	public static final FeatureDescriptor minuend = instance
			.valueOf(minuend_ord);
	public static final FeatureDescriptor subtrahend = instance
			.valueOf(subtrahend_ord);
	public static final FeatureDescriptor dividend = instance
			.valueOf(dividend_ord);
	public static final FeatureDescriptor divisor = instance
			.valueOf(divisor_ord);
	public static final FeatureDescriptor base = instance.valueOf(base_ord);
	public static final FeatureDescriptor exponent = instance
			.valueOf(exponent_ord);
	...
	public static final FeatureDescriptor elements = instance
			.valueOf(elements_ord);
	...
	public static final FeatureDescriptor element = instance
			.valueOf(element_ord);
	public static final FeatureDescriptor rule = instance.valueOf(rule_ord);
	public static final FeatureDescriptor collection1 = instance
			.valueOf(collection1_ord);
	public static final FeatureDescriptor collection2 = instance
			.valueOf(collection2_ord);
	public static final FeatureDescriptor collection = instance
			.valueOf(collection_ord);
	public static final FeatureDescriptor index = instance.valueOf(index_ord);
	public static final FeatureDescriptor numerator = instance
			.valueOf(numerator_ord);
	public static final FeatureDescriptor denominator = instance
			.valueOf(denominator_ord);
