...
public class MathEntityFactory extends GenericEntityFactory {
	...
	public Subtraction createSubtraction(Expression minuend,
	...
	public IEntityBuilder<Subtraction> buildSubtraction() {
		return new EntityBuilder<Subtraction>(
				create(MathEntityDescriptorEnum.Subtraction));
	}
	...
	public IEntityBuilder<Division> buildDivision() {
		return new EntityBuilder<Division>(
				create(MathEntityDescriptorEnum.Division));
	}
	...
	public IEntityBuilder<Quotient> buildQuotient() {
		return new EntityBuilder<Quotient>(
				create(MathEntityDescriptorEnum.Quotient));
	}
	...
	public IEntityBuilder<Remainder> buildRemainder() {
		return new EntityBuilder<Remainder>(
				create(MathEntityDescriptorEnum.Remainder));
	}
	...
	public Exponentiation createExponentiation(Expression base,
			Expression exponent) {
	...
	public IEntityBuilder<Exponentiation> buildExponentiation() {
		return new EntityBuilder<Exponentiation>(
				create(MathEntityDescriptorEnum.Exponentiation));
	}
	...
	public GreatestCommonDivisor createGreatestCommonDivisor(int initialSize) {
		return clone(MathEntityDescriptorEnum.GreatestCommonDivisor,
				initialSize);
	}
	...
	public IEntityBuilder<Implies> buildImplies() {
		return new EntityBuilder<Implies>(
				create(MathEntityDescriptorEnum.Implies));
	}
	...
	public IEntityBuilder<ShiftLeft> buildShiftLeft() {
		return new EntityBuilder<ShiftLeft>(
				create(MathEntityDescriptorEnum.ShiftLeft));
	}
	...
	public IEntityBuilder<ShiftRight> buildShiftRight() {
		return new EntityBuilder<ShiftRight>(
				create(MathEntityDescriptorEnum.ShiftRight));
	}
	...
	public ArithmeticShiftRight createArithmeticShiftRight(
			Expression expression, Expression bits) {
		return create(MathEntityDescriptorEnum.ArithmeticShiftRight,
				expression, bits);
	}

	public IEntityBuilder<ArithmeticShiftRight> buildArithmeticShiftRight() {
		return new EntityBuilder<ArithmeticShiftRight>(
				create(MathEntityDescriptorEnum.ArithmeticShiftRight));
	}
	...
	public IEntityBuilder<NotEquals> buildNotEquals() {
		return new EntityBuilder<NotEquals>(
				create(MathEntityDescriptorEnum.NotEquals));
	}
	...
	public ApproximatelyEqual createApproximatelyEqual(Expression exp1,
			Expression exp2) {
	...
	public IEntityBuilder<ApproximatelyEqual> buildApproximatelyEqual() {
		return new EntityBuilder<ApproximatelyEqual>(
				create(MathEntityDescriptorEnum.ApproximatelyEqual));
	}
	...
	public IEntityBuilder<FactorOf> buildFactorOf() {
		return new EntityBuilder<FactorOf>(
				create(MathEntityDescriptorEnum.FactorOf));
	}
	...
	public IEntityBuilder<Logarithm> buildLogarithm() {
		return new EntityBuilder<Logarithm>(
				create(MathEntityDescriptorEnum.Logarithm));
	}
	...
	public IEntityBuilder<OrderedPair> buildOrderedPair() {
		return new EntityBuilder<OrderedPair>(
				create(MathEntityDescriptorEnum.OrderedPair));
	}
	...
	public IEntityBuilder<Builder> buildBuilder() {
		return new EntityBuilder<Builder>(
				create(MathEntityDescriptorEnum.Builder));
	}
	...
	public Difference createDifference(CollectionExpression collection1,
			CollectionExpression collection2) {
		return create(MathEntityDescriptorEnum.Difference, collection1,
				collection2);
	}

	public IEntityBuilder<Difference> buildDifference() {
		return new EntityBuilder<Difference>(
				create(MathEntityDescriptorEnum.Difference));
	}
	...
	public NotSubset createNotSubset(CollectionExpression collection1,
			CollectionExpression collection2) {
		return create(MathEntityDescriptorEnum.NotSubset, collection1,
				collection2);
	}

	public IEntityBuilder<NotSubset> buildNotSubset() {
		return new EntityBuilder<NotSubset>(
				create(MathEntityDescriptorEnum.NotSubset));
	}
	...
	public NotProperSubset createNotProperSubset(
			CollectionExpression collection1, CollectionExpression collection2) {
		return create(MathEntityDescriptorEnum.NotProperSubset, collection1,
				collection2);
	}

	public IEntityBuilder<NotProperSubset> buildNotProperSubset() {
		return new EntityBuilder<NotProperSubset>(
				create(MathEntityDescriptorEnum.NotProperSubset));
	}
	...
	public Selector createSelector(Expression index,
	...
	public IEntityBuilder<Selector> buildSelector() {
		return new EntityBuilder<Selector>(
				create(MathEntityDescriptorEnum.Selector));
	}
	...
	public Rational createRational(IntegerNumber numerator,
	...
	public IEntityBuilder<Rational> buildRational() {
		return new EntityBuilder<Rational>(
				create(MathEntityDescriptorEnum.Rational));
	}
