 ...
 * @generator Whole
 */
public class EditorsIdentityUnaryVisitor<V extends IVisitor> extends
		AbstractUnaryVisitor<V> implements IEditorsVisitor {
	public EditorsIdentityUnaryVisitor() {
		super(null);
	}

	public EditorsIdentityUnaryVisitor(IVisitor visitor1) {
		super(visitor1);
	}
