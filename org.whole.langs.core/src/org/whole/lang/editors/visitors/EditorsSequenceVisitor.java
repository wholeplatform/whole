 ...
 * @generator Whole
 */
public class EditorsSequenceVisitor extends
		AbstractBinaryVisitor<IEditorsVisitor> implements IEditorsVisitor {
	public EditorsSequenceVisitor(IVisitor visitor1, IVisitor visitor2) {
