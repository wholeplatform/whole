 ...
 *  @generator Whole
 */
public class UsingFilterAdapter extends AbstractEntityAdapter implements UsingFilter {
    ...
    public Filter getFilter() {
        return wGet(TestsFeatureDescriptorEnum.filter).wGetAdapter(TestsEntityDescriptorEnum.Filter);
    }
    ...
    public SubjectStatement getSubjectStatement() {
        return wGet(TestsFeatureDescriptorEnum.subjectStatement).wGetAdapter(TestsEntityDescriptorEnum.SubjectStatement);
    }
