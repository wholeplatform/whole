...
public class TestAdapter extends AbstractEntityAdapter implements Test {
    ...
    public TestStatements getBody() {
        return wGet(TestsFeatureDescriptorEnum.body).wGetAdapter(TestsEntityDescriptorEnum.TestStatements);
    }
    ...
    public Result getActualResult() {
        return wGet(TestsFeatureDescriptorEnum.actualResult).wGetAdapter(TestsEntityDescriptorEnum.Result);
    }
    ...
    public Result getExpectedResult() {
        return wGet(TestsFeatureDescriptorEnum.expectedResult).wGetAdapter(TestsEntityDescriptorEnum.Result);
    }
