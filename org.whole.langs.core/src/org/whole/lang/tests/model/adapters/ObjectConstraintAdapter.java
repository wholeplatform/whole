 ...
 *  @generator Whole
 */
public class ObjectConstraintAdapter extends AbstractEntityAdapter implements ObjectConstraint {
    ...
    public Expression getObject() {
        return wGet(TestsFeatureDescriptorEnum.object).wGetAdapter(TestsEntityDescriptorEnum.Expression);
    }
