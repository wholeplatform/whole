 ...
 *  @generator Whole
 */
public class AspectAdapter extends AbstractEntityAdapter implements Aspect {
    private static final long serialVersionUID = 1;

    public AspectAdapter(IEntity implementor) {
        super(implementor);
    }
    ...
    public EntityDescriptor<Aspect> wGetEntityDescriptor() {
        return TestsEntityDescriptorEnum.Aspect;
    }
