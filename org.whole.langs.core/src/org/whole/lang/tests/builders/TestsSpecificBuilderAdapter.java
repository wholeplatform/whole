 ...
 *  @generator Whole
 */
public class TestsSpecificBuilderAdapter extends GenericBuilderContext implements ITestsBuilder {

    public TestsSpecificBuilderAdapter(IBuilder strategy) {
        super(strategy);
    }

    public TestsSpecificBuilderAdapter(IBuilder strategy, IEntityContext entityContext) {
        super(strategy, entityContext);
    }

    public void cause() {
        wFeature(TestsFeatureDescriptorEnum.cause);
    }

    public void location() {
        wFeature(TestsFeatureDescriptorEnum.location);
    }

    public void outcome() {
        wFeature(TestsFeatureDescriptorEnum.outcome);
    }

    public void errors() {
        wFeature(TestsFeatureDescriptorEnum.errors);
    }

    public void failures() {
        wFeature(TestsFeatureDescriptorEnum.failures);
    }

    public void successes() {
        wFeature(TestsFeatureDescriptorEnum.successes);
    }
    ...
    public void expectedResult() {
        wFeature(TestsFeatureDescriptorEnum.expectedResult);
    }

    public void actualResult() {
        wFeature(TestsFeatureDescriptorEnum.actualResult);
    }
    ...
    public void expectedResults() {
        wFeature(TestsFeatureDescriptorEnum.expectedResults);
    }

    public void actualResults() {
        wFeature(TestsFeatureDescriptorEnum.actualResults);
    }
    ...
    public void Results() {
        wEntity(TestsEntityDescriptorEnum.Results);
    }

    public void Results_() {
        wEntity_(TestsEntityDescriptorEnum.Results);
    }

    public void _Results() {
        _wEntity(TestsEntityDescriptorEnum.Results);
    }

    public void Result() {
        wEntity(TestsEntityDescriptorEnum.Result);
    }

    public void Result_() {
        wEntity_(TestsEntityDescriptorEnum.Result);
    }

    public void _Result() {
        _wEntity(TestsEntityDescriptorEnum.Result);
    }

    public void Outcome() {
        wEntity(TestsEntityDescriptorEnum.Outcome);
    }

    public void Outcome(OutcomeEnum.Value value) {
        wEntity(TestsEntityDescriptorEnum.Outcome, value);
    }
