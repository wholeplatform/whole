 ...
 *  @generator Whole
 */
public class TestsForwardGenericVisitor extends AbstractUnaryVisitor<IVisitor> implements ITestsVisitor {

    public TestsForwardGenericVisitor(IVisitor visitor1) {
        super(visitor1);
    }
