 ...
 *  @generator Whole
 */
public class TestsIdentityUnaryVisitor<V extends IVisitor>  extends AbstractUnaryVisitor<V> implements ITestsVisitor {

    public TestsIdentityUnaryVisitor() {
        super(null);
    }

    public TestsIdentityUnaryVisitor(IVisitor visitor1) {
        super(visitor1);
    }
