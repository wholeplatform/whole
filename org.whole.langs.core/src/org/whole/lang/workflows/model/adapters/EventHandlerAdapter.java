 ...
 *  @generator Whole
 */
public class EventHandlerAdapter extends AbstractEntityAdapter implements EventHandler {
    ...
    public StartEvent getTriggerEvent() {
        return wGet(WorkflowsFeatureDescriptorEnum.triggerEvent).wGetAdapter(WorkflowsEntityDescriptorEnum.StartEvent);
    }
