...
public class AssignAdapter extends AbstractEntityAdapter implements Assign {
    ...
    public Variable getName() {
        return wGet(WorkflowsFeatureDescriptorEnum.name).wGetAdapter(WorkflowsEntityDescriptorEnum.Variable);
    }
    ...
    public Expression getExpression() {
        return wGet(WorkflowsFeatureDescriptorEnum.expression).wGetAdapter(WorkflowsEntityDescriptorEnum.Expression);
    }
