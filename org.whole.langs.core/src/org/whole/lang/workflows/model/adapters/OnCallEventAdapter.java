 ...
 *  @generator Whole
 */
public class OnCallEventAdapter extends AbstractEntityAdapter implements OnCallEvent {
    ...
    public Parameters getParameters() {
        return wGet(WorkflowsFeatureDescriptorEnum.parameters).wGetAdapter(WorkflowsEntityDescriptorEnum.Parameters);
    }
