 ...
 *  @generator Whole
 */
public class FaultHandlerAdapter extends AbstractEntityAdapter implements FaultHandler {
    ...
    public Fault getFaultName() {
        return wGet(WorkflowsFeatureDescriptorEnum.faultName).wGetAdapter(WorkflowsEntityDescriptorEnum.Fault);
    }
    ...
    public Variable getFaultVariable() {
        return wGet(WorkflowsFeatureDescriptorEnum.faultVariable).wGetAdapter(WorkflowsEntityDescriptorEnum.Variable);
    }
