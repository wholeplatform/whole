 ...
 *  @generator Whole
 */
public class SynchronizeArtifactsActivityAdapter extends AbstractEntityAdapter implements SynchronizeArtifactsActivity {
    private static final long serialVersionUID = 1;

    public SynchronizeArtifactsActivityAdapter(IEntity implementor) {
        super(implementor);
    }

    public SynchronizeArtifactsActivityAdapter() {
    }
    ...
    public EntityDescriptor<SynchronizeArtifactsActivity> wGetEntityDescriptor() {
        return WorkflowsEntityDescriptorEnum.SynchronizeArtifactsActivity;
    }
