 ...
 *  @generator Whole
 */
public class OnMessageEventAdapter extends AbstractEntityAdapter implements OnMessageEvent {
    ...
    public Message getMessage() {
        return wGet(WorkflowsFeatureDescriptorEnum.message).wGetAdapter(WorkflowsEntityDescriptorEnum.Message);
    }
