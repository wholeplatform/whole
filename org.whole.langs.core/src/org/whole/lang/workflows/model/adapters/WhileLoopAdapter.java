 ...
 *  @generator Whole
 */
public class WhileLoopAdapter extends AbstractEntityAdapter implements WhileLoop {
    ...
    public TestTime getTestTime() {
        return wGet(WorkflowsFeatureDescriptorEnum.testTime).wGetAdapter(WorkflowsEntityDescriptorEnum.TestTime);
    }
