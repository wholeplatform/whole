 ...
 *  @generator Whole
 */
public class ReturnEventAdapter extends AbstractEntityAdapter implements ReturnEvent {
    ...
    public Result getResult() {
        return wGet(WorkflowsFeatureDescriptorEnum.result).wGetAdapter(WorkflowsEntityDescriptorEnum.Result);
    }
