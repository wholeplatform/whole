 ...
 *  @generator Whole
 */
public class OnTimerEventAdapter extends AbstractEntityAdapter implements OnTimerEvent {
    ...
    public Timer getTimer() {
        return wGet(WorkflowsFeatureDescriptorEnum.timer).wGetAdapter(WorkflowsEntityDescriptorEnum.Timer);
    }
