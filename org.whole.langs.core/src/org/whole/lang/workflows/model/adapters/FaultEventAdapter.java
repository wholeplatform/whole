 ...
 *  @generator Whole
 */
public class FaultEventAdapter extends AbstractEntityAdapter implements FaultEvent {
    ...
    public Fault getFault() {
        return wGet(WorkflowsFeatureDescriptorEnum.fault).wGetAdapter(WorkflowsEntityDescriptorEnum.Fault);
    }
