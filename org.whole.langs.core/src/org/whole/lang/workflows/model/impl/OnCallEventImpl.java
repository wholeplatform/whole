...
import org.whole.lang.workflows.model.Parameters;

/**
 *  @generator Whole
 */
public class OnCallEventImpl extends AbstractSimpleEntity implements OnCallEvent {
    ...
    public Parameters getParameters() {
        return notifyRequested(WorkflowsFeatureDescriptorEnum.parameters, parameters);
    }

    public void setParameters(Parameters parameters) {
        notifyChanged(WorkflowsFeatureDescriptorEnum.parameters, this.parameters, this.parameters = parameters);
    }
    ...
    public void wSet(int index, IEntity value) {
        switch (index) {
            ...
            break;
            case 2 :
            setParameters(value.wGetAdapter(WorkflowsEntityDescriptorEnum.Parameters));
            break;
            default :
            throw new IllegalArgumentException();
        }
