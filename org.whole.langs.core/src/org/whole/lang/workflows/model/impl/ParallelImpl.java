...
public class ParallelImpl extends AbstractSimpleEntity implements Parallel {
    ...
    public FlowObjects getFlowObjects() {
        return notifyRequested(WorkflowsFeatureDescriptorEnum.flowObjects, flowObjects);
    }

    public void setFlowObjects(FlowObjects flowObjects) {
        notifyChanged(WorkflowsFeatureDescriptorEnum.flowObjects, this.flowObjects, this.flowObjects = flowObjects);
    }
    ...
    public void wSet(int index, IEntity value) {
        switch (index) {
            ...
            break;
            case 1 :
            setFlowObjects(value.wGetAdapter(WorkflowsEntityDescriptorEnum.FlowObjects));
            break;
            default :
            throw new IllegalArgumentException();
        }
