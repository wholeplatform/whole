 ...
 *  @generator Whole
 */
public class InvokeOperationImpl extends AbstractSimpleEntity implements InvokeOperation {
    ...
    public Operation getOperation() {
        return notifyRequested(WorkflowsFeatureDescriptorEnum.operation, operation);
    }

    public void setOperation(Operation operation) {
        notifyChanged(WorkflowsFeatureDescriptorEnum.operation, this.operation, this.operation = operation);
    }
    ...
    public void wSet(int index, IEntity value) {
        switch (index) {
            ...
            break;
            case 2 :
            setOperation(value.wGetAdapter(WorkflowsEntityDescriptorEnum.Operation));
            break;
            case 3 :
