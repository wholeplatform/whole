 ...
 *  @generator Whole
 */
public class WorkflowsSpecificBuilderAdapter extends GenericBuilderContext implements IWorkflowsBuilder {

    public WorkflowsSpecificBuilderAdapter(IBuilder strategy) {
        super(strategy);
    }

    public WorkflowsSpecificBuilderAdapter(IBuilder strategy, IEntityContext entityContext) {
    ...
    public void ConditionalCases_(int initialCapacity) {
        wEntity_(WorkflowsEntityDescriptorEnum.ConditionalCases, initialCapacity);
    }
    ...
    public void ArtifactsSynchronizeStrategy(ArtifactsSynchronizeStrategyEnum.Value value) {
        wEntity(WorkflowsEntityDescriptorEnum.ArtifactsSynchronizeStrategy, value);
    }
