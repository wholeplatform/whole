...
public class WorkflowsModelContext extends EntityContext {
	...
	public WorkflowsModelContext getRegistry() {
		return (WorkflowsModelContext) wGet(WorkflowsFeatureDescriptorEnum.registry);
	}

	public void setRegistry(WorkflowsModelContext registry) {
		wSet(WorkflowsFeatureDescriptorEnum.registry, registry);
	}

	public WorkflowsModelContext getEntityName() {
		return (WorkflowsModelContext) wGet(WorkflowsFeatureDescriptorEnum.entityName);
	}

	public void setEntityName(WorkflowsModelContext entityName) {
