...
public class WorkflowsEntityFactory extends GenericEntityFactory {
    ...
    public static WorkflowsEntityFactory instance(IEntityRegistryProvider provider) {
    ...
    public Workflow createWorkflow(Name name, Description description, Declarations declarations, StartEvent startEvent, FlowObject flowObject, FlowEvent endEvent) {
        return create(WorkflowsEntityDescriptorEnum.Workflow, name, description, declarations, startEvent, flowObject, endEvent);
    }

    public IEntityBuilder<Workflow> buildWorkflow() {
        return new EntityBuilder<Workflow>(create(WorkflowsEntityDescriptorEnum.Workflow));
    }
    ...
    public Scope createScope(Label label, Declarations declarations, FlowObject flowObject, FlowObject compensationHandler, EventHandlers eventHandlers, FaultHandlers faultHandlers) {
        return create(WorkflowsEntityDescriptorEnum.Scope, label, declarations, flowObject, compensationHandler, eventHandlers, faultHandlers);
    }

    public IEntityBuilder<Scope> buildScope() {
        return new EntityBuilder<Scope>(create(WorkflowsEntityDescriptorEnum.Scope));
    }
    ...
    public FaultHandlers createFaultHandlers(FaultHandler... entities) {
        return create(WorkflowsEntityDescriptorEnum.FaultHandlers, (IEntity[]) entities);
    }
    ...
    public FaultHandler createFaultHandler(Name name, Label label, Fault faultName, Variable faultVariable, FlowObject flowObject) {
        return create(WorkflowsEntityDescriptorEnum.FaultHandler, name, label, faultName, faultVariable, flowObject);
    }

    public IEntityBuilder<FaultHandler> buildFaultHandler() {
        return new EntityBuilder<FaultHandler>(create(WorkflowsEntityDescriptorEnum.FaultHandler));
    }
    ...
    public EventHandlers createEventHandlers(EventHandler... entities) {
        return create(WorkflowsEntityDescriptorEnum.EventHandlers, (IEntity[]) entities);
    }
    ...
    public EventHandler createEventHandler(Name name, Label label, StartEvent triggerEvent, FlowObject flowObject) {
        return create(WorkflowsEntityDescriptorEnum.EventHandler, name, label, triggerEvent, flowObject);
    }

    public IEntityBuilder<EventHandler> buildEventHandler() {
        return new EntityBuilder<EventHandler>(create(WorkflowsEntityDescriptorEnum.EventHandler));
    }
    ...
    public Sequence createSequence(Label label, FlowObjects flowObjects) {
        return create(WorkflowsEntityDescriptorEnum.Sequence, label, flowObjects);
    }

    public IEntityBuilder<Sequence> buildSequence() {
        return new EntityBuilder<Sequence>(create(WorkflowsEntityDescriptorEnum.Sequence));
    }
    ...
    public Parallel createParallel(Label label, FlowObjects flowObjects) {
        return create(WorkflowsEntityDescriptorEnum.Parallel, label, flowObjects);
    }

    public IEntityBuilder<Parallel> buildParallel() {
        return new EntityBuilder<Parallel>(create(WorkflowsEntityDescriptorEnum.Parallel));
    }
    ...
    public FlowObjects createFlowObjects(FlowObject... entities) {
        return create(WorkflowsEntityDescriptorEnum.FlowObjects, (IEntity[]) entities);
    }
    ...
    public ForeachLoop createForeachLoop(Label label, Variable compositeVariable, Variable elementVariable, Variable indexVariable, FlowObject flowObject) {
        return create(WorkflowsEntityDescriptorEnum.ForeachLoop, label, compositeVariable, elementVariable, indexVariable, flowObject);
    }

    public IEntityBuilder<ForeachLoop> buildForeachLoop() {
        return new EntityBuilder<ForeachLoop>(create(WorkflowsEntityDescriptorEnum.ForeachLoop));
    }
    ...
    public WhileLoop createWhileLoop(Label label, TestTime testTime, Condition condition, FlowObject flowObject) {
        return create(WorkflowsEntityDescriptorEnum.WhileLoop, label, testTime, condition, flowObject);
    }

    public IEntityBuilder<WhileLoop> buildWhileLoop() {
        return new EntityBuilder<WhileLoop>(create(WorkflowsEntityDescriptorEnum.WhileLoop));
    }
    ...
    public PickControl createPickControl(Label label, EventHandlers eventHandlers) {
        return create(WorkflowsEntityDescriptorEnum.PickControl, label, eventHandlers);
    }

    public IEntityBuilder<PickControl> buildPickControl() {
        return new EntityBuilder<PickControl>(create(WorkflowsEntityDescriptorEnum.PickControl));
    }
    ...
    public SwitchControl createSwitchControl(Label label, SwitchType switchType, ConditionalCases conditionalCases, DefaultCase defaultCase) {
        return create(WorkflowsEntityDescriptorEnum.SwitchControl, label, switchType, conditionalCases, defaultCase);
    }

    public IEntityBuilder<SwitchControl> buildSwitchControl() {
        return new EntityBuilder<SwitchControl>(create(WorkflowsEntityDescriptorEnum.SwitchControl));
    }
    ...
    public ConditionalCases createConditionalCases(ConditionalCase... entities) {
        return create(WorkflowsEntityDescriptorEnum.ConditionalCases, (IEntity[]) entities);
    }

    public ConditionalCases createConditionalCases(int initialSize) {
        return clone(WorkflowsEntityDescriptorEnum.ConditionalCases, initialSize);
    }
    ...
    public ConditionalCase createConditionalCase(Label label, Condition condition, FlowObject flowObject) {
        return create(WorkflowsEntityDescriptorEnum.ConditionalCase, label, condition, flowObject);
    }

    public IEntityBuilder<ConditionalCase> buildConditionalCase() {
        return new EntityBuilder<ConditionalCase>(create(WorkflowsEntityDescriptorEnum.ConditionalCase));
    }
    ...
    public OnCallEvent createOnCallEvent(Name name, Label label, Parameters parameters) {
        return create(WorkflowsEntityDescriptorEnum.OnCallEvent, name, label, parameters);
    }

    public IEntityBuilder<OnCallEvent> buildOnCallEvent() {
        return new EntityBuilder<OnCallEvent>(create(WorkflowsEntityDescriptorEnum.OnCallEvent));
    }
    ...
    public OnMessageEvent createOnMessageEvent(Name name, Label label, Message message) {
        return create(WorkflowsEntityDescriptorEnum.OnMessageEvent, name, label, message);
    }

    public IEntityBuilder<OnMessageEvent> buildOnMessageEvent() {
        return new EntityBuilder<OnMessageEvent>(create(WorkflowsEntityDescriptorEnum.OnMessageEvent));
    }
    ...
    public OnTimerEvent createOnTimerEvent(Name name, Label label, Timer timer) {
        return create(WorkflowsEntityDescriptorEnum.OnTimerEvent, name, label, timer);
    }

    public IEntityBuilder<OnTimerEvent> buildOnTimerEvent() {
        return new EntityBuilder<OnTimerEvent>(create(WorkflowsEntityDescriptorEnum.OnTimerEvent));
    }
    ...
    public IEntityBuilder<FaultEvent> buildFaultEvent() {
        return new EntityBuilder<FaultEvent>(create(WorkflowsEntityDescriptorEnum.FaultEvent));
    }
    ...
    public IEntityBuilder<ReturnEvent> buildReturnEvent() {
        return new EntityBuilder<ReturnEvent>(create(WorkflowsEntityDescriptorEnum.ReturnEvent));
    }
    ...
    public Task createTask(Label label, Description description, Assignments assignments, Variable factory) {
        return create(WorkflowsEntityDescriptorEnum.Task, label, description, assignments, factory);
    }

    public IEntityBuilder<Task> buildTask() {
        return new EntityBuilder<Task>(create(WorkflowsEntityDescriptorEnum.Task));
    }
    ...
    public Breakpoint createBreakpoint(Label label, BooleanLiteral disabled, IntLiteral hitCount, Condition condition, ConditionTest conditionTest, Variables showVariables) {
        return create(WorkflowsEntityDescriptorEnum.Breakpoint, label, disabled, hitCount, condition, conditionTest, showVariables);
    }

    public IEntityBuilder<Breakpoint> buildBreakpoint() {
        return new EntityBuilder<Breakpoint>(create(WorkflowsEntityDescriptorEnum.Breakpoint));
    }
    ...
    public Variables createVariables(Variable... entities) {
        return create(WorkflowsEntityDescriptorEnum.Variables, (IEntity[]) entities);
    }
    ...
    public AssignActivity createAssignActivity(Label label, Assignments assignments) {
        return create(WorkflowsEntityDescriptorEnum.AssignActivity, label, assignments);
    }

    public IEntityBuilder<AssignActivity> buildAssignActivity() {
        return new EntityBuilder<AssignActivity>(create(WorkflowsEntityDescriptorEnum.AssignActivity));
    }
    ...
    public CreateModel createCreateModel(Label label, Variable model, Variable template, Assignments bindings) {
        return create(WorkflowsEntityDescriptorEnum.CreateModel, label, model, template, bindings);
    }

    public IEntityBuilder<CreateModel> buildCreateModel() {
        return new EntityBuilder<CreateModel>(create(WorkflowsEntityDescriptorEnum.CreateModel));
    }
    ...
    public LoadJavaModel createLoadJavaModel(Label label, Variable model, Expression className, ClassProvider classProvider) {
        return create(WorkflowsEntityDescriptorEnum.LoadJavaModel, label, model, className, classProvider);
    }

    public IEntityBuilder<LoadJavaModel> buildLoadJavaModel() {
        return new EntityBuilder<LoadJavaModel>(create(WorkflowsEntityDescriptorEnum.LoadJavaModel));
    }
    ...
    public LoadModel createLoadModel(Label label, Variable model, Expression persistence, ResourceKind resourceKind, Expression resource, Assignments bindings) {
        return create(WorkflowsEntityDescriptorEnum.LoadModel, label, model, persistence, resourceKind, resource, bindings);
    }

    public IEntityBuilder<LoadModel> buildLoadModel() {
        return new EntityBuilder<LoadModel>(create(WorkflowsEntityDescriptorEnum.LoadModel));
    }
    ...
    public SaveModel createSaveModel(Label label, Variable model, Expression persistence, ResourceKind resourceKind, Expression resource, Assignments bindings) {
        return create(WorkflowsEntityDescriptorEnum.SaveModel, label, model, persistence, resourceKind, resource, bindings);
    }

    public IEntityBuilder<SaveModel> buildSaveModel() {
        return new EntityBuilder<SaveModel>(create(WorkflowsEntityDescriptorEnum.SaveModel));
    }
    ...
    public DeleteArtifacts createDeleteArtifacts(Label label, Variable model, ResourceKind rootResourceKind, Expression rootResource) {
        return create(WorkflowsEntityDescriptorEnum.DeleteArtifacts, label, model, rootResourceKind, rootResource);
    }

    public IEntityBuilder<DeleteArtifacts> buildDeleteArtifacts() {
        return new EntityBuilder<DeleteArtifacts>(create(WorkflowsEntityDescriptorEnum.DeleteArtifacts));
    }
    ...
    public ArtifactsTraversalStrategy createArtifactsTraversalStrategy(ArtifactsTraversalStrategyEnum.Value value) {
        return create(WorkflowsEntityDescriptorEnum.ArtifactsTraversalStrategy, value);
    }
    ...
    public ArtifactsSynchronizeStrategy createArtifactsSynchronizeStrategy(ArtifactsSynchronizeStrategyEnum.Value value) {
        return create(WorkflowsEntityDescriptorEnum.ArtifactsSynchronizeStrategy, value);
    }
    ...
    public LoadArtifacts createLoadArtifacts(Label label, Variable model, ResourceKind rootResourceKind, Expression rootResource, ArtifactsTraversalStrategy traversalStrategy, ArtifactsSynchronizeStrategy synchronizeStrategy, Expression defaultPersistence) {
        return create(WorkflowsEntityDescriptorEnum.LoadArtifacts, label, model, rootResourceKind, rootResource, traversalStrategy, synchronizeStrategy, defaultPersistence);
    }

    public IEntityBuilder<LoadArtifacts> buildLoadArtifacts() {
        return new EntityBuilder<LoadArtifacts>(create(WorkflowsEntityDescriptorEnum.LoadArtifacts));
    }
    ...
    public SaveArtifacts createSaveArtifacts(Label label, Variable model, ResourceKind rootResourceKind, Expression rootResource, ArtifactsTraversalStrategy traversalStrategy, ArtifactsSynchronizeStrategy synchronizeStrategy, Expression defaultPersistence) {
        return create(WorkflowsEntityDescriptorEnum.SaveArtifacts, label, model, rootResourceKind, rootResource, traversalStrategy, synchronizeStrategy, defaultPersistence);
    }

    public IEntityBuilder<SaveArtifacts> buildSaveArtifacts() {
        return new EntityBuilder<SaveArtifacts>(create(WorkflowsEntityDescriptorEnum.SaveArtifacts));
    }
    ...
    public Parse createParse(Label label, Variable model, Expression text, Expression grammar, Expression nt) {
        return create(WorkflowsEntityDescriptorEnum.Parse, label, model, text, grammar, nt);
    }

    public IEntityBuilder<Parse> buildParse() {
        return new EntityBuilder<Parse>(create(WorkflowsEntityDescriptorEnum.Parse));
    }
    ...
    public Unparse createUnparse(Label label, Variable model, Expression text, Expression grammar, Expression nt) {
        return create(WorkflowsEntityDescriptorEnum.Unparse, label, model, text, grammar, nt);
    }

    public IEntityBuilder<Unparse> buildUnparse() {
        return new EntityBuilder<Unparse>(create(WorkflowsEntityDescriptorEnum.Unparse));
    }
    ...
    public InvokeOperation createInvokeOperation(Label label, Variable model, Operation operation, Assignments bindings) {
        return create(WorkflowsEntityDescriptorEnum.InvokeOperation, label, model, operation, bindings);
    }

    public IEntityBuilder<InvokeOperation> buildInvokeOperation() {
        return new EntityBuilder<InvokeOperation>(create(WorkflowsEntityDescriptorEnum.InvokeOperation));
    }
    ...
    public InvokeQuery createInvokeQuery(Label label, Variable queryName, Arguments arguments) {
        return create(WorkflowsEntityDescriptorEnum.InvokeQuery, label, queryName, arguments);
    }

    public IEntityBuilder<InvokeQuery> buildInvokeQuery() {
        return new EntityBuilder<InvokeQuery>(create(WorkflowsEntityDescriptorEnum.InvokeQuery));
    }
    ...
    public InvokeJavaInstanceMethod createInvokeJavaInstanceMethod(Label label, Variable result, Expression object, Expressions typeArguments, Expression className, Expression method, Expressions arguments) {
        return create(WorkflowsEntityDescriptorEnum.InvokeJavaInstanceMethod, label, result, object, typeArguments, className, method, arguments);
    }

    public IEntityBuilder<InvokeJavaInstanceMethod> buildInvokeJavaInstanceMethod() {
        return new EntityBuilder<InvokeJavaInstanceMethod>(create(WorkflowsEntityDescriptorEnum.InvokeJavaInstanceMethod));
    }
    ...
    public InvokeJavaClassMethod createInvokeJavaClassMethod(Label label, Variable result, Expressions typeArguments, Expression className, Expression method, Expressions arguments) {
        return create(WorkflowsEntityDescriptorEnum.InvokeJavaClassMethod, label, result, typeArguments, className, method, arguments);
    }

    public IEntityBuilder<InvokeJavaClassMethod> buildInvokeJavaClassMethod() {
        return new EntityBuilder<InvokeJavaClassMethod>(create(WorkflowsEntityDescriptorEnum.InvokeJavaClassMethod));
    }
    ...
    public CreateJavaClassInstance createCreateJavaClassInstance(Label label, Variable result, Expressions typeArguments, Expression className, Expression constructor, Expressions arguments) {
        return create(WorkflowsEntityDescriptorEnum.CreateJavaClassInstance, label, result, typeArguments, className, constructor, arguments);
    }

    public IEntityBuilder<CreateJavaClassInstance> buildCreateJavaClassInstance() {
        return new EntityBuilder<CreateJavaClassInstance>(create(WorkflowsEntityDescriptorEnum.CreateJavaClassInstance));
    }
    ...
    public Declarations createDeclarations(Declaration... entities) {
        return create(WorkflowsEntityDescriptorEnum.Declarations, (IEntity[]) entities);
    }
    ...
    public Assignments createAssignments(Assign... entities) {
        return create(WorkflowsEntityDescriptorEnum.Assignments, (IEntity[]) entities);
    }
    ...
    public IEntityBuilder<Assign> buildAssign() {
        return new EntityBuilder<Assign>(create(WorkflowsEntityDescriptorEnum.Assign));
    }
    ...
    public Expressions createExpressions(Expression... entities) {
        return create(WorkflowsEntityDescriptorEnum.Expressions, (IEntity[]) entities);
    }
