...
public class QueriesEntityFactory extends GenericEntityFactory {
	...
	public QueryDeclaration createQueryDeclaration(Name name, Names parameters,
			PathExpression body) {
		return create(QueriesEntityDescriptorEnum.QueryDeclaration, name,
				parameters, body);
	}

	public IEntityBuilder<QueryDeclaration> buildQueryDeclaration() {
		return new EntityBuilder<QueryDeclaration>(
	...
	public CartesianInsert createCartesianInsert(Placement placement,
			PathExpression fromClause, PathExpression valuesClause) {
		return create(QueriesEntityDescriptorEnum.CartesianInsert, placement,
				fromClause, valuesClause);
	}

	public IEntityBuilder<CartesianInsert> buildCartesianInsert() {
		return new EntityBuilder<CartesianInsert>(
				create(QueriesEntityDescriptorEnum.CartesianInsert));
	}
	...
	public PointwiseInsert createPointwiseInsert(Placement placement,
			PathExpression fromClause, PathExpression valuesClause) {
		return create(QueriesEntityDescriptorEnum.PointwiseInsert, placement,
				fromClause, valuesClause);
	}

	public IEntityBuilder<PointwiseInsert> buildPointwiseInsert() {
		return new EntityBuilder<PointwiseInsert>(
				create(QueriesEntityDescriptorEnum.PointwiseInsert));
	}
	...
	public CartesianUpdate createCartesianUpdate(PathExpression fromClause,
			PathExpression valuesClause) {
		return create(QueriesEntityDescriptorEnum.CartesianUpdate, fromClause,
				valuesClause);
	}

	public IEntityBuilder<CartesianUpdate> buildCartesianUpdate() {
		return new EntityBuilder<CartesianUpdate>(
				create(QueriesEntityDescriptorEnum.CartesianUpdate));
	}
	...
	public PointwiseUpdate createPointwiseUpdate(PathExpression fromClause,
			PathExpression valuesClause) {
		return create(QueriesEntityDescriptorEnum.PointwiseUpdate, fromClause,
				valuesClause);
	}

	public IEntityBuilder<PointwiseUpdate> buildPointwiseUpdate() {
		return new EntityBuilder<PointwiseUpdate>(
				create(QueriesEntityDescriptorEnum.PointwiseUpdate));
	}
	...
	public Select createSelect(PathExpression selectClause,
			PathExpressionOrPredicate fromClause, PathExpression whereClause,
			NamesExpression clearClause) {
		return create(QueriesEntityDescriptorEnum.Select, selectClause,
				fromClause, whereClause, clearClause);
	}

	public IEntityBuilder<Select> buildSelect() {
		return new EntityBuilder<Select>(
				create(QueriesEntityDescriptorEnum.Select));
	}
	...
	public EntityTemplate createEntityTemplate(EntityType name,
			Constraints constraints) {
		return create(QueriesEntityDescriptorEnum.EntityTemplate, name,
				constraints);
	}

	public IEntityBuilder<EntityTemplate> buildEntityTemplate() {
		return new EntityBuilder<EntityTemplate>(
				create(QueriesEntityDescriptorEnum.EntityTemplate));
	}
	...
	public IEntityBuilder<EntityCall> buildEntityCall() {
		return new EntityBuilder<EntityCall>(
				create(QueriesEntityDescriptorEnum.EntityCall));
	}
	...
	public IEntityBuilder<Scope> buildScope() {
		return new EntityBuilder<Scope>(
				create(QueriesEntityDescriptorEnum.Scope));
	}
	...
	public Filter createFilter(StepExpression expression,
			PruneOrPredicate predicate) {
		return create(QueriesEntityDescriptorEnum.Filter, expression, predicate);
	}

	public IEntityBuilder<Filter> buildFilter() {
		return new EntityBuilder<Filter>(
				create(QueriesEntityDescriptorEnum.Filter));
	}
	...
	public IndexRangeTest createIndexRangeTest(IntLiteral startIndex,
			IntLiteral endIndex) {
		return create(QueriesEntityDescriptorEnum.IndexRangeTest, startIndex,
				endIndex);
	}

	public IEntityBuilder<IndexRangeTest> buildIndexRangeTest() {
		return new EntityBuilder<IndexRangeTest>(
				create(QueriesEntityDescriptorEnum.IndexRangeTest));
	}
	...
	public Every createEvery(PathExpression fromClause, Predicate whereClause) {
		return create(QueriesEntityDescriptorEnum.Every, fromClause,
				whereClause);
	}

	public IEntityBuilder<Every> buildEvery() {
		return new EntityBuilder<Every>(
				create(QueriesEntityDescriptorEnum.Every));
	}
	...
	public IEntityBuilder<AddNames> buildAddNames() {
		return new EntityBuilder<AddNames>(
				create(QueriesEntityDescriptorEnum.AddNames));
	}
	...
	public RemoveNames createRemoveNames(NamesExpression expression, Names names) {
		return create(QueriesEntityDescriptorEnum.RemoveNames, expression,
				names);
	}

	public IEntityBuilder<RemoveNames> buildRemoveNames() {
		return new EntityBuilder<RemoveNames>(
				create(QueriesEntityDescriptorEnum.RemoveNames));
	}
	...
	public Union createUnion(Expressions expressions, Comparator comparator) {
		return create(QueriesEntityDescriptorEnum.Union, expressions,
				comparator);
	}

	public IEntityBuilder<Union> buildUnion() {
		return new EntityBuilder<Union>(
				create(QueriesEntityDescriptorEnum.Union));
	}
	...
	public Intersect createIntersect(Expressions expressions,
			Comparator comparator) {
		return create(QueriesEntityDescriptorEnum.Intersect, expressions,
				comparator);
	}

	public IEntityBuilder<Intersect> buildIntersect() {
		return new EntityBuilder<Intersect>(
				create(QueriesEntityDescriptorEnum.Intersect));
	}
	...
	public Except createExcept(Expressions expressions, Comparator comparator) {
		return create(QueriesEntityDescriptorEnum.Except, expressions,
				comparator);
	}

	public IEntityBuilder<Except> buildExcept() {
		return new EntityBuilder<Except>(
				create(QueriesEntityDescriptorEnum.Except));
	}
	...
	public PointwiseEquals createPointwiseEquals(PathExpression pexp1,
			PathExpression pexp2) {
	...
	public IEntityBuilder<PointwiseEquals> buildPointwiseEquals() {
		return new EntityBuilder<PointwiseEquals>(
				create(QueriesEntityDescriptorEnum.PointwiseEquals));
	}
	...
	public IEntityBuilder<Addition> buildAddition() {
		return new EntityBuilder<Addition>(
				create(QueriesEntityDescriptorEnum.Addition));
	}
	...
	public IEntityBuilder<Subtraction> buildSubtraction() {
		return new EntityBuilder<Subtraction>(
				create(QueriesEntityDescriptorEnum.Subtraction));
	}
	...
	public IEntityBuilder<Multiplication> buildMultiplication() {
		return new EntityBuilder<Multiplication>(
				create(QueriesEntityDescriptorEnum.Multiplication));
	}
	...
	public IEntityBuilder<Division> buildDivision() {
		return new EntityBuilder<Division>(
				create(QueriesEntityDescriptorEnum.Division));
	}
	...
	public IEntityBuilder<Remainder> buildRemainder() {
		return new EntityBuilder<Remainder>(
				create(QueriesEntityDescriptorEnum.Remainder));
	}
	...
	public IEntityBuilder<Equals> buildEquals() {
		return new EntityBuilder<Equals>(
				create(QueriesEntityDescriptorEnum.Equals));
	}
	...
	public IEntityBuilder<NotEquals> buildNotEquals() {
		return new EntityBuilder<NotEquals>(
				create(QueriesEntityDescriptorEnum.NotEquals));
	}
	...
	public IEntityBuilder<LessThan> buildLessThan() {
		return new EntityBuilder<LessThan>(
				create(QueriesEntityDescriptorEnum.LessThan));
	}
	...
	public IEntityBuilder<LessOrEquals> buildLessOrEquals() {
		return new EntityBuilder<LessOrEquals>(
				create(QueriesEntityDescriptorEnum.LessOrEquals));
	}
	...
	public IEntityBuilder<GreaterThan> buildGreaterThan() {
		return new EntityBuilder<GreaterThan>(
				create(QueriesEntityDescriptorEnum.GreaterThan));
	}
	...
	public IEntityBuilder<GreaterOrEquals> buildGreaterOrEquals() {
		return new EntityBuilder<GreaterOrEquals>(
				create(QueriesEntityDescriptorEnum.GreaterOrEquals));
	}
