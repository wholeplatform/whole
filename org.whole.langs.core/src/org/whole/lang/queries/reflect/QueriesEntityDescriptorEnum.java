...
public class QueriesEntityDescriptorEnum extends EntityDescriptorEnum {
    ...
    public static final int Insert_ord = 5;
    public static final int CartesianInsert_ord = 6;
    public static final int PointwiseInsert_ord = 7;
    public static final int Update_ord = 8;
    public static final int CartesianUpdate_ord = 9;
    public static final int PointwiseUpdate_ord = 10;
    public static final int Select_ord = 11;
    public static final int For_ord = 12;
    public static final int If_ord = 13;
    public static final int Do_ord = 14;
    public static final int StepExpression_ord = 15;
    public static final int EntityTemplate_ord = 16;
    public static final int EntityCall_ord = 17;
    public static final int Call_ord = 18;
    public static final int Constraints_ord = 19;
    public static final int Expressions_ord = 20;
    public static final int Bindings_ord = 21;
    public static final int Bind_ord = 22;
    public static final int Choose_ord = 23;
    public static final int Block_ord = 24;
    public static final int Sequence_ord = 25;
    public static final int Scope_ord = 26;
    public static final int CartesianProduct_ord = 27;
    public static final int PointwiseProduct_ord = 28;
    public static final int Filter_ord = 29;
    public static final int Reverse_ord = 30;
    public static final int ReversibleStep_ord = 31;
    public static final int TraversalStep_ord = 32;
    public static final int AspectStep_ord = 33;
    public static final int DirectStep_ord = 34;
    public static final int AdjacentStep_ord = 35;
    public static final int ReachableStep_ord = 36;
    public static final int ReachableOrSelfStep_ord = 37;
    public static final int InverseStep_ord = 38;
    public static final int InverseAdjacentStep_ord = 39;
    public static final int InverseReachableStep_ord = 40;
    public static final int InverseReachableOrSelfStep_ord = 41;
    public static final int RootStep_ord = 42;
    public static final int FragmentRootStep_ord = 43;
    public static final int SelfStep_ord = 44;
    public static final int ForwardStep_ord = 45;
    public static final int FeatureStep_ord = 46;
    public static final int ChildStep_ord = 47;
    public static final int DescendantStep_ord = 48;
    public static final int DescendantOrSelfStep_ord = 49;
    public static final int FollowingSiblingStep_ord = 50;
    public static final int FollowingSiblingOrSelfStep_ord = 51;
    public static final int FollowingStep_ord = 52;
    public static final int FollowingOrSelfStep_ord = 53;
    public static final int BackwardStep_ord = 54;
    public static final int ParentStep_ord = 55;
    public static final int AncestorStep_ord = 56;
    public static final int AncestorOrSelfStep_ord = 57;
    public static final int PrecedingSiblingStep_ord = 58;
    public static final int PrecedingSiblingOrSelfStep_ord = 59;
    public static final int PrecedingStep_ord = 60;
    public static final int PrecedingOrSelfStep_ord = 61;
    public static final int PruneOrPredicate_ord = 62;
    public static final int Prune_ord = 63;
    public static final int Predicate_ord = 64;
    public static final int VariableTest_ord = 65;
    public static final int StageVariableTest_ord = 66;
    public static final int LanguageVariableTest_ord = 67;
    public static final int TypeVariableTest_ord = 68;
    public static final int SubtypeVariableTest_ord = 69;
    public static final int SupertypeVariableTest_ord = 70;
    public static final int ExtendedSubtypeVariableTest_ord = 71;
    public static final int ExtendedSupertypeVariableTest_ord = 72;
    public static final int IndexVariableTest_ord = 73;
    public static final int KindTest_ord = 74;
    public static final int CompositeKindTest_ord = 75;
    public static final int DataKindTest_ord = 76;
    public static final int StageTest_ord = 77;
    public static final int LanguageTest_ord = 78;
    public static final int TypeTest_ord = 79;
    public static final int SubtypeTest_ord = 80;
    public static final int SupertypeTest_ord = 81;
    public static final int ExtendedSubtypeTest_ord = 82;
    public static final int ExtendedSupertypeTest_ord = 83;
    public static final int AtTypeTest_ord = 84;
    public static final int AtFeatureTest_ord = 85;
    public static final int AtIndexTest_ord = 86;
    public static final int IndexTest_ord = 87;
    public static final int IndexRangeTest_ord = 88;
    public static final int VisitorTest_ord = 89;
    public static final int MatchTest_ord = 90;
    public static final int DistinctTest_ord = 91;
    public static final int And_ord = 92;
    public static final int Or_ord = 93;
    public static final int Not_ord = 94;
    public static final int QuantifiedPredicate_ord = 95;
    public static final int One_ord = 96;
    public static final int Some_ord = 97;
    public static final int Every_ord = 98;
    public static final int ParenthesizedPredicate_ord = 99;
