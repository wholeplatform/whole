...
public class QueriesEntityDescriptorEnum extends EntityDescriptorEnum {
    ...
    public static final int DistinctTest_ord = 89;
    public static final int And_ord = 90;
    public static final int Or_ord = 91;
    public static final int Not_ord = 92;
    public static final int QuantifiedPredicate_ord = 93;
    public static final int One_ord = 94;
    public static final int Some_ord = 95;
    public static final int Every_ord = 96;
    public static final int ParenthesizedPredicate_ord = 97;
    public static final int EntityType_ord = 98;
    public static final int NamesExpression_ord = 99;
    public static final int TemplateNames_ord = 100;
    public static final int AllNames_ord = 101;
    public static final int AddNames_ord = 102;
    public static final int RemoveNames_ord = 103;
    public static final int ScopeFilter_ord = 104;
    public static final int Names_ord = 105;
    public static final int FreshNames_ord = 106;
    public static final int ScopeNames_ord = 107;
    public static final int Name_ord = 108;
    public static final int MathStep_ord = 109;
    public static final int AdditionStep_ord = 110;
    public static final int SubtractionStep_ord = 111;
    public static final int MultiplicationStep_ord = 112;
    public static final int DivisionStep_ord = 113;
    public static final int RemainderStep_ord = 114;
    public static final int EqualsStep_ord = 115;
    public static final int NotEqualsStep_ord = 116;
    public static final int LessThanStep_ord = 117;
    public static final int LessOrEqualsStep_ord = 118;
    public static final int GreaterThanStep_ord = 119;
    public static final int GreaterOrEqualsStep_ord = 120;
    public static final int CollectByExpression_ord = 121;
    public static final int Comparator_ord = 122;
    public static final int IdentityComparator_ord = 123;
    public static final int UnionAll_ord = 124;
    public static final int Union_ord = 125;
    public static final int Intersect_ord = 126;
    public static final int Except_ord = 127;
    public static final int VariableRefStep_ord = 128;
    public static final int Singleton_ord = 129;
    public static final int PointwiseEquals_ord = 130;
    public static final int Tuple_ord = 131;
    public static final int Addition_ord = 132;
    public static final int Subtraction_ord = 133;
    public static final int Multiplication_ord = 134;
    public static final int Division_ord = 135;
    public static final int Remainder_ord = 136;
    public static final int Equals_ord = 137;
    public static final int NotEquals_ord = 138;
    public static final int LessThan_ord = 139;
    public static final int LessOrEquals_ord = 140;
    public static final int GreaterThan_ord = 141;
    public static final int GreaterOrEquals_ord = 142;
    public static final int Literal_ord = 143;
    public static final int VoidLiteral_ord = 144;
    public static final int BooleanLiteral_ord = 145;
    public static final int ByteLiteral_ord = 146;
    public static final int CharLiteral_ord = 147;
    public static final int DoubleLiteral_ord = 148;
    public static final int FloatLiteral_ord = 149;
    public static final int IntLiteral_ord = 150;
    public static final int LongLiteral_ord = 151;
    public static final int ShortLiteral_ord = 152;
    public static final int DateLiteral_ord = 153;
    public static final int StringLiteral_ord = 154;
    public static final int Placement_ord = 155;
