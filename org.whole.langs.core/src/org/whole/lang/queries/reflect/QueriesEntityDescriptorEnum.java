...
public class QueriesEntityDescriptorEnum extends EntityDescriptorEnum {
    ...
    public static final int Delete_ord = 5;
    public static final int Insert_ord = 6;
    public static final int CartesianInsert_ord = 7;
    public static final int PointwiseInsert_ord = 8;
    public static final int Update_ord = 9;
    public static final int CartesianUpdate_ord = 10;
    public static final int PointwiseUpdate_ord = 11;
    public static final int Select_ord = 12;
    public static final int For_ord = 13;
    public static final int If_ord = 14;
    public static final int Do_ord = 15;
    public static final int StepExpression_ord = 16;
    public static final int EntityTemplate_ord = 17;
    public static final int EntityCall_ord = 18;
    public static final int Call_ord = 19;
    public static final int Constraints_ord = 20;
    public static final int Expressions_ord = 21;
    public static final int Bindings_ord = 22;
    public static final int Bind_ord = 23;
    public static final int Choose_ord = 24;
    public static final int Block_ord = 25;
    public static final int Sequence_ord = 26;
    public static final int Scope_ord = 27;
    public static final int CartesianProduct_ord = 28;
    public static final int PointwiseProduct_ord = 29;
    public static final int Filter_ord = 30;
    public static final int Reverse_ord = 31;
    public static final int ReversibleStep_ord = 32;
    public static final int TraversalStep_ord = 33;
    public static final int AspectStep_ord = 34;
    public static final int DirectStep_ord = 35;
    public static final int AdjacentStep_ord = 36;
    public static final int ReachableStep_ord = 37;
    public static final int ReachableOrSelfStep_ord = 38;
    public static final int InverseStep_ord = 39;
    public static final int InverseAdjacentStep_ord = 40;
    public static final int InverseReachableStep_ord = 41;
    public static final int InverseReachableOrSelfStep_ord = 42;
    public static final int RootStep_ord = 43;
    public static final int FragmentRootStep_ord = 44;
    public static final int SelfStep_ord = 45;
    public static final int ForwardStep_ord = 46;
    public static final int FeatureStep_ord = 47;
    public static final int ChildStep_ord = 48;
    public static final int DescendantStep_ord = 49;
    public static final int DescendantOrSelfStep_ord = 50;
    public static final int FollowingSiblingStep_ord = 51;
    public static final int FollowingSiblingOrSelfStep_ord = 52;
    public static final int FollowingStep_ord = 53;
    public static final int FollowingOrSelfStep_ord = 54;
    public static final int BackwardStep_ord = 55;
    public static final int ParentStep_ord = 56;
    public static final int AncestorStep_ord = 57;
    public static final int AncestorOrSelfStep_ord = 58;
    public static final int PrecedingSiblingStep_ord = 59;
    public static final int PrecedingSiblingOrSelfStep_ord = 60;
    public static final int PrecedingStep_ord = 61;
    public static final int PrecedingOrSelfStep_ord = 62;
    public static final int PruneOrPredicate_ord = 63;
    public static final int Prune_ord = 64;
    public static final int Predicate_ord = 65;
    public static final int VariableTest_ord = 66;
    public static final int StageVariableTest_ord = 67;
    public static final int LanguageVariableTest_ord = 68;
    public static final int TypeVariableTest_ord = 69;
    public static final int SubtypeVariableTest_ord = 70;
    public static final int SupertypeVariableTest_ord = 71;
    public static final int ExtendedSubtypeVariableTest_ord = 72;
    public static final int ExtendedSupertypeVariableTest_ord = 73;
    public static final int IndexVariableTest_ord = 74;
    public static final int KindTest_ord = 75;
    public static final int CompositeKindTest_ord = 76;
    public static final int DataKindTest_ord = 77;
    public static final int StageTest_ord = 78;
    public static final int LanguageTest_ord = 79;
    public static final int TypeTest_ord = 80;
    public static final int SubtypeTest_ord = 81;
    public static final int SupertypeTest_ord = 82;
    public static final int ExtendedSubtypeTest_ord = 83;
    public static final int ExtendedSupertypeTest_ord = 84;
    public static final int AtTypeTest_ord = 85;
    public static final int AtFeatureTest_ord = 86;
    public static final int AtIndexTest_ord = 87;
    public static final int IndexTest_ord = 88;
    public static final int IndexRangeTest_ord = 89;
    public static final int VisitorTest_ord = 90;
    public static final int MatchTest_ord = 91;
    public static final int DistinctTest_ord = 92;
    public static final int And_ord = 93;
    public static final int Or_ord = 94;
    public static final int Not_ord = 95;
    public static final int QuantifiedPredicate_ord = 96;
    public static final int One_ord = 97;
    public static final int Some_ord = 98;
    public static final int Every_ord = 99;
    public static final int EntityType_ord = 100;
    public static final int NamesExpression_ord = 101;
    public static final int TemplateNames_ord = 102;
    public static final int AllNames_ord = 103;
    public static final int AddNames_ord = 104;
    public static final int RemoveNames_ord = 105;
    public static final int ScopeFilter_ord = 106;
    public static final int Names_ord = 107;
    public static final int FreshNames_ord = 108;
    public static final int ScopeNames_ord = 109;
    public static final int Name_ord = 110;
    public static final int MathStep_ord = 111;
    public static final int AdditionStep_ord = 112;
    public static final int SubtractionStep_ord = 113;
    public static final int MultiplicationStep_ord = 114;
    public static final int DivisionStep_ord = 115;
    public static final int RemainderStep_ord = 116;
    public static final int EqualsStep_ord = 117;
    public static final int NotEqualsStep_ord = 118;
    public static final int LessThanStep_ord = 119;
    public static final int LessOrEqualsStep_ord = 120;
    public static final int GreaterThanStep_ord = 121;
    public static final int GreaterOrEqualsStep_ord = 122;
    public static final int CollectByExpression_ord = 123;
    public static final int Comparator_ord = 124;
    public static final int IdentityComparator_ord = 125;
    public static final int UnionAll_ord = 126;
    public static final int Union_ord = 127;
    public static final int Intersect_ord = 128;
    public static final int Except_ord = 129;
    public static final int VariableRefStep_ord = 130;
    public static final int Singleton_ord = 131;
    public static final int PointwiseEquals_ord = 132;
    public static final int Tuple_ord = 133;
    public static final int Addition_ord = 134;
    public static final int Subtraction_ord = 135;
    public static final int Multiplication_ord = 136;
    public static final int Division_ord = 137;
    public static final int Remainder_ord = 138;
    public static final int Equals_ord = 139;
    public static final int NotEquals_ord = 140;
    public static final int LessThan_ord = 141;
    public static final int LessOrEquals_ord = 142;
    public static final int GreaterThan_ord = 143;
    public static final int GreaterOrEquals_ord = 144;
