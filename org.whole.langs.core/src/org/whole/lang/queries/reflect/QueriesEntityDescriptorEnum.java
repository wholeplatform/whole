...
public class QueriesEntityDescriptorEnum extends EntityDescriptorEnum {
    ...
    public static final int Clone_ord = 4;
    public static final int Create_ord = 5;
    public static final int Delete_ord = 6;
    public static final int Insert_ord = 7;
    public static final int CartesianInsert_ord = 8;
    public static final int PointwiseInsert_ord = 9;
    public static final int Update_ord = 10;
    public static final int CartesianUpdate_ord = 11;
    public static final int PointwiseUpdate_ord = 12;
    public static final int Select_ord = 13;
    public static final int For_ord = 14;
    public static final int If_ord = 15;
    public static final int Do_ord = 16;
    public static final int StepExpression_ord = 17;
    public static final int Call_ord = 18;
    public static final int Expressions_ord = 19;
    public static final int Choose_ord = 20;
    public static final int Block_ord = 21;
    public static final int Sequence_ord = 22;
    public static final int Scope_ord = 23;
    public static final int CartesianProduct_ord = 24;
    public static final int PointwiseProduct_ord = 25;
    public static final int Filter_ord = 26;
    public static final int Reverse_ord = 27;
    public static final int ReversibleStep_ord = 28;
    public static final int TraversalStep_ord = 29;
    public static final int AspectStep_ord = 30;
    public static final int DirectStep_ord = 31;
    public static final int AdjacentStep_ord = 32;
    public static final int ReachableStep_ord = 33;
    public static final int ReachableOrSelfStep_ord = 34;
    public static final int InverseStep_ord = 35;
    public static final int InverseAdjacentStep_ord = 36;
    public static final int InverseReachableStep_ord = 37;
    public static final int InverseReachableOrSelfStep_ord = 38;
    public static final int RootStep_ord = 39;
    public static final int FragmentRootStep_ord = 40;
    public static final int SelfStep_ord = 41;
    public static final int ForwardStep_ord = 42;
    public static final int FeatureStep_ord = 43;
    public static final int ChildStep_ord = 44;
    public static final int DescendantStep_ord = 45;
    public static final int DescendantOrSelfStep_ord = 46;
    public static final int FollowingSiblingStep_ord = 47;
    public static final int FollowingSiblingOrSelfStep_ord = 48;
    public static final int FollowingStep_ord = 49;
    public static final int FollowingOrSelfStep_ord = 50;
    public static final int BackwardStep_ord = 51;
    public static final int ParentStep_ord = 52;
    public static final int AncestorStep_ord = 53;
    public static final int AncestorOrSelfStep_ord = 54;
    public static final int PrecedingSiblingStep_ord = 55;
    public static final int PrecedingSiblingOrSelfStep_ord = 56;
    public static final int PrecedingStep_ord = 57;
    public static final int PrecedingOrSelfStep_ord = 58;
    public static final int PruneOrPredicate_ord = 59;
    public static final int Prune_ord = 60;
    public static final int Predicate_ord = 61;
    public static final int VariableTest_ord = 62;
    public static final int StageVariableTest_ord = 63;
    public static final int LanguageVariableTest_ord = 64;
    public static final int TypeVariableTest_ord = 65;
    public static final int SubtypeVariableTest_ord = 66;
    public static final int SupertypeVariableTest_ord = 67;
    public static final int ExtendedSubtypeVariableTest_ord = 68;
    public static final int ExtendedSupertypeVariableTest_ord = 69;
    public static final int IndexVariableTest_ord = 70;
    public static final int KindTest_ord = 71;
    public static final int CompositeKindTest_ord = 72;
    public static final int DataKindTest_ord = 73;
    public static final int StageTest_ord = 74;
    public static final int LanguageTest_ord = 75;
    public static final int TypeTest_ord = 76;
    public static final int SubtypeTest_ord = 77;
    public static final int SupertypeTest_ord = 78;
    public static final int ExtendedSubtypeTest_ord = 79;
    public static final int ExtendedSupertypeTest_ord = 80;
    public static final int AtTypeTest_ord = 81;
    public static final int AtFeatureTest_ord = 82;
    public static final int AtIndexTest_ord = 83;
    public static final int IndexTest_ord = 84;
    public static final int IndexRangeTest_ord = 85;
    public static final int VisitorTest_ord = 86;
    public static final int MatchTest_ord = 87;
    ...
    public static final int ScopeFilter_ord = 101;
    public static final int Names_ord = 102;
    public static final int FreshNames_ord = 103;
    public static final int ScopeNames_ord = 104;
    ...
    public static final int EntityType_ord = 140;
    public static final int Registry_ord = 141;
    public static final int Children_ord = 142;
    public static final int Features_ord = 143;
    public static final int Feature_ord = 144;
    public static final int Literal_ord = 145;
    public static final int VoidLiteral_ord = 146;
    public static final int BooleanLiteral_ord = 147;
    public static final int ByteLiteral_ord = 148;
    public static final int CharLiteral_ord = 149;
    public static final int DoubleLiteral_ord = 150;
    public static final int FloatLiteral_ord = 151;
    public static final int IntLiteral_ord = 152;
    public static final int LongLiteral_ord = 153;
    public static final int ShortLiteral_ord = 154;
    public static final int DateLiteral_ord = 155;
    public static final int StringLiteral_ord = 156;
    public static final int Placement_ord = 157;
    ...
    public static final EntityDescriptor<Clone> Clone = (EntityDescriptor<Clone>) instance.valueOf(Clone_ord);
    ...
    public static final EntityDescriptor<Children> Children = (EntityDescriptor<Children>) instance.valueOf(Children_ord);
    public static final EntityDescriptor<Features> Features = (EntityDescriptor<Features>) instance.valueOf(Features_ord);
    public static final EntityDescriptor<Feature> Feature = (EntityDescriptor<Feature>) instance.valueOf(Feature_ord);
    ...
    protected void initEntityDescriptors() {
        putSimpleEntity(Expression_ord, "Expression", Expression.class, true, Delete_ord, Or_ord, Reverse_ord, RootStep_ord, CollectByExpression_ord, Insert_ord, DistinctTest_ord, GreaterThan_ord, PrecedingSiblingStep_ord, SubtractionStep_ord, DivisionStep_ord, DescendantStep_ord, FloatLiteral_ord, LanguageVariableTest_ord, CartesianInsert_ord, ChildStep_ord, Some_ord, FeatureStep_ord, IndexTest_ord, StringLiteral_ord, LessOrEqualsStep_ord, LanguageTest_ord, GreaterOrEqualsStep_ord, VisitorTest_ord, DoubleLiteral_ord, ReachableOrSelfStep_ord, PointwiseEquals_ord, If_ord, LessThanStep_ord, ShortLiteral_ord, AdditionStep_ord, FollowingStep_ord, One_ord, AncestorStep_ord, InverseAdjacentStep_ord, Union_ord, Remainder_ord, IndexVariableTest_ord, AspectStep_ord, CompositeKindTest_ord, QuantifiedPredicate_ord, Division_ord, DirectStep_ord, InverseStep_ord, UnionAll_ord, Path_ord, Call_ord, AncestorOrSelfStep_ord, TraversalStep_ord, AtTypeTest_ord, ExtendedSupertypeTest_ord, QueryDeclaration_ord, Choose_ord, TypeVariableTest_ord, Select_ord, Tuple_ord, StageTest_ord, ExtendedSubtypeTest_ord, PointwiseProduct_ord, MultiplicationStep_ord, Multiplication_ord, DateLiteral_ord, SupertypeVariableTest_ord, TypeTest_ord, Update_ord, InverseReachableStep_ord, ParentStep_ord, Predicate_ord, VariableRefStep_ord, VoidLiteral_ord, LessThan_ord, Intersect_ord, PathExpression_ord, SubtypeTest_ord, PrecedingStep_ord, Literal_ord, GreaterOrEquals_ord, SupertypeTest_ord, IntLiteral_ord, PointwiseInsert_ord, StepExpression_ord, PrecedingSiblingOrSelfStep_ord, Addition_ord, SubtypeVariableTest_ord, KindTest_ord, ExtendedSupertypeVariableTest_ord, CharLiteral_ord, LongLiteral_ord, EqualsStep_ord, For_ord, Do_ord, Sequence_ord, InverseReachableOrSelfStep_ord, CartesianUpdate_ord, NotEquals_ord, EntityType_ord, Not_ord, DescendantOrSelfStep_ord, Singleton_ord, And_ord, LessOrEquals_ord, Block_ord, RemainderStep_ord, Except_ord, AdjacentStep_ord, NotEqualsStep_ord, SelfStep_ord, FollowingSiblingStep_ord, FollowingSiblingOrSelfStep_ord, BooleanLiteral_ord, PrecedingOrSelfStep_ord, ExtendedSubtypeVariableTest_ord, Create_ord, AtIndexTest_ord, Features_ord, Children_ord, VariableTest_ord, MatchTest_ord, MathStep_ord, GreaterThanStep_ord, Clone_ord, AtFeatureTest_ord, DataKindTest_ord, IndexRangeTest_ord, BackwardStep_ord, StageVariableTest_ord, ForwardStep_ord, Registry_ord, FollowingOrSelfStep_ord, FragmentRootStep_ord, Equals_ord, Subtraction_ord, Scope_ord, Filter_ord, Every_ord, ByteLiteral_ord, ReachableStep_ord, PointwiseUpdate_ord, CartesianProduct_ord);
        putSimpleEntity(PathExpression_ord, "PathExpression", PathExpression.class, true, Delete_ord, Reverse_ord, RootStep_ord, Insert_ord, Update_ord, InverseReachableStep_ord, ParentStep_ord, PrecedingSiblingStep_ord, PrecedingStep_ord, PointwiseInsert_ord, StepExpression_ord, PrecedingSiblingOrSelfStep_ord, DescendantStep_ord, For_ord, Do_ord, Sequence_ord, InverseReachableOrSelfStep_ord, CartesianInsert_ord, CartesianUpdate_ord, ChildStep_ord, FeatureStep_ord, DescendantOrSelfStep_ord, Block_ord, ReachableOrSelfStep_ord, If_ord, AdjacentStep_ord, SelfStep_ord, FollowingStep_ord, FollowingSiblingStep_ord, FollowingSiblingOrSelfStep_ord, AncestorStep_ord, PrecedingOrSelfStep_ord, InverseAdjacentStep_ord, AspectStep_ord, Create_ord, DirectStep_ord, InverseStep_ord, Clone_ord, Path_ord, Call_ord, BackwardStep_ord, ForwardStep_ord, AncestorOrSelfStep_ord, TraversalStep_ord, FollowingOrSelfStep_ord, FragmentRootStep_ord, QueryDeclaration_ord, Scope_ord, Choose_ord, Filter_ord, Select_ord, ReachableStep_ord, PointwiseUpdate_ord, CartesianProduct_ord, PointwiseProduct_ord);
        ...
        putSimpleEntity(Clone_ord, "Clone", Clone.class, false).withFeature(QueriesFeatureDescriptorEnum.fromClause, Expression_ord, true, false, false, false, false);
        putSimpleEntity(Create_ord, "Create", Create.class, false).withFeature(QueriesFeatureDescriptorEnum.entityType, Expression_ord).withFeature(QueriesFeatureDescriptorEnum.registry, Expression_ord).withFeature(QueriesFeatureDescriptorEnum.whereClause, Expression_ord, true, false, false, false, false);
        putSimpleEntity(Delete_ord, "Delete", Delete.class, false).withFeature(QueriesFeatureDescriptorEnum.fromClause, Expression_ord);
        putSimpleEntity(Insert_ord, "Insert", Insert.class, false).withFeature(QueriesFeatureDescriptorEnum.placement, Placement_ord).withFeature(QueriesFeatureDescriptorEnum.fromClause, Expression_ord);
        ...
        putSimpleEntity(Update_ord, "Update", Update.class, false).withFeature(QueriesFeatureDescriptorEnum.fromClause, Expression_ord);
        ...
        putSimpleEntity(StepExpression_ord, "StepExpression", StepExpression.class, true, FollowingStep_ord, FollowingSiblingStep_ord, Reverse_ord, FollowingSiblingOrSelfStep_ord, RootStep_ord, AncestorStep_ord, PrecedingOrSelfStep_ord, InverseAdjacentStep_ord, InverseReachableStep_ord, ParentStep_ord, AspectStep_ord, PrecedingSiblingStep_ord, PrecedingStep_ord, DirectStep_ord, InverseStep_ord, Call_ord, BackwardStep_ord, PrecedingSiblingOrSelfStep_ord, ForwardStep_ord, AncestorOrSelfStep_ord, DescendantStep_ord, TraversalStep_ord, Sequence_ord, FollowingOrSelfStep_ord, InverseReachableOrSelfStep_ord, ChildStep_ord, FragmentRootStep_ord, FeatureStep_ord, DescendantOrSelfStep_ord, Scope_ord, Choose_ord, Filter_ord, Block_ord, ReachableStep_ord, ReachableOrSelfStep_ord, CartesianProduct_ord, PointwiseProduct_ord, AdjacentStep_ord, SelfStep_ord);
        ...
        putSimpleEntity(Filter_ord, "Filter", Filter.class, false).withFeature(QueriesFeatureDescriptorEnum.expression, Expression_ord, true, false, false, false, false).withFeature(QueriesFeatureDescriptorEnum.predicate, PruneOrPredicate_ord);
        ...
        putCompositeEntity(Children_ord, "Children", Children.class, false, Expression_ord, true, false);
        putCompositeEntity(Features_ord, "Features", Features.class, false, Feature_ord, true, false);
        putSimpleEntity(Feature_ord, "Feature", Feature.class, false).withFeature(QueriesFeatureDescriptorEnum.name, Name_ord).withFeature(QueriesFeatureDescriptorEnum.value, Expression_ord);
