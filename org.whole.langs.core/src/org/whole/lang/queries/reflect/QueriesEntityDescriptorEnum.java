...
public class QueriesEntityDescriptorEnum extends EntityDescriptorEnum {
    ...
    public static final int StageTest_ord = 73;
    ...
    public static final int MatchTest_ord = 86;
    public static final int ExpressionTest_ord = 87;
    public static final int DistinctTest_ord = 88;
    public static final int And_ord = 89;
    public static final int Or_ord = 90;
    public static final int Not_ord = 91;
    public static final int QuantifiedPredicate_ord = 92;
    public static final int One_ord = 93;
    public static final int Some_ord = 94;
    public static final int Every_ord = 95;
    public static final int ParenthesizedPredicate_ord = 96;
    public static final int EntityType_ord = 97;
    public static final int NamesExpression_ord = 98;
    public static final int TemplateNames_ord = 99;
    public static final int AllNames_ord = 100;
    public static final int AddNames_ord = 101;
    public static final int RemoveNames_ord = 102;
    public static final int Names_ord = 103;
    public static final int Name_ord = 104;
    public static final int Expression_ord = 105;
    public static final int MathStep_ord = 106;
    public static final int AdditionStep_ord = 107;
    public static final int SubtractionStep_ord = 108;
    public static final int MultiplicationStep_ord = 109;
    public static final int DivisionStep_ord = 110;
    public static final int RemainderStep_ord = 111;
    public static final int EqualsStep_ord = 112;
    public static final int NotEqualsStep_ord = 113;
    public static final int LessThanStep_ord = 114;
    public static final int LessOrEqualsStep_ord = 115;
    public static final int GreaterThanStep_ord = 116;
    public static final int GreaterOrEqualsStep_ord = 117;
    public static final int CollectByExpression_ord = 118;
    public static final int Comparator_ord = 119;
    public static final int IdentityComparator_ord = 120;
    public static final int UnionAll_ord = 121;
    public static final int Union_ord = 122;
    public static final int Intersect_ord = 123;
    public static final int Except_ord = 124;
    public static final int VariableRefStep_ord = 125;
    public static final int Singleton_ord = 126;
    public static final int PointwiseEquals_ord = 127;
    public static final int Tuple_ord = 128;
    public static final int Addition_ord = 129;
    public static final int Subtraction_ord = 130;
    public static final int Multiplication_ord = 131;
    public static final int Division_ord = 132;
    public static final int Remainder_ord = 133;
    public static final int Equals_ord = 134;
    public static final int NotEquals_ord = 135;
    public static final int LessThan_ord = 136;
    public static final int LessOrEquals_ord = 137;
    public static final int GreaterThan_ord = 138;
    public static final int GreaterOrEquals_ord = 139;
    public static final int Literal_ord = 140;
    public static final int VoidLiteral_ord = 141;
    public static final int BooleanLiteral_ord = 142;
    public static final int ByteLiteral_ord = 143;
    public static final int CharLiteral_ord = 144;
    public static final int DoubleLiteral_ord = 145;
    public static final int FloatLiteral_ord = 146;
    public static final int IntLiteral_ord = 147;
    public static final int LongLiteral_ord = 148;
    public static final int ShortLiteral_ord = 149;
    public static final int DateLiteral_ord = 150;
    public static final int StringLiteral_ord = 151;
    public static final int Placement_ord = 152;
    ...
    protected void initEntityDescriptors() {
        putSimpleEntity(PathExpressionOrPredicate_ord, "PathExpressionOrPredicate", PathExpressionOrPredicate.class, true, Delete_ord, Or_ord, Reverse_ord, RootStep_ord, CollectByExpression_ord, DistinctTest_ord, GreaterThan_ord, PrecedingSiblingStep_ord, SubtractionStep_ord, DivisionStep_ord, DescendantStep_ord, FloatLiteral_ord, LanguageVariableTest_ord, CartesianInsert_ord, ChildStep_ord, Some_ord, FeatureStep_ord, IndexTest_ord, StringLiteral_ord, LessOrEqualsStep_ord, LanguageTest_ord, GreaterOrEqualsStep_ord, VisitorTest_ord, DoubleLiteral_ord, ReachableOrSelfStep_ord, If_ord, PointwiseEquals_ord, LessThanStep_ord, ShortLiteral_ord, AdditionStep_ord, FollowingStep_ord, One_ord, AncestorStep_ord, InverseAdjacentStep_ord, Union_ord, Remainder_ord, IndexVariableTest_ord, AspectStep_ord, QuantifiedPredicate_ord, Division_ord, DirectStep_ord, InverseStep_ord, UnionAll_ord, Path_ord, Call_ord, EntityCall_ord, AncestorOrSelfStep_ord, TraversalStep_ord, AtTypeTest_ord, ExtendedSupertypeTest_ord, QueryDeclaration_ord, Expression_ord, Choose_ord, TypeVariableTest_ord, Select_ord, StageTest_ord, ExtendedSubtypeTest_ord, PointwiseProduct_ord, Tuple_ord, MultiplicationStep_ord, Multiplication_ord, DateLiteral_ord, SupertypeVariableTest_ord, TypeTest_ord, EntityTemplate_ord, InverseReachableStep_ord, ParentStep_ord, Predicate_ord, VariableRefStep_ord, VoidLiteral_ord, LessThan_ord, Intersect_ord, PathExpression_ord, SubtypeTest_ord, PrecedingStep_ord, Literal_ord, GreaterOrEquals_ord, SupertypeTest_ord, IntLiteral_ord, PointwiseInsert_ord, StepExpression_ord, PrecedingSiblingOrSelfStep_ord, SubtypeVariableTest_ord, KindTest_ord, Addition_ord, ExtendedSupertypeVariableTest_ord, CharLiteral_ord, LongLiteral_ord, EqualsStep_ord, For_ord, Do_ord, Sequence_ord, InverseReachableOrSelfStep_ord, CartesianUpdate_ord, NotEquals_ord, Not_ord, DescendantOrSelfStep_ord, And_ord, Singleton_ord, LessOrEquals_ord, Block_ord, RemainderStep_ord, Except_ord, AdjacentStep_ord, SelfStep_ord, NotEqualsStep_ord, FollowingSiblingStep_ord, ExpressionTest_ord, FollowingSiblingOrSelfStep_ord, BooleanLiteral_ord, PrecedingOrSelfStep_ord, ExtendedSubtypeVariableTest_ord, AtIndexTest_ord, VariableTest_ord, MatchTest_ord, MathStep_ord, GreaterThanStep_ord, AtFeatureTest_ord, IndexRangeTest_ord, BackwardStep_ord, StageVariableTest_ord, ForwardStep_ord, FollowingOrSelfStep_ord, FragmentRootStep_ord, Equals_ord, Subtraction_ord, ParenthesizedPredicate_ord, Scope_ord, Filter_ord, Every_ord, ByteLiteral_ord, ReachableStep_ord, PointwiseUpdate_ord, CartesianProduct_ord);
        putSimpleEntity(PathExpression_ord, "PathExpression", PathExpression.class, true, Delete_ord, Reverse_ord, RootStep_ord, CollectByExpression_ord, GreaterThan_ord, PrecedingSiblingStep_ord, SubtractionStep_ord, DivisionStep_ord, DescendantStep_ord, FloatLiteral_ord, CartesianInsert_ord, ChildStep_ord, FeatureStep_ord, StringLiteral_ord, LessOrEqualsStep_ord, GreaterOrEqualsStep_ord, ReachableOrSelfStep_ord, DoubleLiteral_ord, If_ord, PointwiseEquals_ord, LessThanStep_ord, ShortLiteral_ord, AdditionStep_ord, FollowingStep_ord, AncestorStep_ord, InverseAdjacentStep_ord, Union_ord, Remainder_ord, AspectStep_ord, Division_ord, DirectStep_ord, InverseStep_ord, UnionAll_ord, Path_ord, Call_ord, EntityCall_ord, AncestorOrSelfStep_ord, TraversalStep_ord, QueryDeclaration_ord, Choose_ord, Expression_ord, Select_ord, PointwiseProduct_ord, Tuple_ord, MultiplicationStep_ord, Multiplication_ord, DateLiteral_ord, EntityTemplate_ord, InverseReachableStep_ord, ParentStep_ord, VariableRefStep_ord, VoidLiteral_ord, LessThan_ord, Intersect_ord, PrecedingStep_ord, Literal_ord, GreaterOrEquals_ord, IntLiteral_ord, PointwiseInsert_ord, StepExpression_ord, PrecedingSiblingOrSelfStep_ord, Addition_ord, CharLiteral_ord, LongLiteral_ord, EqualsStep_ord, For_ord, Do_ord, Sequence_ord, InverseReachableOrSelfStep_ord, CartesianUpdate_ord, NotEquals_ord, DescendantOrSelfStep_ord, Singleton_ord, LessOrEquals_ord, Block_ord, RemainderStep_ord, AdjacentStep_ord, Except_ord, SelfStep_ord, NotEqualsStep_ord, FollowingSiblingStep_ord, FollowingSiblingOrSelfStep_ord, BooleanLiteral_ord, PrecedingOrSelfStep_ord, MathStep_ord, GreaterThanStep_ord, BackwardStep_ord, ForwardStep_ord, FollowingOrSelfStep_ord, FragmentRootStep_ord, Equals_ord, Subtraction_ord, Scope_ord, Filter_ord, ReachableStep_ord, ByteLiteral_ord, PointwiseUpdate_ord, CartesianProduct_ord);
        ...
        putSimpleEntity(StepExpression_ord, "StepExpression", StepExpression.class, true, Multiplication_ord, Reverse_ord, DateLiteral_ord, RootStep_ord, EntityTemplate_ord, CollectByExpression_ord, InverseReachableStep_ord, ParentStep_ord, VariableRefStep_ord, VoidLiteral_ord, LessThan_ord, Intersect_ord, GreaterThan_ord, PrecedingSiblingStep_ord, PrecedingStep_ord, Literal_ord, GreaterOrEquals_ord, IntLiteral_ord, SubtractionStep_ord, PrecedingSiblingOrSelfStep_ord, Addition_ord, CharLiteral_ord, DivisionStep_ord, DescendantStep_ord, LongLiteral_ord, FloatLiteral_ord, EqualsStep_ord, Sequence_ord, InverseReachableOrSelfStep_ord, ChildStep_ord, NotEquals_ord, FeatureStep_ord, DescendantOrSelfStep_ord, StringLiteral_ord, LessOrEqualsStep_ord, Singleton_ord, GreaterOrEqualsStep_ord, LessOrEquals_ord, Block_ord, RemainderStep_ord, ReachableOrSelfStep_ord, DoubleLiteral_ord, PointwiseEquals_ord, AdjacentStep_ord, Except_ord, SelfStep_ord, NotEqualsStep_ord, LessThanStep_ord, ShortLiteral_ord, AdditionStep_ord, FollowingStep_ord, FollowingSiblingStep_ord, FollowingSiblingOrSelfStep_ord, BooleanLiteral_ord, AncestorStep_ord, PrecedingOrSelfStep_ord, InverseAdjacentStep_ord, Union_ord, Remainder_ord, AspectStep_ord, Division_ord, DirectStep_ord, InverseStep_ord, MathStep_ord, GreaterThanStep_ord, UnionAll_ord, Call_ord, BackwardStep_ord, ForwardStep_ord, EntityCall_ord, AncestorOrSelfStep_ord, TraversalStep_ord, FollowingOrSelfStep_ord, FragmentRootStep_ord, Equals_ord, Subtraction_ord, Scope_ord, Choose_ord, Filter_ord, Expression_ord, ReachableStep_ord, ByteLiteral_ord, CartesianProduct_ord, PointwiseProduct_ord, Tuple_ord, MultiplicationStep_ord);
