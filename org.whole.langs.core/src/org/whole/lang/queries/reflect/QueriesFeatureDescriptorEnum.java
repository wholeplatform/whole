...
public class QueriesFeatureDescriptorEnum extends FeatureDescriptorEnum {
	...
	public static final FeatureDescriptor fromClause = instance
			.valueOf(fromClause_ord);
	public static final FeatureDescriptor placement = instance
			.valueOf(placement_ord);
	public static final FeatureDescriptor valuesClause = instance
			.valueOf(valuesClause_ord);
	public static final FeatureDescriptor selectClause = instance
			.valueOf(selectClause_ord);
	public static final FeatureDescriptor whereClause = instance
			.valueOf(whereClause_ord);
	public static final FeatureDescriptor clearClause = instance
			.valueOf(clearClause_ord);
	...
	public static final FeatureDescriptor constraints = instance
	...
	public static final FeatureDescriptor localNames = instance
			.valueOf(localNames_ord);
	public static final FeatureDescriptor index = instance.valueOf(index_ord);
	public static final FeatureDescriptor startIndex = instance
			.valueOf(startIndex_ord);
	public static final FeatureDescriptor endIndex = instance
			.valueOf(endIndex_ord);
	public static final FeatureDescriptor comparator = instance
	...
	public static final FeatureDescriptor identity = instance
			.valueOf(identity_ord);
