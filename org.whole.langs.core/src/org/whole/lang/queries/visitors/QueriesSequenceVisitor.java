 ...
 *  @generator Whole
 */
public class QueriesSequenceVisitor extends AbstractBinaryVisitor<IQueriesVisitor> implements IQueriesVisitor {

    public QueriesSequenceVisitor(IVisitor visitor1, IVisitor visitor2) {
