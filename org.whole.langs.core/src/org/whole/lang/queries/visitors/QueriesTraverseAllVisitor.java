 ...
 *  @generator Whole
 */
public class QueriesTraverseAllVisitor extends QueriesIdentityUnaryVisitor<IQueriesVisitor> {

    public QueriesTraverseAllVisitor() {
        wSetVisitor1(this);
    }

    public QueriesTraverseAllVisitor(IVisitor visitor1) {
        super(visitor1);
    }
