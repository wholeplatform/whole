 ...
 * @generator Whole
 */
public class IndexRangeTestImpl extends AbstractSimpleEntity implements
		IndexRangeTest {
	...
	public IntLiteral getStartIndex() {
		return notifyRequested(QueriesFeatureDescriptorEnum.startIndex,
				startIndex);
	}

	public void setStartIndex(IntLiteral startIndex) {
		notifyChanged(QueriesFeatureDescriptorEnum.startIndex, this.startIndex,
	...
	public void setEndIndex(IntLiteral endIndex) {
		notifyChanged(QueriesFeatureDescriptorEnum.endIndex, this.endIndex,
	...
	public void wSet(int index, IEntity value) {
		...
		case 0:
			setStartIndex(value
					.wGetAdapter(QueriesEntityDescriptorEnum.IntLiteral));
			break;
		case 1:
			setEndIndex(value
					.wGetAdapter(QueriesEntityDescriptorEnum.IntLiteral));
