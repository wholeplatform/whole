 ...
 * @generator Whole
 */
public class PointwiseEqualsImpl extends AbstractSimpleEntity implements
		PointwiseEquals {
	...
	public void setPexp1(PathExpression pexp1) {
		notifyChanged(QueriesFeatureDescriptorEnum.pexp1, this.pexp1,
				this.pexp1 = pexp1);
	}
	...
	public void setPexp2(PathExpression pexp2) {
		notifyChanged(QueriesFeatureDescriptorEnum.pexp2, this.pexp2,
				this.pexp2 = pexp2);
	}
