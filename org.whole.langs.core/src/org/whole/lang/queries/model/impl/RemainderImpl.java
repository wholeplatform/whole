 ...
 *  @generator Whole
 */
public class RemainderImpl extends AbstractSimpleEntity implements Remainder {
    private static final long serialVersionUID = 1;

    public EntityDescriptor<Remainder> wGetEntityDescriptor() {
        return QueriesEntityDescriptorEnum.Remainder;
    }

    public int wGetEntityOrd() {
        return QueriesEntityDescriptorEnum.Remainder_ord;
    }
