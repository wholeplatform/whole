 ...
 * @generator Whole
 */
public class AdditionImpl extends AbstractSimpleEntity implements Addition {
	private static final long serialVersionUID = 1;

	public EntityDescriptor<Addition> wGetEntityDescriptor() {
		return QueriesEntityDescriptorEnum.Addition;
	}

	public int wGetEntityOrd() {
		return QueriesEntityDescriptorEnum.Addition_ord;
	}
