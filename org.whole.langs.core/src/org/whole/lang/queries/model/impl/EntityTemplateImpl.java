 ...
 * @generator Whole
 */
public class EntityTemplateImpl extends AbstractSimpleEntity implements
		EntityTemplate {
	...
	public Constraints getConstraints() {
		return notifyRequested(QueriesFeatureDescriptorEnum.constraints,
				constraints);
	}

	public void setConstraints(Constraints constraints) {
		notifyChanged(QueriesFeatureDescriptorEnum.constraints,
	...
	public void wSet(int index, IEntity value) {
		...
		case 1:
			setConstraints(value
					.wGetAdapter(QueriesEntityDescriptorEnum.Constraints));
			break;
		default:
			throw new IllegalArgumentException();
		}
