...
public class SelectImpl extends AbstractSimpleEntity implements Select {
	...
	public PathExpression getSelectClause() {
		return notifyRequested(QueriesFeatureDescriptorEnum.selectClause,
				selectClause);
	}

	public void setSelectClause(PathExpression selectClause) {
		notifyChanged(QueriesFeatureDescriptorEnum.selectClause,
				this.selectClause, this.selectClause = selectClause);
	}
	...
	public NamesExpression getClearClause() {
		return notifyRequested(QueriesFeatureDescriptorEnum.clearClause,
				clearClause);
	}

	public void setClearClause(NamesExpression clearClause) {
		notifyChanged(QueriesFeatureDescriptorEnum.clearClause,
				this.clearClause, this.clearClause = clearClause);
	}
