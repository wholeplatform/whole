...
public class QueriesImplEntityRegistry extends AbstractEntityRegistry {
    ...
    protected void createPrototypes() {
        ...
        put(new LanguageVariableTestImpl());
        put(new TypeVariableTestImpl());
        put(new SubtypeVariableTestImpl());
        put(new SupertypeVariableTestImpl());
        put(new ExtendedSubtypeVariableTestImpl());
