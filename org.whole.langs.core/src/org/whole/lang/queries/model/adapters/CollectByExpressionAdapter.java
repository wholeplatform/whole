 ...
 *  @generator Whole
 */
public class CollectByExpressionAdapter extends AbstractEntityAdapter implements CollectByExpression {
    private static final long serialVersionUID = 1;

    public CollectByExpressionAdapter(IEntity implementor) {
        super(implementor);
    }

    public CollectByExpressionAdapter() {
    }
    ...
    public EntityDescriptor<CollectByExpression> wGetEntityDescriptor() {
        return QueriesEntityDescriptorEnum.CollectByExpression;
    }
