 ...
 *  @generator Whole
 */
public class AdditionStepAdapter extends AbstractEntityAdapter implements AdditionStep {
    private static final long serialVersionUID = 1;

    public AdditionStepAdapter(IEntity implementor) {
        super(implementor);
    }

    public AdditionStepAdapter() {
    }
