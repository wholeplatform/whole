...
public class QueriesAdaptersEntityRegistry extends AbstractEntityRegistry {
    ...
    protected void createPrototypes() {
        ...
        put(new LanguageVariableTestAdapter());
        put(new TypeVariableTestAdapter());
        put(new SubtypeVariableTestAdapter());
        put(new SupertypeVariableTestAdapter());
        put(new ExtendedSubtypeVariableTestAdapter());
        put(new ExtendedSupertypeVariableTestAdapter());
        put(new IndexVariableTestAdapter());
        put(new KindTestAdapter());
        put(new CompositeKindTestAdapter());
        put(new DataKindTestAdapter());
