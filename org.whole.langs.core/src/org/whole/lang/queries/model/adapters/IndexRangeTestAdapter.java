 ...
 * @generator Whole
 */
public class IndexRangeTestAdapter extends AbstractEntityAdapter implements
		IndexRangeTest {
	...
	public IntLiteral getStartIndex() {
		return wGet(QueriesFeatureDescriptorEnum.startIndex).wGetAdapter(
	...
	public IntLiteral getEndIndex() {
		return wGet(QueriesFeatureDescriptorEnum.endIndex).wGetAdapter(
				QueriesEntityDescriptorEnum.IntLiteral);
	}
