 ...
 *  @generator Whole
 */
public class SyntaxTreesTraverseAllChildrenVisitor extends SyntaxTreesIdentityUnaryVisitor<ISyntaxTreesVisitor> {

    public SyntaxTreesTraverseAllChildrenVisitor() {
        wSetVisitor1(this);
    }

    public SyntaxTreesTraverseAllChildrenVisitor(IVisitor visitor1) {
        super(visitor1);
    }
    ...
    public void visit(Rule entity) {
        entity.getName().accept(wGetVisitor1());
        entity.getChildren().accept(wGetVisitor1());
    }
