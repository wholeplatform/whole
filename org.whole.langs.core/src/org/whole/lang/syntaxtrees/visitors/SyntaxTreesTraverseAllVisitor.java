 ...
 *  @generator Whole
 */
public class SyntaxTreesTraverseAllVisitor extends SyntaxTreesIdentityUnaryVisitor<ISyntaxTreesVisitor> {

    public SyntaxTreesTraverseAllVisitor() {
        wSetVisitor1(this);
    }

    public SyntaxTreesTraverseAllVisitor(IVisitor visitor1) {
        super(visitor1);
    }
