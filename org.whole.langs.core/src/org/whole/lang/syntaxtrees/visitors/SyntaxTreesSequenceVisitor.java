 ...
 *  @generator Whole
 */
public class SyntaxTreesSequenceVisitor extends AbstractBinaryVisitor<ISyntaxTreesVisitor> implements ISyntaxTreesVisitor {

    public SyntaxTreesSequenceVisitor(IVisitor visitor1, IVisitor visitor2) {
