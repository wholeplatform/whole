...
import org.whole.lang.syntaxtrees.model.Literal;
 ...
 *  @generator Whole
 */
public class LiteralImpl extends AbstractSimpleEntity implements Literal {
    private static final long serialVersionUID = 1;

    public EntityDescriptor<Literal> wGetEntityDescriptor() {
        return SyntaxTreesEntityDescriptorEnum.Literal;
    }

    public int wGetEntityOrd() {
        return SyntaxTreesEntityDescriptorEnum.Literal_ord;
    }
