 ...
 *  @generator Whole
 */
public class NodesImpl extends AbstractListCompositeEntity<Node> implements Nodes {
    ...
    public int wGetEntityOrd() {
        return SyntaxTreesEntityDescriptorEnum.Nodes_ord;
    }

    public EntityDescriptor<Nodes> wGetEntityDescriptor() {
        return SyntaxTreesEntityDescriptorEnum.Nodes;
    }
}
