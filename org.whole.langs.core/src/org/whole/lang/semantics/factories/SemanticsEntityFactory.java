...
public class SemanticsEntityFactory extends GenericEntityFactory {
	...
	public static SemanticsEntityFactory instance(
	...
	public SemanticTheory createSemanticTheory(URI uri, Namespace namespace,
			Name name, Version version, SemanticFunctions functions) {
		return create(SemanticsEntityDescriptorEnum.SemanticTheory, uri,
				namespace, name, version, functions);
	}

	public IEntityBuilder<SemanticTheory> buildSemanticTheory() {
		return new EntityBuilder<SemanticTheory>(
	...
	public SemanticFunctions createSemanticFunctions(
			SemanticFunction... entities) {
		return create(SemanticsEntityDescriptorEnum.SemanticFunctions,
				(IEntity[]) entities);
	}

	public SemanticFunctions createSemanticFunctions(int initialSize) {
		return clone(SemanticsEntityDescriptorEnum.SemanticFunctions,
				initialSize);
	}
	...
	public SemanticFunction createSemanticFunction(Name name,
			FunctionType signature, FunctionBody rules) {
		return create(SemanticsEntityDescriptorEnum.SemanticFunction, name,
				signature, rules);
	}

	public IEntityBuilder<SemanticFunction> buildSemanticFunction() {
		return new EntityBuilder<SemanticFunction>(
				create(SemanticsEntityDescriptorEnum.SemanticFunction));
	}
	...
	public FunctionType createFunctionType(SignatureOrSequence source,
			SignatureOrSequence target) {
		return create(SemanticsEntityDescriptorEnum.FunctionType, source,
				target);
	}
	...
	public ExecutionRule createExecutionRule(Name name, Predicate condition,
			Expression meaning) {
		return create(SemanticsEntityDescriptorEnum.ExecutionRule, name,
				condition, meaning);
	}

	public IEntityBuilder<ExecutionRule> buildExecutionRule() {
		return new EntityBuilder<ExecutionRule>(
				create(SemanticsEntityDescriptorEnum.ExecutionRule));
	}
	...
	public InferenceRule createInferenceRule(RuleName name, Premises premises,
			Transition conclusion, Predicate condition) {
		return create(SemanticsEntityDescriptorEnum.InferenceRule, name,
				premises, conclusion, condition);
	}

	public IEntityBuilder<InferenceRule> buildInferenceRule() {
		return new EntityBuilder<InferenceRule>(
				create(SemanticsEntityDescriptorEnum.InferenceRule));
	}
	...
	public Transition createTransition(Configuration sourceConfiguration,
	...
	public IEntityBuilder<Transition> buildTransition() {
		return new EntityBuilder<Transition>(
				create(SemanticsEntityDescriptorEnum.Transition));
	}
	...
	public TypedVariable createTypedVariable(Variable variable, Num index,
			Num time, Signature signature) {
		return create(SemanticsEntityDescriptorEnum.TypedVariable, variable,
				index, time, signature);
	}

	public IEntityBuilder<TypedVariable> buildTypedVariable() {
		return new EntityBuilder<TypedVariable>(
				create(SemanticsEntityDescriptorEnum.TypedVariable));
	}
	...
	public IEntityBuilder<StructuredVariable> buildStructuredVariable() {
		return new EntityBuilder<StructuredVariable>(
				create(SemanticsEntityDescriptorEnum.StructuredVariable));
	}
	...
	public Rename createRename(LocalIdentifier newIdentifier,
			LocalIdentifier oldIdentifier) {
		return create(SemanticsEntityDescriptorEnum.Rename, newIdentifier,
				oldIdentifier);
	}

	public IEntityBuilder<Rename> buildRename() {
		return new EntityBuilder<Rename>(
				create(SemanticsEntityDescriptorEnum.Rename));
	}
	...
	public BindingsScope createBindingsScope(LocalIdentifier identifier,
			LocalBindings bindings, BindingsScope nestedScope) {
		return create(SemanticsEntityDescriptorEnum.BindingsScope, identifier,
				bindings, nestedScope);
	}

	public IEntityBuilder<BindingsScope> buildBindingsScope() {
		return new EntityBuilder<BindingsScope>(
				create(SemanticsEntityDescriptorEnum.BindingsScope));
	}
	...
	public LocalBinding createLocalBinding(BindingOp op,
			LocalIdentifier identifier, Expression expression) {
		return create(SemanticsEntityDescriptorEnum.LocalBinding, op,
				identifier, expression);
	}

	public IEntityBuilder<LocalBinding> buildLocalBinding() {
		return new EntityBuilder<LocalBinding>(
				create(SemanticsEntityDescriptorEnum.LocalBinding));
	}
	...
	public EnvironmentVariable createEnvironmentVariable(
			LocalIdentifier environment, LocalIdentifier variable) {
		return create(SemanticsEntityDescriptorEnum.EnvironmentVariable,
				environment, variable);
	}

	public IEntityBuilder<EnvironmentVariable> buildEnvironmentVariable() {
		return new EntityBuilder<EnvironmentVariable>(
				create(SemanticsEntityDescriptorEnum.EnvironmentVariable));
	}
	...
	public IEntityBuilder<TypeCast> buildTypeCast() {
		return new EntityBuilder<TypeCast>(
				create(SemanticsEntityDescriptorEnum.TypeCast));
	}
	...
	public FunctionApplication createFunctionApplication(Name name,
			Expression arguments, Environments environments, StageChange stage) {
		return create(SemanticsEntityDescriptorEnum.FunctionApplication, name,
				arguments, environments, stage);
	}

	public IEntityBuilder<FunctionApplication> buildFunctionApplication() {
		return new EntityBuilder<FunctionApplication>(
				create(SemanticsEntityDescriptorEnum.FunctionApplication));
	}
	...
	public OutputBinding createOutputBinding(BindingSubject identifier,
			Expression expression) {
		return create(SemanticsEntityDescriptorEnum.OutputBinding, identifier,
				expression);
	}

	public IEntityBuilder<OutputBinding> buildOutputBinding() {
		return new EntityBuilder<OutputBinding>(
				create(SemanticsEntityDescriptorEnum.OutputBinding));
	}
	...
	public InputBinding createInputBinding(BindingSubject identifier,
			Expression expression) {
		return create(SemanticsEntityDescriptorEnum.InputBinding, identifier,
				expression);
	}

	public IEntityBuilder<InputBinding> buildInputBinding() {
		return new EntityBuilder<InputBinding>(
				create(SemanticsEntityDescriptorEnum.InputBinding));
	}
	...
	public WhereTemplate createWhereTemplate(Expression expression,
			InputBindings where) {
		return create(SemanticsEntityDescriptorEnum.WhereTemplate, expression,
				where);
	}

	public IEntityBuilder<WhereTemplate> buildWhereTemplate() {
		return new EntityBuilder<WhereTemplate>(
				create(SemanticsEntityDescriptorEnum.WhereTemplate));
	}
	...
	public ForTemplate createForTemplate(Expression expression,
			Expression condition) {
		return create(SemanticsEntityDescriptorEnum.ForTemplate, expression,
				condition);
	}

	public IEntityBuilder<ForTemplate> buildForTemplate() {
		return new EntityBuilder<ForTemplate>(
				create(SemanticsEntityDescriptorEnum.ForTemplate));
	}
	...
	public IfTemplate createIfTemplate(Expression expression,
			Predicate condition) {
		return create(SemanticsEntityDescriptorEnum.IfTemplate, expression,
				condition);
	}

	public IEntityBuilder<IfTemplate> buildIfTemplate() {
		return new EntityBuilder<IfTemplate>(
				create(SemanticsEntityDescriptorEnum.IfTemplate));
	}
	...
	public IEntityBuilder<RuleName> buildRuleName() {
		return new EntityBuilder<RuleName>(
				create(SemanticsEntityDescriptorEnum.RuleName));
	}
