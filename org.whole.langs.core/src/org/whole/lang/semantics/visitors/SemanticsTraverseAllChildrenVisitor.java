 ...
 *  @generator Whole
 */
public class SemanticsTraverseAllChildrenVisitor extends SemanticsIdentityUnaryVisitor<ISemanticsVisitor> {

    public SemanticsTraverseAllChildrenVisitor() {
        wSetVisitor1(this);
    }

    public SemanticsTraverseAllChildrenVisitor(IVisitor visitor1) {
        super(visitor1);
    }
