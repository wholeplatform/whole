...
public class SemanticsInterpreterVisitor extends SemanticsTraverseAllChildrenVisitor {
    ...
    public void visit(StructuredVariable entity) {
    	...
    	if (isSelectedFeature(SemanticsUtils.USE_IDENTIFIER_SEMANTICS))
    		...
    		if (varValue == null)
    			throw new MissingVariableException(entity.toString()).withSourceInfo(getSourceEntity(), getBindings());
    ...
    public void visit(EnvironmentVariable entity) {
    	...
    	try {
			...
			if (varValue == null)
				throw new MissingVariableException(entity.getVariable().toString()).withSourceInfo(getSourceEntity(), getBindings());
