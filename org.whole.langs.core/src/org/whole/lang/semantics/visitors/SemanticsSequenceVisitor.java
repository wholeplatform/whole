 ...
 *  @generator Whole
 */
public class SemanticsSequenceVisitor extends AbstractBinaryVisitor<ISemanticsVisitor> implements ISemanticsVisitor {

    public SemanticsSequenceVisitor(IVisitor visitor1, IVisitor visitor2) {
