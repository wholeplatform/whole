...
public class SemanticsEntityDescriptorEnum extends EntityDescriptorEnum {
    ...
    protected void initEntityDescriptors() {
        ...
        putSimpleEntity(ConfigurationItem_ord, "ConfigurationItem", ConfigurationItem.class, true, LegacyType_ord, UnionType_ord, Category_ord, AbstractVariable_ord, Term_ord, StructuredVariable_ord, SubtypeType_ord, BindingsScope_ord, LanguageType_ord, EntityType_ord, TypedVariable_ord, SupertypeType_ord, EnvironmentType_ord, Environment_ord, AnyType_ord);
        ...
        putSimpleEntity(InlineTemplate_ord, "InlineTemplate", InlineTemplate.class, false).withFeature(SemanticsFeatureDescriptorEnum.expression, Expression_ord);
        putCompositeEntity(ChooseTemplate_ord, "ChooseTemplate", ChooseTemplate.class, false, Case_ord, true, false);
        putSimpleEntity(Case_ord, "Case", Case.class, true, ForTemplate_ord, ElseTemplate_ord, IfDefTemplate_ord, IfTemplate_ord, WhereTemplate_ord).withFeature(SemanticsFeatureDescriptorEnum.expression, Expression_ord);
        putSimpleEntity(WhereTemplate_ord, "WhereTemplate", WhereTemplate.class, false).withFeature(SemanticsFeatureDescriptorEnum.expression, Expression_ord).withFeature(SemanticsFeatureDescriptorEnum.where, InputBindings_ord);
        putSimpleEntity(ForTemplate_ord, "ForTemplate", ForTemplate.class, false).withFeature(SemanticsFeatureDescriptorEnum.expression, Expression_ord).withFeature(SemanticsFeatureDescriptorEnum.condition, Expression_ord);
        putSimpleEntity(IfTemplate_ord, "IfTemplate", IfTemplate.class, false).withFeature(SemanticsFeatureDescriptorEnum.expression, Expression_ord).withFeature(SemanticsFeatureDescriptorEnum.condition, Predicate_ord);
        putSimpleEntity(IfDefTemplate_ord, "IfDefTemplate", IfDefTemplate.class, false).withFeature(SemanticsFeatureDescriptorEnum.expression, Expression_ord);
        putSimpleEntity(ElseTemplate_ord, "ElseTemplate", ElseTemplate.class, false).withFeature(SemanticsFeatureDescriptorEnum.expression, Expression_ord);
