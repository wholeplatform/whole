...
public class SemanticsEntityDescriptorEnum extends EntityDescriptorEnum {
    ...
    public static final int Configuration_ord = 29;
    public static final int ConfigurationItem_ord = 30;
    public static final int BindingSubject_ord = 31;
    public static final int Term_ord = 32;
    ...
    public static final int Predicate_ord = 37;
    ...
    protected void initEntityDescriptors() {
        ...
        putCompositeEntity(SemanticFunctions_ord, "SemanticFunctions", SemanticFunctions.class, false, SemanticFunction_ord, true, false);
        ...
        putSimpleEntity(FunctionBody_ord, "FunctionBody", FunctionBody.class, true, UnionType_ord, Category_ord, Variable_ord, FunctionApplication_ord, AbstractVariable_ord, LocalIdentifier_ord, StructuredVariable_ord, BindingsScope_ord, LanguageType_ord, Template_ord, Predicate_ord, Identifier_ord, IfDefTemplate_ord, WhereTemplate_ord, ChooseTemplate_ord, OutputBindings_ord, IfTemplate_ord, AnyType_ord, LegacyType_ord, InferenceRules_ord, VariableValue_ord, ForTemplate_ord, Rules_ord, SubtypeType_ord, EntityType_ord, TypedVariable_ord, SupertypeType_ord, EnvironmentType_ord, Expression_ord, Environment_ord, EnvironmentVariable_ord, TypeCast_ord, InlineTemplate_ord);
        putCompositeEntity(Rules_ord, "Rules", Rules.class, false, Rule_ord, true, false);
        putCompositeEntity(InferenceRules_ord, "InferenceRules", InferenceRules.class, false, InferenceRule_ord, true, false);
        ...
        putCompositeEntity(UnionType_ord, "UnionType", UnionType.class, false, Category_ord, true, false);
        ...
        putCompositeEntity(ProductType_ord, "ProductType", ProductType.class, false, Signature_ord, true, false);
        putSimpleEntity(Rule_ord, "Rule", Rule.class, true, ExecutionRule_ord);
        putSimpleEntity(ExecutionRule_ord, "ExecutionRule", ExecutionRule.class, false).withFeature(SemanticsFeatureDescriptorEnum.name, Name_ord, true, false, false, false, false).withFeature(SemanticsFeatureDescriptorEnum.condition, Expression_ord).withFeature(SemanticsFeatureDescriptorEnum.meaning, Expression_ord);
        putSimpleEntity(InferenceRule_ord, "InferenceRule", InferenceRule.class, false).withFeature(SemanticsFeatureDescriptorEnum.name, RuleName_ord, true, false, false, false, false).withFeature(SemanticsFeatureDescriptorEnum.premises, Premises_ord, true, false, false, false, false).withFeature(SemanticsFeatureDescriptorEnum.conclusion, Transition_ord).withFeature(SemanticsFeatureDescriptorEnum.condition, Expression_ord, true, false, false, false, false);
        putCompositeEntity(Premises_ord, "Premises", Premises.class, false, Premise_ord, true, false);
        ...
        putCompositeEntity(Configuration_ord, "Configuration", Configuration.class, false, ConfigurationItem_ord, true, false);
        ...
        putSimpleEntity(Term_ord, "Term", Term.class, true, UnionType_ord, Category_ord, Variable_ord, FunctionApplication_ord, AbstractVariable_ord, LocalIdentifier_ord, StructuredVariable_ord, BindingsScope_ord, LanguageType_ord, Template_ord, Predicate_ord, Identifier_ord, IfDefTemplate_ord, WhereTemplate_ord, ChooseTemplate_ord, OutputBindings_ord, IfTemplate_ord, AnyType_ord, LegacyType_ord, VariableValue_ord, ForTemplate_ord, SubtypeType_ord, EntityType_ord, TypedVariable_ord, SupertypeType_ord, EnvironmentType_ord, Expression_ord, Environment_ord, EnvironmentVariable_ord, TypeCast_ord, InlineTemplate_ord);
        putSimpleEntity(Expression_ord, "Expression", Expression.class, true, UnionType_ord, Category_ord, Variable_ord, FunctionApplication_ord, AbstractVariable_ord, LocalIdentifier_ord, StructuredVariable_ord, BindingsScope_ord, LanguageType_ord, Template_ord, Predicate_ord, Identifier_ord, IfDefTemplate_ord, WhereTemplate_ord, ChooseTemplate_ord, OutputBindings_ord, IfTemplate_ord, AnyType_ord, LegacyType_ord, VariableValue_ord, ForTemplate_ord, SubtypeType_ord, EntityType_ord, TypedVariable_ord, SupertypeType_ord, EnvironmentType_ord, Environment_ord, EnvironmentVariable_ord, TypeCast_ord, InlineTemplate_ord);
        ...
        putCompositeEntity(RenameGroup_ord, "RenameGroup", RenameGroup.class, false, Rename_ord, true, false);
        ...
        putCompositeEntity(Environments_ord, "Environments", Environments.class, false, Environment_ord, true, false);
        ...
        putCompositeEntity(LocalBindings_ord, "LocalBindings", LocalBindings.class, false, LocalBinding_ord, false, true);
        ...
        putCompositeEntity(InputBindings_ord, "InputBindings", InputBindings.class, false, InputBinding_ord, true, false);
        ...
        putCompositeEntity(ChooseTemplate_ord, "ChooseTemplate", ChooseTemplate.class, false, Case_ord, true, false);
        ...
        putSimpleEntity(IfTemplate_ord, "IfTemplate", IfTemplate.class, false).withFeature(SemanticsFeatureDescriptorEnum.expression, Term_ord).withFeature(SemanticsFeatureDescriptorEnum.condition, Expression_ord);
