...
public class SemanticsFeatureDescriptorEnum extends FeatureDescriptorEnum {
	...
	public static final FeatureDescriptor version = instance
			.valueOf(version_ord);
	public static final FeatureDescriptor functions = instance
			.valueOf(functions_ord);
	public static final FeatureDescriptor signature = instance
	...
	public static final FeatureDescriptor meaning = instance
			.valueOf(meaning_ord);
	public static final FeatureDescriptor premises = instance
			.valueOf(premises_ord);
	public static final FeatureDescriptor conclusion = instance
			.valueOf(conclusion_ord);
	public static final FeatureDescriptor sourceConfiguration = instance
			.valueOf(sourceConfiguration_ord);
	public static final FeatureDescriptor targetConfiguration = instance
			.valueOf(targetConfiguration_ord);
	public static final FeatureDescriptor variable = instance
	...
	public static final FeatureDescriptor identifier = instance
			.valueOf(identifier_ord);
	public static final FeatureDescriptor newIdentifier = instance
			.valueOf(newIdentifier_ord);
	public static final FeatureDescriptor oldIdentifier = instance
			.valueOf(oldIdentifier_ord);
	public static final FeatureDescriptor bindings = instance
			.valueOf(bindings_ord);
	public static final FeatureDescriptor nestedScope = instance
			.valueOf(nestedScope_ord);
	...
	public static final FeatureDescriptor environment = instance
	...
	public static final FeatureDescriptor environments = instance
