 ...
 *  @generator Whole
 */
public class SemanticFunctionAdapter extends AbstractEntityAdapter implements SemanticFunction {
    ...
    public FunctionType getSignature() {
        return wGet(SemanticsFeatureDescriptorEnum.signature).wGetAdapter(SemanticsEntityDescriptorEnum.FunctionType);
    }
    ...
    public FunctionBody getRules() {
        return wGet(SemanticsFeatureDescriptorEnum.rules).wGetAdapter(SemanticsEntityDescriptorEnum.FunctionBody);
    }
