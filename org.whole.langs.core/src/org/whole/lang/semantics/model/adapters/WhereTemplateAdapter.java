 ...
 *  @generator Whole
 */
public class WhereTemplateAdapter extends AbstractEntityAdapter implements WhereTemplate {
    ...
    public InputBindings getWhere() {
        return wGet(SemanticsFeatureDescriptorEnum.where).wGetAdapter(SemanticsEntityDescriptorEnum.InputBindings);
    }
