 ...
 *  @generator Whole
 */
public class SupertypeTypeAdapter extends AbstractEntityAdapter implements SupertypeType {
    ...
    public Category getCategory() {
        return wGet(SemanticsFeatureDescriptorEnum.category).wGetAdapter(SemanticsEntityDescriptorEnum.Category);
    }
