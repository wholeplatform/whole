 ...
 *  @generator Whole
 */
public class SubtypeTypeAdapter extends AbstractEntityAdapter implements SubtypeType {
    ...
    public EntityType getCategory() {
        return wGet(SemanticsFeatureDescriptorEnum.category).wGetAdapter(SemanticsEntityDescriptorEnum.EntityType);
    }
