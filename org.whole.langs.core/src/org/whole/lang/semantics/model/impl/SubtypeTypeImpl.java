 ...
 *  @generator Whole
 */
public class SubtypeTypeImpl extends AbstractSimpleEntity implements SubtypeType {
    ...
    public void wSet(int index, IEntity value) {
        switch (index) {
            case 0 :
            setCategory(value.wGetAdapter(SemanticsEntityDescriptorEnum.EntityType));
            break;
            default :
            throw new IllegalArgumentException();
        }
