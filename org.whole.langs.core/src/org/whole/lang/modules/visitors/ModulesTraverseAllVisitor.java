 ...
 *  @generator  Whole
 */
public class ModulesTraverseAllVisitor extends ModulesIdentityUnaryVisitor<IModulesVisitor> {

    public ModulesTraverseAllVisitor() {
        wSetVisitor1(this);
    }

    public ModulesTraverseAllVisitor(IVisitor visitor1) {
        super(visitor1);
    }
