...
public class TypesEntityFactory extends GenericEntityFactory {
	...
	public IEntityBuilder<TypeSystem> buildTypeSystem() {
		return new EntityBuilder<TypeSystem>(
	...
	public IEntityBuilder<TypeRule> buildTypeRule() {
		return new EntityBuilder<TypeRule>(
				create(TypesEntityDescriptorEnum.TypeRule));
	}
	...
	public FeatureTableType createFeatureTableType(Arguments arguments,
			Cases cases) {
		return create(TypesEntityDescriptorEnum.FeatureTableType, arguments,
				cases);
	}

	public IEntityBuilder<FeatureTableType> buildFeatureTableType() {
		return new EntityBuilder<FeatureTableType>(
				create(TypesEntityDescriptorEnum.FeatureTableType));
	}
	...
	public IEntityBuilder<Subtype> buildSubtype() {
		return new EntityBuilder<Subtype>(
				create(TypesEntityDescriptorEnum.Subtype));
	}
	...
	public IEntityBuilder<Supertype> buildSupertype() {
		return new EntityBuilder<Supertype>(
				create(TypesEntityDescriptorEnum.Supertype));
	}
}
