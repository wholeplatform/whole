 ...
 * @generator Whole
 */
public class FeatureTableTypeImpl extends AbstractSimpleEntity implements
		FeatureTableType {
	...
	public void setArguments(Arguments arguments) {
		notifyChanged(TypesFeatureDescriptorEnum.arguments, this.arguments,
	...
	public void setCases(Cases cases) {
		notifyChanged(TypesFeatureDescriptorEnum.cases, this.cases,
				this.cases = cases);
	}
