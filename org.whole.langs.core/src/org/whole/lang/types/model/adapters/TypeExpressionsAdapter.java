 ...
 *  @generator Whole
 */
public class TypeExpressionsAdapter extends AbstractListEntityAdapter<TypeExpression> implements TypeExpressions {
    private static final long serialVersionUID = 1;

    public TypeExpressionsAdapter(IEntity implementor) {
        super(implementor);
    }

    public TypeExpressionsAdapter() {
    }
