 ...
 *  @generator Whole
 */
public class FeatureTableTypeAdapter extends AbstractEntityAdapter implements FeatureTableType {
    ...
    public Arguments getArguments() {
        return wGet(TypesFeatureDescriptorEnum.arguments).wGetAdapter(TypesEntityDescriptorEnum.Arguments);
    }
    ...
    public Cases getCases() {
        return wGet(TypesFeatureDescriptorEnum.cases).wGetAdapter(TypesEntityDescriptorEnum.Cases);
    }
