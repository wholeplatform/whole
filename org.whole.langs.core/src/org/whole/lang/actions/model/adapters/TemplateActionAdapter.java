 ...
 * @generator Whole
 */
public class TemplateActionAdapter extends AbstractEntityAdapter implements
		TemplateAction {
	private static final long serialVersionUID = 1;

	public TemplateActionAdapter(IEntity implementor) {
		super(implementor);
	}

	public TemplateActionAdapter() {
	}
