...
public class ReusablesEntityDescriptorEnum extends EntityDescriptorEnum {
    ...
    public static final int Model_ord = 10;
    public static final int Registry_ord = 11;
    public static final int PathExpression_ord = 12;
    public static final int StepExpression_ord = 13;
    public static final int Load_ord = 14;
    public static final int Save_ord = 15;
    public static final int Content_ord = 16;
    public static final int Contents_ord = 17;
    public static final int Folder_ord = 18;
    public static final int File_ord = 19;
    ...
    public static final int Persistence_ord = 25;
    public static final int PersistenceId_ord = 26;
    public static final int Revision_ord = 27;
    public static final int Any_ord = 28;
    ...
    protected void initEntityDescriptors() {
        ...
        putSimpleEntity(Resource_ord, "Resource", Resource.class, true, Load_ord, PathExpression_ord, FileSystem_ord, Classpath_ord, Model_ord, Save_ord, Registry_ord, StepExpression_ord, Workspace_ord);
