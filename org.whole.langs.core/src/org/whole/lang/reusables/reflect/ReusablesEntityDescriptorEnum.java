...
public class ReusablesEntityDescriptorEnum extends EntityDescriptorEnum {
    ...
    public static final int PathExpression_ord = 5;
    public static final int Resource_ord = 6;
    public static final int Locator_ord = 7;
    public static final int WorkspacePath_ord = 8;
    public static final int FileSystemPath_ord = 9;
    public static final int ClassPathURI_ord = 10;
    public static final int URI_ord = 11;
    public static final int Persistence_ord = 12;
    public static final int Registry_ord = 13;
    ...
    protected void initEntityDescriptors() {
        putSimpleEntity(Reusable_ord, "Reusable", Reusable.class, true);
        ...
        putSimpleEntity(Source_ord, "Source", Source.class, true, PathExpression_ord, Resource_ord);
        putSimpleEntity(PathExpression_ord, "PathExpression", PathExpression.class, true);
        putSimpleEntity(Resource_ord, "Resource", Resource.class, false).withFeature(ReusablesFeatureDescriptorEnum.locator, Locator_ord).withFeature(ReusablesFeatureDescriptorEnum.persistence, Persistence_ord, true, false, false, false, false).withFeature(ReusablesFeatureDescriptorEnum.registry, Registry_ord, true, false, false, false, false);
