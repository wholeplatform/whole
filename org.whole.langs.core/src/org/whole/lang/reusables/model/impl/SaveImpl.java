 ...
 *  @generator Whole
 */
public class SaveImpl extends AbstractSimpleEntity implements Save {
    private static final long serialVersionUID = 1;

    public EntityDescriptor<Save> wGetEntityDescriptor() {
        return ReusablesEntityDescriptorEnum.Save;
    }

    public int wGetEntityOrd() {
        return ReusablesEntityDescriptorEnum.Save_ord;
    }
