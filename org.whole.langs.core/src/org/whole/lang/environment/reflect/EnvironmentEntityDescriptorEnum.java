...
public class EnvironmentEntityDescriptorEnum extends EntityDescriptorEnum {
    ...
    public static final int Null_ord = 15;
    public static final int ContextViewModel_ord = 16;
    public static final int SampleViewModel_ord = 17;
    public static final int DebugViewModel_ord = 18;
    public static final int Jobs_ord = 19;
    public static final int Job_ord = 20;
    public static final int ExecutionStack_ord = 21;
    public static final int ExecutionFrame_ord = 22;
    public static final int VariablesViewModel_ord = 23;
    public static final int Environments_ord = 24;
    public static final int Environment_ord = 25;
    public static final int BindingsModel_ord = 26;
    public static final int ScopedBindings_ord = 27;
    public static final int Bindings_ord = 28;
    public static final int Binding_ord = 29;
    public static final int Scope_ord = 30;
    public static final int Id_ord = 31;
    public static final int Names_ord = 32;
    public static final int Name_ord = 33;
    public static final int Index_ord = 34;
    public static final int Value_ord = 35;
    public static final int EnvironmentManager_ord = 36;
    public static final int BindingManager_ord = 37;
    public static final int BindingScope_ord = 38;
    public static final int BindingOrScope_ord = 39;
    ...
    protected void initEntityDescriptors() {
        putSimpleEntity(Data_ord, "Data", Data.class, true, ContainmentTuple_ord, Null_ord, CharData_ord, IntData_ord, ObjectData_ord, LongData_ord, DoubleData_ord, ShortData_ord, BooleanData_ord, ByteData_ord, FloatData_ord, DateData_ord, StringData_ord, Void_ord, Tuple_ord);
        ...
        putCompositeEntity(Jobs_ord, "Jobs", Jobs.class, false, Job_ord, true, false);
        ...
        putCompositeEntity(ExecutionStack_ord, "ExecutionStack", ExecutionStack.class, false, ExecutionFrame_ord, true, false);
        ...
        putCompositeEntity(ScopedBindings_ord, "ScopedBindings", ScopedBindings.class, false, BindingOrScope_ord, true, false);
