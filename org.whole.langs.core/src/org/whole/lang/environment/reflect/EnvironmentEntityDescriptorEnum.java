...
public class EnvironmentEntityDescriptorEnum extends EntityDescriptorEnum {
	...
	public static final EntityDescriptor<Data> Data = (EntityDescriptor<Data>) instance
			.valueOf(Data_ord);
	...
	public static final EntityDescriptor<DateData> DateData = (EntityDescriptor<DateData>) instance
			.valueOf(DateData_ord);
	public static final EntityDescriptor<ObjectData> ObjectData = (EntityDescriptor<ObjectData>) instance
			.valueOf(ObjectData_ord);
	public static final EntityDescriptor<Tuple> Tuple = (EntityDescriptor<Tuple>) instance
			.valueOf(Tuple_ord);
	public static final EntityDescriptor<ContainmentTuple> ContainmentTuple = (EntityDescriptor<ContainmentTuple>) instance
			.valueOf(ContainmentTuple_ord);
	public static final EntityDescriptor<Void> Void = (EntityDescriptor<Void>) instance
			.valueOf(Void_ord);
	...
	protected void initEntityDescriptors() {
		putSimpleEntity(Data_ord, "Data", Data.class, true,
				ContainmentTuple_ord, DateData_ord, Void_ord, FloatData_ord,
				LongData_ord, StringData_ord, Tuple_ord, BooleanData_ord,
				CharData_ord, IntData_ord, ShortData_ord, DoubleData_ord,
				ObjectData_ord, ByteData_ord);
		...
		putDataEntity(StringData_ord, "StringData", StringData.class, false,
				String.class);
		putDataEntity(DateData_ord, "DateData", DateData.class, false,
				java.util.Date.class);
		putDataEntity(ObjectData_ord, "ObjectData", ObjectData.class, false,
				Object.class);
		putCompositeEntity(Tuple_ord, "Tuple", Tuple.class, false, Data_ord,
				true, false, true, false, false);
		putCompositeEntity(ContainmentTuple_ord, "ContainmentTuple",
				ContainmentTuple.class, false, Data_ord, true, false);
