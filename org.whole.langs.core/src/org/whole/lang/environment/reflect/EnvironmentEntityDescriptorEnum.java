...
public class EnvironmentEntityDescriptorEnum extends EntityDescriptorEnum {
    ...
    public static final int ExecutionStack_ord = 18;
    public static final int ExecutionFrame_ord = 19;
    public static final int VariablesViewModel_ord = 20;
    public static final int Environments_ord = 21;
    public static final int Environment_ord = 22;
    public static final int BindingsModel_ord = 23;
    public static final int ScopedBindings_ord = 24;
    public static final int Bindings_ord = 25;
    public static final int Binding_ord = 26;
    public static final int Scope_ord = 27;
    public static final int Id_ord = 28;
    public static final int Names_ord = 29;
    public static final int Name_ord = 30;
    public static final int FrameIndex_ord = 31;
    public static final int Value_ord = 32;
    public static final int EnvironmentManager_ord = 33;
    public static final int BindingManager_ord = 34;
    public static final int BindingScope_ord = 35;
    public static final int BindingOrScope_ord = 36;
    ...
    public static final EntityDescriptor<FrameIndex> FrameIndex = (EntityDescriptor<FrameIndex>) instance.valueOf(FrameIndex_ord);
    ...
    protected void initEntityDescriptors() {
        ...
        putSimpleEntity(DebugViewModel_ord, "DebugViewModel", DebugViewModel.class, false).withFeature(EnvironmentFeatureDescriptorEnum.focusFrame, FrameIndex_ord).withFeature(EnvironmentFeatureDescriptorEnum.executionStack, ExecutionStack_ord);
        ...
        putDataEntity(FrameIndex_ord, "FrameIndex", FrameIndex.class, false, int.class);
