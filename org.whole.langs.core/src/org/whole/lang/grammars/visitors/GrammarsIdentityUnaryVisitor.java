 ...
 * @generator Whole
 */
public class GrammarsIdentityUnaryVisitor<V extends IVisitor> extends
		AbstractUnaryVisitor<V> implements IGrammarsVisitor {
	public GrammarsIdentityUnaryVisitor() {
		super(null);
	}

	public GrammarsIdentityUnaryVisitor(IVisitor visitor1) {
		super(visitor1);
	}
