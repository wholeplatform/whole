 ...
 * @generator Whole
 */
public class GrammarsSequenceVisitor extends
		AbstractBinaryVisitor<IGrammarsVisitor> implements IGrammarsVisitor {
	public GrammarsSequenceVisitor(IVisitor visitor1, IVisitor visitor2) {
