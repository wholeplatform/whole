 ...
 * @generator Whole
 */
public class PatternApplicationAdapter extends AbstractEntityAdapter implements
		PatternApplication {
	...
	public Arguments getArguments() {
		return wGet(PatternsFeatureDescriptorEnum.arguments).wGetAdapter(
				PatternsEntityDescriptorEnum.Arguments);
	}
