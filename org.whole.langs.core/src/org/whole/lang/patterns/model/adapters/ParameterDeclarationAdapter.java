 ...
 *  @generator Whole
 */
public class ParameterDeclarationAdapter extends AbstractEntityAdapter implements ParameterDeclaration {
    private static final long serialVersionUID = 1;

    public ParameterDeclarationAdapter(IEntity implementor) {
        super(implementor);
    }

    public ParameterDeclarationAdapter() {
    }
