 ...
 *  @generator Whole
 */
public class SlotDeclarationAdapter extends AbstractEntityAdapter implements SlotDeclaration {
    private static final long serialVersionUID = 1;

    public SlotDeclarationAdapter(IEntity implementor) {
        super(implementor);
    }

    public SlotDeclarationAdapter() {
    }
