...
public class SlotAdapter extends AbstractEntityAdapter implements Slot {
	...
	public BooleanValue getOptional() {
		return wGet(PatternsFeatureDescriptorEnum.optional).wGetAdapter(
				PatternsEntityDescriptorEnum.BooleanValue);
	}
	...
	public PathExpression getAdapter() {
		return wGet(PatternsFeatureDescriptorEnum.adapter).wGetAdapter(
	...
	public Type getType() {
		return wGet(PatternsFeatureDescriptorEnum.type).wGetAdapter(
				PatternsEntityDescriptorEnum.Type);
	}
