 ...
 * @generator Whole
 */
public class ScopePointAdapter extends AbstractEntityAdapter implements
		ScopePoint {
	...
	public Declarations getContext() {
		return wGet(PatternsFeatureDescriptorEnum.context).wGetAdapter(
				PatternsEntityDescriptorEnum.Declarations);
	}
