...
public class PlacementEnum extends EnumType<PlacementEnum.Value> {
    public static final int AROUND_ord = 0;
    public static final int BEFORE_ord = 1;
    public static final int AFTER_ord = 2;
    public static final int BEFORE_FIRST_CHILD_ord = 3;
    public static final int AFTER_LAST_CHILD_ord = 4;
