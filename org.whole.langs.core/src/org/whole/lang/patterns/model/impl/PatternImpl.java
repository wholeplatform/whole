...
public class PatternImpl extends AbstractSimpleEntity implements Pattern {
	...
	public ResultTypes getResultTypes() {
		return notifyRequested(PatternsFeatureDescriptorEnum.resultTypes,
				resultTypes);
	}

	public void setResultTypes(ResultTypes resultTypes) {
		notifyChanged(PatternsFeatureDescriptorEnum.resultTypes,
				this.resultTypes, this.resultTypes = resultTypes);
	}
