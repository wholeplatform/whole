...
public class SlotImpl extends AbstractSimpleEntity implements Slot {
	...
	public void setOptional(BooleanValue optional) {
		notifyChanged(PatternsFeatureDescriptorEnum.optional, this.optional,
	...
	public void setAdapter(PathExpression adapter) {
		notifyChanged(PatternsFeatureDescriptorEnum.adapter, this.adapter,
	...
	public void wSet(int index, IEntity value) {
		...
		case 1:
			setOptional(value
					.wGetAdapter(PatternsEntityDescriptorEnum.BooleanValue));
			break;
		case 2:
			setAdapter(value
