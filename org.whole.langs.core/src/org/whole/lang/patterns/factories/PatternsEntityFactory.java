...
public class PatternsEntityFactory extends GenericEntityFactory {
	...
	public static PatternsEntityFactory instance(
	...
	public PatternLanguage createPatternLanguage(URI uri, Namespace namespace,
			Name name, Version version, Patterns patterns) {
		return create(PatternsEntityDescriptorEnum.PatternLanguage, uri,
				namespace, name, version, patterns);
	}

	public IEntityBuilder<PatternLanguage> buildPatternLanguage() {
		return new EntityBuilder<PatternLanguage>(
	...
	public Patterns createPatterns(Pattern... entities) {
		return create(PatternsEntityDescriptorEnum.Patterns,
				(IEntity[]) entities);
	}
	...
	public Library createLibrary(URI uri, Namespace namespace, Name name,
			Version version, Declarations declarations) {
		return create(PatternsEntityDescriptorEnum.Library, uri, namespace,
				name, version, declarations);
	}

	public IEntityBuilder<Library> buildLibrary() {
		return new EntityBuilder<Library>(
				create(PatternsEntityDescriptorEnum.Library));
	}
	...
	public Pattern createPattern(ResultTypes resultTypes, Name name,
			Template template) {
		return create(PatternsEntityDescriptorEnum.Pattern, resultTypes, name,
				template);
	}

	public IEntityBuilder<Pattern> buildPattern() {
		return new EntityBuilder<Pattern>(
				create(PatternsEntityDescriptorEnum.Pattern));
	}
	...
	public PatternApplication createPatternApplication(Name name,
			Arguments arguments) {
		return create(PatternsEntityDescriptorEnum.PatternApplication, name,
				arguments);
	}

	public IEntityBuilder<PatternApplication> buildPatternApplication() {
		return new EntityBuilder<PatternApplication>(
				create(PatternsEntityDescriptorEnum.PatternApplication));
	}
	...
	public IEntityBuilder<Binding> buildBinding() {
		return new EntityBuilder<Binding>(
				create(PatternsEntityDescriptorEnum.Binding));
	}
	...
	public VariablePoint createVariablePoint(Name name, ResultType resultType) {
		return create(PatternsEntityDescriptorEnum.VariablePoint, name,
				resultType);
	}

	public IEntityBuilder<VariablePoint> buildVariablePoint() {
		return new EntityBuilder<VariablePoint>(
				create(PatternsEntityDescriptorEnum.VariablePoint));
	}
	...
	public FunctionApplicationPoint createFunctionApplicationPoint(Name name,
	...
	public IEntityBuilder<FunctionApplicationPoint> buildFunctionApplicationPoint() {
		return new EntityBuilder<FunctionApplicationPoint>(
				create(PatternsEntityDescriptorEnum.FunctionApplicationPoint));
	}
	...
	public Slot createSlot(Name name, BooleanValue optional,
			PathExpression adapter, Type type, Type resultType) {
		return create(PatternsEntityDescriptorEnum.Slot, name, optional,
				adapter, type, resultType);
	}

	public IEntityBuilder<Slot> buildSlot() {
		return new EntityBuilder<Slot>(
				create(PatternsEntityDescriptorEnum.Slot));
	}
	...
	public ResultPoint createResultPoint(Type resultType, Template template,
			PathExpression weaver) {
		return create(PatternsEntityDescriptorEnum.ResultPoint, resultType,
				template, weaver);
	}

	public IEntityBuilder<ResultPoint> buildResultPoint() {
		return new EntityBuilder<ResultPoint>(
				create(PatternsEntityDescriptorEnum.ResultPoint));
	}
	...
	public IEntityBuilder<JoinPoint> buildJoinPoint() {
		return new EntityBuilder<JoinPoint>(
				create(PatternsEntityDescriptorEnum.JoinPoint));
	}
	...
	public ScopePoint createScopePoint(Declarations context, Template template) {
		return create(PatternsEntityDescriptorEnum.ScopePoint, context,
				template);
	}

	public IEntityBuilder<ScopePoint> buildScopePoint() {
		return new EntityBuilder<ScopePoint>(
				create(PatternsEntityDescriptorEnum.ScopePoint));
	}
	...
	public DerivationPoint createDerivationPoint(Expression expression,
			ResultType resultType) {
		return create(PatternsEntityDescriptorEnum.DerivationPoint, expression,
				resultType);
	}

	public IEntityBuilder<DerivationPoint> buildDerivationPoint() {
		return new EntityBuilder<DerivationPoint>(
				create(PatternsEntityDescriptorEnum.DerivationPoint));
	}
	...
	public ConditionPoint createConditionPoint(Predicate condition,
			Template template) {
		return create(PatternsEntityDescriptorEnum.ConditionPoint, condition,
				template);
	}

	public IEntityBuilder<ConditionPoint> buildConditionPoint() {
		return new EntityBuilder<ConditionPoint>(
				create(PatternsEntityDescriptorEnum.ConditionPoint));
	}
	...
	public IterationPoint createIterationPoint(PathExpression iterator,
			Template template) {
		return create(PatternsEntityDescriptorEnum.IterationPoint, iterator,
				template);
	}

	public IEntityBuilder<IterationPoint> buildIterationPoint() {
		return new EntityBuilder<IterationPoint>(
				create(PatternsEntityDescriptorEnum.IterationPoint));
	}
	...
	public FunctionDeclaration createFunctionDeclaration(
			ResultTypes applicationTypes, Name name, Expression body) {
		return create(PatternsEntityDescriptorEnum.FunctionDeclaration,
				applicationTypes, name, body);
	}

	public IEntityBuilder<FunctionDeclaration> buildFunctionDeclaration() {
		return new EntityBuilder<FunctionDeclaration>(
				create(PatternsEntityDescriptorEnum.FunctionDeclaration));
	}
	...
	public PointcutDeclaration createPointcutDeclaration(Name name,
			Expression expression) {
		return create(PatternsEntityDescriptorEnum.PointcutDeclaration, name,
				expression);
	}

	public IEntityBuilder<PointcutDeclaration> buildPointcutDeclaration() {
		return new EntityBuilder<PointcutDeclaration>(
				create(PatternsEntityDescriptorEnum.PointcutDeclaration));
	}
	...
	public JoinPointDeclaration createJoinPointDeclaration(Name name,
			Expression expression) {
		return create(PatternsEntityDescriptorEnum.JoinPointDeclaration, name,
				expression);
	}

	public IEntityBuilder<JoinPointDeclaration> buildJoinPointDeclaration() {
		return new EntityBuilder<JoinPointDeclaration>(
				create(PatternsEntityDescriptorEnum.JoinPointDeclaration));
	}
	...
	public VariableDeclaration createVariableDeclaration(Name name,
			Expression expression, Type resultType) {
		return create(PatternsEntityDescriptorEnum.VariableDeclaration, name,
				expression, resultType);
	}

	public IEntityBuilder<VariableDeclaration> buildVariableDeclaration() {
		return new EntityBuilder<VariableDeclaration>(
				create(PatternsEntityDescriptorEnum.VariableDeclaration));
	}
	...
	public Repetition createRepetition(Name name, Type type) {
		return create(PatternsEntityDescriptorEnum.Repetition, name, type);
	}

	public IEntityBuilder<Repetition> buildRepetition() {
		return new EntityBuilder<Repetition>(
				create(PatternsEntityDescriptorEnum.Repetition));
	}
	...
	public Choice createChoice(Name name, Types types) {
		return create(PatternsEntityDescriptorEnum.Choice, name, types);
	}

	public IEntityBuilder<Choice> buildChoice() {
		return new EntityBuilder<Choice>(
				create(PatternsEntityDescriptorEnum.Choice));
	}
	...
	public Enumeration createEnumeration(Name name, Type resultType,
			EnumValues values) {
		return create(PatternsEntityDescriptorEnum.Enumeration, name,
				resultType, values);
	}

	public IEntityBuilder<Enumeration> buildEnumeration() {
		return new EntityBuilder<Enumeration>(
				create(PatternsEntityDescriptorEnum.Enumeration));
	}
	...
	public IEntityBuilder<EnumValue> buildEnumValue() {
		return new EntityBuilder<EnumValue>(
				create(PatternsEntityDescriptorEnum.EnumValue));
	}
	...
	public IEntityBuilder<Insert> buildInsert() {
		return new EntityBuilder<Insert>(
				create(PatternsEntityDescriptorEnum.Insert));
	}
