...
public class PatternsFeatureDescriptorEnum extends FeatureDescriptorEnum {
    ...
    public static final int actions_ord = 6;
    public static final int guestActions_ord = 7;
    public static final int resultTypes_ord = 8;
    public static final int template_ord = 9;
    public static final int type_ord = 10;
    public static final int supertypes_ord = 11;
    public static final int types_ord = 12;
    public static final int resultType_ord = 13;
    public static final int values_ord = 14;
    public static final int value_ord = 15;
    public static final int result_ord = 16;
    public static final int dataType_ord = 17;
    public static final int arguments_ord = 18;
    public static final int expression_ord = 19;
    public static final int optional_ord = 20;
    public static final int adapter_ord = 21;
    public static final int weaver_ord = 22;
    public static final int context_ord = 23;
    public static final int condition_ord = 24;
    public static final int variability_ord = 25;
    public static final int variants_ord = 26;
    public static final int iterator_ord = 27;
    public static final int applicationTypes_ord = 28;
    public static final int body_ord = 29;
    public static final int subgoals_ord = 30;
    public static final int variant_ord = 31;
    public static final int path_ord = 32;
    public static final int placement_ord = 33;
    ...
    public static final FeatureDescriptor guestActions = instance.valueOf(guestActions_ord);
    ...
    private PatternsFeatureDescriptorEnum() {
        ...
        putFeatureDescriptor(guestActions_ord, "guestActions");
