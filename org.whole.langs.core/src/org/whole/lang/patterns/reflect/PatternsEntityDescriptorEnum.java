...
public class PatternsEntityDescriptorEnum extends EntityDescriptorEnum {
    ...
    public static final int FunctionApplicationPoint_ord = 18;
    ...
    public static final int IterationPoint_ord = 28;
    public static final int SequencePoint_ord = 29;
    public static final int InlinePoint_ord = 30;
    public static final int Declarations_ord = 31;
    public static final int FunctionDeclaration_ord = 32;
    public static final int PointcutDeclaration_ord = 33;
    public static final int JoinPointDeclaration_ord = 34;
    public static final int VariableDeclaration_ord = 35;
    public static final int Types_ord = 36;
    public static final int ResultTypes_ord = 37;
    public static final int Type_ord = 38;
    public static final int ResultTypeOrPathExpression_ord = 39;
    public static final int ResultType_ord = 40;
    public static final int Name_ord = 41;
    public static final int PathExpression_ord = 42;
    public static final int StepExpression_ord = 43;
    public static final int PatternJoinPointStep_ord = 44;
    public static final int JoinPointStep_ord = 45;
    public static final int PointcutStep_ord = 46;
    public static final int SlotStep_ord = 47;
    public static final int OuterDefinitionStep_ord = 48;
    public static final int Cut_ord = 49;
    public static final int Insert_ord = 50;
    public static final int SlotsDefined_ord = 51;
    public static final int PatternTypeTest_ord = 52;
    public static final int Placement_ord = 53;
    public static final int URI_ord = 54;
    public static final int Namespace_ord = 55;
    public static final int Version_ord = 56;
    public static final int BooleanValue_ord = 57;
    public static final int Argument_ord = 58;
    public static final int Predicate_ord = 59;
    public static final int Declaration_ord = 60;
    public static final int Expression_ord = 61;
    ...
    public static final EntityDescriptor<FunctionApplicationPoint> FunctionApplicationPoint = (EntityDescriptor<FunctionApplicationPoint>) instance.valueOf(FunctionApplicationPoint_ord);
    ...
    protected void initEntityDescriptors() {
        ...
        putSimpleEntity(Template_ord, "Template", Template.class, true, Pattern_ord, ResultPoint_ord, DerivationPoint_ord, InsertionPoint_ord, SelectionPoint_ord, ScopePoint_ord, JoinPoint_ord, ConditionPoint_ord, IterationPoint_ord, PatternApplication_ord, VariablePoint_ord, InlinePoint_ord, VariationPoint_ord, TemplatePoint_ord, Slot_ord, SequencePoint_ord, FunctionApplicationPoint_ord);
        ...
        putSimpleEntity(VariationPoint_ord, "VariationPoint", VariationPoint.class, true, ResultPoint_ord, DerivationPoint_ord, InsertionPoint_ord, SelectionPoint_ord, ScopePoint_ord, JoinPoint_ord, ConditionPoint_ord, IterationPoint_ord, PatternApplication_ord, VariablePoint_ord, InlinePoint_ord, TemplatePoint_ord, Slot_ord, SequencePoint_ord, FunctionApplicationPoint_ord);
        ...
        putSimpleEntity(FunctionApplicationPoint_ord, "FunctionApplicationPoint", FunctionApplicationPoint.class, false).withFeature(PatternsFeatureDescriptorEnum.name, Name_ord).withFeature(PatternsFeatureDescriptorEnum.resultType, ResultType_ord, true, false, false, false, false);
        ...
        putSimpleEntity(ResultTypeOrPathExpression_ord, "ResultTypeOrPathExpression", ResultTypeOrPathExpression.class, true, Cut_ord, PathExpression_ord, JoinPointStep_ord, PointcutStep_ord, PatternJoinPointStep_ord, ResultType_ord, OuterDefinitionStep_ord, SlotStep_ord, Insert_ord, StepExpression_ord, Name_ord);
        ...
        putSimpleEntity(PathExpression_ord, "PathExpression", PathExpression.class, true, Cut_ord, JoinPointStep_ord, PointcutStep_ord, PatternJoinPointStep_ord, OuterDefinitionStep_ord, SlotStep_ord, Insert_ord, StepExpression_ord);
        putSimpleEntity(StepExpression_ord, "StepExpression", StepExpression.class, true, Cut_ord, JoinPointStep_ord, PointcutStep_ord, PatternJoinPointStep_ord, OuterDefinitionStep_ord, SlotStep_ord, Insert_ord);
        ...
        putSimpleEntity(Declaration_ord, "Declaration", Declaration.class, true, FunctionDeclaration_ord, VariableDeclaration_ord, PointcutDeclaration_ord, JoinPointDeclaration_ord);
        putSimpleEntity(Expression_ord, "Expression", Expression.class, true, ResultPoint_ord, DerivationPoint_ord, InsertionPoint_ord, PointcutStep_ord, Insert_ord, JoinPoint_ord, PathExpression_ord, VariablePoint_ord, TemplatePoint_ord, PatternJoinPointStep_ord, OuterDefinitionStep_ord, SlotStep_ord, StepExpression_ord, FunctionApplicationPoint_ord, Cut_ord, JoinPointStep_ord, SelectionPoint_ord, ScopePoint_ord, ConditionPoint_ord, IterationPoint_ord, PatternApplication_ord, InlinePoint_ord, VariationPoint_ord, Slot_ord, SequencePoint_ord);
    }
