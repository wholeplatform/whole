...
public class PatternsEntityDescriptorEnum extends EntityDescriptorEnum {
    ...
    public static final int PointcutDeclaration_ord = 36;
    public static final int JoinPointDeclaration_ord = 37;
    public static final int VariableDeclaration_ord = 38;
    public static final int VariantSelector_ord = 39;
    public static final int Types_ord = 40;
    public static final int ResultTypes_ord = 41;
    public static final int Type_ord = 42;
    public static final int ResultTypeOrPathExpression_ord = 43;
    ...
    public static final int SlotStep_ord = 51;
    public static final int OuterDefinitionStep_ord = 52;
    public static final int Cut_ord = 53;
    public static final int Insert_ord = 54;
    public static final int SlotsDefined_ord = 55;
    public static final int PatternTypeTest_ord = 56;
    public static final int Placement_ord = 57;
    public static final int URI_ord = 58;
    public static final int Namespace_ord = 59;
    public static final int Version_ord = 60;
    public static final int BooleanValue_ord = 61;
    public static final int Argument_ord = 62;
    public static final int Predicate_ord = 63;
    public static final int Declaration_ord = 64;
    public static final int Expression_ord = 65;
    ...
    protected void initEntityDescriptors() {
        ...
        putSimpleEntity(VariationPoint_ord, "VariationPoint", VariationPoint.class, true, ResultPoint_ord, VariantSelectionPoint_ord, DerivationPoint_ord, InsertionPoint_ord, SelectionPoint_ord, ScopePoint_ord, JoinPoint_ord, ConditionPoint_ord, IterationPoint_ord, PatternApplication_ord, VariablePoint_ord, InlinePoint_ord, TemplatePoint_ord, Slot_ord, SequencePoint_ord, FunctionApplicationPoint_ord);
        ...
        putSimpleEntity(Declaration_ord, "Declaration", Declaration.class, true, FunctionDeclaration_ord, VariantSelector_ord, VariableDeclaration_ord, PointcutDeclaration_ord, JoinPointDeclaration_ord);
        putSimpleEntity(Expression_ord, "Expression", Expression.class, true, ResultPoint_ord, DerivationPoint_ord, InsertionPoint_ord, PointcutStep_ord, Insert_ord, Name_ord, JoinPoint_ord, PathExpression_ord, VariablePoint_ord, TemplatePoint_ord, PatternJoinPointStep_ord, OuterDefinitionStep_ord, SlotStep_ord, StepExpression_ord, FunctionApplicationPoint_ord, Cut_ord, VariantSelectionPoint_ord, JoinPointStep_ord, SelectionPoint_ord, ScopePoint_ord, ConditionPoint_ord, IterationPoint_ord, PatternApplication_ord, InlinePoint_ord, VariationPoint_ord, Slot_ord, SequencePoint_ord);
    }
