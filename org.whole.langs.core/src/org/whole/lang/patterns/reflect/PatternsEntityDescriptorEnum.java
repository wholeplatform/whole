...
public class PatternsEntityDescriptorEnum extends EntityDescriptorEnum {
    ...
    public static final int PathExpression_ord = 47;
    ...
    public static final int Cut_ord = 55;
    public static final int Insert_ord = 56;
    public static final int SlotsDefined_ord = 57;
    public static final int PatternTypeTest_ord = 58;
    public static final int Placement_ord = 59;
    public static final int URI_ord = 60;
    public static final int Namespace_ord = 61;
    public static final int Version_ord = 62;
    public static final int BooleanValue_ord = 63;
    public static final int GoalExpression_ord = 64;
    public static final int Argument_ord = 65;
    public static final int Predicate_ord = 66;
    public static final int Declaration_ord = 67;
    public static final int Expression_ord = 68;
    ...
    protected void initEntityDescriptors() {
        ...
        putSimpleEntity(ResultTypeOrPathExpression_ord, "ResultTypeOrPathExpression", ResultTypeOrPathExpression.class, true, Cut_ord, PathExpression_ord, JoinPointStep_ord, PointcutStep_ord, GoalStep_ord, PatternJoinPointStep_ord, ResultType_ord, OuterDefinitionStep_ord, Insert_ord, SlotStep_ord, StepExpression_ord, Name_ord);
        ...
        putSimpleEntity(PathExpression_ord, "PathExpression", PathExpression.class, true, Cut_ord, JoinPointStep_ord, PointcutStep_ord, GoalStep_ord, PatternJoinPointStep_ord, OuterDefinitionStep_ord, SlotStep_ord, Insert_ord, StepExpression_ord);
        putSimpleEntity(StepExpression_ord, "StepExpression", StepExpression.class, true, Cut_ord, JoinPointStep_ord, PointcutStep_ord, GoalStep_ord, PatternJoinPointStep_ord, OuterDefinitionStep_ord, SlotStep_ord, Insert_ord);
