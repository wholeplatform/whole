...
public class PatternsEntityDescriptorEnum extends EntityDescriptorEnum {
    ...
    public static final int ParameterDeclaration_ord = 40;
    public static final int SlotDeclaration_ord = 41;
    public static final int VariantSelector_ord = 42;
    public static final int Types_ord = 43;
    public static final int ResultTypes_ord = 44;
    public static final int Type_ord = 45;
    public static final int ResultType_ord = 46;
    public static final int Expression_ord = 47;
    public static final int Name_ord = 48;
    public static final int ResultWeaver_ord = 49;
    public static final int StepExpression_ord = 50;
    public static final int PatternJoinPointStep_ord = 51;
    public static final int JoinPointStep_ord = 52;
    public static final int PointcutStep_ord = 53;
    public static final int GoalStep_ord = 54;
    public static final int FunctionStep_ord = 55;
    public static final int SlotStep_ord = 56;
    public static final int OuterDefinitionStep_ord = 57;
    public static final int PatternInstance_ord = 58;
    public static final int Cut_ord = 59;
    public static final int Insert_ord = 60;
    public static final int Predicate_ord = 61;
    public static final int SlotsDefined_ord = 62;
    public static final int PatternTypeTest_ord = 63;
    public static final int PatternSubtypeTest_ord = 64;
    public static final int Placement_ord = 65;
    public static final int URI_ord = 66;
    public static final int Namespace_ord = 67;
    public static final int Version_ord = 68;
    public static final int BooleanValue_ord = 69;
    public static final int GoalExpression_ord = 70;
    public static final int Argument_ord = 71;
    public static final int Declaration_ord = 72;
