...
public class PatternsEntityDescriptorEnum extends EntityDescriptorEnum {
    ...
    public static final int DerivationPoint_ord = 24;
    public static final int TemplatePoint_ord = 25;
    public static final int TemplateApplicationPoint_ord = 26;
    public static final int SelectionPoint_ord = 27;
    public static final int ConditionPoint_ord = 28;
    public static final int VariantSelectionPoint_ord = 29;
    public static final int Variants_ord = 30;
    public static final int Variant_ord = 31;
    public static final int IterationPoint_ord = 32;
    public static final int SequencePoint_ord = 33;
    public static final int InlinePoint_ord = 34;
    public static final int Declarations_ord = 35;
    public static final int FunctionDeclaration_ord = 36;
    public static final int GoalDeclaration_ord = 37;
    public static final int PointcutDeclaration_ord = 38;
    public static final int JoinPointDeclaration_ord = 39;
    public static final int VariableDeclaration_ord = 40;
    public static final int ParameterDeclaration_ord = 41;
    public static final int SlotDeclaration_ord = 42;
    public static final int VariantSelector_ord = 43;
    public static final int Types_ord = 44;
    public static final int ResultTypes_ord = 45;
    public static final int Type_ord = 46;
    public static final int ResultType_ord = 47;
    public static final int Expression_ord = 48;
    public static final int Name_ord = 49;
    public static final int ResultWeaver_ord = 50;
    public static final int StepExpression_ord = 51;
    public static final int PatternJoinPointStep_ord = 52;
    public static final int JoinPointStep_ord = 53;
    public static final int PointcutStep_ord = 54;
    public static final int GoalStep_ord = 55;
    public static final int FunctionStep_ord = 56;
    public static final int SlotStep_ord = 57;
    public static final int OuterDefinitionStep_ord = 58;
    public static final int PatternInstance_ord = 59;
    public static final int Cut_ord = 60;
    public static final int Insert_ord = 61;
    public static final int Predicate_ord = 62;
    public static final int SlotsDefined_ord = 63;
    public static final int PatternTypeTest_ord = 64;
    public static final int PatternSubtypeTest_ord = 65;
    public static final int Placement_ord = 66;
    public static final int URI_ord = 67;
    public static final int Namespace_ord = 68;
    public static final int Version_ord = 69;
    public static final int BooleanValue_ord = 70;
    ...
    public static final EntityDescriptor<TemplateApplicationPoint> TemplateApplicationPoint = (EntityDescriptor<TemplateApplicationPoint>) instance.valueOf(TemplateApplicationPoint_ord);
    ...
    public static final EntityDescriptor<ParameterDeclaration> ParameterDeclaration = (EntityDescriptor<ParameterDeclaration>) instance.valueOf(ParameterDeclaration_ord);
    public static final EntityDescriptor<SlotDeclaration> SlotDeclaration = (EntityDescriptor<SlotDeclaration>) instance.valueOf(SlotDeclaration_ord);
    ...
    public static final EntityDescriptor<ResultWeaver> ResultWeaver = (EntityDescriptor<ResultWeaver>) instance.valueOf(ResultWeaver_ord);
    ...
    public static final EntityDescriptor<PatternSubtypeTest> PatternSubtypeTest = (EntityDescriptor<PatternSubtypeTest>) instance.valueOf(PatternSubtypeTest_ord);
    ...
    protected void initEntityDescriptors() {
        ...
        putSimpleEntity(Template_ord, "Template", Template.class, true, ResultPoint_ord, TemplateApplicationPoint_ord, DerivationPoint_ord, PointcutStep_ord, InsertionPoint_ord, FunctionPoint_ord, Insert_ord, Name_ord, Predicate_ord, JoinPoint_ord, FunctionStep_ord, SlotsDefined_ord, VariablePoint_ord, TemplatePoint_ord, PatternJoinPointStep_ord, OuterDefinitionStep_ord, SlotStep_ord, PatternSubtypeTest_ord, StepExpression_ord, Cut_ord, PatternInstance_ord, PatternTypeTest_ord, VariantSelectionPoint_ord, ResultWeaver_ord, JoinPointStep_ord, SelectionPoint_ord, ScopePoint_ord, ConditionPoint_ord, IterationPoint_ord, PatternApplication_ord, Expression_ord, InlinePoint_ord, VariationPoint_ord, GoalStep_ord, Slot_ord, SequencePoint_ord);
        ...
        putSimpleEntity(VariationPoint_ord, "VariationPoint", VariationPoint.class, true, ResultPoint_ord, TemplateApplicationPoint_ord, VariantSelectionPoint_ord, DerivationPoint_ord, InsertionPoint_ord, FunctionPoint_ord, SelectionPoint_ord, ScopePoint_ord, JoinPoint_ord, ConditionPoint_ord, IterationPoint_ord, PatternApplication_ord, VariablePoint_ord, InlinePoint_ord, TemplatePoint_ord, Slot_ord, SequencePoint_ord);
        ...
        putSimpleEntity(FunctionPoint_ord, "FunctionPoint", FunctionPoint.class, false).withFeature(PatternsFeatureDescriptorEnum.name, Name_ord).withFeature(PatternsFeatureDescriptorEnum.resultType, ResultType_ord, true, false, false, false, false).withFeature(PatternsFeatureDescriptorEnum.expression, Expression_ord, true, false, false, false, false);
        putSimpleEntity(Slot_ord, "Slot", Slot.class, false).withFeature(PatternsFeatureDescriptorEnum.name, Name_ord).withFeature(PatternsFeatureDescriptorEnum.optional, BooleanValue_ord).withFeature(PatternsFeatureDescriptorEnum.adapter, Expression_ord, true, false, false, false, false).withFeature(PatternsFeatureDescriptorEnum.type, Type_ord, true, false, false, false, false).withFeature(PatternsFeatureDescriptorEnum.resultType, Type_ord, true, false, false, false, false);
        putSimpleEntity(ResultPoint_ord, "ResultPoint", ResultPoint.class, false).withFeature(PatternsFeatureDescriptorEnum.resultType, Type_ord, true, false, false, false, false).withFeature(PatternsFeatureDescriptorEnum.template, Template_ord).withFeature(PatternsFeatureDescriptorEnum.weaver, Expression_ord, true, false, false, false, false);
        ...
        putSimpleEntity(DerivationPoint_ord, "DerivationPoint", DerivationPoint.class, false).withFeature(PatternsFeatureDescriptorEnum.expression, Expression_ord).withFeature(PatternsFeatureDescriptorEnum.resultType, ResultType_ord, true, false, false, false, false);
        ...
        putSimpleEntity(TemplateApplicationPoint_ord, "TemplateApplicationPoint", TemplateApplicationPoint.class, false).withFeature(PatternsFeatureDescriptorEnum.template, Template_ord);
        putCompositeEntity(SelectionPoint_ord, "SelectionPoint", SelectionPoint.class, false, ConditionPoint_ord, true, false);
        putSimpleEntity(ConditionPoint_ord, "ConditionPoint", ConditionPoint.class, false).withFeature(PatternsFeatureDescriptorEnum.condition, Expression_ord, true, false, false, false, false).withFeature(PatternsFeatureDescriptorEnum.template, Template_ord);
        ...
        putSimpleEntity(IterationPoint_ord, "IterationPoint", IterationPoint.class, false).withFeature(PatternsFeatureDescriptorEnum.iterator, Expression_ord).withFeature(PatternsFeatureDescriptorEnum.template, Template_ord);
        ...
        putSimpleEntity(GoalDeclaration_ord, "GoalDeclaration", GoalDeclaration.class, false).withFeature(PatternsFeatureDescriptorEnum.subgoals, GoalExpression_ord, true, false, false, false, false).withFeature(PatternsFeatureDescriptorEnum.name, Name_ord).withFeature(PatternsFeatureDescriptorEnum.body, Expression_ord);
        putSimpleEntity(PointcutDeclaration_ord, "PointcutDeclaration", PointcutDeclaration.class, false).withFeature(PatternsFeatureDescriptorEnum.name, Name_ord).withFeature(PatternsFeatureDescriptorEnum.expression, Expression_ord);
        putSimpleEntity(JoinPointDeclaration_ord, "JoinPointDeclaration", JoinPointDeclaration.class, false).withFeature(PatternsFeatureDescriptorEnum.name, Name_ord).withFeature(PatternsFeatureDescriptorEnum.expression, Expression_ord, true, false, false, false, false);
        putSimpleEntity(VariableDeclaration_ord, "VariableDeclaration", VariableDeclaration.class, false).withFeature(PatternsFeatureDescriptorEnum.name, Name_ord).withFeature(PatternsFeatureDescriptorEnum.expression, Expression_ord, true, false, false, false, false).withFeature(PatternsFeatureDescriptorEnum.resultType, Type_ord, true, false, false, false, false);
        putSimpleEntity(ParameterDeclaration_ord, "ParameterDeclaration", ParameterDeclaration.class, false).withFeature(PatternsFeatureDescriptorEnum.name, Name_ord).withFeature(PatternsFeatureDescriptorEnum.expression, Expression_ord, true, false, false, false, false).withFeature(PatternsFeatureDescriptorEnum.resultType, Type_ord, true, false, false, false, false);
        putSimpleEntity(SlotDeclaration_ord, "SlotDeclaration", SlotDeclaration.class, false).withFeature(PatternsFeatureDescriptorEnum.name, Name_ord).withFeature(PatternsFeatureDescriptorEnum.type, Type_ord).withFeature(PatternsFeatureDescriptorEnum.optional, BooleanValue_ord);
        putSimpleEntity(VariantSelector_ord, "VariantSelector", VariantSelector.class, false).withFeature(PatternsFeatureDescriptorEnum.variability, Name_ord).withFeature(PatternsFeatureDescriptorEnum.variant, Expression_ord);
        ...
        putSimpleEntity(Expression_ord, "Expression", Expression.class, true, ResultPoint_ord, TemplateApplicationPoint_ord, DerivationPoint_ord, PointcutStep_ord, InsertionPoint_ord, FunctionPoint_ord, Insert_ord, Name_ord, Predicate_ord, JoinPoint_ord, FunctionStep_ord, SlotsDefined_ord, VariablePoint_ord, TemplatePoint_ord, PatternJoinPointStep_ord, OuterDefinitionStep_ord, SlotStep_ord, PatternSubtypeTest_ord, StepExpression_ord, Cut_ord, PatternInstance_ord, PatternTypeTest_ord, VariantSelectionPoint_ord, ResultWeaver_ord, JoinPointStep_ord, SelectionPoint_ord, ScopePoint_ord, ConditionPoint_ord, IterationPoint_ord, PatternApplication_ord, InlinePoint_ord, VariationPoint_ord, GoalStep_ord, Slot_ord, SequencePoint_ord);
        putDataEntity(Name_ord, "Name", Name.class, false, String.class);
        putSimpleEntity(ResultWeaver_ord, "ResultWeaver", ResultWeaver.class, false);
        putSimpleEntity(StepExpression_ord, "StepExpression", StepExpression.class, true, ResultPoint_ord, TemplateApplicationPoint_ord, DerivationPoint_ord, PointcutStep_ord, InsertionPoint_ord, FunctionPoint_ord, Insert_ord, JoinPoint_ord, FunctionStep_ord, VariablePoint_ord, TemplatePoint_ord, PatternJoinPointStep_ord, OuterDefinitionStep_ord, SlotStep_ord, Cut_ord, PatternInstance_ord, VariantSelectionPoint_ord, JoinPointStep_ord, SelectionPoint_ord, ScopePoint_ord, ConditionPoint_ord, IterationPoint_ord, PatternApplication_ord, InlinePoint_ord, VariationPoint_ord, GoalStep_ord, Slot_ord, SequencePoint_ord);
        ...
        putSimpleEntity(Cut_ord, "Cut", Cut.class, false).withFeature(PatternsFeatureDescriptorEnum.path, Expression_ord);
        putSimpleEntity(Insert_ord, "Insert", Insert.class, false).withFeature(PatternsFeatureDescriptorEnum.placement, Placement_ord).withFeature(PatternsFeatureDescriptorEnum.path, Expression_ord);
        putSimpleEntity(Predicate_ord, "Predicate", Predicate.class, true, PatternSubtypeTest_ord, SlotsDefined_ord, PatternTypeTest_ord);
        ...
        putDataEntity(PatternSubtypeTest_ord, "PatternSubtypeTest", PatternSubtypeTest.class, false, String.class);
