...
public class PatternsEntityDescriptorEnum extends EntityDescriptorEnum {
    ...
    public static final int SlotDeclaration_ord = 40;
    public static final int VariantSelector_ord = 41;
    public static final int Types_ord = 42;
    public static final int ResultTypes_ord = 43;
    public static final int Type_ord = 44;
    public static final int ResultType_ord = 45;
    public static final int Expression_ord = 46;
    public static final int Name_ord = 47;
    public static final int StepExpression_ord = 48;
    ...
    public static final int Predicate_ord = 59;
    public static final int SlotsDefined_ord = 60;
    public static final int PatternTypeTest_ord = 61;
    public static final int PatternSubtypeTest_ord = 62;
    public static final int Placement_ord = 63;
    public static final int URI_ord = 64;
    public static final int Namespace_ord = 65;
    public static final int Version_ord = 66;
    public static final int BooleanValue_ord = 67;
    public static final int GoalExpression_ord = 68;
    public static final int Argument_ord = 69;
    public static final int Declaration_ord = 70;
    ...
    protected void initEntityDescriptors() {
        ...
        putSimpleEntity(Declaration_ord, "Declaration", Declaration.class, true, FunctionDeclaration_ord, PointcutDeclaration_ord, SlotDeclaration_ord, VariantSelector_ord, GoalDeclaration_ord, VariableDeclaration_ord, JoinPointDeclaration_ord);
    }
