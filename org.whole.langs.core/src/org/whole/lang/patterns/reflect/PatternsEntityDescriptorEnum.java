...
public class PatternsEntityDescriptorEnum extends EntityDescriptorEnum {
    ...
    public static final int Placement_ord = 62;
    public static final int URI_ord = 63;
    public static final int Namespace_ord = 64;
    public static final int Version_ord = 65;
    public static final int BooleanValue_ord = 66;
    public static final int GoalExpression_ord = 67;
    public static final int Argument_ord = 68;
