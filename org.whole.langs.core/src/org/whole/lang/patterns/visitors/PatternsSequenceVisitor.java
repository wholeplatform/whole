 ...
 *  @generator Whole
 */
public class PatternsSequenceVisitor extends AbstractBinaryVisitor<IPatternsVisitor> implements IPatternsVisitor {

    public PatternsSequenceVisitor(IVisitor visitor1, IVisitor visitor2) {
