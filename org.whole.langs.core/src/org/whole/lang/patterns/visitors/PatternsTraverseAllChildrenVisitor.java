 ...
 *  @generator Whole
 */
public class PatternsTraverseAllChildrenVisitor extends PatternsIdentityUnaryVisitor<IPatternsVisitor> {

    public PatternsTraverseAllChildrenVisitor() {
        wSetVisitor1(this);
    }

    public PatternsTraverseAllChildrenVisitor(IVisitor visitor1) {
        super(visitor1);
    }
    ...
    public void visit(PatternLanguage entity) {
        ...
        entity.getGuestActions().accept(wGetVisitor1());
    }
