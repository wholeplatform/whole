 ...
 *  @generator Whole
 */
public class ArtifactsSpecificBuilderAdapter extends GenericBuilderContext implements IArtifactsBuilder {

    public ArtifactsSpecificBuilderAdapter(IBuilder strategy) {
        super(strategy);
    }

    public ArtifactsSpecificBuilderAdapter(IBuilder strategy, IEntityContext entityContext) {
