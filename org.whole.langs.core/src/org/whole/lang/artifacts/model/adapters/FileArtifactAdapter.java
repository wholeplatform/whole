 ...
 *  @generator Whole
 */
public class FileArtifactAdapter extends AbstractEntityAdapter implements FileArtifact {
    ...
    public FileName getName() {
        return wGet(ArtifactsFeatureDescriptorEnum.name).wGetAdapter(ArtifactsEntityDescriptorEnum.FileName);
    }
    ...
    public Content getContent() {
        return wGet(ArtifactsFeatureDescriptorEnum.content).wGetAdapter(ArtifactsEntityDescriptorEnum.Content);
    }
