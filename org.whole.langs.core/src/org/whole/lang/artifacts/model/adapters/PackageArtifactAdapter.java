 ...
 *  @generator Whole
 */
public class PackageArtifactAdapter extends AbstractEntityAdapter implements PackageArtifact {
    ...
    public PackageName getName() {
        return wGet(ArtifactsFeatureDescriptorEnum.name).wGetAdapter(ArtifactsEntityDescriptorEnum.PackageName);
    }
