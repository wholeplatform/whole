 ...
 *  @generator Whole
 */
public class ArtifactsTraverseAllChildrenVisitor extends ArtifactsIdentityUnaryVisitor<IArtifactsVisitor> {

    public ArtifactsTraverseAllChildrenVisitor() {
        wSetVisitor1(this);
    }

    public ArtifactsTraverseAllChildrenVisitor(IVisitor visitor1) {
        super(visitor1);
    }
