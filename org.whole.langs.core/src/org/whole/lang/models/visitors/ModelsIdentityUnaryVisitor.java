 ...
 * @generator Whole
 */
public class ModelsIdentityUnaryVisitor<V extends IVisitor> extends
		AbstractUnaryVisitor<V> implements IModelsVisitor {
	public ModelsIdentityUnaryVisitor() {
		super(null);
	}

	public ModelsIdentityUnaryVisitor(IVisitor visitor1) {
		super(visitor1);
	}
