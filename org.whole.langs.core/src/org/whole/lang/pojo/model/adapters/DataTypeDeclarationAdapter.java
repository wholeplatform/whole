 ...
 * @generator Whole
 */
public class DataTypeDeclarationAdapter extends AbstractEntityAdapter implements
		DataTypeDeclaration {
	private static final long serialVersionUID = 1;

	public DataTypeDeclarationAdapter(IEntity implementor) {
		super(implementor);
	}

	public DataTypeDeclarationAdapter() {
	}
