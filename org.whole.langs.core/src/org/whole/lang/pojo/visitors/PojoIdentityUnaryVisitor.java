 ...
 * @generator Whole
 */
public class PojoIdentityUnaryVisitor<V extends IVisitor> extends
		AbstractUnaryVisitor<V> implements IPojoVisitor {
	public PojoIdentityUnaryVisitor() {
		super(null);
	}

	public PojoIdentityUnaryVisitor(IVisitor visitor1) {
		super(visitor1);
	}
