...
public class SteppersTemplateManager extends AbstractTemplateManager {
    ...
    private SteppersTemplateManager() {
        put("empty", new AbstractTemplateFactory<StepperApplication>() {

            public StepperApplication create() {
                return GenericEntityFactory.instance.create(SteppersEntityDescriptorEnum.StepperApplication);
            }
        });
    }
}
