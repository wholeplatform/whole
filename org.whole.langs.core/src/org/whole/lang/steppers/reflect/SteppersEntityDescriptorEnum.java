...
public class SteppersEntityDescriptorEnum extends EntityDescriptorEnum {
    ...
    public static final int ResultAction_ord = 2;
    public static final int Argument_ord = 3;
    public static final int Declarations_ord = 4;
    public static final int Declaration_ord = 5;
    public static final int Stepper_ord = 6;
    public static final int StepperDeclaration_ord = 7;
    public static final int StepperReference_ord = 8;
    public static final int Name_ord = 9;
    public static final int Target_ord = 10;
    public static final int CallFlow_ord = 11;
    public static final int Calls_ord = 12;
    public static final int CallBranch_ord = 13;
    public static final int ActionFlow_ord = 14;
    public static final int Actions_ord = 15;
    public static final int ActionBranch_ord = 16;
    public static final int GoalFlow_ord = 17;
    public static final int AndGoals_ord = 18;
    public static final int OrGoals_ord = 19;
    public static final int GoalBranch_ord = 20;
    public static final int ArgumentFlow_ord = 21;
    public static final int AndArgument_ord = 22;
    public static final int OrArgument_ord = 23;
    public static final int ArgumentBranch_ord = 24;
    ...
    protected void initEntityDescriptors() {
        putSimpleEntity(Expression_ord, "Expression", Expression.class, true, Stepper_ord, Scope_ord, Argument_ord, StepperReference_ord, ResultAction_ord, StepperDeclaration_ord);
        ...
        putSimpleEntity(CallFlow_ord, "CallFlow", CallFlow.class, true, Calls_ord, Stepper_ord, CallBranch_ord, StepperReference_ord, StepperDeclaration_ord);
        ...
        putSimpleEntity(ActionFlow_ord, "ActionFlow", ActionFlow.class, true, ActionBranch_ord, Stepper_ord, Actions_ord, StepperReference_ord, StepperDeclaration_ord);
        ...
        putSimpleEntity(GoalFlow_ord, "GoalFlow", GoalFlow.class, true, Target_ord, AndGoals_ord, GoalBranch_ord, StepperReference_ord, Stepper_ord, OrGoals_ord, StepperDeclaration_ord);
        ...
        putSimpleEntity(ArgumentFlow_ord, "ArgumentFlow", ArgumentFlow.class, true, AndArgument_ord, Target_ord, StepperReference_ord, Stepper_ord, ArgumentBranch_ord, OrArgument_ord, StepperDeclaration_ord);
