...
public class SteppersEntityDescriptorEnum extends EntityDescriptorEnum {
    ...
    public static final int Step_ord = 7;
    public static final int Choose_ord = 8;
    ...
    protected void initEntityDescriptors() {
        putSimpleEntity(Expression_ord, "Expression", Expression.class, true, Scope_ord, Argument_ord, Choose_ord, StepperReference_ord, Stepper_ord, Step_ord, ResultAction_ord);
