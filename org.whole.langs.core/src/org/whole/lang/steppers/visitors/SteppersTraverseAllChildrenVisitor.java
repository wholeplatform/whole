 ...
 *  @generator Whole
 */
public class SteppersTraverseAllChildrenVisitor extends SteppersIdentityUnaryVisitor<ISteppersVisitor> {

    public SteppersTraverseAllChildrenVisitor() {
        wSetVisitor1(this);
    }

    public SteppersTraverseAllChildrenVisitor(IVisitor visitor1) {
        super(visitor1);
    }
    ...
    public void visit(StepperApplication entity) {
        ...
        entity.getResults().accept(wGetVisitor1());
    }
