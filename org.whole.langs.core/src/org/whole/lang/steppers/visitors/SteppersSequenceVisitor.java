 ...
 *  @generator Whole
 */
public class SteppersSequenceVisitor extends AbstractBinaryVisitor<ISteppersVisitor> implements ISteppersVisitor {

    public SteppersSequenceVisitor(IVisitor visitor1, IVisitor visitor2) {
