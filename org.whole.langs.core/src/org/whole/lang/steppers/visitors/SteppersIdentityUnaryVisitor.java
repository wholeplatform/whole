 ...
 *  @generator Whole
 */
public class SteppersIdentityUnaryVisitor<V extends IVisitor>  extends AbstractUnaryVisitor<V> implements ISteppersVisitor {

    public SteppersIdentityUnaryVisitor() {
        super(null);
    }

    public SteppersIdentityUnaryVisitor(IVisitor visitor1) {
        super(visitor1);
    }
