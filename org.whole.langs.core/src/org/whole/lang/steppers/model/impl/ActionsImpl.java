 ...
 *  @generator Whole
 */
public class ActionsImpl extends AbstractListCompositeEntity<ActionFlow> implements Actions {
    ...
    public int wGetEntityOrd() {
        return SteppersEntityDescriptorEnum.Actions_ord;
    }

    public EntityDescriptor<Actions> wGetEntityDescriptor() {
        return SteppersEntityDescriptorEnum.Actions;
    }
}
