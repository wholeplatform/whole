 ...
 *  @generator Whole
 */
public class CallsImpl extends AbstractListCompositeEntity<CallFlow> implements Calls {
    ...
    public int wGetEntityOrd() {
        return SteppersEntityDescriptorEnum.Calls_ord;
    }

    public EntityDescriptor<Calls> wGetEntityDescriptor() {
        return SteppersEntityDescriptorEnum.Calls;
    }
}
