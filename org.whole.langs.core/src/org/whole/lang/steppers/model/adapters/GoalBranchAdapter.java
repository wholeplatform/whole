 ...
 *  @generator Whole
 */
public class GoalBranchAdapter extends AbstractEntityAdapter implements GoalBranch {
    private static final long serialVersionUID = 1;

    public GoalBranchAdapter(IEntity implementor) {
        super(implementor);
    }

    public GoalBranchAdapter() {
    }
    ...
    public GoalFlow getCalls() {
        return wGet(SteppersFeatureDescriptorEnum.calls).wGetAdapter(SteppersEntityDescriptorEnum.GoalFlow);
    }
    ...
    public GoalFlow getActions() {
        return wGet(SteppersFeatureDescriptorEnum.actions).wGetAdapter(SteppersEntityDescriptorEnum.GoalFlow);
    }
