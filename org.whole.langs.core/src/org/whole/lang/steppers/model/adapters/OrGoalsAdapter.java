 ...
 *  @generator Whole
 */
public class OrGoalsAdapter extends AbstractListEntityAdapter<GoalFlow> implements OrGoals {
    private static final long serialVersionUID = 1;

    public OrGoalsAdapter(IEntity implementor) {
        super(implementor);
    }

    public OrGoalsAdapter() {
    }
