 ...
 *  @generator Whole
 */
public class StepperAdapter extends AbstractEntityAdapter implements Stepper {
    private static final long serialVersionUID = 1;

    public StepperAdapter(IEntity implementor) {
        super(implementor);
    }

    public StepperAdapter() {
    }
    ...
    public EntityDescriptor<Stepper> wGetEntityDescriptor() {
        return SteppersEntityDescriptorEnum.Stepper;
    }
}
