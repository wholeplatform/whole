 ...
 *  @generator Whole
 */
public class CallBranchAdapter extends AbstractEntityAdapter implements CallBranch {
    private static final long serialVersionUID = 1;

    public CallBranchAdapter(IEntity implementor) {
        super(implementor);
    }

    public CallBranchAdapter() {
    }
