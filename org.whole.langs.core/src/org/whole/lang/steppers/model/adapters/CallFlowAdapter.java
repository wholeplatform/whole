 ...
 *  @generator Whole
 */
public class CallFlowAdapter extends AbstractEntityAdapter implements CallFlow {
    private static final long serialVersionUID = 1;

    public CallFlowAdapter(IEntity implementor) {
        super(implementor);
    }

    public CallFlowAdapter() {
    }
    ...
    public EntityDescriptor<CallFlow> wGetEntityDescriptor() {
        return SteppersEntityDescriptorEnum.CallFlow;
    }
}
