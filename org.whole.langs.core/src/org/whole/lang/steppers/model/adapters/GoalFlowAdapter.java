 ...
 *  @generator Whole
 */
public class GoalFlowAdapter extends AbstractEntityAdapter implements GoalFlow {
    private static final long serialVersionUID = 1;

    public GoalFlowAdapter(IEntity implementor) {
        super(implementor);
    }

    public GoalFlowAdapter() {
    }
    ...
    public EntityDescriptor<GoalFlow> wGetEntityDescriptor() {
        return SteppersEntityDescriptorEnum.GoalFlow;
    }
}
