 ...
 *  @generator Whole
 */
public class ArgumentBranchAdapter extends AbstractEntityAdapter implements ArgumentBranch {
    private static final long serialVersionUID = 1;

    public ArgumentBranchAdapter(IEntity implementor) {
        super(implementor);
    }

    public ArgumentBranchAdapter() {
    }
    ...
    public ArgumentFlow getCalls() {
        return wGet(SteppersFeatureDescriptorEnum.calls).wGetAdapter(SteppersEntityDescriptorEnum.ArgumentFlow);
    }
    ...
    public ArgumentFlow getActions() {
        return wGet(SteppersFeatureDescriptorEnum.actions).wGetAdapter(SteppersEntityDescriptorEnum.ArgumentFlow);
    }
