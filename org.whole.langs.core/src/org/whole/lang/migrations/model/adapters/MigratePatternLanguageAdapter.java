 ...
 *  @generator Whole
 */
public class MigratePatternLanguageAdapter extends AbstractEntityAdapter implements MigratePatternLanguage {
    private static final long serialVersionUID = 1;

    public MigratePatternLanguageAdapter(IEntity implementor) {
        super(implementor);
    }

    public MigratePatternLanguageAdapter() {
    }
    ...
    public URI getSource() {
        return wGet(MigrationsFeatureDescriptorEnum.source).wGetAdapter(MigrationsEntityDescriptorEnum.URI);
    }
    ...
    public URI getTarget() {
        return wGet(MigrationsFeatureDescriptorEnum.target).wGetAdapter(MigrationsEntityDescriptorEnum.URI);
    }
