 ...
 *  @generator Whole
 */
public class FeatureReferenceAdapter extends AbstractEntityAdapter implements FeatureReference {
    ...
    public FeatureStep getFeature() {
        return wGet(MigrationsFeatureDescriptorEnum.feature).wGetAdapter(MigrationsEntityDescriptorEnum.FeatureStep);
    }
