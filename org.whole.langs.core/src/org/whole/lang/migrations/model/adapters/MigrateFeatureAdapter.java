 ...
 *  @generator Whole
 */
public class MigrateFeatureAdapter extends AbstractEntityAdapter implements MigrateFeature {
    private static final long serialVersionUID = 1;

    public MigrateFeatureAdapter(IEntity implementor) {
        super(implementor);
    }

    public MigrateFeatureAdapter() {
    }
    ...
    public FeatureStep getTarget() {
        return wGet(MigrationsFeatureDescriptorEnum.target).wGetAdapter(MigrationsEntityDescriptorEnum.FeatureStep);
    }
