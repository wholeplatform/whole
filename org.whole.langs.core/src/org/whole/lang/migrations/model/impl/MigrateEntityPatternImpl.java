 ...
 *  @generator Whole
 */
public class MigrateEntityPatternImpl extends AbstractSimpleEntity implements MigrateEntityPattern {
    ...
    public int wGetEntityOrd() {
        return MigrationsEntityDescriptorEnum.MigrateEntityPattern_ord;
    }
    ...
    public void wSet(int index, IEntity value) {
        switch (index) {
            ...
            break;
            case 1 :
            setTarget(value.wGetAdapter(MigrationsEntityDescriptorEnum.Expression));
            break;
            default :
            throw new IllegalArgumentException();
        }
