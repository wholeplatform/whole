 ...
 *  @generator Whole
 */
public class MigrationsTraverseAllVisitor extends MigrationsIdentityUnaryVisitor<IMigrationsVisitor> {

    public MigrationsTraverseAllVisitor() {
        wSetVisitor1(this);
    }

    public MigrationsTraverseAllVisitor(IVisitor visitor1) {
        super(visitor1);
    }
