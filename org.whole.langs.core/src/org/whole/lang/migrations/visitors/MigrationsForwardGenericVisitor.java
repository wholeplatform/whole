 ...
 *  @generator Whole
 */
public class MigrationsForwardGenericVisitor extends AbstractUnaryVisitor<IVisitor> implements IMigrationsVisitor {

    public MigrationsForwardGenericVisitor(IVisitor visitor1) {
        super(visitor1);
    }
