 ...
 * @generator Whole
 */
public class FramesSequenceVisitor extends
		AbstractBinaryVisitor<IFramesVisitor> implements IFramesVisitor {
	public FramesSequenceVisitor(IVisitor visitor1, IVisitor visitor2) {
