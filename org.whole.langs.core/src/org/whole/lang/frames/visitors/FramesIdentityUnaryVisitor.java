 ...
 * @generator Whole
 */
public class FramesIdentityUnaryVisitor<V extends IVisitor> extends
		AbstractUnaryVisitor<V> implements IFramesVisitor {
	public FramesIdentityUnaryVisitor() {
		super(null);
	}

	public FramesIdentityUnaryVisitor(IVisitor visitor1) {
		super(visitor1);
	}
