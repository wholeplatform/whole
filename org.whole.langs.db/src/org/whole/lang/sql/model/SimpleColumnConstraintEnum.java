 ...
 * @generator Whole
 */
public class SimpleColumnConstraintEnum extends
		EnumType<SimpleColumnConstraintEnum.Value> {
	public static final int NOT_NULL_ord = 0;
	public static final int PRIMARY_KEY_ord = 1;
	public static final int UNIQUE_ord = 2;
