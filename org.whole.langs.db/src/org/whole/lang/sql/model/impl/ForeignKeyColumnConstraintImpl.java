 ...
 * @generator Whole
 */
public class ForeignKeyColumnConstraintImpl extends AbstractSimpleEntity implements ForeignKeyColumnConstraint {
	...
	public ColumnName getForeignColumnName() {
		return notifyRequested(SQLFeatureDescriptorEnum.foreignColumnName, foreignColumnName);
	}

	public void setForeignColumnName(ColumnName foreignColumnName) {
		notifyChanged(SQLFeatureDescriptorEnum.foreignColumnName, this.foreignColumnName,
	...
	public void wSet(int index, IEntity value) {
		...
		case 0:
			...
			break;
		case 1:
			setForeignColumnName(value.wGetAdapter(SQLEntityDescriptorEnum.ColumnName));
			break;
		default:
			throw new IllegalArgumentException();
		}
