 ...
 * @generator Whole
 */
public class NotBetweenImpl extends AbstractSimpleEntity implements NotBetween {
	...
	public int wGetEntityOrd() {
		return SQLEntityDescriptorEnum.NotBetween_ord;
	}
	...
	public SQLExpression getLowerExpression() {
		return notifyRequested(SQLFeatureDescriptorEnum.lowerExpression, lowerExpression);
	}

	public void setLowerExpression(SQLExpression lowerExpression) {
		notifyChanged(SQLFeatureDescriptorEnum.lowerExpression, this.lowerExpression,
	...
	public SQLExpression getUpperExpression() {
		return notifyRequested(SQLFeatureDescriptorEnum.upperExpression, upperExpression);
	}

	public void setUpperExpression(SQLExpression upperExpression) {
		notifyChanged(SQLFeatureDescriptorEnum.upperExpression, this.upperExpression,
	...
	public void wSet(int index, IEntity value) {
		...
		case 0:
			...
			break;
		case 1:
			setLowerExpression(value.wGetAdapter(SQLEntityDescriptorEnum.SQLExpression));
			break;
		case 2:
			setUpperExpression(value.wGetAdapter(SQLEntityDescriptorEnum.SQLExpression));
			break;
		default:
			throw new IllegalArgumentException();
		}
