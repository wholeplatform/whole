 ...
 * @generator Whole
 */
public class BooleanOperatorImpl extends AbstractDataEntity implements BooleanOperator {
	private static final long serialVersionUID = 1;
	private org.whole.lang.sql.model.BooleanOperatorEnum.Value value;
	...
	public int wGetEntityOrd() {
		return SQLEntityDescriptorEnum.BooleanOperator_ord;
	}
	...
	public void wSetValue(Object value) {
		setValue((org.whole.lang.sql.model.BooleanOperatorEnum.Value) value);
	}
	...
	public void wSetValue(String value) {
		try {
			setValue(BooleanOperatorEnum.instance.valueOf(value));
