 ...
 * @generator Whole
 */
public class BinaryExpressionImpl extends AbstractSimpleEntity implements BinaryExpression {
	...
	public void wSet(int index, IEntity value) {
		...
		case 0:
			...
			break;
		case 1:
			setOperator(value.wGetAdapter(SQLEntityDescriptorEnum.BinaryOperator));
			break;
		case 2:
