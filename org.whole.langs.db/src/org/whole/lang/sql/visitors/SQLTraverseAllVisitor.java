 ...
 * @generator Whole
 */
public class SQLTraverseAllVisitor extends SQLIdentityUnaryVisitor<ISQLVisitor> {
	public SQLTraverseAllVisitor() {
		wSetVisitor1(this);
	}

	public SQLTraverseAllVisitor(IVisitor visitor1) {
		super(visitor1);
	}
