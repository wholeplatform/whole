...
public class SQLEntityDescriptorEnum extends EntityDescriptorEnum {
	...
	public static final int ConstraintName_ord = 62;
	public static final int CaseExpression_ord = 63;
	public static final int WhenClauses_ord = 64;
	public static final int WhenClause_ord = 65;
	public static final int In_ord = 66;
	public static final int NotIn_ord = 67;
	public static final int InPredicate_ord = 68;
	public static final int Subquery_ord = 69;
	public static final int InValueList_ord = 70;
	public static final int BinaryExpression_ord = 71;
	public static final int BinaryOperator_ord = 72;
	public static final int BooleanExpression_ord = 73;
	public static final int BooleanBinaryExpression_ord = 74;
	public static final int BooleanOperator_ord = 75;
	public static final int FunctionExpression_ord = 76;
	public static final int FunctionName_ord = 77;
	public static final int OrderByColumnExpressions_ord = 78;
	public static final int OrderByColumnExpression_ord = 79;
	public static final int OrderType_ord = 80;
	public static final int SetClauses_ord = 81;
	public static final int SetClause_ord = 82;
	public static final int DeclarationOrConstraints_ord = 83;
	public static final int DeclarationOrConstraint_ord = 84;
	public static final int ColumnDeclaration_ord = 85;
	public static final int ColumnType_ord = 86;
	public static final int Type_ord = 87;
	public static final int ColumnConstraints_ord = 88;
	public static final int ColumnConstraint_ord = 89;
	public static final int SimpleColumnConstraint_ord = 90;
	public static final int ForeignKeyColumnConstraint_ord = 91;
	public static final int TableConstraint_ord = 92;
	public static final int UniqueTableConstraint_ord = 93;
	public static final int PrimaryKeyTableConstraint_ord = 94;
	public static final int ForeignKeyTableConstraint_ord = 95;
	public static final int Match_ord = 96;
	public static final int Action_ord = 97;
	public static final int Deferrable_ord = 98;
	public static final int DeferCheck_ord = 99;
	public static final int StoredProcedures_ord = 100;
	public static final int StoredProcedure_ord = 101;
	public static final int ProcedureDeclaration_ord = 102;
	public static final int ProcedureDeclarations_ord = 103;
	public static final int ProcedureStatements_ord = 104;
	public static final int DeclareCursor_ord = 105;
	public static final int SimpleVariableDeclaration_ord = 106;
	public static final int VariableDeclaration_ord = 107;
	public static final int Reference_ord = 108;
	public static final int ReferenceType_ord = 109;
	public static final int ArrayExpr_ord = 110;
	public static final int Name_ord = 111;
	...
	public static final EntityDescriptor<Update> Update = (EntityDescriptor<Update>) instance.valueOf(Update_ord);
	public static final EntityDescriptor<Create> Create = (EntityDescriptor<Create>) instance.valueOf(Create_ord);
	public static final EntityDescriptor<Delete> Delete = (EntityDescriptor<Delete>) instance.valueOf(Delete_ord);
	public static final EntityDescriptor<Drop> Drop = (EntityDescriptor<Drop>) instance.valueOf(Drop_ord);
	...
	public static final EntityDescriptor<Foreach> Foreach = (EntityDescriptor<Foreach>) instance.valueOf(Foreach_ord);
	...
	public static final EntityDescriptor<Alias> Alias = (EntityDescriptor<Alias>) instance.valueOf(Alias_ord);
	...
	public static final EntityDescriptor<Between> Between = (EntityDescriptor<Between>) instance.valueOf(Between_ord);
	public static final EntityDescriptor<NotBetween> NotBetween = (EntityDescriptor<NotBetween>) instance
			.valueOf(NotBetween_ord);
	public static final EntityDescriptor<Is> Is = (EntityDescriptor<Is>) instance.valueOf(Is_ord);
	public static final EntityDescriptor<IsType> IsType = (EntityDescriptor<IsType>) instance.valueOf(IsType_ord);
	public static final EntityDescriptor<Values> Values = (EntityDescriptor<Values>) instance.valueOf(Values_ord);
	...
	public static final EntityDescriptor<ConstraintName> ConstraintName = (EntityDescriptor<ConstraintName>) instance
			.valueOf(ConstraintName_ord);
	...
	public static final EntityDescriptor<Match> Match = (EntityDescriptor<Match>) instance.valueOf(Match_ord);
	public static final EntityDescriptor<Action> Action = (EntityDescriptor<Action>) instance.valueOf(Action_ord);
	...
	protected void initEntityDescriptors() {
		putCompositeEntity(SQLStatements_ord, "SQLStatements", SQLStatements.class, false, SQLStatement_ord, true,
				false);
		putSimpleEntity(SelectSQLStatement_ord, "SelectSQLStatement", SelectSQLStatement.class, true, Select_ord,
				UnionSelect_ord);
		putSimpleEntity(SQLStatement_ord, "SQLStatement", SQLStatement.class, true, Delete_ord, AlterTable_ord,
				SelectSQLStatement_ord, UnionSelect_ord, Truncate_ord, Insert_ord, Update_ord, Drop_ord,
				CreateIndex_ord, StoredProcedures_ord, InsertFromSelect_ord, Create_ord, Select_ord, Foreach_ord,
				DropIndex_ord);
		putSimpleEntity(SQLExpression_ord, "SQLExpression", SQLExpression.class, true, WhenClauses_ord,
				ConstraintName_ord, In_ord, NotIn_ord, BooleanBinaryExpression_ord, Is_ord, Subquery_ord,
				CaseExpression_ord, IndexName_ord, BooleanExpression_ord, NullValue_ord, FunctionExpression_ord,
				BinaryExpression_ord, ClobValue_ord, SmallIntValue_ord, DateValue_ord, BooleanValue_ord,
				TimestampValue_ord, StringValue_ord, IntValue_ord, TimeValue_ord, RawValue_ord, BigIntValue_ord,
				ParenthesizedExpression_ord, RealValue_ord, Between_ord, BinaryValue_ord, InPredicate_ord,
				BlobValue_ord, TableName_ord, ColumnName_ord, DecimalValue_ord, DoubleValue_ord, NotBetween_ord,
				InValueList_ord, ArrayValue_ord, TinyIntValue_ord);
		putSimpleEntity(FromClause_ord, "FromClause", FromClause.class, true, RightOuterJoinFromClause_ord,
				InnerJoinFromClause_ord, SimpleFromClause_ord, LeftOuterJoinFromClause_ord);
		putSimpleEntity(Select_ord, "Select", Select.class, false)
				.withFeature(SQLFeatureDescriptorEnum.selectType, SelectType_ord, true, false, false, false, false)
				.withFeature(SQLFeatureDescriptorEnum.columnExprs, ColumnExpressions_ord)
				.withFeature(SQLFeatureDescriptorEnum.fromClauses, FromClauses_ord, true, false, false, false, false)
				.withFeature(SQLFeatureDescriptorEnum.whereExpr, SQLExpression_ord, true, false, false, false, false)
				.withFeature(SQLFeatureDescriptorEnum.groupByExprs, SQLExpressions_ord, true, false, false, false,
						false)
				.withFeature(SQLFeatureDescriptorEnum.havingExpr, SQLExpression_ord, true, false, false, false, false)
				.withFeature(SQLFeatureDescriptorEnum.orderByColumnExprs, OrderByColumnExpressions_ord, true, false,
						false, false, false);
		putSimpleEntity(UnionSelect_ord, "UnionSelect", UnionSelect.class, false)
				.withFeature(SQLFeatureDescriptorEnum.simpleSelect, Select_ord)
				.withFeature(SQLFeatureDescriptorEnum.unionSelectStatement, SelectSQLStatement_ord);
		putSimpleEntity(Insert_ord, "Insert", Insert.class, false)
				.withFeature(SQLFeatureDescriptorEnum.tableName, TableName_ord)
				.withFeature(SQLFeatureDescriptorEnum.columnNames, ColumnNames_ord, true, false, false, false, false)
				.withFeature(SQLFeatureDescriptorEnum.values, Values_ord);
		putSimpleEntity(InsertFromSelect_ord, "InsertFromSelect", InsertFromSelect.class, false)
				.withFeature(SQLFeatureDescriptorEnum.tableName, TableName_ord)
				.withFeature(SQLFeatureDescriptorEnum.columnNames, ColumnNames_ord, true, false, false, false, false)
				.withFeature(SQLFeatureDescriptorEnum.select, SelectSQLStatement_ord);
		putSimpleEntity(Update_ord, "Update", Update.class, false)
				.withFeature(SQLFeatureDescriptorEnum.tableName, TableName_ord)
				.withFeature(SQLFeatureDescriptorEnum.setClauses, SetClauses_ord)
				.withFeature(SQLFeatureDescriptorEnum.fromClauses, FromClauses_ord, true, false, false, false, false)
				.withFeature(SQLFeatureDescriptorEnum.whereExpr, SQLExpression_ord, true, false, false, false, false)
				.withFeature(SQLFeatureDescriptorEnum.limit, IntValue_ord, true, false, false, false, false);
		putSimpleEntity(Create_ord, "Create", Create.class, false)
				.withFeature(SQLFeatureDescriptorEnum.tableName, TableName_ord)
				.withFeature(SQLFeatureDescriptorEnum.declarationOrConstraints, DeclarationOrConstraints_ord);
		putSimpleEntity(Delete_ord, "Delete", Delete.class, false)
				.withFeature(SQLFeatureDescriptorEnum.tableName, TableName_ord)
				.withFeature(SQLFeatureDescriptorEnum.whereExpr, SQLExpression_ord, true, false, false, false, false)
				.withFeature(SQLFeatureDescriptorEnum.limit, IntValue_ord, true, false, false, false, false);
		putSimpleEntity(Drop_ord, "Drop", Drop.class, false).withFeature(SQLFeatureDescriptorEnum.tableName,
				TableName_ord);
		putSimpleEntity(Truncate_ord, "Truncate", Truncate.class, false).withFeature(SQLFeatureDescriptorEnum.tableName,
				TableName_ord);
		...
		putSimpleEntity(CreateIndex_ord, "CreateIndex", CreateIndex.class, false)
				.withFeature(SQLFeatureDescriptorEnum.unique, UniqueIndex_ord, true, false, false, false, false)
				.withFeature(SQLFeatureDescriptorEnum.indexName, IndexName_ord)
				.withFeature(SQLFeatureDescriptorEnum.tableName, TableName_ord)
				.withFeature(SQLFeatureDescriptorEnum.indexDeclarations, IndexDeclarations_ord);
		putSimpleEntity(UniqueIndex_ord, "UniqueIndex", UniqueIndex.class, false);
		putCompositeEntity(IndexDeclarations_ord, "IndexDeclarations", IndexDeclarations.class, false,
				IndexDeclaration_ord, false, true);
		putSimpleEntity(IndexDeclaration_ord, "IndexDeclaration", IndexDeclaration.class, false)
				.withFeature(SQLFeatureDescriptorEnum.columnName, ColumnName_ord)
				.withFeature(SQLFeatureDescriptorEnum.orderType, OrderType_ord, true, false, false, false, false)
				.withFeature(SQLFeatureDescriptorEnum.nullOrderType, NullOrderType_ord, true, false, false, false,
						false);
		putDataEntity(NullOrderType_ord, "NullOrderType", NullOrderType.class, false, NullOrderTypeEnum.Value.class);
		...
		putSimpleEntity(Foreach_ord, "Foreach", Foreach.class, false)
				...
				.withFeature(SQLFeatureDescriptorEnum.trueBody, SQLStatement_ord);
		putSimpleEntity(AlterAction_ord, "AlterAction", AlterAction.class, true, AddAction_ord);
		putSimpleEntity(AddAction_ord, "AddAction", AddAction.class, false)
				.withFeature(SQLFeatureDescriptorEnum.declarationOrConstraint, DeclarationOrConstraint_ord);
		putDataEntity(SelectType_ord, "SelectType", SelectType.class, false, SelectTypeEnum.Value.class);
		putCompositeEntity(ColumnNames_ord, "ColumnNames", ColumnNames.class, false, ColumnName_ord, true, true);
		putCompositeEntity(ColumnExpressions_ord, "ColumnExpressions", ColumnExpressions.class, false,
				ColumnExpression_ord, true, true);
		putSimpleEntity(ColumnExpression_ord, "ColumnExpression", ColumnExpression.class, false)
				.withFeature(SQLFeatureDescriptorEnum.expression, SQLExpression_ord)
				.withFeature(SQLFeatureDescriptorEnum.alias, Alias_ord, true, false, false, false, false);
		putDataEntity(Alias_ord, "Alias", Alias.class, false, String.class);
		putCompositeEntity(FromClauses_ord, "FromClauses", FromClauses.class, false, FromClause_ord, true, true);
		putDataEntity(SimpleFromClause_ord, "SimpleFromClause", SimpleFromClause.class, false, String.class);
		putSimpleEntity(InnerJoinFromClause_ord, "InnerJoinFromClause", InnerJoinFromClause.class, false)
				.withFeature(SQLFeatureDescriptorEnum.tableName, TableName_ord)
				.withFeature(SQLFeatureDescriptorEnum.innerTable, TableName_ord)
				.withFeature(SQLFeatureDescriptorEnum.onExpression, SQLExpression_ord);
		putSimpleEntity(LeftOuterJoinFromClause_ord, "LeftOuterJoinFromClause", LeftOuterJoinFromClause.class, false)
				.withFeature(SQLFeatureDescriptorEnum.tableName, TableName_ord)
				.withFeature(SQLFeatureDescriptorEnum.outerTable, TableName_ord)
				.withFeature(SQLFeatureDescriptorEnum.onExpression, SQLExpression_ord);
		putSimpleEntity(RightOuterJoinFromClause_ord, "RightOuterJoinFromClause", RightOuterJoinFromClause.class, false)
				.withFeature(SQLFeatureDescriptorEnum.tableName, TableName_ord)
				.withFeature(SQLFeatureDescriptorEnum.outerTable, TableName_ord)
				.withFeature(SQLFeatureDescriptorEnum.onExpression, SQLExpression_ord);
		putSimpleEntity(Between_ord, "Between", Between.class, false)
				.withFeature(SQLFeatureDescriptorEnum.expression, SQLExpression_ord)
				.withFeature(SQLFeatureDescriptorEnum.lowerExpression, SQLExpression_ord)
				.withFeature(SQLFeatureDescriptorEnum.upperExpression, SQLExpression_ord);
		putSimpleEntity(NotBetween_ord, "NotBetween", NotBetween.class, false)
				.withFeature(SQLFeatureDescriptorEnum.expression, SQLExpression_ord)
				.withFeature(SQLFeatureDescriptorEnum.lowerExpression, SQLExpression_ord)
				.withFeature(SQLFeatureDescriptorEnum.upperExpression, SQLExpression_ord);
		putSimpleEntity(Is_ord, "Is", Is.class, false)
				.withFeature(SQLFeatureDescriptorEnum.expression, SQLExpression_ord)
				.withFeature(SQLFeatureDescriptorEnum.type, IsType_ord);
		putDataEntity(IsType_ord, "IsType", IsType.class, false, IsTypeEnum.Value.class);
		putCompositeEntity(Values_ord, "Values", Values.class, false, SQLExpressions_ord, true, false);
		putSimpleEntity(ParenthesizedExpression_ord, "ParenthesizedExpression", ParenthesizedExpression.class, false)
				.withFeature(SQLFeatureDescriptorEnum.expression, SQLExpression_ord);
		putCompositeEntity(SQLExpressions_ord, "SQLExpressions", SQLExpressions.class, false, SQLExpression_ord, true,
				false);
		putSimpleEntity(NullValue_ord, "NullValue", NullValue.class, false);
		putDataEntity(ArrayValue_ord, "ArrayValue", ArrayValue.class, false, Object.class);
		putDataEntity(BooleanValue_ord, "BooleanValue", BooleanValue.class, false, boolean.class);
		putDataEntity(TinyIntValue_ord, "TinyIntValue", TinyIntValue.class, false, byte.class);
		putDataEntity(SmallIntValue_ord, "SmallIntValue", SmallIntValue.class, false, short.class);
		putDataEntity(IntValue_ord, "IntValue", IntValue.class, false, int.class);
		putDataEntity(BigIntValue_ord, "BigIntValue", BigIntValue.class, false, long.class);
		putDataEntity(DoubleValue_ord, "DoubleValue", DoubleValue.class, false, double.class);
		putDataEntity(RealValue_ord, "RealValue", RealValue.class, false, float.class);
		putDataEntity(DecimalValue_ord, "DecimalValue", DecimalValue.class, false, java.math.BigDecimal.class);
		putDataEntity(StringValue_ord, "StringValue", StringValue.class, false, String.class);
		putDataEntity(BinaryValue_ord, "BinaryValue", BinaryValue.class, false, Object.class);
		putDataEntity(DateValue_ord, "DateValue", DateValue.class, false, java.sql.Date.class);
		putDataEntity(TimeValue_ord, "TimeValue", TimeValue.class, false, java.sql.Time.class);
		putDataEntity(TimestampValue_ord, "TimestampValue", TimestampValue.class, false, java.sql.Timestamp.class);
		putDataEntity(BlobValue_ord, "BlobValue", BlobValue.class, false, java.sql.Blob.class);
		putDataEntity(ClobValue_ord, "ClobValue", ClobValue.class, false, java.sql.Clob.class);
		putDataEntity(RawValue_ord, "RawValue", RawValue.class, false, Object.class);
		putDataEntity(TableName_ord, "TableName", TableName.class, false, String.class);
		putDataEntity(ColumnName_ord, "ColumnName", ColumnName.class, false, String.class);
		putDataEntity(IndexName_ord, "IndexName", IndexName.class, false, String.class);
		putDataEntity(ConstraintName_ord, "ConstraintName", ConstraintName.class, false, String.class);
		putSimpleEntity(CaseExpression_ord, "CaseExpression", CaseExpression.class, false)
				.withFeature(SQLFeatureDescriptorEnum.whenClauses, WhenClauses_ord)
				.withFeature(SQLFeatureDescriptorEnum.elseClause, SQLExpression_ord, true, false, false, false, false);
		putCompositeEntity(WhenClauses_ord, "WhenClauses", WhenClauses.class, false, WhenClause_ord, true, false);
		putSimpleEntity(WhenClause_ord, "WhenClause", WhenClause.class, false)
				.withFeature(SQLFeatureDescriptorEnum.condition, BooleanExpression_ord)
				.withFeature(SQLFeatureDescriptorEnum.result, SQLExpression_ord);
		putSimpleEntity(In_ord, "In", In.class, false).withFeature(SQLFeatureDescriptorEnum.leftExpr, SQLExpression_ord)
				.withFeature(SQLFeatureDescriptorEnum.inPredicate, InPredicate_ord);
		putSimpleEntity(NotIn_ord, "NotIn", NotIn.class, false)
				.withFeature(SQLFeatureDescriptorEnum.leftExpr, SQLExpression_ord)
				.withFeature(SQLFeatureDescriptorEnum.inPredicate, InPredicate_ord);
		putSimpleEntity(InPredicate_ord, "InPredicate", InPredicate.class, true, WhenClauses_ord, Subquery_ord,
				InValueList_ord);
		putSimpleEntity(Subquery_ord, "Subquery", Subquery.class, false).withFeature(SQLFeatureDescriptorEnum.query,
				SelectSQLStatement_ord);
		putCompositeEntity(InValueList_ord, "InValueList", InValueList.class, false, SQLExpression_ord, true, false);
		putSimpleEntity(BinaryExpression_ord, "BinaryExpression", BinaryExpression.class, false)
				.withFeature(SQLFeatureDescriptorEnum.leftExpr, SQLExpression_ord)
				.withFeature(SQLFeatureDescriptorEnum.operator, BinaryOperator_ord)
				.withFeature(SQLFeatureDescriptorEnum.rightExpr, SQLExpression_ord);
		putDataEntity(BinaryOperator_ord, "BinaryOperator", BinaryOperator.class, false,
				BinaryOperatorEnum.Value.class);
		putSimpleEntity(BooleanExpression_ord, "BooleanExpression", BooleanExpression.class, true, In_ord,
				NotBetween_ord, Between_ord, BooleanValue_ord, NotIn_ord, BooleanBinaryExpression_ord, Is_ord);
		putSimpleEntity(BooleanBinaryExpression_ord, "BooleanBinaryExpression", BooleanBinaryExpression.class, false)
				.withFeature(SQLFeatureDescriptorEnum.leftExpr, SQLExpression_ord)
				.withFeature(SQLFeatureDescriptorEnum.operator, BooleanOperator_ord)
				.withFeature(SQLFeatureDescriptorEnum.rightExpr, SQLExpression_ord);
		putDataEntity(BooleanOperator_ord, "BooleanOperator", BooleanOperator.class, false,
				BooleanOperatorEnum.Value.class);
		putSimpleEntity(FunctionExpression_ord, "FunctionExpression", FunctionExpression.class, false)
				.withFeature(SQLFeatureDescriptorEnum.functionName, FunctionName_ord)
				.withFeature(SQLFeatureDescriptorEnum.params, SQLExpressions_ord);
		putDataEntity(FunctionName_ord, "FunctionName", FunctionName.class, false, String.class);
		putCompositeEntity(OrderByColumnExpressions_ord, "OrderByColumnExpressions", OrderByColumnExpressions.class,
				false, OrderByColumnExpression_ord, true, false);
		putSimpleEntity(OrderByColumnExpression_ord, "OrderByColumnExpression", OrderByColumnExpression.class, false)
				.withFeature(SQLFeatureDescriptorEnum.expression, SQLExpression_ord)
				.withFeature(SQLFeatureDescriptorEnum.orderType, OrderType_ord, true, false, false, false, false);
		putDataEntity(OrderType_ord, "OrderType", OrderType.class, false, OrderTypeEnum.Value.class);
		putCompositeEntity(SetClauses_ord, "SetClauses", SetClauses.class, false, SetClause_ord, false, true);
		putSimpleEntity(SetClause_ord, "SetClause", SetClause.class, false)
				.withFeature(SQLFeatureDescriptorEnum.columnName, ColumnName_ord, false, true, false, false, false)
				.withFeature(SQLFeatureDescriptorEnum.expression, SQLExpression_ord);
		putCompositeEntity(DeclarationOrConstraints_ord, "DeclarationOrConstraints", DeclarationOrConstraints.class,
				false, DeclarationOrConstraint_ord, false, true);
		putSimpleEntity(DeclarationOrConstraint_ord, "DeclarationOrConstraint", DeclarationOrConstraint.class, true,
				PrimaryKeyTableConstraint_ord, ForeignKeyTableConstraint_ord, UniqueTableConstraint_ord,
				ColumnDeclaration_ord, TableConstraint_ord);
		putSimpleEntity(ColumnDeclaration_ord, "ColumnDeclaration", ColumnDeclaration.class, false)
				.withFeature(SQLFeatureDescriptorEnum.columnName, ColumnName_ord)
				.withFeature(SQLFeatureDescriptorEnum.columnType, ColumnType_ord)
				.withFeature(SQLFeatureDescriptorEnum.columnConstraints, ColumnConstraints_ord, true, false, false,
						false, false);
		putSimpleEntity(ColumnType_ord, "ColumnType", ColumnType.class, false)
				.withFeature(SQLFeatureDescriptorEnum.type, Type_ord)
				.withFeature(SQLFeatureDescriptorEnum.size, IntValue_ord, true, false, false, false, false)
				.withFeature(SQLFeatureDescriptorEnum.precision, IntValue_ord, true, false, false, false, false);
		putDataEntity(Type_ord, "Type", Type.class, false, String.class);
		putCompositeEntity(ColumnConstraints_ord, "ColumnConstraints", ColumnConstraints.class, false,
				ColumnConstraint_ord, false, true);
		putSimpleEntity(ColumnConstraint_ord, "ColumnConstraint", ColumnConstraint.class, true,
				ForeignKeyColumnConstraint_ord, SimpleColumnConstraint_ord);
		putDataEntity(SimpleColumnConstraint_ord, "SimpleColumnConstraint", SimpleColumnConstraint.class, false,
				SimpleColumnConstraintEnum.Value.class);
		putSimpleEntity(ForeignKeyColumnConstraint_ord, "ForeignKeyColumnConstraint", ForeignKeyColumnConstraint.class,
				false).withFeature(SQLFeatureDescriptorEnum.foreignTableName, TableName_ord).withFeature(
						SQLFeatureDescriptorEnum.foreignColumnName, ColumnName_ord, true, false, false, false, false);
		putSimpleEntity(TableConstraint_ord, "TableConstraint", TableConstraint.class, true,
				PrimaryKeyTableConstraint_ord, ForeignKeyTableConstraint_ord, UniqueTableConstraint_ord)
						.withFeature(SQLFeatureDescriptorEnum.constraintName, ConstraintName_ord, true, true, false,
								false, false)
						.withFeature(SQLFeatureDescriptorEnum.columnNames, ColumnNames_ord);
		putSimpleEntity(UniqueTableConstraint_ord, "UniqueTableConstraint", UniqueTableConstraint.class, false)
				.withFeature(SQLFeatureDescriptorEnum.constraintName, ConstraintName_ord, true, true, false, false,
						false)
				.withFeature(SQLFeatureDescriptorEnum.columnNames, ColumnNames_ord);
		putSimpleEntity(
				PrimaryKeyTableConstraint_ord, "PrimaryKeyTableConstraint", PrimaryKeyTableConstraint.class, false)
						.withFeature(SQLFeatureDescriptorEnum.constraintName, ConstraintName_ord, true, true, false,
								false, false)
						.withFeature(SQLFeatureDescriptorEnum.columnNames, ColumnNames_ord);
		putSimpleEntity(ForeignKeyTableConstraint_ord, "ForeignKeyTableConstraint", ForeignKeyTableConstraint.class,
				false).withFeature(SQLFeatureDescriptorEnum.constraintName, ConstraintName_ord, true, true, false,
						false, false).withFeature(SQLFeatureDescriptorEnum.columnNames, ColumnNames_ord)
						.withFeature(SQLFeatureDescriptorEnum.foreignTableName, TableName_ord)
						.withFeature(SQLFeatureDescriptorEnum.foreignColumnNames, ColumnNames_ord, true, false, false,
								false, false)
						.withFeature(SQLFeatureDescriptorEnum.match, Match_ord, true, false, false, false, false)
						.withFeature(SQLFeatureDescriptorEnum.onDelete, Action_ord, true, false, false, false, false)
						.withFeature(SQLFeatureDescriptorEnum.onUpdate, Action_ord, true, false, false, false, false)
						.withFeature(SQLFeatureDescriptorEnum.deferrable, Deferrable_ord, true, false, false, false,
								false)
						.withFeature(SQLFeatureDescriptorEnum.deferCheck, DeferCheck_ord, true, false, false, false,
								false);
		putDataEntity(Match_ord, "Match", Match.class, false, MatchEnum.Value.class);
		putDataEntity(Action_ord, "Action", Action.class, false, ActionEnum.Value.class);
		putDataEntity(Deferrable_ord, "Deferrable", Deferrable.class, false, DeferrableEnum.Value.class);
		putDataEntity(DeferCheck_ord, "DeferCheck", DeferCheck.class, false, DeferCheckEnum.Value.class);
		putCompositeEntity(StoredProcedures_ord, "StoredProcedures", StoredProcedures.class, false, StoredProcedure_ord,
				false, true);
		putSimpleEntity(StoredProcedure_ord, "StoredProcedure", StoredProcedure.class, false)
				.withFeature(SQLFeatureDescriptorEnum.name, Name_ord, false, true, false, false, false)
				.withFeature(SQLFeatureDescriptorEnum.procedureDeclarations, ProcedureDeclarations_ord, true, false,
						false, false, false)
				.withFeature(SQLFeatureDescriptorEnum.procedureStatements, ProcedureStatements_ord);
		putSimpleEntity(ProcedureDeclaration_ord, "ProcedureDeclaration", ProcedureDeclaration.class, true,
				DeclareCursor_ord, VariableDeclaration_ord, SimpleVariableDeclaration_ord);
		putCompositeEntity(ProcedureDeclarations_ord, "ProcedureDeclarations", ProcedureDeclarations.class, false,
				ProcedureDeclaration_ord, false, true);
		putCompositeEntity(ProcedureStatements_ord, "ProcedureStatements", ProcedureStatements.class, false,
				SQLStatement_ord, false, true);
		putSimpleEntity(DeclareCursor_ord, "DeclareCursor", DeclareCursor.class, false)
				.withFeature(SQLFeatureDescriptorEnum.name, Name_ord)
				.withFeature(SQLFeatureDescriptorEnum.sqlStatement, SQLStatement_ord);
		putSimpleEntity(SimpleVariableDeclaration_ord, "SimpleVariableDeclaration", SimpleVariableDeclaration.class,
				false).withFeature(SQLFeatureDescriptorEnum.name, Name_ord).withFeature(SQLFeatureDescriptorEnum.type,
						Type_ord);
		putSimpleEntity(VariableDeclaration_ord, "VariableDeclaration", VariableDeclaration.class, false)
				...
				.withFeature(SQLFeatureDescriptorEnum.referenceType, ReferenceType_ord);
		putDataEntity(Reference_ord, "Reference", Reference.class, false, String.class);
		putDataEntity(ReferenceType_ord, "ReferenceType", ReferenceType.class, false, ReferenceTypeEnum.Value.class);
		putDataEntity(ArrayExpr_ord, "ArrayExpr", ArrayExpr.class, false, String.class);
