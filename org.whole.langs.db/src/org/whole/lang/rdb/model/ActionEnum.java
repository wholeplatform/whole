...
public class ActionEnum extends EnumType<ActionEnum.Value> {
	public static final int RESTRICT_ord = 0;
	public static final int CASCADE_ord = 1;
	public static final int SET_NULL_ord = 2;
	public static final int SET_DEFAULT_ord = 3;
