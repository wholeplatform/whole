 ...
 */
public class TraverseAllVisitorBuilder extends AbstractVisitorCompilationUnitBuilder {
	public TraverseAllVisitorBuilder(LanguageGenerator generator) {
		super(generator);

		addClassDeclaration(generator.traverseAllVisitorName(),
		...
		addFactoryMethod("traverseAll", params);
	}
