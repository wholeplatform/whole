 ...
 */
public class TraverseAllChildrenVisitorBuilder extends AbstractVisitorCompilationUnitBuilder {
	public TraverseAllChildrenVisitorBuilder(LanguageGenerator generator) {
		super(generator);

		addClassDeclaration(generator.traverseAllChildrenVisitorName(),
		...
		addFactoryMethod("traverseAllChildren", params);
	}
