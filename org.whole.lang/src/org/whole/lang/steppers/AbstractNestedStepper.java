 ...
 */
public abstract class AbstractNestedStepper extends AbstractExecutableSteppingEvaluator {
	...
	public IExecutable clone(ICloneContext cc) {
		...
		AbstractNestedStepper stepper = (AbstractNestedStepper) super.clone(cc);
