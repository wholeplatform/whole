...
public abstract class AbstractDecorationManager implements IDecorationManager {
	public void addInfo(IEntity entity, String message, String location) {
		addDecoration(DecorationKind.INFO, entity, message, location);
	}
	public void addWarning(IEntity entity, String message, String location) {
		addDecoration(DecorationKind.WARNING, entity, message, location);		
	}
	public void addError(IEntity entity, String message, String location) {
		addDecoration(DecorationKind.ERROR, entity, message, location);
	}
}
