 ...
 */
public class ListCompositeEntityImpl<E extends IEntity> extends AbstractListCompositeEntity<org.whole.lang.model.IEntity> {
	private static final long serialVersionUID = 1;

	public ListCompositeEntityImpl() {}
	public ListCompositeEntityImpl(EntityDescriptor<?> ed) {
	...
	public boolean isContainment() {
		return !wGetFeatureDescriptor(0).isReference();
	}
