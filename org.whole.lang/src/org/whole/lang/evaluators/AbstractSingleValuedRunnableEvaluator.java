 ...
 */
public abstract class AbstractSingleValuedRunnableEvaluator<E extends IEntity> extends AbstractRunnableEvaluator<E> {
    protected boolean isEvaluated;

	protected AbstractSingleValuedRunnableEvaluator(IEntityIterator<?>... argsIterators) {
		super(argsIterators);
	}
	protected AbstractSingleValuedRunnableEvaluator(int[] optionalArgsIndexes, IEntityIterator<?>... argsIterators) {
	...
	public E evaluateNext() {
		if (isEvaluated)
			...
			return lastEntity = (E) bm.getResult();
		}
	}
