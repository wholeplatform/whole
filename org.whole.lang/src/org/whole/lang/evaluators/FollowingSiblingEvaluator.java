 ...
 */
public class FollowingSiblingEvaluator<E extends IEntity> extends AbstractByIndexEvaluator<E> {
	protected boolean includeSelf;

	public FollowingSiblingEvaluator(boolean forward, boolean includeSelf) {
		super(forward);
