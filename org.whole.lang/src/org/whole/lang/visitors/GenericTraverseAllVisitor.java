 ...
 */
public class GenericTraverseAllVisitor extends AbstractUnaryVisitor<IVisitor> {
    public GenericTraverseAllVisitor(IVisitor visitor) {
        super(visitor);
    }
	...
	public void visit(IEntityContext context) {
		for (int i=0; i<context.wSize(); i++) {
			wGetVisitor1().visit(context.wGet(i));
		}
	}
}
