 ...
 */
public interface IResourceFactoryRegistry extends IResourceFactory {
	...
	public IResourceFactory addResourceFactory(EntityDescriptor<?> ed, IResourceFactory value);
}
