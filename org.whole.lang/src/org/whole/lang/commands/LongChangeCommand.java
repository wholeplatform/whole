 ...
 */
public class LongChangeCommand extends AbstractCommand {
	private static final long serialVersionUID = 1L;
	private long oldValue;
	public final long newValue;

	public LongChangeCommand(int executionTime, IEntity source, long oldValue, long newValue) {
