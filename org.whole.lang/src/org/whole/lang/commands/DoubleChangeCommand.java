 ...
 */
public class DoubleChangeCommand extends AbstractCommand {
	private static final long serialVersionUID = 1L;
	private double oldValue;
	public final double newValue;

	public DoubleChangeCommand(int executionTime, IEntity source, double oldValue, double newValue) {
