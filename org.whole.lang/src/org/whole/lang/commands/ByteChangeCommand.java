 ...
 */
public class ByteChangeCommand extends AbstractCommand {
	private static final long serialVersionUID = 1L;
	private byte oldValue;
	public final byte newValue;

	public ByteChangeCommand(int executionTime, IEntity source, byte oldValue, byte newValue) {
