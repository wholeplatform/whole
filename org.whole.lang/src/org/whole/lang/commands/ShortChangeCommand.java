 ...
 */
public class ShortChangeCommand extends AbstractCommand {
	private static final long serialVersionUID = 1L;
	private short oldValue;
	public final short newValue;

	public ShortChangeCommand(int executionTime, IEntity source, short oldValue, short newValue) {
