 ...
 */
public class IntChangeCommand extends AbstractCommand {
	private static final long serialVersionUID = 1L;
	private int oldValue;
	public final int newValue;

	public IntChangeCommand(int executionTime, IEntity source, int oldValue, int newValue) {
