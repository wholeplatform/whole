 ...
 */
public class BooleanChangeCommand extends AbstractCommand {
	private static final long serialVersionUID = 1L;
	private boolean oldValue;
	public final boolean newValue;

	public BooleanChangeCommand(int executionTime, IEntity source, boolean oldValue, boolean newValue) {
