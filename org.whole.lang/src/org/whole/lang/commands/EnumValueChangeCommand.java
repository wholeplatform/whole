 ...
 */
public class EnumValueChangeCommand extends AbstractCommand {
	private static final long serialVersionUID = 1L;
	private EnumValue oldValue;
	public final EnumValue newValue;

	public EnumValueChangeCommand(int executionTime, IEntity source, EnumValue oldValue, EnumValue newValue) {
