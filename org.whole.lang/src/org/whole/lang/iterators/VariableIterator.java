 ...
 */
public class VariableIterator<E extends IEntity> extends SelfIterator<E> {
	...
	public boolean hasNext() {
		return useVar && BindingUtils.wIsSet(getBindings(), varName);
	}

	@SuppressWarnings("unchecked")
	@Override
	public E lookahead() {
		return hasNext() ? (E) BindingUtils.wGet(getBindings(), varName) : null;
	}
	@Override
	public E next() {
		try {
