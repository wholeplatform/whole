 ...
 */
public class TestLanguagesDeployer extends AbstractSuiteDeployer {
	public int getDeployLevel() {
		return IDeployer.LEVEL_LANGUAGE;
	}

	@SuppressWarnings("unchecked")
	public TestLanguagesDeployer() {
		super(
			TestEntitiesLanguageDeployer.class,
			TestEventsLanguageDeployer.class
		);
	}
}
