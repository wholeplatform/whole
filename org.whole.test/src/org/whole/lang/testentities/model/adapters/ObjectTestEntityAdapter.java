 ...
 * @generator Whole
 */
public class ObjectTestEntityAdapter extends AbstractEntityAdapter implements
		ObjectTestEntity {
	private static final long serialVersionUID = 1;

	public ObjectTestEntityAdapter(IEntity implementor) {
		super(implementor);
	}

	public ObjectTestEntityAdapter() {
	}
