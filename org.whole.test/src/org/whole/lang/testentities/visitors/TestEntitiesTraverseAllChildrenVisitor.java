 ...
 * @generator Whole
 */
public class TestEntitiesTraverseAllChildrenVisitor extends
		TestEntitiesIdentityUnaryVisitor<ITestEntitiesVisitor> {
	public TestEntitiesTraverseAllChildrenVisitor() {
		wSetVisitor1(this);
	}

	public TestEntitiesTraverseAllChildrenVisitor(IVisitor visitor1) {
		super(visitor1);
	}
