    ...
    public ITemplateFactory<IEntity> newfragment23() {
        return new AbstractTemplateFactory<IEntity>() {
            ...
            public void apply(org.whole.lang.builders.IBuilderOperation op) {
                ...
                b1.Concatenate_(3);
                b1.As_();
                b1.NonTerminal("ARecord");
                b1.Name("header");
                b1._As();
                b1.As_();
                b1.NonTerminal("CRecords");
                b1.Name("body");
                b1._As();
                b1.As_();
                b1.NonTerminal("ERecord");
                b1.Name("footer");
                b1._As();
                b1._Concatenate();
                b0.Resolver();
                ...
                b1.NonTerminal("TOKEN1");
                b1.As_();
                b1.NonTerminal("TransactionKind");
                b1.Name("transactionKind");
                b1._As();
                b1.As_();
                b1.NonTerminal("SNumber");
                b1.Name("bankID");
                b1._As();
                b1.NonTerminal("TOKEN2");
                b1.As_();
                b1.NonTerminal("Chars");
                b1.Name("customerName");
                b1._As();
                b1.As_();
                b1.NonTerminal("SDate");
                b1.Name("currentDate");
                b1._As();
                b1.NonTerminal("TOKEN3");
                b1.As_();
                b1.NonTerminal("LNumber");
                b1.Name("accountNo");
                b1._As();
                b1.As_();
                b1.NonTerminal("RefType");
                b1.Name("refNo");
                b1._As();
                b1.NonTerminal("TOKEN4");
                b1.As_();
                b1.NonTerminal("FDate");
                b1.Name("executionDate");
                b1._As();
                b1.NonTerminal("TOKEN5");
                b1.As_();
                b1.NonTerminal("Currency");
                b1.Name("currency");
                b1._As();
                b1._Concatenate();
                b0.Resolver();
                ...
                b1.As_();
                b1.NonTerminal("SNumber");
                b1.Name("contractingBankID");
                b1._As();
                b1.As_();
                b1.NonTerminal("SNumber");
                b1.Name("targetBankID");
                b1._As();
                b1.As_();
                b1.NonTerminal("LNumber");
                b1.Name("targetAccountNo");
                b1._As();
                b1.As_();
                b1.NonTerminal("InternalID");
                b1.Name("internalCustomerID");
                b1._As();
                b1.As_();
                b1.NonTerminal("TransactionType");
                b1.Name("transactionType");
                b1._As();
                b1.NonTerminal("TOKEN7");
                b1.As_();
                b1.NonTerminal("AMNumber");
                b1.Name("dmAmount");
                b1._As();
                b1.As_();
                b1.NonTerminal("SNumber");
                ...
                b1.NonTerminal("TOKEN10");
                b1.As_();
                b1.NonTerminal("VSNumber");
                b1.Name("expansionRecNo");
                b1._As();
                b1.As_();
                b1.NonTerminal("ExpansionType");
                b1.Name("expansionType1");
                b1._As();
                b1.As_();
                b1.NonTerminal("Chars");
                b1.Name("expansion1");
                ...
                b1.NonTerminal("TOKEN11");
                b1.As_();
                b1.NonTerminal("ExpansionRecords");
                b1.Name("expansionRecords");
                b1._As();
                b1._Concatenate();
                b0.Resolver();
                b1._Production();
                ...
                b1.Size(99);
                b0.Resolver();
                b1.NonTerminal("ExpansionRecord");
                b1._Repeat();
                b0.Resolver();
                b1._Production();
                b1.Production_();
                ...
                b1.NonTerminal("TOKEN14");
                b1.As_();
                b1.NonTerminal("RecordNumber");
                b1.Name("bodyLength");
                b1._As();
                b1.As_();
                b1.NonTerminal("STotal");
                b1.Name("dmTotal");
                b1._As();
                b1.As_();
                b1.NonTerminal("LTotal");
                b1.Name("accountTotal");
                b1._As();
                b1.As_();
                b1.NonTerminal("LTotal");
                b1.Name("bankTotal");
                ...
                b1.NonTerminal("TransactionType");
                b1.DataTerminal_();
                b1.RegExp("((04000)|(05000)|(05005)|(05006)|(05015)|(51000)|(53000)|(54[0-9][0-9]J)|(56000))");
                b1.Category("LITERAL");
                b1.Format("%s");
                b1._DataTerminal();
                b1.DataType("STRING");
                ...
                b1._Production();
                b1._Productions();
                b1.URI("http://examples.whole.org/DTAUSGrammar");
