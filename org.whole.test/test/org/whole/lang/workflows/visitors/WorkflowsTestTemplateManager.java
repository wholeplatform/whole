    ...
    public ITemplateFactory<IEntity> newcreateEntityTest() {
        return new AbstractTemplateFactory<IEntity>() {
            ...
            public void apply(org.whole.lang.builders.IBuilderOperation op) {
                ...
                b3.Create_();
                b3.EntityType("http://lang.whole.org/Models#SimpleEntity");
                b3.Registry("DEFAULT");
                b3.Children_(4);
                b1.StageUpFragment_();
                b2.EntityModifiers_(0);
                b2._EntityModifiers();
                b1._StageUpFragment();
                b3.VariableRefStep("name");
                b1.StageUpFragment_();
                b2.Types_(1);
                b2.SimpleName("Type");
                b2._Types();
                b1._StageUpFragment();
                b3.VariableRefStep("features");
                b3._Children();
                b3._Create();
                b0._Assign();
                b0._Assignments();
    ...
    public ITemplateFactory<IEntity> newinvokeJavaInstanceMethodTest() {
        return new AbstractTemplateFactory<IEntity>() {
            ...
            public void apply(org.whole.lang.builders.IBuilderOperation op) {
                ...
                org.whole.lang.queries.builders.IQueriesBuilder b1 = (org.whole.lang.queries.builders.IQueriesBuilder) op.wGetBuilder(org.whole.lang.queries.reflect.QueriesLanguageKit.URI);
                b1.Create_();
                b1.EntityType("http://lang.whole.org/Models#SimpleEntity");
                b1.Registry("DEFAULT");
                org.whole.lang.commons.builders.ICommonsBuilder b2 = (org.whole.lang.commons.builders.ICommonsBuilder) op.wGetBuilder(org.whole.lang.commons.reflect.CommonsLanguageKit.URI);
                b2.Resolver();
                b1._Create();
                ...
                b0.Expressions_(1);
                b1.Create_();
                b1.EntityType("http://lang.whole.org/Models#CompositeEntity");
                b1.Registry("DEFAULT");
                b2.Resolver();
                b1._Create();
                b0._Expressions();
