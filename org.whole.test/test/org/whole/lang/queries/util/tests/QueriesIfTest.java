...
public class QueriesIfTest extends TestCase {
    ...
    protected static IEntity create(String templateName) {
        return QueriesIfTestTemplateManager.instance().create(templateName);
    }
    ...
    public void testConditionScope() {
        ...
        try {
            ...
            assertThat("at /testCases/2/tests/0/body/0", subject, matches(evaluate("fragment2")));
            subject = evaluate("fragment3");
            assertThat("at /testCases/2/tests/0/body/1", subject, matches(evaluate("fragment4")));
            subject = evaluate("fragment5");
            assertThat("at /testCases/2/tests/0/body/2", subject, matches(evaluate("fragment6")));
        } finally {
            ts.rollback();
            bindings().wExitScope();
        }
