...
public class UndoAction extends AbstractClipboardAction {
	public UndoAction(IEclipseContext context, String label) {
		super(context, label);
		setId(EDIT_UNDO);
		setActionDefinitionId(EDIT_UNDO);
	}

	public UndoAction(IEclipseContext context, String label, String iconURI) {
		this(context, label);
		try {
