 ...
 */
public class OverwriteTextCommand extends AbstractTextCommand {
	private String data;
	private int length;

	public OverwriteTextCommand() {
		super(TextCommandTypes.OVERWRITE);
	}

	@Override
	public boolean canExecute() {
		return length > 0 && (getSourcePart().getCaretPositions() - getSourcePart().getCaretPosition()) >= length;
	}
