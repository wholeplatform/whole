 ...
 */
public class IndexViewer extends AbstractDerivedGraphicalViewer {
	public IndexViewer(Composite parent, WholeEditDomain editDomain, AbstractDerivedGraphicalView view) {
	...
	protected IEntity deriveModel(IEntity model, IEntity firstSelectedEntity, WholeEditDomain editDomain, IStructuredSelection structuredSelection, IProgressMonitor monitor) {
		return FindDeclarationsOperation.findDeclarations(
				model);//, defineBindings(model, editDomain, structuredSelection));
	}
}
