 ...
 */
public class MapView extends AbstractDerivedGraphicalView {
	public static String ID = MapView.class.getName();
	@Override
	...
	protected AbstractDerivedGraphicalViewer createGraphicalViewer(Composite parent, WholeEditDomain editDomain) {
		return new MapViewer(parent, editDomain, this);
	}

	@Override
	protected Page createGraphicalPage(WholeGraphicalViewer viewer) {
		return new MapPage(viewer, this);
	}
