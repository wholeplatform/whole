 ...
 */
public class MapViewer extends AbstractDerivedGraphicalViewer {
	public MapViewer(Composite parent, WholeEditDomain editDomain, AbstractDerivedGraphicalView view) {
	...
	protected IEntity deriveModel(IEntity model, IEntity firstSelectedEntity, WholeEditDomain editDomain, IStructuredSelection structuredSelection, IProgressMonitor monitor) {
		return FindDeclarationOperation.findDeclaration(
				firstSelectedEntity);//, defineBindings(model, editDomain, structuredSelection));
	}
}
