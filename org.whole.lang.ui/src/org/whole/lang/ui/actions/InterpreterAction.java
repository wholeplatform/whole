 ...
 */
public class InterpreterAction extends AbstractVisitorOperationAction {
	public InterpreterAction() {
		super(InterpreterOperation.ID);
	}

	public void run(IProgressMonitor monitor) throws InvocationTargetException, InterruptedException {
		monitor.beginTask("Interpreting...", IOperationProgressMonitor.TOTAL_WORK);
		...
		InterpreterOperation.interpret(entity, args, ioConsole.getInputStream(), os);
	}
}
