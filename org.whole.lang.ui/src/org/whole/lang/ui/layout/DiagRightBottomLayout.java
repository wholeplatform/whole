 ...
 */
public class DiagRightBottomLayout extends AbstractEntityLayout {
	private int horizontalSpacing;
	public int getHorizontalSpacing() {
		return horizontalSpacing;
	}
	public DiagRightBottomLayout withHorizontalSpacing(int spacing) {
	...
	public DiagRightBottomLayout withVerticalSpacing(int spacing) {
		this.verticalSpacing = spacing;
		return this;
	}
	public DiagRightBottomLayout withSpacing(int spacing) {
	...
	protected void setLocation(Rectangle area, int[] x, int[] y) {
		...
		if (v1) {
			x[1] = area.x + (v0 ? getHorizontalSpacing() + childSize[0].width : 0);
