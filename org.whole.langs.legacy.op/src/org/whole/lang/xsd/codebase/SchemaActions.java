...
public class SchemaActions extends AbstractTemplateFactory<org.whole.lang.actions.model.LanguageActionFactory> {
    ...
    public void apply(IBuilderOperation op) {
        ...
        b2.Some_();
        b2.Path_(2);
        b2.FeatureStep("http://www.w3.org/2001/XMLSchema#namespaces");
        b2.ChildStep();
        b2._Path();
        b1.Resolver();
        b2._Some();
        ...
        b2.ChildStep();
        b2.Filter_();
        b2.FeatureStep("http://www.w3.org/2001/XMLSchema#prefix");
        b2.And_(2);
        b2.KindTest("IMPL");
        b2.VariableTest("prefix");
        b2._And();
        ...
        b2.Path_(2);
        b0.ActionCall_();
        b0.Label("whole:org.whole.lang.xsd.codebase:SchemaActions#Derive Model and Mappings");
        b1.Resolver();
        b0._ActionCall();
        org.whole.lang.semantics.builders.ISemanticsBuilder b7 = (org.whole.lang.semantics.builders.ISemanticsBuilder) op.wGetBuilder(org.whole.lang.semantics.reflect.SemanticsLanguageKit.URI);
        b7.FunctionApplication_();
        b7.Name("#stagedVisit");
        b1.Resolver();
        b1.Resolver();
        b1.Resolver();
        b7._FunctionApplication();
        b2._Path();
        b0._SimpleAction();
        b0.SimpleAction_();
        b0.Label("Generate");
        ...
        b2.Select_();
        b1.StageUpFragment_();
        org.whole.lang.artifacts.builders.IArtifactsBuilder b8 = (org.whole.lang.artifacts.builders.IArtifactsBuilder) op.wGetBuilder(org.whole.lang.artifacts.reflect.ArtifactsLanguageKit.URI);
        b8.Workspace_();
        b1.Resolver();
        b8.Projects_(1);
        b8.Project_();
        ...
        b1._Variable();
        b8.Extension("java");
        b8._NameWithExtension();
        b8.Metadata_();
        b1.Resolver();
        b1.Resolver();
        b1.Resolver();
        b1.Resolver();
        b8.PersistenceKitId("org.whole.lang.java.codebase.JavaBuilderPersistenceKit");
        b8._Metadata();
        b1.StageUpFragment_();
        b1.Variable_();
        ...
        b0.MenuActions_(1);
        b0.GuardedAction_();
        b0.Label("Derive Model and Mappings");
        b2.Block_(10);
        b2.Filter_();
        b3.InvokeJavaClassMethod_();
        b3.Text("get default strategy");
        ...
        b2._Call();
        b1.StageUpFragment_();
        org.whole.lang.misc.builders.IMiscBuilder b9 = (org.whole.lang.misc.builders.IMiscBuilder) op.wGetBuilder(org.whole.lang.misc.reflect.MiscLanguageKit.URI);
        b9.Misc_(2);
        b1.StageDownFragment_();
        b2.Filter_();
        b2.ChildStep();
