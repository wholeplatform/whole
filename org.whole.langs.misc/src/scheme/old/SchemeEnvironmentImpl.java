...
class SchemeEnvironmentImpl implements SchemeEnvironment {
    public SchemeEnvironmentImpl() {
	map = new HashMap();
    }
	...
	return new SchemeEnvironmentImpl(map);
    }
	...
	return (SchemeValue) map.get(name);
    }
