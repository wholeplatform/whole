 ...
 * @generator Whole
 */
public class JoinImpl extends AbstractSimpleEntity implements Join {
	...
	public int wGetEntityOrd() {
		return FlowchartEntityDescriptorEnum.Join_ord;
	}
	...
	private Transitions targetTransitions;

	public Transitions getTargetTransitions() {
		return notifyRequested(
				FlowchartFeatureDescriptorEnum.targetTransitions,
				targetTransitions);
	}

	public void setTargetTransitions(Transitions targetTransitions) {
		notifyChanged(FlowchartFeatureDescriptorEnum.targetTransitions,
				this.targetTransitions,
				this.targetTransitions = targetTransitions, false);
	}
	...
	public IEntity wGet(int index) {
		...
		case 5:
			return getTargetTransitions().wGetAdaptee(false);
		case 6:
