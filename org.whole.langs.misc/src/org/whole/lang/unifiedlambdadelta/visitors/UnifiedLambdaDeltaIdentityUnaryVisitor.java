 ...
 * @generator Whole
 */
public class UnifiedLambdaDeltaIdentityUnaryVisitor<V extends IVisitor> extends
		AbstractUnaryVisitor<V> implements IUnifiedLambdaDeltaVisitor {
	public UnifiedLambdaDeltaIdentityUnaryVisitor() {
		super(null);
	}

	public UnifiedLambdaDeltaIdentityUnaryVisitor(IVisitor visitor1) {
		super(visitor1);
	}
