...
import org.whole.lang.unifiedlambdadelta.ui.figures.NameFigure;

/** 
 * @author Riccardo Solmi
 */
public class NamePart extends AbstractContentPanePart {
	...
	protected List<IEntity> getModelSpecificChildren() {
		...
		Name entity = getModelEntity();
		list.add(entity.getAccess());
		list.add(entity.getPrefix());
		list.add(entity.getPostfix());
		return list;
	}
}
