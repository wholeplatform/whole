 ...
 * @generator Whole
 */
public class BinaryContextBinderAdapter extends AbstractEntityAdapter implements
		BinaryContextBinder {
	private static final long serialVersionUID = 1;

	public BinaryContextBinderAdapter(IEntity implementor) {
		super(implementor);
	}

	public BinaryContextBinderAdapter() {
	}
	...
	public EntityDescriptor<BinaryContextBinder> wGetEntityDescriptor() {
		return UnifiedLambdaDeltaEntityDescriptorEnum.BinaryContextBinder;
	}
