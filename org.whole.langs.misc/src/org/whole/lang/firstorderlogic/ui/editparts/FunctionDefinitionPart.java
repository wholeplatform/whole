...
import org.whole.lang.firstorderlogic.ui.figures.FunctionFigure;
 ...
 */
public class FunctionDefinitionPart extends AbstractContentPanePart {
	...
	protected List<IEntity> getModelSpecificChildren() {
		...
		FunctionDefinition entity = getModelEntity();
		list.add(entity.getFunction());
		list.add(entity.getParameters());
		list.add(entity.getTerm());
		return list;
	}
}