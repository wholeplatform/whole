...
import org.whole.lang.firstorderlogic.ui.figures.PredicateFigure;
 ...
 */
public class PredicateDefinitionPart extends AbstractContentPanePart {
	protected IFigure createFigure() {
		return new PredicateFigure();
	}

	protected List<IEntity> getModelSpecificChildren() {
		List<IEntity> list = new ArrayList<IEntity>(3);
		PredicateDefinition entity = getModelEntity();
