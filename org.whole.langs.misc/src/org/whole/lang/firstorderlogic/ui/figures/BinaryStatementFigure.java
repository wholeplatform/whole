 ...
 */
public class BinaryStatementFigure extends ContentPaneFigure {
    private IFigure p1, p2, p3, p4;

    public BinaryStatementFigure(String operatorLabel) {
        super(new RowLayout().withSpacing(0));
        initContentPanes(2);
        p1 = addContentLighter("(");
        add(createContentPane(0));
        p2 = addContentLighter(")");
        addLabel(operatorLabel).setFont(WholeUIPlugin.getOpenSymbolMediumFont());
