 ...
 * @generator Whole
 */
public class CoimplicationAdapter extends AbstractEntityAdapter implements
		Coimplication {
	private static final long serialVersionUID = 1;

	public CoimplicationAdapter(IEntity implementor) {
		super(implementor);
	}

	public CoimplicationAdapter() {
	}
	...
	public EntityDescriptor<Coimplication> wGetEntityDescriptor() {
		return FirstOrderLogicEntityDescriptorEnum.Coimplication;
	}
