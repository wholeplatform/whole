 ...
 * @generator Whole
 */
public class FirstOrderLogicForwardGenericVisitor extends
		AbstractUnaryVisitor<IVisitor> implements IFirstOrderLogicVisitor {
	public FirstOrderLogicForwardGenericVisitor(IVisitor visitor1) {
		super(visitor1);
	}
