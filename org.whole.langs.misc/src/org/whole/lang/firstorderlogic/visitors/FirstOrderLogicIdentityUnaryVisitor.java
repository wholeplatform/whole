 ...
 * @generator Whole
 */
public class FirstOrderLogicIdentityUnaryVisitor<V extends IVisitor> extends
		AbstractUnaryVisitor<V> implements IFirstOrderLogicVisitor {
	public FirstOrderLogicIdentityUnaryVisitor() {
		super(null);
	}

	public FirstOrderLogicIdentityUnaryVisitor(IVisitor visitor1) {
		super(visitor1);
	}
