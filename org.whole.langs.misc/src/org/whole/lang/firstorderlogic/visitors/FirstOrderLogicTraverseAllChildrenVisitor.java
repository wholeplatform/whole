 ...
 * @generator Whole
 */
public class FirstOrderLogicTraverseAllChildrenVisitor extends
		FirstOrderLogicIdentityUnaryVisitor<IFirstOrderLogicVisitor> {
	public FirstOrderLogicTraverseAllChildrenVisitor() {
		wSetVisitor1(this);
	}

	public FirstOrderLogicTraverseAllChildrenVisitor(IVisitor visitor1) {
		super(visitor1);
	}
