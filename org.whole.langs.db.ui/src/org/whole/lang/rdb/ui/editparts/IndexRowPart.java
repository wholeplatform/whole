 ...
 */
public class IndexRowPart extends AbstractPart {
	...
	protected List<IEntity> getModelSpecificChildren() {
		...
		Index entity = getModelEntity();
		children.add(entity.getName());
		children.add(entity.getQualifier());
		children.add(entity.getUnique());
		children.add(entity.getType());
		children.add(entity.getColumnIndices());
		return children;
	}
}
