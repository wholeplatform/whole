 ...
 */
public class CloneGroupTreeRightLayout extends FeatureGroupTreeRightLayout implements IFeatureGroupLayout {
	{
		CHILDREN_GAP = 10;
	}
	...
	protected ConnectionAnchor[] createRootTargetAnchors(IStyledFigure styledFigure) {
		return new ConnectionAnchor[] {
				AnchorFactory.createRightMiddleAnchor(childFigure[0])
		};
	}
