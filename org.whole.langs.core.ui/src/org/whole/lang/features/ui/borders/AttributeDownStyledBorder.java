 ...
 */
public class AttributeDownStyledBorder extends RectangleStyledBorder {

	@Override
	public void paintBackground(IFigure figure, Graphics graphics, Insets insets) {
		if (getFillColor() != null) {
			updateTempRect(figure, insets);
			tempRect.resize(0, - ((IFigure) figure.getChildren().get(1)).getBounds().height-2);
			...
			graphics.drawLine(tempRect.x, tempRect.bottom()-1, tempRect.right(), tempRect.bottom()-1);
		}
	}
}
