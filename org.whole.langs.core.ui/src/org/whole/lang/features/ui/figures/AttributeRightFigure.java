...
import org.whole.lang.features.ui.borders.AttributeRightStyledBorder;
 ...
 */
public class AttributeRightFigure extends StyledFigure {

	public AttributeRightFigure() {
		super(new LeafLayout());
		setShapeInsets(new Insets(2,0,0,3));
...
//		headerFigure.addParenthesis(")");
	...
	protected IStyledBorder createShape() {
		return new AttributeRightStyledBorder();
	}
}
