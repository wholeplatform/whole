...
import org.whole.lang.features.ui.layouts.CloneGroupTreeRightLayout;

/**
 * @author Riccardo Solmi
 */
public class CloneGroupRightPart extends CloneGroupDownPart {
	protected IFigure createFigure() {
		return new FeatureGroupFigure(
				new CloneGroupTreeRightLayout(), new Insets(0,0,14,6));
	}
	@Override
