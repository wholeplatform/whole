...
import org.whole.lang.reusables.ui.figures.AdaptFigure;

/**
 *  @generator Whole
 */
public class AdaptPart extends AbstractContentPanePart {

    protected IFigure createFigure() {
        return new AdaptFigure();
    }

    protected List<IEntity> getModelSpecificChildren() {
        Adapt entity = getModelEntity();
