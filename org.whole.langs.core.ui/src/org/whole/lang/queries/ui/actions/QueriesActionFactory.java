...
public class QueriesActionFactory extends ActionFactory {
	...
	public Object[][] wrapActions() {
		...
		return new Object[][] {
				{ pf.assignableTo(QueriesEntityDescriptorEnum.Expression), QueriesEntityDescriptorEnum.Delete, "Delete", wrapIn0},
				{ pf.assignableTo(QueriesEntityDescriptorEnum.Expression), QueriesEntityDescriptorEnum.CartesianInsert, "Cartesian Insert", wrapIn(1)},
				{ pf.assignableTo(QueriesEntityDescriptorEnum.Expression), QueriesEntityDescriptorEnum.PointwiseInsert, "Pointwise Insert", wrapIn(1)},
				{ pf.assignableTo(QueriesEntityDescriptorEnum.Expression), QueriesEntityDescriptorEnum.CartesianUpdate, "Cartesian Update", wrapIn0},
				{ pf.assignableTo(QueriesEntityDescriptorEnum.Expression), QueriesEntityDescriptorEnum.PointwiseUpdate, "Pointwise Update", wrapIn0},
				{ pf.assignableTo(QueriesEntityDescriptorEnum.Expression), QueriesEntityDescriptorEnum.Select, "Select", wrapIn(1)},
				{ pf.assignableTo(QueriesEntityDescriptorEnum.Expression), QueriesEntityDescriptorEnum.For, "For", wrapIn0},
				{ pf.assignableTo(QueriesEntityDescriptorEnum.Expression), QueriesEntityDescriptorEnum.If, "If", wrapIn(1)},
				...
				{ pf.assignableTo(QueriesEntityDescriptorEnum.Expression), QueriesEntityDescriptorEnum.Filter, "Filter as expression", wrapIn0},
				{ pf.assignableTo(QueriesEntityDescriptorEnum.Expression), QueriesEntityDescriptorEnum.Filter, "Filter as predicate", wrapIn(1)},
