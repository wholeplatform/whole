...
import org.whole.lang.queries.model.ExpressionTest;
 ...
 */
public class ExpressionTestPart extends AbstractContentPanePart {
	protected IFigure createFigure() {
		IFigure f = new ParenthesizedPredicateFigure(7);
		f.setBorder(new SquareBracketsBorder(7, 7)  {
	...
	protected List<IEntity> getModelSpecificChildren() {
		ExpressionTest entity = getModelEntity();
