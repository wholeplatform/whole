...
import org.whole.lang.queries.ui.figures.InfixExpressionFigure;
...
public class InfixExpressionPart extends AbstractContentPanePart {
	...
	protected List<IEntity> getModelSpecificChildren() {
		...
		IEntity exp1 = entity.wGet(QueriesFeatureDescriptorEnum.exp1);
		IEntity exp2 = entity.wGet(QueriesFeatureDescriptorEnum.exp2);
