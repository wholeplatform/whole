...
import org.whole.lang.queries.ui.figures.VariableTestFigure;
 ...
 */
public class VariableTestPart extends AbstractOverQualifiedDataEntityPart {
	private boolean showBrackets;

	public VariableTestPart(boolean showBrackets) {
		this.showBrackets = showBrackets;
	}

	public IFigure createFigure() {
		return new VariableTestFigure(showBrackets);
	}
