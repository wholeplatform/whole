 ...
 */
public class DashedScopeBracketsBorder extends MarginBorder {
	public DashedScopeBracketsBorder(int margin) {
		super(margin);
	}
	public DashedScopeBracketsBorder(int top, int left, int bottom, int right) {
