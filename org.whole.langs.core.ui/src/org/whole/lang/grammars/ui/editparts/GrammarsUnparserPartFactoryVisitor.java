 ...
 */
public class GrammarsUnparserPartFactoryVisitor extends GrammarsPartFactoryVisitor {
	@Override
	public void visit(LiteralTerminal entity) {
		part = new LiteralTerminalUnparserPart();
	}

	@Override
	public void visit(DataTerminal entity) {
		part = new DataTerminalUnparserPart();
	}
}
