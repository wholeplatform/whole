 ...
 */
public class SplitPart extends AbstractPart {
	protected IFigure createFigure() {
		IFigure f = new EntityFigure(new OverColumnLayout().withSpacing(4)
				.withMinorAlignment(Alignment.FILL));//CENTER).withAutoresizeWeight(1f));
