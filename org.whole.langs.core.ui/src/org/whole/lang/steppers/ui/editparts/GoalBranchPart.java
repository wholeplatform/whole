...
import org.whole.lang.steppers.ui.figures.GoalBranchFigure;

/**
 *  @generator Whole
 */
public class GoalBranchPart extends AbstractContentPanePart {

    protected IFigure createFigure() {
        return new GoalBranchFigure();
    }

    protected List<IEntity> getModelSpecificChildren() {
        GoalBranch entity = getModelEntity();
