...
import org.whole.lang.steppers.ui.figures.ArgumentBranchFigure;

/**
 *  @generator Whole
 */
public class ArgumentBranchPart extends AbstractContentPanePart {

    protected IFigure createFigure() {
        return new ArgumentBranchFigure();
    }

    protected List<IEntity> getModelSpecificChildren() {
        ArgumentBranch entity = getModelEntity();
