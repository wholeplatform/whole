 ...
 *  @generator Whole
 */
public class SteppersEditorKit extends AbstractEditorKit {
    private static final long serialVersionUID = 1;
    public static final String ID = SteppersEditorKit.class.getName();
    ...
    public IEditPartFactory getPartFactory() {
        return new SteppersPartFactoryVisitor();
    }
