...
import org.whole.lang.workflows.ui.figures.CreateModelFigure;

/**
 * @author Riccardo Solmi
 */
public class CreateModelPart extends AbstractContentPanePart {
	protected IFigure createFigure() {
		return new CreateModelFigure();
	}

	protected List<IEntity> getModelSpecificChildren() {
		CreateModel entity = getModelEntity();
