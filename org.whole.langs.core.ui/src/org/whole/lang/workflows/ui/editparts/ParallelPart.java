...
import org.whole.lang.ui.notations.flowchart.figures.ParallelFigure;
import org.whole.lang.workflows.model.Parallel;

/**
 * @author Riccardo Solmi
 */
public class ParallelPart extends AbstractContentPanePart {
	protected IFigure createFigure() {
		return new ParallelFigure();
	}

	protected List<IEntity> getModelSpecificChildren() {
		Parallel entity = getModelEntity();
