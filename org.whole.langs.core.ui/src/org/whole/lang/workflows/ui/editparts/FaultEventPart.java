...
import org.whole.lang.ui.notations.flowchart.figures.IntermediateEventFigure;
import org.whole.lang.workflows.model.FaultEvent;

/**
 * @author Riccardo Solmi
 */
public class FaultEventPart extends AbstractContentPanePart {
	protected IFigure createFigure() {
		return new IntermediateEventFigure(NotationImages.THROW16);
	}

	protected List getModelSpecificChildren() {
		FaultEvent entity = getModelEntity();
