 ...
 */
public class ConditionalCasePart extends AbstractContentPanePart {
	protected IFigure createFigure() {
		return new GuardedActivityFigure(NotationImages.CASE16);
	}

	protected List<IEntity> getModelSpecificChildren() {
		ConditionalCase entity = getModelEntity();
