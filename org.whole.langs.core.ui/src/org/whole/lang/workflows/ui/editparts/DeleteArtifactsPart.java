...
import org.whole.lang.workflows.ui.figures.DeleteArtifactsFigure;

/**
 * @author Enrico Persiani
 */
public class DeleteArtifactsPart extends AbstractContentPanePart {
	protected IFigure createFigure() {
		return new DeleteArtifactsFigure();
	}

	protected List<IEntity> getModelSpecificChildren() {
		DeleteArtifacts entity = getModelEntity();
