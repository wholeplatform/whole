...
import org.whole.lang.workflows.ui.figures.LoadJavaModelFigure;

/**
 * @author Enrico Persiani
 */
public class LoadJavaModelPart extends AbstractContentPanePart {
	protected IFigure createFigure() {
		return new LoadJavaModelFigure();
	}

	protected List<IEntity> getModelSpecificChildren() {
		LoadJavaModel entity = getModelEntity();
		...
		children.add(entity.getClassProvider());
		return children;
	}
}
