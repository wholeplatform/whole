...
import org.whole.lang.ui.notations.flowchart.figures.DefaultActivityFigure;
import org.whole.lang.workflows.model.DefaultCase;

/**
 * @author Riccardo Solmi
 */
public class DefaultCasePart extends AbstractContentPanePart {
	protected IFigure createFigure() {
		return new DefaultActivityFigure(NotationImages.CASE16);
	}

	protected List<IEntity> getModelSpecificChildren() {
		DefaultCase entity = getModelEntity();
