...
import org.whole.lang.workflows.ui.figures.InvokeJavaInstanceMethodFigure;

/**
 * @author Riccardo Solmi
 */
public class InvokeJavaInstanceMethodPart extends AbstractContentPanePart {
	protected IFigure createFigure() {
		return new InvokeJavaInstanceMethodFigure();
	}
	@Override
	public InvokeJavaInstanceMethodFigure getFigure() {
		return (InvokeJavaInstanceMethodFigure) super.getFigure();
	}
