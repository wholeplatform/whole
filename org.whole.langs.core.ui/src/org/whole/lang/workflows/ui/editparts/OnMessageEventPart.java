...
import org.whole.lang.ui.notations.flowchart.figures.StartEventFigure;
import org.whole.lang.workflows.model.OnMessageEvent;

/**
 * @author Riccardo Solmi
 */
public class OnMessageEventPart extends AbstractContentPanePart {
	protected IFigure createFigure() {
		return new StartEventFigure(NotationImages.ON_MESSAGE16);
	}

	protected List getModelSpecificChildren() {
		OnMessageEvent entity = getModelEntity();
