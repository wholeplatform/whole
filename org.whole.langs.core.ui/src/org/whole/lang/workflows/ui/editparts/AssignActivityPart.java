...
import org.whole.lang.workflows.ui.figures.AssignActivityFigure;

/**
 * @author Riccardo Solmi
 */
public class AssignActivityPart extends AbstractContentPanePart {
	protected IFigure createFigure() {
		return new AssignActivityFigure();
	}

	protected List<IEntity> getModelSpecificChildren() {
		AssignActivity entity = getModelEntity();
