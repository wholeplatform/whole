...
import org.whole.lang.workflows.ui.figures.SaveModelFigure;

/**
 * @author Riccardo Solmi
 */
public class SaveModelPart extends AbstractContentPanePart {
	protected IFigure createFigure() {
		return new SaveModelFigure();
	}

	protected List<IEntity> getModelSpecificChildren() {
		SaveModel entity = getModelEntity();
