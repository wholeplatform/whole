...
import org.whole.lang.workflows.ui.figures.SaveArtifactsFigure;

/**
 * @author Riccardo Solmi
 */
public class SaveArtifactsPart extends AbstractContentPanePart {
	protected IFigure createFigure() {
		return new SaveArtifactsFigure();
	}

	protected List<IEntity> getModelSpecificChildren() {
		SaveArtifacts entity = getModelEntity();
