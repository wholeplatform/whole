...
import org.whole.lang.workflows.ui.figures.LoadModelFigure;

/**
 * @author Riccardo Solmi
 */
public class LoadModelPart extends AbstractContentPanePart {
	protected IFigure createFigure() {
		return new LoadModelFigure();
	}

	protected List<IEntity> getModelSpecificChildren() {
		LoadModel entity = getModelEntity();
		...
		children.add(entity.getResourceKind());
