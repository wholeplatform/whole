...
import org.whole.lang.ui.notations.flowchart.figures.ActivityFigure;
import org.whole.lang.workflows.model.EmptyActivity;

/**
 * @author Riccardo Solmi
 */
public class EmptyActivityPart extends AbstractTextualEntityPart {
	protected IFigure createFigure() {
		return new ActivityFigure(NotationImages.EMPTY16);
	}

	public IEntity getModelTextEntity() {
		EmptyActivity entity = getModelEntity();
