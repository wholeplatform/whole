 ...
 */
public class ParseFigure extends AbstractActivityWithTableFigure {
	public ParseFigure() {
	...
	public void paintFigure(Graphics g) {
        ...
        PaintFigureHelper.drawGradientRoundRectangle(g, getBounds(),
        		ColorConstants.white, FigureUtilities.lighter(ColorConstants.lightBlue), ColorConstants.darkBlue, false);
	}
}
