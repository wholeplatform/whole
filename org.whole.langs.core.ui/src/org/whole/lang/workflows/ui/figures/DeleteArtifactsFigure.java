 ...
 */
public class DeleteArtifactsFigure extends AbstractActivityWithTableFigure {
	public DeleteArtifactsFigure() {
	...
	public void paintFigure(Graphics g) {
        ...
        PaintFigureHelper.drawFilledRoundRectangle(g, getBounds(),
        		ColorConstants.darkGreen, FigureUtilities.lighter(ColorConstants.lightGreen));
	}
}
