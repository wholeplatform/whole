 ...
 */
public class InvokeOperationFigure extends AbstractActivityWithTableFigure {
	private Label constructorLabel;

	public InvokeOperationFigure() {
		super(4, NotationImages.OPERATION16);
