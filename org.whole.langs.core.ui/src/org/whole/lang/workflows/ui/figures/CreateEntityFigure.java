 ...
 */
public class CreateEntityFigure extends AbstractActivityWithTableFigure {
	public CreateEntityFigure() {
		super(5, NotationImages.CREATE_MODEL16);
		...
		row.add(createContentPane(4, new MarginBorder(4,0,0,0)));
		contentFigure.add(row);
	}
