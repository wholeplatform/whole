 ...
 */
public class MathEditorKit extends AbstractEditorKit {
	private static final long serialVersionUID = 1;

	public static final String ID = MathEditorKit.class.getName();
	...
	public IEditPartFactory getPartFactory() {
		return new MathPartFactoryVisitor();
	}

	public boolean canApply(ILanguageKit languageKit) {
		return languageKit.getURI().equals(MathLanguageKit.URI);
	}
}
