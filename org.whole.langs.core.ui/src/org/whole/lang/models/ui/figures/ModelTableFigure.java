 ...
 */
public class ModelTableFigure extends ContentPaneFigure {
	public ModelTableFigure() {
		initContentPanes(6);
		...
		uriRowFigure.add(createContentPane(3));
		...
		nameRowFigure.addContentLighter("Model Name");
		...
		versionRowFigure.add(createContentPane(2));
		headersFigure.add(versionRowFigure);

		TableRowFigure typeRelationsRowFigure = new TableRowFigure();
		typeRelationsRowFigure.addContentLighter("Foreign Types\nRelations");
		typeRelationsRowFigure.add(createContentPane(4));
		headersFigure.add(typeRelationsRowFigure);
