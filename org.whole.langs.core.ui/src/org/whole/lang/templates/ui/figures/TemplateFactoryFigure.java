 ...
 */
package org.whole.lang.templates.ui.figures;
 ...
 */
public class TemplateFactoryFigure extends ContentPaneFigure {

    public TemplateFactoryFigure() {
        super(new ColumnLayout());
        initContentPanes(3);
        EntityFigure row;
        add(row = new EntityFigure(new RowLayout().withSpacing(4)));
        setBorder(new MarginBorder(4, 0, 4, 0));
        row.addKeyword("template");
