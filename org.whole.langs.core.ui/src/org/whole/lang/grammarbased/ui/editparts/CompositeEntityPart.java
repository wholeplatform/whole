...
import org.whole.lang.grammarbased.ui.figures.CompositeEntityFigure;
 ...
 */
public class CompositeEntityPart extends AbstractCompositePart {
	protected IEntity configuration;

	public CompositeEntityPart(IEntity configuration) {
		this.configuration = configuration;
	}

	@Override
	protected IFigure createFigure() {
		return new CompositeEntityFigure(configuration);
	}
