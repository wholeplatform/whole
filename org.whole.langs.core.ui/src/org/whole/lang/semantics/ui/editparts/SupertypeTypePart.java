 ...
 */
public class SupertypeTypePart extends AbstractContentPanePart {
	protected IFigure createFigure() {
		PrefixContentPaneFigure f = new PrefixContentPaneFigure("\u2282", 1);
		f.getLayoutManager().withMarginLeft(2).withMarginRight(2);
		return f;
	}

	protected List<IEntity> getModelSpecificChildren() {
		SupertypeType entity = getModelEntity();
