...
import org.whole.lang.semantics.ui.figures.VariableValueFigure;
 ...
 */
public class VariableValuePart extends AbstractContentPanePart {
	protected IFigure createFigure() {
		return new VariableValueFigure();
	}

	protected List<IEntity> getModelSpecificChildren() {
		VariableValue entity = getModelEntity();
	...
	protected void refreshVisuals() {
		...
		VariableValue entity = getModelEntity();
		VariableValueFigure f = (VariableValueFigure) getFigure();
