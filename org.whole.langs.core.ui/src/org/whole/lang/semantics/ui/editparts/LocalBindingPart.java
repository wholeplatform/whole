...
import org.whole.lang.semantics.ui.figures.BindingFigure;
import org.whole.lang.ui.editparts.AbstractContentPanePart;

/**
 * @author Riccardo Solmi
 */
public class LocalBindingPart extends AbstractContentPanePart {
	protected IFigure createFigure() {
		return new BindingFigure();
	}

	protected List<IEntity> getModelSpecificChildren() {
		LocalBinding entity = getModelEntity();
		List<IEntity> list = new ArrayList<IEntity>(3);
		list.add(entity.getOp());
