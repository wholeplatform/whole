...
import org.whole.lang.semantics.ui.figures.TypedVariableFigure;

/**
 * @author Riccardo Solmi
 */
public class TypedVariablePart extends AbstractVariablePart {
	protected IFigure createFigure() {
		return new TypedVariableFigure();
	}

	protected List<IEntity> getModelSpecificChildren() {
		TypedVariable entity = getModelEntity();
